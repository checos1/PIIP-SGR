(function () {
    'use strict';
    angular.module('backbone').factory('conpesSgpServicio', conpesSgpServicio);

    conpesSgpServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];

    function conpesSgpServicio($q, $http, $location, constantesBackbone) {
        return {
