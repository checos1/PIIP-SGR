var politicasTransversalesMlFormularioCtrl = null;

(function () {
    'use strict';
    angular.module('backbone').controller('politicasTransversalesMlFormulario', politicasTransversalesMlFormulario);
    politicasTransversalesMlFormulario.$inject = [
        '$scope',
        '$uibModal',
        '$log',
        '$q',
    ...
    function politicasTransversalesMlFormulario(
        $scope,
        $uibModal,
        $log,
        $q,
        ...
        utilidades) {
        var vm = this;
        politicasTransversalesMlFormularioCtrl = vm;
        //variables
        vm.lang = "es";
        vm.TabActivo = 1;
        vm.nombreComponente = "politicasTransversalesMlFormulario";
                ...
                function (respuesta) {
                    if (respuesta.data != null && respuesta.data != "") {
                        ...
                        for (var pl = 0; pl < arregloDatosGenerales.length; pl++) {
                            ...
                            if (arregloDatosGenerales[pl].EnProyecto || arregloDatosGenerales[pl].EnFirme)
        ...
        function abrirModalAgregarPoliticaTrans() {
            ...
            $uibModal.open({
                templateUrl: 'src/app/formulario/ventanas/comun/modificacionLey/politicas/detallePolitica/politica/modal/modalAgregarPoliticaTransversalMl.html',
                controller: 'modalAgregarPoliticaTransversalMlController',
                bindings: {
                    tramiteproyectoid: '@',
                    proyectoid: '@'
                }
        ...
        function eliminarPolitica(politicaId, politica) {
            ...
            utilidades.mensajeWarning("¿Está seguro de continuar?", function funcionContinuar() {
                ...
                return comunesServicio.eliminarPoliticasProyectoProgramacion(vm.tramiteproyectoid, politicaId).then(
                    function (respuesta) {
    ...
    angular.module('backbone')
        .component('politicasTransversalesMlFormulario', {
            templateUrl: 'src/app/formulario/ventanas/comun/modificacionLey/politicas/detallePolitica/politica/politicasTransversalesMlFormulario.html',
            controller: 'politicasTransversalesMlFormulario',
            controllerAs: 'vm',
            bindings: {
                callback: '&',
