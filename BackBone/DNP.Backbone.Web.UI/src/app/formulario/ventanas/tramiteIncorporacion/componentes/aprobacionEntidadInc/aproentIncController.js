(function () {
    ...
    aproentIncController.$inject = ['$scope',];

    function aproentIncController(
        $scope,
    ...
    angular.module('backbone').component('aproentInc', {
        templateUrl: "/src/app/formulario/ventanas/tramiteIncorporacion/componentes/aprobacionEntidadInc/aproentInc.html",

        controller: aproentIncController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
