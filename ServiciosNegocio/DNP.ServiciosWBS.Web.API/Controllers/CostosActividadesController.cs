namespace DNP.ServiciosWBS.Web.API.Controllers
{
    ...
    public class CostosActividadesController : ApiController
    {
        private readonly ICostosActividadesServicios _costosActividadesServicios;
        private readonly IAutorizacionUtilidades _autorizacionUtilidades;

        public CostosActividadesController(ICostosActividadesServicios costosActividadesServicios, IAutorizacionUtilidades autorizacionUtilidades)
        {
            _costosActividadesServicios = costosActividadesServicios;
            _autorizacionUtilidades = autorizacionUtilidades;
        }

        [Route("api/DNP_SN_Eje_Ajustes_CostosActividadesDto")]
        [SwaggerResponse(HttpStatusCode.OK, "Retorna costo de las actividades", typeof(CostosActividadesDto))]
        [HttpGet]
        public async Task<IHttpActionResult> Consultar(string bpin)
        {
            ...
            var result = await Task.Run(() => _costosActividadesServicios.ObtenerCostosActividades(
        ...
        [Route("api/DNP_SN_Eje_Ajustes_CostosActividadesDto/Preview")]
        [SwaggerResponse(HttpStatusCode.OK, "Retorna costo de actividades", typeof(CostosActividadesDto))]
        [HttpGet]
        public async Task<IHttpActionResult> Preview()
        {
            ...
            var result = await Task.Run(() => _costosActividadesServicios.ObtenerCostosActividadesPreview());
            return Ok(result);
        }
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Definitivo(CostosActividadesDto costosActividadesDto)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.ValidarUsuario(RequestContext.Principal.Identity.Name, 
                ...
                var parametrosGuardar = _costosActividadesServicios.ConstruirParametrosGuardado(Request, costosActividadesDto);
                ...
                await Task.Run(() => _costosActividadesServicios.Guardar(parametrosGuardar, parametrosAuditoria, false));
        ...
        [Route("api/DNP_SN_Eje_Ajustes_CostosActividadesDto/Temporal")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion devuelta por guardado definitivo", typeof(HttpResponseMessage))]
        [HttpPost]
        public async Task<IHttpActionResult> Temporal(CostosActividadesDto costosActividadesDto)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.ValidarUsuario(RequestContext.Principal.Identity.Name, 
                ...
                await Task.Run(() => _costosActividadesServicios.Guardar(parametrosGuardar, parametrosAuditoria, true));
