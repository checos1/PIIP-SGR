(function () {
    'use strict';
    firmaCtusIntegradoSgrController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function firmaCtusIntegradoSgrController(
        utilidades,
        $sessionStorage,
        justificacionCambiosServicio,
        servicioFichasProyectos,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgrctusintegradofirmaprocesofirma';
        //vm.ventanaPadre = 'FirmaCtusIntegradoSgr';
        ...
        vm.mostrarBotonPdf = function () {
            var mostrar = false;
            if (vm.nombreComponente == "sgrctusintegradofirmaprocesofirma") { mostrar = true; }
            return mostrar;
            ;
    ...
    angular.module('backbone').component('firmaCtusIntegradoSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/firmaEmision/procesoFirma/procesoFirmaSgr/firmaCtusIntegradoSgr.html",
        controller: firmaCtusIntegradoSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
