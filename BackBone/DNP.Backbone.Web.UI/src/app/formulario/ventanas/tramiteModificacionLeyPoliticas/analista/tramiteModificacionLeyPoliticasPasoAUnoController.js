(function () {
    ...
    tramiteModificacionLeyPoliticasPasoAUnoController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionLeyPoliticasPasoAUnoController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
        ...
        vm.obtenerDetalleTramiteyRol = function () {
            ...
            $sessionStorage.soloLecturaBandera = $sessionStorage.soloLectura;
            //Solo para casos de ML analista en paso 1
            $sessionStorage.soloLectura = !vm.rolAnalista;
    ...
    angular.module('backbone').component('tramiteModificacionLeyPoliticasPasoAUno', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionLeyPoliticas/analista/tramiteModificacionLeyPoliticasPasoAUno.html",
        controller: tramiteModificacionLeyPoliticasPasoAUnoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
