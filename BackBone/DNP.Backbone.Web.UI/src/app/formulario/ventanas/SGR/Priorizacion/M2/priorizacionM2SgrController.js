(function () {
    ...
    priorizacionM2SgrController.$inject = ['$scope', 'priorizacionSgrServicio', 'utilidades', '$sessionStorage', 'sesionServicios', 'utilsValidacionSeccionCapitulosServicio', 'constantesBackbone', 'validacionArchivosServicio'];

    function priorizacionM2SgrController(
        $scope,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrpriorizacionm2priorizacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
        ...
        vm.inicializarComponenteCheck = function (estado) {
            ...
            vm.handlerComponentesChecked = {
                'sgrpriorizacionM2priorizacion': true,
                'sgrpriorizacionM2soportes': true,
            };
        }
    ...
    angular.module('backbone').component('priorizacionM2Sgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/Priorizacion/M2/priorizacionM2Sgr.html",

        controller: priorizacionM2SgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
