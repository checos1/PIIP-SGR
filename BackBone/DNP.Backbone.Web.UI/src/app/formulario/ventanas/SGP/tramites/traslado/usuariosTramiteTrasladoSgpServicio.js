(function () {
    ...
    angular.module('backbone').factory('usuariosTramiteTrasladoSgpServicio', usuariosTramiteTrasladoSgpServicio);

    usuariosTramiteTrasladoSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function usuariosTramiteTrasladoSgpServicio($http, constantesBackbone) {
