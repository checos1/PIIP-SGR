...
{
    public interface IEjecutorEntidadServicio
    {
        /// <summary>
        ...
        /// <returns></returns>
        Task<List<EjecutorEntidadDto>> ConsultarListadoEjecutores(string nit, int? tipoEntidadId, int? entidadId);
        ...
        /// <returns></returns>
        Task<List<EjecutorEntidadAsociado>> ObtenerListadoEjecutoresAsociados(int proyectoId);
