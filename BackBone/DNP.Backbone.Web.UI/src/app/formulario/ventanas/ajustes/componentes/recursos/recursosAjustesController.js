(function () {
    ...
    function recursosAjustesController(
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "recursos";
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";
        vm.handlerComponentes = [
            { id: 1, componente: 'recursosfuentesdefinanc', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'recursoscostosdelasacti', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'recursosregionalizacion', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.guardado = function (nombreComponenteHijo) {
            ...
            if (nombreComponenteHijo == "recursosfuentesdefinanc") {
                vm.notificarRefrescoFuentes();
            }
            else if (nombreComponenteHijo == "recursoscostosdelasacti") {
                vm.notificarRefrescoCostos();
            }
            else if (nombreComponenteHijo == "recursosregionalizacion") {
       ...
       */
        ...
        vm.notificarRefresco = function (handler, nombreComponente) {
            ...
            if (nombreComponente == "recursosfuentesdefinanc") {
                vm.notificarRefrescoCostos = handler;
            }
            else if (nombreComponente == "recursoscostosdelasacti") {
                vm.notificarRefrescoFuentes = handler;
            }
            else if (nombreComponente == "recursosregionalizacion") {
