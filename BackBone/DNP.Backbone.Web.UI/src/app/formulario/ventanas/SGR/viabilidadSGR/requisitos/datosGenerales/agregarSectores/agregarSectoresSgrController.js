(function () {
    ...
    agregarSectoresSgrController.$inject = ['$scope', 'requisitosSgrServicio', 'justificacionCambiosServicio', 'utilidades', '$sessionStorage','$timeout'];

    function agregarSectoresSgrController(
        $scope,
        ...
        var vm = this;
        vm.nombreComponente = "sgrviabilidadrequisitosdatosgeneralesagregarsectores";
        vm.Bpin = null;
    ...
    angular.module('backbone').component('agregarSectoresSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/requisitos/datosGenerales/agregarSectores/agregarSectoresSgr.html",

        controller: agregarSectoresSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
