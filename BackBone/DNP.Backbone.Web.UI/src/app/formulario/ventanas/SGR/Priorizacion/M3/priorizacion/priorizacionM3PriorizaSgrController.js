(function () {
    ...
    priorizacionM3PriorizaSgrController.$inject = ['$scope', 'utilidades','$sessionStorage'];

    function priorizacionM3PriorizaSgrController(
        $scope,
        utilidades,
        $sessionStorage
    ) {
        var vm = this;
        vm.nombreComponente = "sgrpriorizacionm3priorizacion";
        vm.nombreComponenteHijo = "sgrpriorizacionm3priorizacionregistropriorizacion";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrpriorizacionm3priorizacionregistropriorizacion', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrpriorizacionm3priorizacionestadopriorizacion', handlerValidacion: null, handlerCambios: null, esValido: true }
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrpriorizacionm3priorizacionregistropriorizacion': true,
                'sgrpriorizacionm3priorizacionestadopriorizacion': true
            };
        }
    ...
    angular.module('backbone').component('priorizacionM3PriorizaSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/Priorizacion/M3/priorizacion/priorizacionM3PriorizaSgr.html",
        controller: priorizacionM3PriorizaSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
