(function () {
    ...
    tramiteModificacionLeyRedPasoDosController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionLeyRedPasoDosController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionLeyRedPasoDos', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionLeyRed/presupuestoPrel/tramiteModificacionLeyRedPasoDos.html",
        controller: tramiteModificacionLeyRedPasoDosController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
