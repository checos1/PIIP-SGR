(function () {
    ...
    aproSuperTadController.$inject = ['$scope',];

    function aproSuperTadController(
        $scope,
    ...
    angular.module('backbone').component('aproSuperTad', {
        templateUrl: "/src/app/formulario/ventanas/tramiteAdicionDonacion/componentes/aprobacionSupervisorTad/aproSuperTad.html",
        controller: aproSuperTadController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
