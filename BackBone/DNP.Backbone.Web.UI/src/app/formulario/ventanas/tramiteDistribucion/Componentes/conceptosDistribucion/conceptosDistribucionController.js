(function () {
    ...
    conceptosDistribucionController.$inject = ['$scope', 'aclaracionLeyendaServicio'];

    function conceptosDistribucionController(
        $scope,
    ...
    angular.module('backbone').component('conceptosDistribucion', {
        templateUrl: "src/app/formulario/ventanas/tramiteDistribucion/componentes/conceptosDistribucion/conceptosDistribucion.html",
        controller: conceptosDistribucionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
