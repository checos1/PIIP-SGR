(function () {
    ...
    firmaFormularioSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
    ...
    function firmaFormularioSgpController(
        $scope,
        $sessionStorage,
        utilidades,
        firmaFormularioSgpServicio,
    ...
    angular.module('backbone').component('firmaFormularioSgp', {

        templateUrl: "src/app/formulario/ventanas/SGP/comun/firma/firmaFormularioSgp.html",
        controller: firmaFormularioSgpController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
