(function () {
    ...
    informacionPresupuestalTrController.$inject = [
        '$scope'
    ];

    function informacionPresupuestalTrController(
        $scope
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = 'informacionpresupuestal';
        vm.nombreComponenteHijo = "informacionpresupuestalsolicitudmodificaciondeleytraslado";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'informacionpresupuestalsolicitudmodificaciondeleytraslado', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
    ...
    angular.module('backbone').component('informacionPresupuestalTr', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionTraslado/Componentes/informacionPresupuestalTr/informacionPresupuestalTr.html",
        controller: informacionPresupuestalTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
