var politicasTransversalesFormularioCtrl = null;

(function () {
    'use strict';
    angular.module('backbone').controller('politicasTransversalesFormulario', politicasTransversalesFormulario);
    politicasTransversalesFormulario.$inject = [
        '$scope',
        '$uibModal',
        '$log',
        '$q',
    ...
    function politicasTransversalesFormulario(
        $scope,
        $uibModal,
        $log,
        $q,
        ...
        utilidades) {
        var vm = this;
        politicasTransversalesFormularioCtrl = vm;
        //variables
        vm.lang = "es";
        vm.TabActivo = 1;
    ...
    angular.module('backbone')
        .component('politicasTransversalesFormulario', {
            templateUrl: 'src/app/formulario/ventanas/comun/programacionRecursos/politicas/detallePolitica/politica/politicasTransversalesFormulario.html',
            controller: 'politicasTransversalesFormulario',
            controllerAs: 'vm',
            bindings: {
                callback: '&',
