(function () {
    ...
    requisitosSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function requisitosSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        requisitosSgrServicio,
        ...
        vm.init = function () {
            ...
            vm.preguntaDocumento = utilidades.obtenerParametroTransversal('IdPreguntaInsumoOtroSector');

            var accionRequisitos = $sessionStorage.listadoAccionesTramite.find(f => f.Ventana == 'requisitosViabilidadSgr');
        ...
        * */
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadrequisitosdatosgenerales', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null, handlerInicio: null },
            { id: 2, componente: 'sgrviabilidadrequisitosverificacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null, handlerInicio: null },
    ...
    angular.module('backbone').component('requisitosSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/requisitosSgr.html",
        controller: requisitosSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
