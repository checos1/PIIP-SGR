(function () {
    ...
    detalleMuchosUnTipoFormulario.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
        'flujoServicios',
    ...
    function detalleMuchosUnTipoFormulario(
        $sessionStorage,
        sesionServicios,
        utilidades,
        flujoServicios,
        ...
        vm.init = function () {
            ...
            if (vm.tipotramiteid === '50' || vm.tipotramiteid === '51' || vm.tipotramiteid === '53' || vm.tipotramiteid === '54') {
                vm.mostrarbtnEditar = false;
                //SE AJUSTA AL NIVEL_ID DEL FLUJO DE MODIFICACION DE LEY
                if (vm.tipotramiteid === '51' || vm.tipotramiteid === '53') {
                    ...
                    var estadotramite = $sessionStorage.InstanciaSeleccionada.estadoTramite = "Cancelado" || estadoPaso.Estado === "Ejecutada" || (estadoPaso.Estado !== "Ejecutada" && rolapresupuestopreliminar === undefined) ? false : true;
                ...
                if (vm.tipotramiteid === '50' || vm.tipotramiteid === '54') {
                    var estadoPaso = $sessionStorage.listadoAccionesTramite.find(x => x.Nombre === $sessionStorage.nombreAccion);
            ...
            //$scope.$watch('vm.ajusteml', function () {
            //    var total = vm.ajusteml;
            //    if (vm.ajusteml!='0' && (vm.tipotramiteid === '50' || vm.tipotramiteid === '51' || vm.tipotramiteid === '53' || vm.tipotramiteid === '54')) {
            //        vm.generarInstanciasMasiva();
            //    }
            //});
            ...
            comunesServicio.obtenerProyectosTramite(vm.tramiteid)
                .then(function (response) {
                    if (response.data !== null && response.data.length > 0) {
                        ...
                        if (vm.tipotramiteid == 7 && vm.cantProyectosAsociados > 0) {//incorporaciones
                        ...
                        vm.listaGrupoEntidades.forEach(entidad => {
                            ...
                            vm.listaEntidadesProy.filter(lent => lent.EntidadId === entidad.EntidadId).forEach(proyectoentidad => {
                        ...
                        //MODIFICACIONES DE LEY, SI ENCUENTRA UN PROYECTO NUEVO, BUSCA CREAR LA INSTANCIA ---luidiaz 01/06/2023
                        if (vm.ajusteml != vm.ajustemlTemp && (vm.tipotramiteid === '50' || vm.tipotramiteid === '51' || vm.tipotramiteid === '53' || vm.tipotramiteid === '54')) {
                            /* vm.generarInstanciasMasiva();*/
                            vm.ajustemlTemp = vm.ajusteml;
                        }
        ...
        vm.generarInstanciasMasiva = function () {
            ...
            if (vm.tipotramiteid === '7' && ($sessionStorage.sessionDocumentos < 100 || $sessionStorage.sessionDocumentos === undefined)) {
        ...
        function eliminarAsociacion(proyectoId, bpin, tipoProyecto) {
            if (proyectoId === undefined || proyectoId === '' || proyectoId === 0) {
                ...
                if (vm.tipotramiteid === '50' || vm.tipotramiteid === '51' || vm.tipotramiteid === '53' || vm.tipotramiteid === '54') {
                    var mensajemodal = "Con esto, la información del proyecto definida en otros espacios del trámite se perderá. ¿Esta seguro de continuar?";
                }
                else {
                    var mensajemodal = "Esto eliminará la información correspondiente al BPIN " + bpin + " incluida en este proceso de trámite, mas la consignada en el proceso de Ajustes del proyecto. ¿Esta seguro de continuar?";
                }
                utilidades.mensajeWarning(mensajemodal,
                                        ...
                                        trasladosServicio.eliminarInstanciaCerrada_AbiertaProyectoTramite($sessionStorage.idInstanciaIframe, proyectoId)
                                            .then(function (result) {
                                                if (result.status === 200) {
                                                    ...
                                                    var texto = "El proyecto con BPIN " + bpin + " ha sido desasociado del trámite" + $sessionStorage.idObjetoNegocio;
        ...
        function formatearNumero(value) {
            ...
            else// Modificaciones Ley Adicion y Reduccion
            {
        ...
        vm.actualizarValores = function (response) {
            ...
            if (vm.unSoloTipoOperacion && vm.tipotramiteid === "7") {
                var totalVigenteConvenio = 0;
                $sessionStorage.listaDatosIncorporacion.forEach(incorp => {
        ...
        function eliminarCapitulosModificados() {
            ...
            if (vm.tipotramiteid === '50' || vm.tipotramiteid === '51' || vm.tipotramiteid === '53' || vm.tipotramiteid === '54') {
                ...
                if (vm.tipotramiteid === '50' || vm.tipotramiteid === '53' ) {
            const span = document.getElementById('id-capitulo-informacionpresupuestalsolicitudmodificaciondeleyadicion');
            vm.seccionCapitulo = span.textContent;
                }
                if (vm.tipotramiteid === '51' || vm.tipotramiteid === '54') {
                    const span = document.getElementById('id-capitulo-informacionpresupuestalsolicitudmodificaciondeleyreduccion');
                    vm.seccionCapitulo = span.textContent;
                }
            var dataInfoPtal = {
                //ProyectoId: 0,//$sessionStorage.InstanciaSeleccionada.ProyectoId,
            ...
            justificacionCambiosServicio.eliminarCapitulosModificados(dataInfoPtal)
                .then(function (response) {
                    if (response.data.Exito) {                      
                            $sessionStorage.EstadoAsociacionVF = 'Sin Asociación' + vm.tipoproyecto;
                            $sessionStorage.EstadoAjusteCreado = false;
    ...
    angular.module('backbone').component('detalleMuchosUnTipoFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/asociarMuchosUnTipo/detalleMuchosUnTipo/detalleMuchosUnTipoFormulario.html",
        controller: detalleMuchosUnTipoFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
