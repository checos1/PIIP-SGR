var conceptoVictimasMlCtrl = null;

(function () {
    'use strict';
    angular.module('backbone').controller('conceptoVictimasMl', conceptoVictimasMl);
    conceptoVictimasMl.$inject = [
        '$scope',
        '$sessionStorage',
        '$timeout',
    ...
    function conceptoVictimasMl(
        ...
        vm.TienePoliticas = 0;
        vm.nombreComponente = "conceptoVictimasMlFormulario";
        vm.activar = false;
                        ...
                        vm.ResumenSolicitudConcepto.forEach(rs => {
                            if (rs.Resumen) {
                                ...
                                if (vm.ResumenSolicitudDetalle.length <= 0) {
                                    ...
                                    let result = rs.Resumen.reduce((a, b) => a.FechaHoraRegistro > b.FechaHoraRegistro ? a : b);
                                    if (result) {
    ...
    angular.module('backbone')
        .component('conceptoVictimasMl', {
            templateUrl: 'src/app/formulario/ventanas/comun/modificacionLey/politicas/concepto/conceptoVictimasMlFormulario.html',
            controller: 'conceptoVictimasMl',
            controllerAs: 'vm',
            bindings: {
                callback: '&',
