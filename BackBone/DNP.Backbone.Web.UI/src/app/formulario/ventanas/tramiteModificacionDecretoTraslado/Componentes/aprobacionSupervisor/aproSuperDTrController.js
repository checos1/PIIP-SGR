(function () {
    ...
    aproSuperDTrController.$inject = ['$scope',];

    function aproSuperDTrController(
        $scope,
    ...
    angular.module('backbone').component('aproSuperDTr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/componentes/aprobacionSupervisor/aproSuperDTr.html",
        controller: aproSuperDTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
