(function () {
    ...
    informacionGeneralViabilidadSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function informacionGeneralViabilidadSinTramiteSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponenteHijo = "sgpviabilidadviabilidadInformacionBasicausuariosinvolucradossintramitesgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpviabilidadviabilidadInformacionBasicausuariosinvolucradossintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        vm.handlerComponentesChecked = {};

        vm.init = function () {
            vm.tipoConceptoId = vm.tipoconceptoid;
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpviabilidadviabilidadInformacionBasicausuariosinvolucradossintramitesgp': true,
                'sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsintramitesgp': true
            };
        }
    ...
    angular.module('backbone').component('informacionGeneralViabilidadSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/viabilidadAjustesSinTramite/informacionGeneral/informacionGeneralViabilidadSinTramiteSgp.html",
        controller: informacionGeneralViabilidadSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
