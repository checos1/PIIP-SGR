...
namespace DNP.ServiciosNegocio.Test.Servicios.FuentesProgramarSolicitado
{
    ...
    [TestClass]
    public class DatosAdicionalesServicioTest
    {
        private string BpinBase { get; set; }
        private IDatosAdicionalesServicio _datosAdicionalesServicio;
        private DatosAdicionalesServicio DatosAdicionalesServicio { get; set; }
        ...
        private IDatosAdicionalesPersistencia DatosAdicionalesPersistencia { get; set; }
        ...
        public void Init()
        {
            ...
            _datosAdicionalesServicio = contenedor.Resolve<IDatosAdicionalesServicio>();
            DatosAdicionalesPersistencia = UnityContainerExtensions.Resolve<IDatosAdicionalesPersistencia>(contenedor);
            PersistenciaTemporal = contenedor.Resolve<IPersistenciaTemporal>();
            AuditoriaServicio = contenedor.Resolve<IAuditoriaServicios>();
            DatosAdicionalesServicio = new DatosAdicionalesServicio(DatosAdicionalesPersistencia, PersistenciaTemporal, AuditoriaServicio);
            ...
            _mockContext.Setup(mc => mc.UspGetDatosAdicionalesFinanciacion_JSON(1)).Returns(mockFuentes.Object);
        ...
        {
            _datosAdicionalesServicio = new DatosAdicionalesServicio(new DatosAdicionalesPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), new AuditoriaServicios());
            var fuenteId = 1;
            var result = _datosAdicionalesServicio.ObtenerDatosAdicionalesFuenteFinanciacion(fuenteId);
        ...
        {
            DatosAdicionalesServicio = new DatosAdicionalesServicio(new DatosAdicionalesPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), new AuditoriaServicios());
            var parametros = new ParametrosConsultaDto();
            DatosAdicionalesServicio.Obtener(parametros);
        }
        ...
        {
            DatosAdicionalesServicio = new DatosAdicionalesServicio(new DatosAdicionalesPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), new AuditoriaServicios());
            var parametros = new ParametrosGuardarDto<DatosAdicionalesDto>();
            var parametroAuditoria = new ParametrosAuditoriaDto()
            {
                Usuario = "Leticia01",
                Ip = "localhost"
            };
            DatosAdicionalesServicio.Guardar(parametros, parametroAuditoria, false);
        }
    }
}
