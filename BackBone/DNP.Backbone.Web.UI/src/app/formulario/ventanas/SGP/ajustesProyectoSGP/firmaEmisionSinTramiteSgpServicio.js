(function () {
    ...
    angular.module('backbone').factory('firmaEmisionSinTramiteSgpServicio', firmaEmisionSinTramiteSgpServicio);

    firmaEmisionSinTramiteSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function firmaEmisionSinTramiteSgpServicio($http, constantesBackbone) {
