(function () {
    'use strict';
    angular.module('backbone').factory('ajustesConTramiteServicio', ajustesConTramiteServicio);

    ajustesConTramiteServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];
    ...
    function ajustesConTramiteServicio($q, $http, $location, constantesBackbone) {
        return {
