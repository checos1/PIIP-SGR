(function () {
    ...
    alojarDocumentosRequisitosSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function alojarDocumentosRequisitosSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponenteHijo = "sgpviabilidadrequisitossoportesalojararchivossgp";
        vm.notificacionCambiosCapitulos = null;
        vm.rol = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'sgpviabilidadrequisitossoportesalojararchivossgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('alojarDocumentosRequisitosSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/viabilidadSGP/requisitos/soportes/alojarDocumentosRequisitosSgp.html",
        controller: alojarDocumentosRequisitosSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
