namespace DNP.ServiciosWBS.Test.Servicios
{
    ...
    [TestClass]
    public class CostosActividadesServicioTest
    {
        private string BpinBase { get; set; }
        private ICostosActividadesServicios _costosActividadesServicios { get; set; }
        private CostosActividadesServicios CostosActividadesServicio { get; set; }
        ...
        private ICostosActividadesPersistencia CostosActividadesPersistencia { get; set; }
        ...
        public void Init()
        {
            ...
            _costosActividadesServicios = contenedor.Resolve<ICostosActividadesServicios>();
            CostosActividadesPersistencia = UnityContainerExtensions.Resolve<ICostosActividadesPersistencia>(contenedor);
            PersistenciaTemporal = contenedor.Resolve<IPersistenciaTemporal>();
            AuditoriaServicio = contenedor.Resolve<IAuditoriaServicios>();
            CostosActividadesServicio = new CostosActividadesServicios(CostosActividadesPersistencia, PersistenciaTemporal, AuditoriaServicio);
        ...
        [TestMethod]
        public void CostosActividades()
        {
            _costosActividadesServicios = new CostosActividadesServicios(new CostosActividadesPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), new AuditoriaServicios());
            var result = _costosActividadesServicios.ObtenerCostosActividades(new ParametrosConsultaDto
            {
                Bpin = BpinBase,
                AccionId = new Guid("E00485B4-34D9-495A-82CF-7F7F477FD16F"),
                InstanciaId = new Guid("76A7958B-D20A-48AD-87C9-917D3B388E21")
        ...
        [TestMethod]
        public void CostosActividadesPreviewTest()
        {

            var result = _costosActividadesServicios.ObtenerCostosActividadesPreview();
            Assert.IsNotNull(result);
            Assert.IsTrue(result.vigencias.Count >= 1);
        }

        [TestMethod]
        public void CostosActividades_ObtenerDefinitivo_Test()
        {
            CostosActividadesServicio = new CostosActividadesServicios(new CostosActividadesPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), new AuditoriaServicios());
            ...
            var resultado = CostosActividadesServicio.Obtener(parametrosConsulta);
            Assert.IsNotNull(resultado);
        }

        [TestMethod]
        public void CostosActividades_Obtener_Test()
        {
            CostosActividadesServicio = new CostosActividadesServicios(new CostosActividadesPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), new AuditoriaServicios());
            var parametrosConsulta = new ParametrosConsultaDto()
            {
            ...
            var resultado = CostosActividadesServicio.ObtenerCostosActividades(parametrosConsulta);
            Assert.IsNotNull(resultado);
        }

        [TestMethod]
        public void CostosActividades_GuardarDefinitivo()
        {
            var parametrosGuardar = new ParametrosGuardarDto<CostosActividadesDto>()
            {
                ...
                InstanciaId = new Guid("76A7958B-D20A-48AD-87C9-917D3B388E21"),
                Usuario = "Leticia01",
                Contenido = new CostosActividadesDto()
                {
                    ProyectoId = 72210,
                    BPIN = "202000000000005",
        ...
        CostosActividadesServicio.Guardar(parametrosGuardar, parametroAuditoria, false);
        }
}
}
