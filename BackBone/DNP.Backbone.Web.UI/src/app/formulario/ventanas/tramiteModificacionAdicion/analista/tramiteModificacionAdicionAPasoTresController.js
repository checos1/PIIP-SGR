(function () {
    ...
    tramiteModificacionAdicionAPasoTresController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionAdicionAPasoTresController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionAdicionAPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionAdicion/analista/tramiteModificacionAdicionAPasoTres.html",
        controller: tramiteModificacionAdicionAPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
