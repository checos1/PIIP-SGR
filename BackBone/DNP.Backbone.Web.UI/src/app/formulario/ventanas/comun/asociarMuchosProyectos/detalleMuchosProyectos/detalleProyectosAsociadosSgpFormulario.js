(function () {
    ...
    detalleProyectosAsociadosSgpFormulario.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
        'flujoServicios',
        ...
        '$location',
        'comunesServicio',
        'tramiteTrasladoSgpServicio',
        'transversalSgpServicio',
        'tramiteSGPServicio'

    ];

    function detalleProyectosAsociadosSgpFormulario(
        $sessionStorage,
        sesionServicios,
        utilidades,
        flujoServicios,
        ...
        function ObtenerProyectosTramite() {
            ...
            if (vm.tipotramiteid == 99) {
                vm.mostrarSubprograma = false;
            } 
                    ...
                    if (response.data !== null && response.data.length > 0) {
                        ...
                        vm.listaGrupoEntidades.forEach(entidad => {
                            ...
                            vm.listaEntidadesProy.forEach(proyectoentidad => {                               
                                //proyectoentidad.ValorMontoProyectoNacion = procesarNumero(proyectoentidad.ValorMontoProyectoNacion === null ? '0' : proyectoentidad.ValorMontoProyectoNacion);
                                //proyectoentidad.ValorMontoProyectoPropios = procesarNumero(proyectoentidad.ValorMontoProyectoPropios === null ? '0' : proyectoentidad.ValorMontoProyectoPropios);
                                //proyectoentidad.ValorMontoTramiteNacion = procesarNumero(proyectoentidad.ValorMontoTramiteNacion === null ? '0' : proyectoentidad.ValorMontoTramiteNacion);
                                //proyectoentidad.ValorMontoTramitePropios = procesarNumero(proyectoentidad.ValorMontoTramitePropios === null ? '0' : proyectoentidad.ValorMontoTramitePropios);
                                proyectoentidad.ValorMontoProyectoNacion = formatearNumeroFloat(proyectoentidad.ValorMontoProyectoNacion === null ? '0' : proyectoentidad.ValorMontoProyectoNacion);
                                proyectoentidad.ValorMontoProyectoPropios = formatearNumeroFloat(proyectoentidad.ValorMontoProyectoPropios === null ? '0' : proyectoentidad.ValorMontoProyectoPropios);
                                proyectoentidad.ValorMontoTramiteNacion = formatearNumeroFloat(proyectoentidad.ValorMontoTramiteNacion === null ? '0' : proyectoentidad.ValorMontoTramiteNacion);
                                proyectoentidad.ValorMontoTramitePropios = formatearNumeroFloat(proyectoentidad.ValorMontoTramitePropios === null ? '0' : proyectoentidad.ValorMontoTramitePropios);
                        ...
                        //Objeto para generar instancia masiva
                        vm.listaGrillaProyectos = [];
                        vm.listaEntidadesProy.forEach(entidad => {
                        ...
                        vm.listaEntidadesProy.forEach(proyectoentidad => {
                            ...
                            var MontoTramiteNacion = proyectoentidad.ValorMontoTramiteNacion === null ? '0' : proyectoentidad.ValorMontoTramiteNacion;
                            var MontoTramitePropios = proyectoentidad.ValorMontoTramitePropios === null ? '0' : proyectoentidad.ValorMontoTramitePropios;
                        ...
                        vm.ValorTotalMontoRC = procesarNumero(vm.ValorTotalMontoRC);
                        ...
                        vm.ValorTotalMontoRCC = procesarNumero(vm.ValorTotalMontoRCC);
        ...
        function formatearNumeroFloat(value) {
            var numerotmp = (value == '' || Number.isNaN(value)) ? 0 : value.toString().replaceAll(',', '.');
            return parseFloat(numerotmp.toString().replaceAll(',', '.'));
        }
            ...
            //else {
                if (vm.continuarMasivo == true) {
                    ...
                    if (boolproyectossinmontotramite)
                        ...
                        tramiteTrasladoSgpServicio.validacionProyectosTramiteNegocio($sessionStorage.tramiteId).then(
                            function (respuesta) {
                                if (respuesta.data != null && respuesta.data != "") {
                                    utilidades.mensajeError(respuesta.data);
                                } else {
                        ...
                        trasladosServicio.eliminarProyectoTramite(eliminarAsociacionDto, eliminarAsociacionDto)
                            .then(function (response) {
                                if (response.status == "200") {
                                    ...
                                    transversalSgpServicio.notificarCambio({ cargarProyectoAsociado: true });
                ...
                flujoServicios.generarInstancia(tramiteDto)
                    .then(function (resultado) {
                        ...
                        if (cantidadInstanciasFallidas) {
                            ...
                            // utilidades.mensajeSuccess('Se crearon instancias exitosamente');
                            vm.actualizadetalle++;
                            utilidades.mensajeSuccess('Recuerde que para la activación del proceso es necesario diligenciar y guardar las fuentes por proyecto (SGP o Propios).', false, false, false, "El curso del proceso se ha iniciado con éxito. Sus datos se reflejarán en otros espacios de este formulario.");                       
                        }         
                    });
            //}
        ...
        function ActualizarInstanciaProyecto(proyecto, resultado) {
            ...
            var montotramitenacion = proyecto.ValorMontoTramiteNacion;
            var montotramitepropio = proyecto.ValorMontoTramitePropios;
            var montoTramite = montotramitenacion + montotramitepropio;
                ...
                comunesServicio.ActualizarInstanciaProyecto(proyectoTramiteDto).then(
                    function (resultado) {
                        ...
                        if (resultado.data && (resultado.statusText === "OK" || resultado.status === 200)) {
                            transversalSgpServicio.notificarCambio({ creaProcesoAjusteProyectoSgp: true });
                            //utilidades.mensajeSuccess("Operación realizada con éxito!", false, false, false);
                            utilidades.mensajeSuccess('Recuerde que para la activación de los procesos es necesario diligenciar y guardar las fuentes por proyecto (SGP o Propios).', false, false, false, "El curso de procesos se ha iniciado con éxito. Los datos se reflejarán en otros espacios de este formulario.");
                            vm.actualizacomponentes = vm.actualizacomponentes + '1';
                            tramiteSGPServicio.notificarCambio({ cargarProyectoAsociado: true });
        ...
        //vm.ValidarTramite = function () {                      
        //    tramiteTrasladoSgpServicio.validacionProyectosTramiteNegocio($sessionStorage.tramiteId).then(
        //        function (respuesta) {
        //            if (respuesta.data != null && respuesta.data != "") {                        
        //                vm.validacionTramite = respuesta.data;
        //                utilidades.mensajeError(vm.validacionTramite);                   
        //                vm.Tramitevalido = false;
        //            }
        //        });
        //};       
    ...
    angular.module('backbone').component('detalleProyectosAsociadosSgpFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/detalleMuchosProyectos/detalleProyectosAsociadosSgpFormulario.html",
        controller: detalleProyectosAsociadosSgpFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
