(function () {
    ...
    modificacionLeyCreditosPasoTresController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
    ...
    function modificacionLeyCreditosPasoTresController(
        $scope,
        $sessionStorage,
        utilidades,
        modificacionLeyServicio
            ...
            if (vm.tramiteproyectoid != '') {
                ...
                switch (vm.origen) {
                    case 'Adición Presupuesto Paso3':
                        vm.nombreComponente = "informacionpresupuestalsolicitudmodificaciondeleyadicion";
                        break;
                    case 'Reducción Presupuesto Paso3':
    ...
    angular.module('backbone').component('modificacionLeyCreditosPasoTres', {

        templateUrl: "src/app/formulario/ventanas/comun/modificacionLey/creditos/modificacionLeyCreditosPasoTres.html",
        controller: modificacionLeyCreditosPasoTresController,
        controllerAs: "vm",
        bindings: {
            tramiteproyectoid: '@',
            origen: '@',
