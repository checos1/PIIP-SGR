(function () {
    ...
    modalInstanciasProyectoController.$inject = [
        '$scope',
        '$uibModalInstance',
        'objProyecto',
    ...
    function modalInstanciasProyectoController(
        $scope,
        $uibModalInstance,
        objProyecto,
        servicioConsolaProyectos,
        ...
        function obtenerInstanciasProyecto() {
            servicioConsolaProyectos.obtenerInstanciasProyecto(vm.peticion, vm.filtro)
    ...
    angular.module('backbone').controller('modalInstanciasProyectoController', modalInstanciasProyectoController);
})();