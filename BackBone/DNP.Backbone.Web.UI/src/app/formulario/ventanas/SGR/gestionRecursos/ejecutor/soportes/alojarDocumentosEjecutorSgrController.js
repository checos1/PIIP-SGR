(function () {
    'use strict';
    alojarDocumentosEjecutorSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function alojarDocumentosEjecutorSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrejecutordesignacionsoporte";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrejecutordesignacionsoportealojararchivo";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrejecutordesignacionsoportealojararchivo', handlerValidacion: null, handlerCambios: null, esValido: true } //Funcion
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrejecutordesignacionsoportealojararchivo': true
            };
        }
    ...
    angular.module('backbone').component('alojarDocumentosEjecutorSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/gestionRecursos/ejecutor/soportes/alojarDocumentosEjecutorSgr.html",
        controller: alojarDocumentosEjecutorSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
