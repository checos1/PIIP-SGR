(function () {
    ...
    reporteFinancieroController.$inject = [
        '$scope',
        '$sessionStorage',
    ...
    function reporteFinancieroController(
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "financiero";
        ...
        vm.handlerComponentes = [{ id: 1, componente: 'financieroavancefinanciero', handlerValidacion: null, handlerCambios: null, esValido: true },
                                 { id: 2, componente: 'financieroavancepresupuestal', handlerValidacion: null, handlerCambios: null, esValido: true }];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'financieroavancefinanciero': true,
                'financieroavancepresupuestal': true
            };
        }
    ...
    angular.module('backbone').component('reporteFinanciero', {

        templateUrl: "src/app/formulario/ventanas/seguimientoControl/componentes/reporteFinanciero/reporteFinanciero.html",
        controller: reporteFinancieroController,
        controllerAs: "vm",
        bindings: {
            verificacion: '&',
            notificacioncambios: '&',
