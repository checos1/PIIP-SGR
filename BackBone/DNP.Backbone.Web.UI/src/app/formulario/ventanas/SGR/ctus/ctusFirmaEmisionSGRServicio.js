(function () {
    ...
    angular.module('backbone').factory('ctusFirmaEmisionSgrServicio', ctusFirmaEmisionSgrServicio);

    ctusFirmaEmisionSgrServicio.$inject = ['$http', 'constantesBackbone'];

    function ctusFirmaEmisionSgrServicio($http, constantesBackbone) {
