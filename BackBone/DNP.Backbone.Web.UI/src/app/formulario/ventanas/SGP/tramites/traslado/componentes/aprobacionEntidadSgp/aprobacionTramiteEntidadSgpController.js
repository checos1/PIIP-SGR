(function () {
    ...
    aprobacionTramiteEntidadSgpController.$inject = ['$scope',
        'transversalSgpServicio'
    ];

    function aprobacionTramiteEntidadSgpController(
        $scope,
        transversalSgpServicio
    ) {
        var vm = this;
        vm.nombreComponente = "aprobaciontramitesgp";
        vm.nombreComponenteHijo = "aprobaciontramitesgpconfirmacionaprobaciontramitesgp";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'aprobaciontramitesgpconfirmacionaprobaciontramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.init = function () {
            ...
            transversalSgpServicio.registrarObservador(function (datos) {
                if (datos.actualizarAprobacion === true) {
                    vm.init();
                }
            });
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'aprobaciontramitesgpconfirmacionaprobaciontramitesgp': true
            };
        }
    ...
    angular.module('backbone').component('aprobacionTramiteEntidadSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/traslado/componentes/aprobacionEntidadSgp/aprobacionTramiteEntidadSgp.html",
        controller: aprobacionTramiteEntidadSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
