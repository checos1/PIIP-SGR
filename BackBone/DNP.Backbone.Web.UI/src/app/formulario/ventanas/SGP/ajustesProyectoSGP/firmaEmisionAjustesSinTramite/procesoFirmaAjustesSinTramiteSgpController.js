(function () {
    ...
    procesoFirmaAjustesSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function procesoFirmaAjustesSinTramiteSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpfirmaresponsables";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgpfirmaresponsablesprocesofirmassintramitesgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpfirmaresponsablesprocesofirmassintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        vm.handlerComponentesChecked = {};

        vm.init = function () {
            vm.tipoConceptoViabilidadId = vm.tipoconceptoviabilidadid;
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpfirmaresponsablesprocesofirmassintramitesgp': true
            };
        }
    ...
    angular.module('backbone').component('procesoFirmaAjustesSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/firmaEmisionAjustesSinTramite/procesoFirmaAjustesSinTramiteSgp.html",
        controller: procesoFirmaAjustesSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
