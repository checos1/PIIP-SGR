(function () {
    ...
    informacionPresupuestalDTrController.$inject = [
        '$scope'
    ];

    function informacionPresupuestalDTrController(
        $scope
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = 'informacionpresupuestal';
        vm.nombreComponenteHijo = "informacionpresupuestalsolicitudmodificaciondecretotraslado";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'informacionpresupuestalsolicitudmodificaciondecretotraslado', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'informacionpresupuestalsolicitudmodificaciondeleyreduccion': true,
            };
        }
    ...
    angular.module('backbone').component('informacionPresupuestalDTr', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/Componentes/informacionPresupuestalTr/informacionPresupuestalDTr.html",
        controller: informacionPresupuestalDTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
