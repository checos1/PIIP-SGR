(function () {
    ...
    ResumenSgpController.$inject = ['$sessionStorage', 'focalizacionAjustesSGPServicio'];

    function ResumenSgpController(
        $sessionStorage,
        focalizacionAjustesSGPServicio
    ) {
        var vm = this;
        vm.init = init;
        vm.nombreComponente = "sgpsolicitudrecursosfocalizacionresumenfocalizacionsgp";
        ...
        vm.obtenerPoliticasTransversalesResumen = function (bpin) {
            ...
            return focalizacionAjustesSGPServicio.ObtenerPoliticasTransversalesResumenSGP(idInstanciaProyecto, usuarioDNP, idInstancia).then(
                function (respuesta) {
    ...
    angular.module('backbone').component('resumenSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/focalizacion/Resumen/ResumenSgp.html",
        controller: ResumenSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
