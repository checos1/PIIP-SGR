(function () {
    ...
    angular.module('backbone')
        .controller('modalAgregarCategoriaPoliticaMlController', modalAgregarCategoriaPoliticaMlController);

    modalAgregarCategoriaPoliticaMlController.$inject = [
        '$scope',
        '$uibModalInstance',
        '$sessionStorage',
        'utilidades',
    ...
    function modalAgregarCategoriaPoliticaMlController(
        $scope,
        $uibModalInstance,
        $sessionStorage,
        utilidades,
        ...
        function guardar() {
            ...
            var parametros = {
                ...
                Bpin: $sessionStorage.idInstancia
            };
            ...
            return focalizacionAjustesServicio.guardarFocalizacionCategoriasPolitica(parametros, usuarioDNP)
                .then(function (response) {
                    ...
                    if (exito === '"ok"') {
                        ...
                        utilidades.mensajeSuccess('Usted puede visualizarla en el listado de categorías de la política "' + nombrePolitica + '".', false, false, false, 'La categoría ha sido agregada y guardada con éxito.');
