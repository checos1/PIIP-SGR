(function () {
    ...
    ctusIntegradoFirmaSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function ctusIntegradoFirmaSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        firmaEmisionSgrServicio,
    ...
    angular.module('backbone').component('ctusIntegradoFirmaSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/ctusIntegradoFirmaSgr.html",
        controller: ctusIntegradoFirmaSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
