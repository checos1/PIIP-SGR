(function () {
    ...
    aproentVfexcepController.$inject = ['$scope',];

    function aproentVfexcepController(
        $scope,
    ...
    angular.module('backbone').component('aproentVfexcep', {
        templateUrl: "/src/app/formulario/ventanas/tramiteVFexcep/componentes/aprobacionEntidad/aproentVfexcep.html",
        controller: aproentVfexcepController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
