(function () {
    ...
    usuariosInvolucradosViabilidadSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function usuariosInvolucradosViabilidadSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrviabilidadinformaciongeneralusuariosinvolucrados";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrviabilidadinformaciongeneralusuariosinvolucrados";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadinformaciongeneralusuariosinvolucrados', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('usuariosInvolucradosViabilidadSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/viabilidad/informacionGeneral/usuariosInvolucrados/usuariosInvolucradosViabilidadSgr.html",
        controller: usuariosInvolucradosViabilidadSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
