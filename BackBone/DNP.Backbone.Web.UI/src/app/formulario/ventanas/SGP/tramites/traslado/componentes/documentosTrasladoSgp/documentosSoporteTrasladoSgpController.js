(function () {
    ...
    documentosSoporteTrasladoSgpController.$inject = ['$scope','$sessionStorage'];

    function documentosSoporteTrasladoSgpController(
        $scope,
        $sessionStorage,

    ) {
        var vm = this;
        vm.nombreComponente = "soportestramitesgp";
        vm.nombreComponenteHijo = "soportestramitesgpdocumentotramitesgp";
        vm.notificacionCambiosCapitulos = null;
        vm.objetonegocioid = $sessionStorage.idObjetoNegocio;

        vm.handlerComponentes = [
            { id: 1, componente: 'soportestramitesgpdocumentotramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'soportestramitesgpdocumentotramitesgp': true
            };
        }
    ...
    angular.module('backbone').component('documentosSoporteTrasladoSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/traslado/componentes/documentosTrasladoSgp/documentosSoporteTrasladoSgp.html",
        controller: documentosSoporteTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
