(function () {
    ...
    aproSuperLeyController.$inject = ['$scope',];

    function aproSuperLeyController(
        $scope,
    ...
    angular.module('backbone').component('aproSuperLey', {
        templateUrl: "/src/app/formulario/ventanas/tramiteTrasladoLey/componentes/aprobacionSupervisor/aproSuperLey.html",
        controller: aproSuperLeyController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
