(function () {
    ...
    asociarProyectoLeyController.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarProyectoLeyController(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
    ...
    angular.module('backbone').component('asociarProyectoLey', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoLey/componentes/asociarProyectoLey/asociarProyectoLey.html",
        controller: asociarProyectoLeyController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
