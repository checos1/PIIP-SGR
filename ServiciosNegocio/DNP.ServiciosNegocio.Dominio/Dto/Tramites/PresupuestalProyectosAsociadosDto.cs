...
namespace DNP.ServiciosNegocio.Dominio.Dto.Tramites
{
    ...
    public class ResumenProyectosAsociadosDto
    {
        ...
        public decimal? totalTipoAprobacion { get; set; } = 0; 
    ...
    public class ProyectosAsociadosDto
    {
        ...
        public bool EditarTramiteIncorporacion { get; set; } = false;
    }
    ...
    public class DetalleFuentesProyectosAsociadosDto
    {
        ...
        public decimal? ValorIncorporarCSFOriginal { get; set; } = 0;
        public decimal? ValorIncorporarSSFOriginal { get; set; } = 0;
        public decimal? ValorIncorporarAprobadoCSF { get; set; }
        public decimal? ValorIncorporarAprobadoSSF { get; set; }
        public decimal? ValorIncorporarAprobadoCSFOriginal { get; set; } = 0;
        public decimal? ValorIncorporarAprobadoSSFOriginal { get; set; } = 0;
    }
