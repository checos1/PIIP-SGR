(function () {
    ...
    asociarProyectoDistribucionController.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarProyectoDistribucionController(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
    ...
    angular.module('backbone').component('asociarProyectoDistribucion', {
        templateUrl: "src/app/formulario/ventanas/tramiteDistribucion/componentes/asociarProyectoDistribucion/asociarProyectoDistribucion.html",
        controller: asociarProyectoDistribucionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
