(function () {
    ...
    function metaProductoController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        justificacionCambiosServicio,
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "metaproducto";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'metaproductoavancemetacap', handlerValidacion: null, handlerCambios: null, esValido: true },
    ...
    angular.module('backbone').component('metaProducto', {
        templateUrl: "src/app/formulario/ventanas/seguimientoControl/componentes/metaProducto/metaProducto.html",
        controller: metaProductoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
