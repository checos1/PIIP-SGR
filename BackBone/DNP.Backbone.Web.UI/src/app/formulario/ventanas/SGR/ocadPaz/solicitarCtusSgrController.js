(function () {
    ...
    solicitarCtusSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function solicitarCtusSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        solicitarCtusSgrServicio,
        ...
        * */
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrocadpazsolicitarCtus', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
        ];
    ...
    angular.module('backbone').component('solicitarCtusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ocadPaz/solicitarCtusSgr.html",
        controller: solicitarCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
