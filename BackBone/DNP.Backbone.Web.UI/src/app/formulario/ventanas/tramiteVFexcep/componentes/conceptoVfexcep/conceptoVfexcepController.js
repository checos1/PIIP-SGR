(function () {
    ...
    conceptoVfexcepController.$inject = ['$scope', 'aclaracionLeyendaServicio'];

    function conceptoVfexcepController(
        $scope,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'solicitarconceptodatosiniciales', handlerValidacion: null, handlerCambios: null, esValido: true },
    ...
    angular.module('backbone').component('conceptoVfexcep', {
        templateUrl: "src/app/formulario/ventanas/tramiteVfexcep/componentes/conceptoVfexcep/conceptoVfexcep.html",
        controller: conceptoVfexcepController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
