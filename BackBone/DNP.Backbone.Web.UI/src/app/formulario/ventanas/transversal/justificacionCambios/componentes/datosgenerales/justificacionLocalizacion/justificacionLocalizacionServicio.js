(function () {
	'use strict';
	angular.module('backbone').factory('justificacionLocalizacionServicio', justificacionLocalizacionServicio);

	justificacionLocalizacionServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];

	function justificacionLocalizacionServicio($q, $http, $location, constantesBackbone) {
		return {
