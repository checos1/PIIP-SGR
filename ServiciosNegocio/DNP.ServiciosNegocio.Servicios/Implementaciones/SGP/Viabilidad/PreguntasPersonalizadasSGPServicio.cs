namespace DNP.ServiciosNegocio.Servicios.Implementaciones.SGP.Viabilidad
{
    ...
    using Interfaces.SGP.Viabilidad;
    using Interfaces.Transversales;
    using Persistencia.Interfaces.SGP.Viabilidad;
    ...
    public class PreguntasPersonalizadasSGPServicio : ServicioBase<ServicioPreguntasPersonalizadasDto>, IPreguntasPersonalizadasSGPServicio
    {
        private readonly IPreguntasPersonalizadasPersistencia _preguntasPersonalizadasPersistencia;
        private readonly IPreguntasPersonalizadasSGPPersistencia _preguntasPersonalizadasComponentePersistencia;
        public string Usuario { get; set; }
        public string Ip { get; set; }

        public PreguntasPersonalizadasSGPServicio(IPreguntasPersonalizadasPersistencia preguntasPersonalizadasPersistencia,
            IPreguntasPersonalizadasSGPPersistencia preguntasPersonalizadasComponentePersistencia,
            IAuditoriaServicios auditoriaServicios) : base(null, auditoriaServicios)
        {
            _preguntasPersonalizadasPersistencia = preguntasPersonalizadasPersistencia;
            _preguntasPersonalizadasComponentePersistencia = preguntasPersonalizadasComponentePersistencia;
        }

        public override ServicioPreguntasPersonalizadasDto Obtener(ParametrosConsultaDto parametrosConsultaDto)
        {
            return ObtenerDefinitivo(parametrosConsultaDto);
        }

        protected override ServicioPreguntasPersonalizadasDto ObtenerDefinitivo(ParametrosConsultaDto parametrosConsultaDto)
        {
            CuestionarioDto infoCuestionario = null;

            ServicioPreguntasPersonalizadasDto preguntas = new ServicioPreguntasPersonalizadasDto();
            preguntas.PreguntasEspecificas = new List<TematicaDto>();
            preguntas.PreguntasGenerales = new List<TematicaDto>();
            ...
            var listaRoles = parametrosConsultaDto.ListaRoles;
            ...
            {
                var result = _preguntasPersonalizadasPersistencia.ObtenerAgregarPreguntas();
            ...
            {
                preguntas.PreguntasGenerales = _preguntasPersonalizadasPersistencia.ObtenerPreguntasGenerales(bPin, nivelId, instanciaId, listaRoles, out infoCuestionario);
            ...
            {
                preguntas.PreguntasEspecificas = _preguntasPersonalizadasPersistencia.ObtenerPreguntasEspecificas(bPin, nivelId, instanciaId, listaRoles, out infoCuestionario);
                if (infoCuestionario != null)
                {
                    preguntas.CodigoBPIN = infoCuestionario.CodigoBPIN;
                    preguntas.Cuestionario = infoCuestionario.Cuestionario;
        ...
        public ServicioPreguntasPersonalizadasDto ObtenerPreguntasPersonalizadas(string bPin, Guid nivelId, Guid instanciaId, string listaRoles)
        {
            ...
            var tipoGrilla = TipoGrillaPreguntasEnum.TodosLosTipos;
            ...
            if (tipoGrilla == TipoGrillaPreguntasEnum.Generales || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                ...
                if (infoCuestionario != null)
                {
                    ...
                    preguntas.Usuario = infoCuestionario.Usuario;
                    preguntas.AgregarRequisitos = infoCuestionario.AgregarRequisitos;
                    preguntas.Definitivo = infoCuestionario.Definitivo;
                    preguntas.CumpleCuestionario = infoCuestionario.CumpleCuestionario;
                }
            }
        ...
        public ServicioPreguntasPersonalizadasDto ObtenerPreguntasPersonalizadasComponente(string bPin, Guid nivelId, Guid instanciaId, string nombreComponente, string listaRoles)
        {
            ...
            if (tipoGrilla == TipoGrillaPreguntasEnum.Especificas || tipoGrilla == TipoGrillaPreguntasEnum.Generales || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                var result = _preguntasPersonalizadasComponentePersistencia.ObtenerAgregarPreguntas();
                preguntas.AgregarPreguntasRequisitos = getAgregarPreguntas(preguntas, result);
            }

            if (tipoGrilla == TipoGrillaPreguntasEnum.Generales || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                preguntas.PreguntasGenerales = _preguntasPersonalizadasComponentePersistencia.ObtenerPreguntasGeneralesComponenteSGPCustom(bPin, nivelId, instanciaId, nombreComponente, listaRoles, out infoCuestionario);
                if (infoCuestionario != null)
                {
                    preguntas.CodigoBPIN = infoCuestionario.CodigoBPIN;
                    preguntas.Cuestionario = infoCuestionario.Cuestionario;
            ...
            if (tipoGrilla == TipoGrillaPreguntasEnum.Especificas || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                preguntas.PreguntasEspecificas = _preguntasPersonalizadasComponentePersistencia.ObtenerPreguntasEspecificasComponenteSGPCustom(bPin, nivelId, instanciaId, nombreComponente, listaRoles, out infoCuestionario);
                if (infoCuestionario != null)
                {
                    preguntas.CodigoBPIN = infoCuestionario.CodigoBPIN;
                    preguntas.Cuestionario = infoCuestionario.Cuestionario;
        ...
        public ServicioPreguntasPersonalizadasDto ObtenerPreguntasPersonalizadasComponenteSGP(string bPin, Guid nivelId, Guid instanciaId, string nombreComponente, string listaRoles)
        {
            CuestionarioDto infoCuestionario = null;
            ...
            if (tipoGrilla == TipoGrillaPreguntasEnum.Generales || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                preguntas.PreguntasGenerales = _preguntasPersonalizadasComponentePersistencia.ObtenerPreguntasGeneralesComponenteSGPCustomSGP(bPin, nivelId, instanciaId, nombreComponente, listaRoles, out infoCuestionario);
                if (infoCuestionario != null)
                {
                    preguntas.CodigoBPIN = infoCuestionario.CodigoBPIN;
                    preguntas.Cuestionario = infoCuestionario.Cuestionario;
            ...
            if (tipoGrilla == TipoGrillaPreguntasEnum.Especificas || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                preguntas.PreguntasEspecificas = _preguntasPersonalizadasComponentePersistencia.ObtenerPreguntasEspecificasComponenteSGPCustomSGP(bPin, nivelId, instanciaId, nombreComponente, listaRoles, out infoCuestionario);
                if (infoCuestionario != null)
                {
                    preguntas.CodigoBPIN = infoCuestionario.CodigoBPIN;
                    preguntas.Cuestionario = infoCuestionario.Cuestionario;
        ...
        private static List<AgregarPreguntaRequisito> getAgregarPreguntas(ServicioPreguntasPersonalizadasDto preguntas, List<AgregarPreguntasDto> result)
        {
        ...
        public override void Guardar(ParametrosGuardarDto<ServicioPreguntasPersonalizadasDto> parametrosGuardar, ParametrosAuditoriaDto parametrosAuditoria,
        ...
        public void GuardarCustomSGP(ParametrosGuardarDto<ServicioPreguntasPersonalizadasDto> parametrosGuardar, ParametrosAuditoriaDto parametrosAuditoria,
                                     bool guardarTemporalmente)
        {
            string mensajeAccion;

            GuardadoDefinitivoCustomSGP(parametrosGuardar, parametrosAuditoria.Usuario);
            mensajeAccion = string.Format(ServiciosNegocioRecursos.GuardadoDefinitivo, parametrosGuardar.Contenido);
        ...
        protected override void GuardadoDefinitivo(ParametrosGuardarDto<ServicioPreguntasPersonalizadasDto> parametrosGuardar, string usuario)
        {
            _preguntasPersonalizadasPersistencia.GuardarDefinitivamente(parametrosGuardar, usuario);
        }

        protected void GuardadoDefinitivoCustomSGP(ParametrosGuardarDto<ServicioPreguntasPersonalizadasDto> parametrosGuardar, string usuario)
        {
            _preguntasPersonalizadasComponentePersistencia.GuardarPreguntasPersonalizadasCustomSGP(parametrosGuardar, usuario);
        }
        ...
        {
            return _preguntasPersonalizadasPersistencia.ObtenerDatosGeneralesProyecto(pProyectoId, pNivelId);
        }

        public void DevolverCuestionarioProyecto(Guid nivelId, Guid instanciaId, int estadoAccionesPorInstancia)
        {
            _preguntasPersonalizadasPersistencia.DevolverCuestionarioProyecto(nivelId, instanciaId, estadoAccionesPorInstancia);
        }

        public ParametrosGuardarDto<ServicioPreguntasPersonalizadasDto> ConstruirParametrosGuardar(HttpRequestMessage request)
        {
            var parametrosGuardar = new ParametrosGuardarDto<ServicioPreguntasPersonalizadasDto>();
        ...
        {
            return _preguntasPersonalizadasPersistencia.ObtenerConfiguracionEntidades(pProyectoId, pNivelId);
        }
