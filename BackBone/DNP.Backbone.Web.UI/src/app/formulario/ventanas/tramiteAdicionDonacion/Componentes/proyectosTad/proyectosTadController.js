(function () {
    ...
    function proyectosTadController(
        $scope,
        $sessionStorage,
        tramiteVigenciaFuturaServicio,
        utilidades,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'proyectodatosadicionpordonacion', handlerValidacion: null, handlerCambios: null, esValido: true },
    ...
    angular.module('backbone').component('proyectosTad', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/proyectosTad/proyectosTad.html",
               
        controller: proyectosTadController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
