(function () {
    ...
    tramiteModificacionTrasladoPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionTrasladoPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteProgramacionRecursosServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionTrasladoPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionTraslado/presupuestoPrel/tramiteModificacionTrasladoPasoCuatro.html",
        controller: tramiteModificacionTrasladoPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
