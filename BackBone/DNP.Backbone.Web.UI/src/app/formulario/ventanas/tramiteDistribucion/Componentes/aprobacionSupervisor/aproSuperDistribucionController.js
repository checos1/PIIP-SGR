(function () {
    ...
    aproSuperDistribucionController.$inject = ['$scope',];

    function aproSuperDistribucionController(
        $scope,
    ...
    angular.module('backbone').component('aproSuperDistribucion', {
        templateUrl: "/src/app/formulario/ventanas/tramiteDistribucion/componentes/aprobacionSupervisor/aproSuperDistribucion.html",
        controller:aproSuperDistribucionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
