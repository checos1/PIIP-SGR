(function () {
    ...
    justificacionRvfController.$inject = [
        '$scope',

    ];

    function justificacionRvfController(
        $scope,
    ...
    angular.module('backbone').component('justificacionRvf', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/Componentes/justificacionRvf/justificacionRvf.html",


        controller: justificacionRvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
