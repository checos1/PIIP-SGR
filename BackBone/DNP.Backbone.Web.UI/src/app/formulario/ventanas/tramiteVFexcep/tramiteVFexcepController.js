(function () {
    ...
    tramiteVfexcepController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteVfexcepController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
        ...
        vm.section = "requerimientosTramite";//Tengo que preguntarle a FERNANDO
    ...
    angular.module('backbone').component('tramiteVfexcep', {
        templateUrl: "src/app/formulario/ventanas/tramiteVFexcep/tramiteVfexcep.html",

        controller: tramiteVfexcepController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
