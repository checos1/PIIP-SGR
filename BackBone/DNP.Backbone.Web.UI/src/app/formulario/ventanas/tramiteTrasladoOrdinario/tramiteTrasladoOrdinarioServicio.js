(function () {
    ...
    angular.module('backbone').factory('tramiteTrasladoOrdinarioServicio', tramiteTrasladoOrdinarioServicio);

    tramiteTrasladoOrdinarioServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone', 'servicioFichasProyectos', 'utilidades', 'FileSaver'];


    function tramiteTrasladoOrdinarioServicio($q, $http, $location, constantesBackbone, servicioFichasProyectos, utilidades, FileSaver) {
        return {
        ...
        function generarPdfCartaTramite(tramiteId, borrador = true, nombrearchivo) {
            ...
            nombreFichaTramite = constantesBackbone.apiBackBoneNombrePDFCarta;// Traslado Ordinario
