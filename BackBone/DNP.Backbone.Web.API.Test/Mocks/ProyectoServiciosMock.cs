namespace DNP.Backbone.Web.API.Test.Mocks
{
    ...
    public class ProyectoServiciosMock : IProyectoServicios
    {
        ...
        Task<ProyectoResumenDto> IProyectoServicios.ObtenerMonitoreoProyectos(ProyectoParametrosDto datosConsulta, string token, ProyectoFiltroDto proyectoFiltroDto)
        {
            return Task.FromResult(new ProyectoResumenDto());
        }
        ...
        {
            IEnumerable<ProyectoCreditoDto> result = new List<ProyectoCreditoDto>() { new ProyectoCreditoDto() };
        ...
        public Task<List<IndicadorCapituloModificadoDto>> IndicadoresValidarCapituloModificado(string bpin, string usuarioDNP, string tokenAutorizacion)
        {
            throw new System.NotImplementedException();
        }
        ...
        {
            RegionalizacionDto result = new RegionalizacionDto();
            return Task.FromResult(result);
        }
		...
		{
            LocalizacionJustificacionProyectoDto result = new LocalizacionJustificacionProyectoDto();
            return Task.FromResult(result);
        }
        ...
        public byte[] ObtenerArchivoDocumentos(List<DocumentosDto> datos)
        {
            byte[] archivo = null;
            return archivo;
        }
