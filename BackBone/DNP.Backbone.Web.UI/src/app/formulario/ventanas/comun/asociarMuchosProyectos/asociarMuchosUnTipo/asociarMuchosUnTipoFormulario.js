(function () {
    ...
    asociarMuchosUnTipoFormulario.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarMuchosUnTipoFormulario(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
        ...
        vm.init = function () {
            vm.mostrarBuscar = !$sessionStorage.soloLectura;
    ...
    angular.module('backbone').component('asociarMuchosUnTipoFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/asociarMuchosUnTipo/asociarMuchosUnTipoFormulario.html",
        controller: asociarMuchosUnTipoFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
