...
namespace DNP.ServiciosNegocio.Persistencia.Interfaces.Programacion
{
    public interface IProgramacionPersistencia
    {
        bool ValidarCalendarioProgramacion(Nullable<int> entityTypeCatalogOptionId, Nullable<System.Guid> nivelId, Nullable<int> seccionCapituloId);
        ...
        string ObtenerDatostProgramacionProducto(int tramiteId);
