(function () {
    ...
    cuerpoConceptoFormulario.$inject = [
        'sesionServicios',
        '$uibModal',
        '$scope',
        'utilidades',
    ...
    function cuerpoConceptoFormulario(
        sesionServicios,
        $uibModal,
        $scope,
        utilidades,
            ...
            $scope.$watch(() => vm.tramiteid
                , (newVal, oldVal) => {
                    if (newVal) {
                        ...
                        else if (vm.tipotramiteid === '7') {//Incorporacion
                            vm.mostrarSeccionCDP = false;
                            consultarConvenio();
                        }
                        else {
                    ...
                    response.data.forEach(autorizacion => {
                        ...
                        if (autorizacion.TipoProyecto == 'Contracredito') {
                            ...
                            for (var i = 0; i < vm.recursoss.length; i++) {
                                ...
                                vm.totalContra = vm.totalContra + valorCred;
                            }
                                var datosContra = {
                            ...
                            // #region cuandoeranacionyPropios                            
                            //vm.datosAutContraCredito.nombreProyecto = autorizacion.NombreProyecto.split('Programa')[0];
                        ...
                        else if (autorizacion.TipoProyecto == 'Credito') //Credito
                        {
                            ...
                            //}
                            // #region cuandoereaNacionyPRopios                            
                            //vm.datosAutCredito.nombreProyecto = autorizacion.NombreProyecto.split('Programa')[0];
                            ...
                            ////if (autorizacion.Recurso.includes('NACION')) {
                            ...
                            //    vm.RecursoNacion = true;
                            //    vm.fuentesN = vm.tipotramiteid==="7"?autorizacion.Recurso.split('-')[1]:'';
                            ////}
                            ////if (autorizacion.Recurso.includes('PROPIOS')) {
                            ...
                            ////    vm.RecursoPropios = true;
                            ////    vm.fuentesP = vm.tipotramiteid==="7"?autorizacion.Recurso.split('-')[1]:'';
                            ////}
    ...
    angular.module('backbone').component('cuerpoConceptoFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/elaborarConcepto/cuerpoConceptoFormulario.html",
        controller: cuerpoConceptoFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
