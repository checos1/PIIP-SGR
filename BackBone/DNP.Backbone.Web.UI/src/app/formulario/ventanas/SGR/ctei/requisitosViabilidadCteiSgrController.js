(function () {
    ...
    requisitosViabilidadCteiSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function requisitosViabilidadCteiSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        requisitosViabilidadCteiSgrServicio,
        ...
        vm.init = function () {
            ...
            var accionRequisitos = $sessionStorage.listadoAccionesTramite.find(f => f.Ventana == 'requisitosViabilidadCteiSgr');
        ...
        * */
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrcteidatosctei', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
            ...
            { id: 3, componente: 'sgrviabilidadrequisitosverificacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
            { id: 4, componente: 'sgrviabilidadrequisitossoportes', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null }
        ];
        ...
        function eventoValidar() {
            ...
            requisitosViabilidadCteiSgrServicio.obtenerErroresviabilidadSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        //function eventoValidar() {
        //    vm.inicializarComponenteCheck();
        //    requisitosViabilidadCteiSgrServicio.obtenerErroresviabilidadSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {
       ...
       */
        vm.showAlertError = function (nombreComponente, esValido) {
            var nomAlerta = "";
            if (nombreComponente == "sgrviabilidadrequisitosverificacion" && vm.SeccionIdViabilidad !== '')
    ...
    angular.module('backbone').component('requisitosViabilidadCteiSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctei/requisitosViabilidadCteiSgr.html",
        controller: requisitosViabilidadCteiSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
