(function () {
    ...
    angular.module('backbone')
        .controller('modalAgregarCategoriaPoliticaSinTramiteSgpController', modalAgregarCategoriaPoliticaSinTramiteSgpController);

    modalAgregarCategoriaPoliticaSinTramiteSgpController.$inject = [
        '$scope',
        '$uibModalInstance',
        '$sessionStorage',
        'utilidades',
    ...
    function modalAgregarCategoriaPoliticaSinTramiteSgpController(
        $scope,
        $uibModalInstance,
        $sessionStorage,
        utilidades,
        ...
        function consultarCategoriasPolitica(idPadre,nombrePolitica) {
            ...
            vm.politica = idPadre;
            return focalizacionAjustesSinTramiteSgpServicio.ConsultarCategoriasSubcategorias(idPadre, idEntidad, 1, esGrupoEtnico, usuarioDNP).then(            
                function (respuesta) {                    
        ...
        function consultarSubcategorias(idCategoria) {
            ...
            return focalizacionAjustesSinTramiteSgpServicio.ConsultarCategoriasSubcategorias(idCategoria, idEntidad, 0, esGrupoEtnico, usuarioDNP).then(
                function (respuesta) {                    
        ...
        function guardar() {
            ...
            return focalizacionAjustesSinTramiteSgpServicio.guardarFocalizacionCategoriasPolitica(parametros, usuarioDNP)
