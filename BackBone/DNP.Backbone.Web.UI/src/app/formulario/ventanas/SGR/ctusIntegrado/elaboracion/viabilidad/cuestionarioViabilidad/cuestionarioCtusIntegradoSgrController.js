(function () {
    'use strict';
    cuestionarioCtusIntegradoSgrController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function cuestionarioCtusIntegradoSgrController(
        utilidades,
        $sessionStorage,
        viabilidadSgrServicio,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "sgrctusintegradoviabilidadcuestionarioviabilidad";
    ...
    angular.module('backbone').component('cuestionarioCtusIntegradoSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/elaboracion/viabilidad/cuestionarioViabilidad/cuestionarioCtusIntegradoSgr.html",
        controller: cuestionarioCtusIntegradoSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
