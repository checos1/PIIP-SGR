(function () {
    ...
    ResumenFocalizacionFormularioController.$inject = [
        '$scope',
        '$sessionStorage',
        '$uibModal',
        'utilidades',
    ...
    function ResumenFocalizacionFormularioController(
        $scope,
        $sessionStorage,
        $uibModal,
        utilidades,
    ...
    angular.module('backbone').component('resumenFocalizacionFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/programacionRecursos/politicas/detallePolitica/transversales/ResumenFocalizacionFormulario.html",
        controller: ResumenFocalizacionFormularioController,
        controllerAs: "vm",
        bindings: {
