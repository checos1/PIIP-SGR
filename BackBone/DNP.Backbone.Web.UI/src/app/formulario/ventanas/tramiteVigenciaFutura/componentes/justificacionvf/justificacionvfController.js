(function () {
    ...
    justificacionvfController.$inject = ['$scope',];

    function justificacionvfController(
        $scope,
    ...
    angular.module('backbone').component('justificacionvf', {
        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/componentes/justificacionvf/justificacionvf.html",
        controller: justificacionvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
