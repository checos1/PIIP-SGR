namespace DNP.ServiciosWBS.Web.API.Tests.Controllers
{
    ...
    public sealed class ProductoControllerTest : IDisposable
    {
        ...
        public async Task ProductoController_Temporal__RetornaTrue()
        {
            ...
            var result = (OkNegotiatedContentResult<HttpResponseMessage>)await _productoController.Temporal(productoDto);
            Assert.IsNotNull(result.Content);
        }
        ...
        public async Task ProductoController_Definitivo__RetornaTrue()
        {
            ...
            _productoController.Request.Headers.Add("piip-idAplicacion", Guid.NewGuid().ToString());
            var result = (OkNegotiatedContentResult<HttpResponseMessage>)await _productoController.Definitivo(new ProyectoDto());
            Assert.IsNotNull(result.Content);
        }
