(function () {
    ...
    tramiteModificacionTrasladoPasoUnoController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
    ...
    function tramiteModificacionTrasladoPasoUnoController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
    ...
    angular.module('backbone').component('tramiteModificacionTrasladoPasoUno', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionTraslado/presupuestoPrel/tramiteModificacionTrasladoPasoUno.html",
        controller: tramiteModificacionTrasladoPasoUnoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
