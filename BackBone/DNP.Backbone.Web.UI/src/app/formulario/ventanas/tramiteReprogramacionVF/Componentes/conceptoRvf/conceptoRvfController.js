(function () {
    ...
    function conceptoRvfController(
        $scope,
        $sessionStorage,
        tramiteReprogramacionVfServicio
    ...
    angular.module('backbone').component('conceptoRvf', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/Componentes/conceptoRvf/conceptoRvf.html",


        controller: conceptoRvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
