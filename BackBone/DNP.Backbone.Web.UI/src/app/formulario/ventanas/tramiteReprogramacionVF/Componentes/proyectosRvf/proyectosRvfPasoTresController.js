(function () {
    ...
    proyectosRvfPasoTresController.$inject = [
        '$scope',
        '$sessionStorage',
    ...
    function proyectosRvfPasoTresController(
        $scope,
        $sessionStorage,
        tramiteVigenciaFuturaServicio,
        utilidades,
    ...
    angular.module('backbone').component('proyectosRvfPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/Componentes/proyectosRvf/proyectosRvfPasoTres.html",

        controller: proyectosRvfPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
