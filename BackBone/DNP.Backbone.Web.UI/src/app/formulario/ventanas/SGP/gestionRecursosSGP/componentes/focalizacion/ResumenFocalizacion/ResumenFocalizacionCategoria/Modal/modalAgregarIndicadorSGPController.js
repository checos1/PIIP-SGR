(function () {
	...
	modalAgregarIndicadorSgpController.$inject = [
		'$sessionStorage',
		'$uibModalInstance',
		'utilidades',
	...
	function modalAgregarIndicadorSgpController(
		$uibModalInstance,
		$sessionStorage,
		utilidades,
		focalizacionAjustesSGPServicio
		...
		function ConsultarPoliticasCategoriasIndicadores() {
			...
			return focalizacionAjustesSGPServicio.ConsultarPoliticasCategoriasIndicadoresSGP(vm.idInstancia, usuarioDNP, vm.idInstancia).then(
				function (respuesta) {
	...
	angular.module('backbone').controller('modalAgregarIndicadorSgpController', modalAgregarIndicadorSgpController);
})();
