(function () {
    ...
    buscarProyectovfController.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function buscarProyectovfController(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
        ...
        vm.abrirTooltip = function () {
            utilidades.mensajeInformacion('Se indica si el tramite de Vigencia Futura, ya tiene un proyecto asociado.'
                ...
                if (x.select) {
                    tramiteVigenciaFuturaServicio.asociarProyecto(x).then(function (response) {
                        if (response.data == 'True') {
                            ...
                            vm.gridProyectos.data = [];
                            parent.postMessage("cerrarModal", window.location.origin);
                            utilidades.mensajeSuccess("Para Completar el proceso, cree el ajuste correspondiente.", false, false, false, "El proyecto ha sido asociado y guardado con éxito.");
                            //para guardar los capitulos modificados y que se llenen las lunas
    ...
    angular.module('backbone').component('buscarProyectovf', {
        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/componentes/asociarProyectovf/seleccionProyecto/buscarProyecto/buscarProyectovf.html",
        controller: buscarProyectovfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
