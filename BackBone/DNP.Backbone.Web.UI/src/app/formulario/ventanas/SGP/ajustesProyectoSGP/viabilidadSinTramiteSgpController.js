(function () {
    ...
    viabilidadSinTramiteSgpController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function viabilidadSinTramiteSgpController(
        $scope,
        utilidades,
        $sessionStorage,
        viabilidadSinTramiteSgpServicio,
        ...
        * */
        ...
        function eventoValidar() {
            ...
            viabilidadSinTramiteSgpServicio.obtenerErroresviabilidadSgp(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {
                ...
                viabilidadSinTramiteSgpServicio.SGPViabilidadValidarCargueDocumentoObligatorio(dataArchivo, "tramites").then(function (response) {
                    if (respuesta.data) {
    ...
    angular.module('backbone').component('viabilidadSinTramiteSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/ajustesProyectoSGP/viabilidadSinTramiteSgp.html",
        controller: viabilidadSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tipoconceptoid: '@'
