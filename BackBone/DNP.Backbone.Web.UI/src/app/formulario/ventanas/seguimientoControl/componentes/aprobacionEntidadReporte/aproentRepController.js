(function () {
    ...
    aproentRepController.$inject = ['$scope',];

    function aproentRepController(
        $scope,
    ...
    angular.module('backbone').component('aproentRep', {
        templateUrl: "/src/app/formulario/ventanas/seguimientoControl/componentes/aprobacionEntidadReporte/aproentRep.html",
        controller: aproentRepController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
