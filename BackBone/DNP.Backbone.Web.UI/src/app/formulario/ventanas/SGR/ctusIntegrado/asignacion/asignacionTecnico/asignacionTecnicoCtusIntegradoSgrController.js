(function () {
    ...
    asignacionTecnicoCtusIntegradoSgrController.$inject = [
        '$scope',
        '$sessionStorage',
        'ctusIntegradoAsignacionSgrServicio'
    ];

    function asignacionTecnicoCtusIntegradoSgrController(
        $scope,
        $sessionStorage,
        ctusIntegradoAsignacionSgrServicio
    ) {
        ...
        vm.nombreComponente = "sgrctusintegradoasignacion";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrctusintegradoasignaciondelegar";
        vm.notificacionCambiosCapitulos = null;
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";
        vm.reqEntidad = true;
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctusintegradoasignaciondelegar', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrctusintegradoasignacionasignar', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrctusintegradoasignaciondelegar': true,
                'sgrctusintegradoasignacionasignar': true
            };
        }
        ...
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (vm.reqEntidad) {
                var listErrorest = {
                    errores: [
                        {
                            Seccion: 'sgrctusintegradoasignacion',
                            Capitulo: 'delegar',
                            Errores: '{"sgrctusintegradoasignaciondelegar":[{"Error":"DELECTUSI-sgrctusintegradoasignaciondelegar","Descripcion":"Debe responder esta pregunta."}]}'
                        }
                    ]
                };
    ...
    angular.module('backbone').component('asignacionTecnicoCtusIntegradoSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/asignacion/asignacionTecnico/asignacionTecnicoCtusIntegradoSgr.html",
        controller: asignacionTecnicoCtusIntegradoSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
