(function () {
    ...
    aproentTadController.$inject = ['$scope',];

    function aproentTadController(
        $scope,
    ...
    angular.module('backbone').component('aproentTad', {
        templateUrl: "/src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/aprobacionEntidadTad/aproentTad.html",

        controller: aproentTadController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
