(function () {
    ...
    soporteIncController.$inject = [
        '$scope',

    ];

    function soporteIncController(
        $scope,
    ...
    angular.module('backbone').component('soporteInc', {
        templateUrl: "src/app/formulario/ventanas/tramiteIncorporacion/componentes/soporteInc/soporteInc.html",


        controller: soporteIncController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
