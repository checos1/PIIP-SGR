(function () {
    ...
    informacionPresupuestalTmlrController.$inject = [
        '$scope',
    ];

    function informacionPresupuestalTmlrController(
        $scope,
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = 'informacionpresupuestal';
        vm.nombreComponenteHijo = "informacionpresupuestalsolicitudmodificaciondeleyreduccion";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'informacionpresupuestalsolicitudmodificaciondeleyreduccion', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
    ...
    angular.module('backbone').component('informacionPresupuestalTmlr', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionLeyRed/componentes/informacionPresupuestalTmlr/informacionPresupuestalTmlr.html",


        controller: informacionPresupuestalTmlrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
