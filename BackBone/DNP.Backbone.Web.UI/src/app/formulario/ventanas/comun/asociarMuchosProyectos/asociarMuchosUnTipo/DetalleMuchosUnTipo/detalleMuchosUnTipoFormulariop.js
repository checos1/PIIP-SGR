(function () {
    ...
    detalleMuchosUnTipoFormulariop.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
        'flujoServicios',
    ...
    function detalleMuchosUnTipoFormulariop(
        $sessionStorage,
        sesionServicios,
        utilidades,
        flujoServicios,
        ...
        vm.init = function () {
            ...
            if (vm.tipotramiteid === '50' || vm.tipotramiteid === '51' || vm.tipotramiteid === '53' || vm.tipotramiteid === '54' || vm.tipotramiteid === '55' || vm.tipotramiteid === '56') {
                vm.mostrarbtnEditar = false;
                //SE AJUSTA AL NIVEL_ID DEL FLUJO DE MODIFICACION DE LEY
                if (vm.tipotramiteid === '51' || vm.tipotramiteid === '53' || vm.tipotramiteid === '55') {
                ...
                if (vm.tipotramiteid === '50' || vm.tipotramiteid === '54' || vm.tipotramiteid === '56') {
                    var estadoPaso = $sessionStorage.listadoAccionesTramite.find(x => x.Nombre === $sessionStorage.nombreAccion);
            ...
            comunesServicio.obtenerProyectosTramite(vm.tramiteid)
                .then(function (response) {
                    if (response.data !== null && response.data.length > 0) {
                        ...
                        if (vm.ajusteml != vm.ajustemlTemp && (vm.tipotramiteid === '50' || vm.tipotramiteid === '51' || vm.tipotramiteid === '53' || vm.tipotramiteid === '54' || vm.tipotramiteid === '55' || vm.tipotramiteid === '56')) {
                            /* vm.generarInstanciasMasiva();*/
    ...
    angular.module('backbone').component('detalleMuchosUnTipoFormulariop', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/asociarMuchosUnTipo/detalleMuchosUnTipo/detalleMuchosUnTipoFormulariop.html",
        controller: detalleMuchosUnTipoFormulariop,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
