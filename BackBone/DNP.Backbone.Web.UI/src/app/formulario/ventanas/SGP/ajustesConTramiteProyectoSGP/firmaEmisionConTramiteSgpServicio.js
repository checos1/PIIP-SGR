(function () {
    ...
    angular.module('backbone').factory('firmaEmisionConTramiteSgpServicio', firmaEmisionConTramiteSgpServicio);

    firmaEmisionConTramiteSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function firmaEmisionConTramiteSgpServicio($http, constantesBackbone) {
