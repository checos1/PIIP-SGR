(function () {
    ...
    angular.module('backbone').factory('tramiteAdicionSgpServicio', tramiteAdicionSgpServicio);

    tramiteAdicionSgpServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone', 'servicioFichasProyectos', 'utilidades', 'FileSaver'];


    function tramiteAdicionSgpServicio($q, $http, $location, constantesBackbone, servicioFichasProyectos, utilidades, FileSaver) {
        return {
