(function () {
    ...
    informacionPresupuestalAdPasoTresController.$inject = [
        '$scope'
    ];

    function informacionPresupuestalAdPasoTresController(
        $scope
    ) {
        var vm = this;
        vm.lang = "es";
    ...
    angular.module('backbone').component('informacionPresupuestalAdPasoTres', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionAdicion/componentes/informacionPresupuestalAd/informacionPresupuestalAdPasoTres.html",
        controller: informacionPresupuestalAdPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
