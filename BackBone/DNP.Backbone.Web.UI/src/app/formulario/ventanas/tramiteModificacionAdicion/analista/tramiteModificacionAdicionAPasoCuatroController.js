(function () {
    ...
    tramiteModificacionAdicionAPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionAdicionAPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteProgramacionRecursosServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionAdicionAPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionAdicion/analista/tramiteModificacionAdicionAPasoCuatro.html",
        controller: tramiteModificacionAdicionAPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
