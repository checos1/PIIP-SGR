(function () {
    ...
    tramiteModificacionDTrasladoPasoUnoController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
    ...
    function tramiteModificacionDTrasladoPasoUnoController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
    ...
    angular.module('backbone').component('tramiteModificacionDTrasladoPasoUno', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/presupuestoPrel/tramiteModificacionDTrasladoPasoUno.html",
        controller: tramiteModificacionDTrasladoPasoUnoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
