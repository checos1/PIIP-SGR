(function () {
    ...
    politicasTransversalesPrPasoTresController.$inject = ['$scope', '$sessionStorage', 'comunesServicio'];

    function politicasTransversalesPrPasoTresController(
        $scope,
        $sessionStorage,
        comunesServicio
    ) {
        var vm = this;
        vm.nombreComponente = "politicastransversales";
        vm.nombreComponenteHijo = "politicastransversalespoliticastransv";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'politicastransversalespoliticastransv', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'politicastransversalespoliticastransv': true
            };
        }
    ...
    angular.module('backbone').component('politicasTransversalesPrPasoTres', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/Componentes/politicasTransversalesPr/politicasTransversalesPrPasoTres.html",
        controller: politicasTransversalesPrPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
