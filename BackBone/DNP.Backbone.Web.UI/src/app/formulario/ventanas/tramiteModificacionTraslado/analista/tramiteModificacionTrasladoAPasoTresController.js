(function () {
    ...
    tramiteModificacionTrasladoAPasoTresController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
    ...
    function tramiteModificacionTrasladoAPasoTresController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
    ...
    angular.module('backbone').component('tramiteModificacionTrasladoAPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionTraslado/analista/tramiteModificacionTrasladoAPasoTres.html",
        controller: tramiteModificacionTrasladoAPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
