(function () {
    ...
    aprobacionSupervisorRvfController.$inject = ['$scope',];

    function aprobacionSupervisorRvfController(
        $scope,


    ) {
        var vm = this;
        vm.nombreComponente = "aprobacionpaso4";
        vm.nombreComponenteHijo = "aprobacionpaso4confirmacionapr";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'aprobacionpaso4confirmacionapr', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'aprobacionpaso4confirmacionapr': true
            };
        }
    ...
    angular.module('backbone').component('aprobacionSupervisorRvf', {
        templateUrl: "/src/app/formulario/ventanas/tramiteReprogramacionVF/componentes/aprobacionSupervisorRvf/aprobacionSupervisorRvf.html",
        controller: aprobacionSupervisorRvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
