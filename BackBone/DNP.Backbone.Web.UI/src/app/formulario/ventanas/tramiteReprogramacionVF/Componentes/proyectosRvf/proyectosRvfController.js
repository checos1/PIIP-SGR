(function () {
    ...
    function proyectosRvfController(
        $scope,
        $sessionStorage,
        tramiteVigenciaFuturaServicio,
        utilidades,
    ...
    angular.module('backbone').component('proyectosRvf', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/Componentes/proyectosRvf/proyectosRvf.html",

        controller: proyectosRvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
