(function () {
    ...
    function conceptovfController(
        ...
        vm.extension = "";
        vm.filename = "";
        vm.inicializarDS = inicializarDS;
        ...
        //Validaciones
        vm.nombreComponente = "solicitarconcepto";

        //para guardar los capitulos modificados y que se llenen las lunas
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'solicitarconceptoelaborarconcepto', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'solicitarconceptodatosiniciales', handlerValidacion: null, handlerCambios: null, esValido: true },
            //{ id: 3, componente: 'solicitarconceptocuerpo', handlerValidacion: null, handlerCambios: null, esValido: true },
            //{ id: 4, componente: 'solicitarconceptodatosdespedida', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
        vm.handlerComponentesChecked = {};
   

        function inicializarDS(){
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'solicitarconceptoelaborarconcepto': true,
                'solicitarconceptodatosiniciales': true,
                //'solicitarconceptocuerpo': true,
                //'solicitarconceptodatosdespedida': true,
    ...
    angular.module('backbone').component('conceptovf', {
        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/aprobacion/componentes/concepto/conceptovf.html",
        controller: conceptovfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
