(function () {
    ...
    priorizacionM1PriorizaSgrController.$inject = ['$scope', 'utilidades', '$sessionStorage'];

    function priorizacionM1PriorizaSgrController(
        $scope,
        utilidades,
        $sessionStorage        
    ) {
        var vm = this;
        vm.nombreComponente = "sgrpriorizacionm1priorizacion";
        vm.nombreComponenteHijo = "sgrpriorizacionm1priorizacionregistropriorizacion";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrpriorizacionm1priorizacionregistropriorizacion', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrpriorizacionm1priorizacionestadopriorizacion', handlerValidacion: null, handlerCambios: null, esValido: true }
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrpriorizacionm1priorizacionregistro': true,
                'sgrpriorizacionm1priorizacionestado': true
            };
        }
    ...
    angular.module('backbone').component('priorizacionM1PriorizaSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/Priorizacion/M1/priorizacion/priorizacionM1PriorizaSgr.html",
        controller: priorizacionM1PriorizaSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
