(function () {
    ...
    tramiteAdicionDonacionPasoTresController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteAdicionDonacionPasoTresController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteAdicionDonacionPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/tramiteAdicionDonacionPasoTres.html",
        controller: tramiteAdicionDonacionPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
