(function () {
    ...
    elaboracionEntidadNacionalSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function elaboracionEntidadNacionalSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        justificacionCambiosServicio,
        ...
        vm.init = function () {
            ...
            elaboracionEntidadNacionalSgrServicio.SGR_Viabilidad_obtenerConceptosPreviosEmitidos(vm.Bpin).then(
                function (response) {
    ...
    angular.module('backbone').component('elaboracionEntidadNacionalSgr', {
        templateUrl: "src/app/formulario/ventanas/SGR/entidadNacional/elaboracionEntidadNacionalSgr.html",
        controller: elaboracionEntidadNacionalSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
