(function () {
    ...
    ajustesProyectoConTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
        'ajustesProyectoConTramiteSgpServicio',
        'viabilidadServicio',
        'utilidades',
    ...
    function ajustesProyectoConTramiteSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        ajustesProyectoConTramiteSgpServicio,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'datosgeneralessgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: []},
            { id: 2, componente: 'recursossgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
            { id: 3, componente: 'focalizacionpolsgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
            { id: 4, componente: 'justificacionsintramitesgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
            { id: 5, componente: 'soportesintramitesgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] }
        ];
        ...
        vm.abrirMGA = function () {
            ajustesProyectoConTramiteSgpServicio.ObtenerTokenMGA(vm.BPIN, tipoUsuarioAutenticado).then(function (respuesta) {
        ...
        vm.obtenerDetalleTramiteyRol = function () {
            ...
            vm.NivelValidacion = constantesBackbone.idNivelJustificaciónAJustesTramite;
        ...
        function eventoValidar() {
            ...
            ajustesProyectoConTramiteSgpServicio.obtenerErroresProyecto(vm.guiMacroproceso, vm.ProyectoId, vm.idInstancia).then(function (respuesta) {
        ...
        vm.notificacionValidacionHijos = function (errores) {
            ...
            if ($sessionStorage.sessionDocumentos < 100 && vm.IdNivel.toLowerCase() === vm.NivelValidacion.toLowerCase()) {
                error = {
                    Seccion: "soportesintramitesgp",
                    Capitulo: "soportessgp",
                    Errores: '{"soportesintramitesgpsoportessgp":[{"Error":"VFO006","Descripcion":"Diligencie los documentos obligatorios"}]}',
                }
            }
            else {
                error = {
    ...
    angular.module('backbone').component('ajustesProyectoConTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesConTramiteProyectoSGP/ajustesProyectoConTramiteSgp.html",
        controller: ajustesProyectoConTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
