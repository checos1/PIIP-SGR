(function () {
    'use strict';
    viabilidadViabilidadSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'viabilidadSgpServicio'
    ];

    function viabilidadViabilidadSgpController(
        $scope,
        $sessionStorage,
        viabilidadSgpServicio
    ) {
        ...
        vm.nombreComponenteHijo = "sgpviabilidadcuestionarioviabilidadsgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpviabilidadcuestionarioviabilidadsgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpviabilidadcuestionarioviabilidadsgp': true
            };
        }
        ...
        vm.devolverProyecto = function () {
            ...
            if (Observacion.value != null && Observacion.value !== "") {
                ...
                return viabilidadSgpServicio.devolverProyecto(vm.DevolverProyecto).then(
                    function (response) {
    ...
    angular.module('backbone').component('viabilidadViabilidadSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/viabilidadSGP/viabilidad/viabilidad/viabilidadViabilidadSgp.html",
        controller: viabilidadViabilidadSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
