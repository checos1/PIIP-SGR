(function () {
    ...
    documentoSoportevfController.$inject = [
        '$sessionStorage',
        'archivoServicios',
        '$scope',
        'servicioAcciones',
    ...
    function documentoSoportevfController(
        $sessionStorage,
        archivoServicios,
        $scope,
        servicioAcciones,
        ...
        vm.nombreComponente = "documentossoporte";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'documentossoportealojararchivo', handlerValidacion: null, handlerCambios: null, esValido: true },
          //  { id: 2, componente: 'archivosenprocesoactual', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'documentossoportealojararchivo': true,
    ...
    angular.module('backbone').component('documentoSoportevf', {
        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/componentes/documentoSoporte/documentoSoportevf.html",
        controller: documentoSoportevfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
