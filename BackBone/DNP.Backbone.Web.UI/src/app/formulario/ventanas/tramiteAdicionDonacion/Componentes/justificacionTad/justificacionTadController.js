(function () {
    ...
    justificacionTadController.$inject = [
        '$scope',

    ];

    function justificacionTadController(
        $scope,
    ...
    angular.module('backbone').component('justificacionTad', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/justificacionTad/justificacionTad.html",
                   
               
        controller: justificacionTadController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
