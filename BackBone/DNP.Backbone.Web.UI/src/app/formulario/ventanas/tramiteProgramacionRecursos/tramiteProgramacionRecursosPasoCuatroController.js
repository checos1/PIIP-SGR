(function () {
    ...
    tramiteProgramacionRecursosPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteProgramacionRecursosPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteProgramacionRecursosServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteProgramacionRecursosPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteProgramacionRecursos/tramiteProgramacionRecursosPasoCuatro.html",
        controller: tramiteProgramacionRecursosPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
