(function () {
    ...
    angular.module('backbone')
        .controller('modalAgregarInvolucradosTramiteTrasladoSgpController', modalAgregarInvolucradosTramiteTrasladoSgpController);

    modalAgregarInvolucradosTramiteTrasladoSgpController.$inject = [
        '$scope',
        '$uibModalInstance',
        '$sessionStorage',
        'utilidades',
    ...
    function modalAgregarInvolucradosTramiteTrasladoSgpController(
        $scope,
        $uibModalInstance,
        $sessionStorage,
        utilidades,
            ...
            transversalSgpServicio.SGPTransversalLeerParametro("RolFirmaTramiteTrasladoSgp")
                .then(function (respuestaParametro) {
                    if (respuestaParametro.data) {
                        var roles = $sessionStorage.listadoAccionesTramite.find(f => f.Ventana == 'TramiteTrasladoSgpPasoDos');
