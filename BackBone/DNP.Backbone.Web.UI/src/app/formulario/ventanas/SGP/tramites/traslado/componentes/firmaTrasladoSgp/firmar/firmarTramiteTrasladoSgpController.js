(function () {
    'use strict';
    firmarTramiteTrasladoSgpController.$inject = [
        'utilidades',
        '$sessionStorage',
        'justificacionCambiosServicio',
        'firmaEmisionTramiteTrasladoSgpServicio',
        'servicioFichasProyectos',
        'FileSaver',
        'transversalSgpServicio'
    ];

    function firmarTramiteTrasladoSgpController(
        utilidades,
        $sessionStorage,
        justificacionCambiosServicio,
        firmaEmisionTramiteTrasladoSgpServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgpfirmaresponsablestramiteprocesofirmastrasladosgp';
        vm.ventanaPadre = 'procesoFirmaTramiteTrasladoSgp';
        ...
        vm.mostrarBotonPdf = function () {
            var mostrar = false;
            if (vm.nombreComponente == "sgpfirmaresponsablestramiteprocesofirmastrasladosgp") { mostrar = true; }
            return mostrar;
            ;
    ...
    angular.module('backbone').component('firmarTramiteTrasladoSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/traslado/componentes/firmaTrasladoSgp/firmar/firmarTramiteTrasladoSgp.html",
        controller: firmarTramiteTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
