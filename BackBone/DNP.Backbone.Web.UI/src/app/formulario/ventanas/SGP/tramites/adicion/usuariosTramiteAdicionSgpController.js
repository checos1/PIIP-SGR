(function () {
    ...
    usuariosTramiteAdicionSgpController.$inject = [
        '$scope',
        '$location',
        'utilidades',
        '$sessionStorage',
        'usuariosTramiteAdicionSgpServicio',
    ...
    function usuariosTramiteAdicionSgpController(
        $scope,
        $location,
        utilidades,
        $sessionStorage,
    ...
    angular.module('backbone').component('usuariosTramiteAdicionSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/adicion/usuariosTramiteAdicionSgp.html",
        controller: usuariosTramiteAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
