(function () {
    ...
    informacionPresupuestalVfexcepController.$inject = [
        '$scope',
        '$sessionStorage',
    ...
    function informacionPresupuestalVfexcepController(
        $scope,
        $sessionStorage,
        tramiteVigenciaFuturaServicio,
        utilidades,
        ...
        vm.handlerComponentes = [
            ...
            { id: 2, componente: 'informacionpresupuestalresumen', handlerValidacion: null, handlerCambios: null, esValido: true },
        ...
        vm.validaAplicaConpes = function () {
            ...
            if (vm.idNivel.toUpperCase() === constantesBackbone.idNivelElaboracionConcepto) {
                vm.showConpes = false;
            }
            else {
    ...
    angular.module('backbone').component('informacionPresupuestalVfexcep', {
        templateUrl: "src/app/formulario/ventanas/tramiteVFexcep/componentes/informacionPresupuestalVfexcep/informacionPresupuestalVfexcep.html",
               
        controller: informacionPresupuestalVfexcepController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
