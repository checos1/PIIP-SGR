(function () {
    ...
    detalleMuchosUnTipoFormularioa.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
        'flujoServicios',
    ...
    function detalleMuchosUnTipoFormularioa(
        $sessionStorage,
        sesionServicios,
        utilidades,
        flujoServicios,
    ...
    angular.module('backbone').component('detalleMuchosUnTipoFormularioa', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/asociarMuchosUnTipo/detalleMuchosUnTipo/detalleMuchosUnTipoFormularioa.html",
        controller: detalleMuchosUnTipoFormularioa,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
