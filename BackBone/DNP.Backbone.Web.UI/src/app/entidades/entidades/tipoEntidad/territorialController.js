(function () {
    'use strict';
    angular.module('backbone.entidades').controller('territorialController', territorialController);

    territorialController.$inject = [
        '$scope',
        'servicioEntidades',
    ...
    function territorialController($scope, servicioEntidades, constantesAutorizacion, $uibModal, backboneServicios) {
        ...
        function listarEntidades(entidadeFiltro, cabezaSector, actualizar) {
            ...
            if (vm.listaEntidadesOrigem && !actualizar) {
                ...
                servicioEntidades.obtenerEntidadesPorTipo('Territorial')
                    .then(function (response) {
