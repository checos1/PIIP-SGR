(function () {
    'use strict';
    viabilidadSepOcadPazSgrController.$inject = [
        '$scope',
        '$sessionStorage',
        'viabilidadSgrServicio'
    ];

    function viabilidadSepOcadPazSgrController(
        $scope,
        $sessionStorage,
        viabilidadSgrServicio
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sistemaevaluacionpuntaje";
        vm.nombreComponenteHijo = "sistemaevaluacionpuntajesistemaevaluacionpuntaje";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sistemaevaluacionpuntajesistemaevaluacionpuntaje', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('viabilidadSepOcadPazSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ocadPaz/viabilidad/viabilidad/viabilidadSepOcadPazSgr.html",
        controller: viabilidadSepOcadPazSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
