(function () {
    'use strict';
    solicitarCtusIntegradoController.$inject = [
        '$scope',
        '$sessionStorage'
    ];

    function solicitarCtusIntegradoController(
        $scope,
        $sessionStorage
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrsolicitarctusintegrado";
        vm.nombreComponenteHijo = "sgrsolicitarctusintegradosolicitarintegrado";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrsolicitarctusintegradosolicitarintegrado', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrsolicitarctusintegradosolicitarintegrado': true
            };
        }
    ...
    angular.module('backbone').component('solicitarCtusIntegrado', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/Solicitar/SolicitarCtusIntegrado.html",
        controller: solicitarCtusIntegradoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
