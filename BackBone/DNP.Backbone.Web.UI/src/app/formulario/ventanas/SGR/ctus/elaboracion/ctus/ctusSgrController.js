(function () {
    ...
    ctusSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function ctusSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrctuselaboracionctus";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrctuselaboracionctusconcepto";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctuselaboracionctusconcepto', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrctuselaboracionctusresultadoconcepto', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrctuselaboracionctusconcepto': true,
                'sgrctuselaboracionctusresultadoconcepto': true
            };
        }
    ...
    angular.module('backbone').component('ctusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctus/elaboracion/ctus/ctusSgr.html",
        controller: ctusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
