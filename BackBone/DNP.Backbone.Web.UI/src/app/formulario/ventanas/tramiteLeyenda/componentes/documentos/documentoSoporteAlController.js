(function () {
    ...
    documentoSoporteAlController.$inject = ['$scope',];

    function documentoSoporteAlController(
        $scope,
    ...
    angular.module('backbone').component('documentoSoporteAl', {
        templateUrl: "src/app/formulario/ventanas/tramiteLeyenda/componentes/documentos/documentoSoporteAl.html",
        controller: documentoSoporteAlController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
