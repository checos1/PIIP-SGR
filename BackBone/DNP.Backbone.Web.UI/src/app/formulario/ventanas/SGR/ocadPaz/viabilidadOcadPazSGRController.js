(function () {
    ...
    viabilidadOcadPazSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
        'viabilidadOcadPazSgrServicio',
    ...
    function viabilidadOcadPazSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        viabilidadOcadPazSgrServicio,
        ...
        vm.init = function () {
            ...
            viabilidadOcadPazSgrServicio.validarInstanciaCTUSNoFinalizada(vm.ProyectoId).then(
                function (respuesta) {
        ...
        * */
        vm.handlerComponentes = [
            { id: 1, componente: 'sistemaevaluacionpuntaje', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
            { id: 2, componente: 'sgrocadpazviabilidad', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
        ...
        function eventoValidar() {
            ...
            viabilidadOcadPazSgrServicio.obtenerErroresviabilidadOcadPazSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        //function eventoValidar() {
        //    vm.inicializarComponenteCheck();
        //    viabilidadOcadPazSgrServicio.obtenerErroresviabilidadOcadPazSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {
    ...
    angular.module('backbone').component('viabilidadOcadPazSgr', {
        templateUrl: "src/app/formulario/ventanas/SGR/ocadPaz/viabilidadOcadPazSgr.html",
        controller: viabilidadOcadPazSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
