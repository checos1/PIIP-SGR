(function () {
    ...
    procesoFirmaViabilidadSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function procesoFirmaViabilidadSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrviabilidadprocesofirma";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrviabilidadprocesofirmaprocesofirma";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadprocesofirmaprocesofirma', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('procesoFirmaViabilidadSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/firmaEmision/procesoFirma/procesoFirmaViabilidadSgr.html",
        controller: procesoFirmaViabilidadSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
