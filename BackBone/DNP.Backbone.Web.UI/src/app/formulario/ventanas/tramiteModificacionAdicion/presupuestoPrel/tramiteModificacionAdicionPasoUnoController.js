(function () {
    ...
    tramiteModificacionAdicionPasoUnoController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionAdicionPasoUnoController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionAdicionPasoUno', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionAdicion/presupuestoPrel/tramiteModificacionAdicionPasoUno.html",
        controller: tramiteModificacionAdicionPasoUnoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
