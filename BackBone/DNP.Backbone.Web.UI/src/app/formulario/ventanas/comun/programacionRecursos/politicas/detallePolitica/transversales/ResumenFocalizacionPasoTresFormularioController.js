(function () {
    ...
    ResumenFocalizacionPasoTresFormularioController.$inject = [
        '$scope',
        '$sessionStorage',
        '$uibModal',
        'utilidades',
    ...
    function ResumenFocalizacionPasoTresFormularioController(
        $scope,
        $sessionStorage,
        $uibModal,
        utilidades,
        ...
        vm.componentesRefresh = [
            ...
            'focalizacionpolSolicitarConAju',
        ];
        ...
        vm.GuardarPolitica = function (politicasIndicadores) {
            ...
            angular.forEach(politicasIndicadores.Categorias, function (categoria) {
                ...
                angular.forEach(categoria.Localizaciones, function (localizacion) {
                    ...
                    datosDistribucion.LocalizacionId = localizacion.LocalizacionId;
                    datosDistribucion.ValorDistribuidoNacion = localizacion.ValorDistribuidoNacion;
                    datosDistribucion.ValorDistribuidoPropios = localizacion.ValorDistribuidoPropios;
                    datosDistribucion.ValorRecursosAprobadosNacion = localizacion.ValorRecursosAprobadosNacion;
                    datosDistribucion.ValorRecursosAprobadosPropios = localizacion.ValorRecursosAprobadosPropios;
            ...
            return comunesServicio.guardarPoliticasTransversalesCategoriasProgramacion(proyecto)
        ...
        vm.CalcularSolicitados = function (localizaciones) {
            let total = 0;

            angular.forEach(localizaciones, function (item) {
                total += parseFloat(item.RecursosSolicitadosNacion) + parseFloat(item.RecursosSolicitadosPropios);
            });

            return total;
        }

        vm.CalcularDistribuidos = function (localizaciones) {
            let total = 0;

            angular.forEach(localizaciones, function (item) {
                total += parseFloat(item.ValorDistribuidoNacion) + parseFloat(item.ValorDistribuidoPropios);
            });

            return total;
        }

        vm.CalcularAprobados = function (localizaciones) {
            let total = 0;

            angular.forEach(localizaciones, function (item) {
                total += parseFloat(item.ValorRecursosAprobadosNacion) + parseFloat(item.ValorRecursosAprobadosPropios);
            });
        ...
        vm.obtenerPoliticasTransversales = function (bpin) {
            ...
            return focalizacionAjustesServicio.obtenerPoliticasTransversalesProyecto(bpin, usuarioDNP, idInstancia).then(
                //return comunesServicio.consultarPoliticasTransversalesProgramacion(bpin).then(
                function (respuesta) {
        ...
        function abrirModalAgregarIndicador(CategoiaId1, CategoriaId2, Subcategoria, Categoria, Politica, FocalizacionId) {
            ...
            $uibModal.open({
                templateUrl: 'src/app/formulario/ventanas/ajustes/componentes/focalizacion/ResumenFocalizacion/ResumenFocalizacionCategoria/Modal/modalAgregarIndicador.html',
        ...
        vm.obtenerPoliticasTransversalesCategorias = function () {
            ...
            //bpin = '{ "InstanciaId": "806656bd-cf11-44b8-892c-2791669fb23e", "ProyectoId": 31012, "Bpin": "2017011000339", "Texto": "ConsultaCategorias", "DetalleLocalizacion": [] }';


            //return focalizacionAjustesServicio.obtenerPoliticasTransversalesCategorias(bpin, usuarioDNP, idInstancia).then(



            //vm.listaPoliticasCategorias = { "ProyectoId": 119650, "BPIN": "2018011001016", "ListadoPoliticas": [{ "PoliticaId": 3, "NombrePolitica": "Campesinos" }, { "PoliticaId": 4, "NombrePolitica": "Construcción de Paz" }, { "PoliticaId": 10, "NombrePolitica": "Grupos étnicos - Comunidades Indígenas" }, { "PoliticaId": 19, "NombrePolitica": "Tecnologías de información y comunicaciones" }, { "PoliticaId": 20, "NombrePolitica": "Víctimas" }], "PoliticasCategorias": [{ "PoliticaId": 10, "NombrePolitica": "Grupos étnicos - Comunidades Indígenas", "Categorias": null }, { "PoliticaId": 19, "NombrePolitica": "Tecnologías de información y comunicaciones", "Categorias": [{ "PoliticaId": 19, "DimensionId": 119, "NombreCategoria": "Aplicaciones \/ Software", "NombreSubcategoria": "N\/A", "Localizaciones": [{ "LocalizacionId": 12021, "NombreLocalizacion": "Nacional - Nacional -  -  - ", "RecursosSolicitadosNacion": 0.00, "RecursosSolicitadosPropios": 0.00, "ValorDistribuidoNacion": 0.00, "ValorDistribuidoPropios": 0.00 }] }, { "PoliticaId": 19, "DimensionId": 120, "NombreCategoria": "Infraestructura\/Hardware", "NombreSubcategoria": "N\/A", "Localizaciones": [{ "LocalizacionId": 12021, "NombreLocalizacion": "Nacional - Nacional -  -  - ", "RecursosSolicitadosNacion": 0.00, "RecursosSolicitadosPropios": 0.00, "ValorDistribuidoNacion": 0.00, "ValorDistribuidoPropios": 0.00 }] }, { "PoliticaId": 19, "DimensionId": 121, "NombreCategoria": "Servicios", "NombreSubcategoria": "N\/A", "Localizaciones": [{ "LocalizacionId": 12021, "NombreLocalizacion": "Nacional - Nacional -  -  - ", "RecursosSolicitadosNacion": 0.00, "RecursosSolicitadosPropios": 0.00, "ValorDistribuidoNacion": 0.00, "ValorDistribuidoPropios": 0.00 }] }] }, { "PoliticaId": 20, "NombrePolitica": "Víctimas", "Categorias": [{ "PoliticaId": 20, "DimensionId": 4744, "NombreCategoria": "Víctimas de otros hechos diferentes a Desplazamiento", "NombreSubcategoria": "Asistencia - Alimentación", "Localizaciones": [{ "LocalizacionId": 12021, "NombreLocalizacion": "Nacional - Nacional -  -  - ", "RecursosSolicitadosNacion": 0.00, "RecursosSolicitadosPropios": 0.00, "ValorDistribuidoNacion": 0.00, "ValorDistribuidoPropios": 0.00 }] }, { "PoliticaId": 20, "DimensionId": 4746, "NombreCategoria": "Víctimas de otros hechos diferentes a Desplazamiento", "NombreSubcategoria": "Asistencia - Educación", "Localizaciones": [{ "LocalizacionId": 12021, "NombreLocalizacion": "Nacional - Nacional -  -  - ", "RecursosSolicitadosNacion": 0.00, "RecursosSolicitadosPropios": 0.00, "ValorDistribuidoNacion": 0.00, "ValorDistribuidoPropios": 0.00 }] }] }, { "PoliticaId": 3, "NombrePolitica": "Campesinos", "Categorias": [{ "PoliticaId": 3, "DimensionId": 5613, "NombreCategoria": "Mesa Campesina Del Cauca", "NombreSubcategoria": "MCC001 - Subsidios de Vivienda de Interés Social Rural para vivienda nueva y mejoramiento de vivienda rural", "Localizaciones": [{ "LocalizacionId": 12021, "NombreLocalizacion": "Nacional - Nacional -  -  - ", "RecursosSolicitadosNacion": 0.00, "RecursosSolicitadosPropios": 0.00, "ValorDistribuidoNacion": 0.00, "ValorDistribuidoPropios": 0.00 }] }] }, { "PoliticaId": 4, "NombrePolitica": "Construcción de Paz", "Categorias": [{ "PoliticaId": 4, "DimensionId": 4467, "NombreCategoria": "1. Reforma Rural Integral  -  1.0. Planes nacionales para la reforma rural integral", "NombreSubcategoria": "N\/A", "Localizaciones": [{ "LocalizacionId": 12021, "NombreLocalizacion": "Nacional - Nacional -  -  - ", "RecursosSolicitadosNacion": 0.00, "RecursosSolicitadosPropios": 0.00, "ValorDistribuidoNacion": 0.00, "ValorDistribuidoPropios": 0.00 }] }] }] };

            //console.log(vm.listaPoliticasCategorias);
            //vm.Focalizacion = vm.listaPoliticasCategorias;
            //vm.existeFocalizacion = true;
            ////guardaValoresOriginales();
            //ValidarVerDescarDocumentos();

            return comunesServicio.consultarPoliticasTransversalesCategoriasProgramacion(parametroConsulta).then(
                function (respuesta) {
                    if (respuesta.data != null && respuesta.data != "") {
        ...
        vm.cancelarEdicion = function (politica, categoria, fuente, producto, localizacion, indexPoliticas, indexCategorias, indexFuentes, indexProducto) {
            ...
            utilidades.mensajeWarning("¿Está seguro de continuar?", function funcionContinuar() {
                ...
                //2023-03-17  se pone en comentario el llamado nuevamente al servio: obtenerPoliticasTransversalesProyecto,  ya que consume recursos y no es necesario
                //2023-03-17 return focalizacionAjustesServicio.obtenerPoliticasTransversalesProyecto(vm.BPIN, usuarioDNP, idInstancia).then(
                //function (respuesta) {
        ...
        function abrirModalAgregarCategoriaPolitica(Politica) {
            ...
            let modalInstance = $uibModal.open({
                ...
                templateUrl: "src/app/formulario/ventanas/ajustes/componentes/focalizacion/ResumenFocalizacion/FocalizacionCategoria/modalAgregarCategoriaPolitica.html",
                ...
                angular.forEach(politicasIndicadores.Categorias, function (categoria) {
                    ...
                    angular.forEach(categoria.Localizaciones, function (localizacion) {
                        ...
                        angular.forEach(vm.PoliticasTransversalesArchivo, function (fila) {
                            ...
                            if (fila.LocalizacionId == localizacion.LocalizacionId && fila.DimensionId == categoria.DimensionId) {
                                ...
                                datosDistribucion.ValorRecursosAprobadosNacion = fila.ValorRecursosAprobadosNacion;
                                datosDistribucion.ValorRecursosAprobadosPropios = fila.ValorRecursosAprobadosPropios;
        ...
        function exportarFocalizacionExcel(politicasIndicadores) {
            ...
            utilidades.mensajeWarning("Si ocurren inconvenientes de descarga o visualización, es necesario actualizar la aplicación.", function funcionContinuar() {
                ...
                var columns = [
                    ...
                    {
                        name: 'ValorDistribuidoNacion', title: 'Valor Distribuido Nacion'
                    },
                    {
                        name: 'ValorDistribuidoPropios', title: 'Valor Distribuido Propios'
                    },
                    {
                        name: 'ValorRecursosAprobadosNacion', title: 'Valor Aprobados Nacion'
                    },
                    {
                        name: 'ValorRecursosAprobadosPropios', title: 'Valor Aprobados Propios'
                    }
                ];
                ...
                politicasIndicadores.Categorias.forEach(categoria => {
                    categoria.Localizaciones.forEach(localizacion => {
                        data.push({
                            ...
                            Localizacion: localizacion.NombreLocalizacion,
                            ValorDistribuidoNacion: localizacion.ValorDistribuidoNacion,
                            ValorDistribuidoPropios: localizacion.ValorDistribuidoPropios,
                            ValorRecursosAprobadosNacion: localizacion.ValorRecursosAprobadosNacion,
                            ValorRecursosAprobadosPropios: localizacion.ValorRecursosAprobadosPropios
                        });
                    });
                });
                ...
                const worksheet = XLSX.utils.json_to_sheet(data, {
                    header: ["TramiteId",
                        ...
                        "Dimension",
                        "Localizacion",
                        "ValorDistribuidoNacion",
                        "ValorDistribuidoPropios",
                        "ValorRecursosAprobadosNacion",
                        "ValorRecursosAprobadosPropios"]
                });
                ...
                wb.Sheets["Distribucion"] = worksheet;

                var wbout = XLSX.write(wb, { bookType: 'xlsx', type: 'binary' });
                //saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PlantillaAjusteRegionalizacion.xlsx');
                saveAs(new Blob([s2ab(wbout)], { type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=utf-8" }), 'PlantillaDistribucion' + NombrePolitica + '.xlsx');
            }, function funcionCancelar(reason) {
                        ...
                        if (reader.readAsBinaryString) {
                            reader.onload = function (e) {
                                ...
                                resultado = excelRows.map(function (item, index) {
                                    ...
                                    if (item["ValorDistribuidoNacion"] == undefined) {
                                        utilidades.mensajeError("La columna ValorDistribuidoNacion no trae valor!");
                                        return false;
                                    }
                                    else if (!ValidarDicimal(item["ValorDistribuidoNacion"].toString(), 2)) {
                                        utilidades.mensajeError("El valor ValorDistribuidoNacion " + item["ValorDistribuidoNacion"] + " no es númerico!");
                                        return false;
                                    }

                                    if (item["ValorDistribuidoPropios"] == undefined) {
                                        utilidades.mensajeError("La columna ValorDistribuidoPropios no trae valor!");
                                        return false;
                                    }
                                    else if (!ValidarDicimal(item["ValorDistribuidoPropios"].toString(), 2)) {
                                        utilidades.mensajeError("El valor ValorDistribuidoPropios " + item["ValorDistribuidoPropios"] + " no es númerico!");
                                        return false;
                                    }

                                    if (item["ValorRecursosAprobadosNacion"] == undefined) {
                                        utilidades.mensajeError("La columna ValorRecursosAprobadosNacion no trae valor!");
                                        return false;
                                    }
                                    else if (!ValidarDicimal(item["ValorRecursosAprobadosNacion"].toString(), 2)) {
                                        utilidades.mensajeError("El valor ValorRecursosAprobadosNacion " + item["ValorRecursosAprobadosNacion"] + " no es númerico!");
                                        return false;
                                    }

                                    if (item["ValorRecursosAprobadosPropios"] == undefined) {
                                        utilidades.mensajeError("La columna ValorRecursosAprobadosPropios no trae valor!");
                                        return false;
                                    }
                                    else if (!ValidarDicimal(item["ValorRecursosAprobadosPropios"].toString(), 2)) {
                                        utilidades.mensajeError("El valor ValorRecursosAprobadosPropios " + item["ValorRecursosAprobadosPropios"] + " no es númerico!");
                                        return false;
                                    }
                                    ...
                                    var valoresarchivo = {
                                        ...
                                        ValorDistribuidoNacion: item["ValorDistribuidoNacion"],
                                        ValorDistribuidoPropios: item["ValorDistribuidoPropios"],
                                        ValorRecursosAprobadosNacion: item["ValorRecursosAprobadosNacion"],
                                        ValorRecursosAprobadosPropios: item["ValorRecursosAprobadosPropios"]
                                    };
    ...
    angular.module('backbone').component('resumenFocalizacionPasoTresFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/programacionRecursos/politicas/detallePolitica/transversales/resumenFocalizacionPasoTresFormulario.html",
        controller: ResumenFocalizacionPasoTresFormularioController,
        controllerAs: "vm",
        bindings: {
