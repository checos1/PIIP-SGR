(function () {
    ...
    tramiteModificacionTrasladoAPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionTrasladoAPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteProgramacionRecursosServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionTrasladoAPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionTraslado/analista/tramiteModificacionTrasladoAPasoCuatro.html",
        controller: tramiteModificacionTrasladoAPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
