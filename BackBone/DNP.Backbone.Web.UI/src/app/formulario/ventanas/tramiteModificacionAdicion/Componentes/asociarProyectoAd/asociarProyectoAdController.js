(function () {
    ...
    asociarProyectoAdController.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarProyectoAdController(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
    ...
    angular.module('backbone').component('asociarProyectoAd', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionAdicion/componentes/asociarProyectoAd/asociarProyectoAd.html",
        controller: asociarProyectoAdController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
