(function () {
    'use strict';
    angular.module('backbone').factory('editarActividadModalServicio', editarActividadModalServicio);

    editarActividadModalServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];

    function editarActividadModalServicio($q, $http, $location, constantesBackbone) {
        return {
