(function () {
    ...
    asociarProyectoTrasladoSgpController.$inject = [
        '$sessionStorage',
        'utilidades',
        'constantesBackbone',
        '$scope'
    ...
    function asociarProyectoTrasladoSgpController(
        $sessionStorage,
        utilidades,
        constantesBackbone,
        $scope
    ...
    angular.module('backbone').component('asociarProyectoTrasladoSgp', {        
        templateUrl: "src/app/formulario/ventanas/SGP/tramites/traslado/componentes/asociarProyectoTrasladoSgp/asociarProyectoTrasladoSgp.html",
        controller: asociarProyectoTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
