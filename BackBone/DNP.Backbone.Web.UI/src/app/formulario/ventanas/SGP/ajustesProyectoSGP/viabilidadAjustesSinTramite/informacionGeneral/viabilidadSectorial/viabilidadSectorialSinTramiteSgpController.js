(function () {
    ...
    viabilidadSectorialSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function viabilidadSectorialSinTramiteSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsintramitesgp";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsintramitesgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('viabilidadSectorialSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/viabilidadAjustesSinTramite/informacionGeneral/viabilidadSectorial/viabilidadSectorialSinTramiteSgp.html",
        controller: viabilidadSectorialSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
