(function () {
    ...
    detalleProyectosUnTipoFormulario.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
        'flujoServicios',
    ...
    function detalleProyectosUnTipoFormulario(
        $sessionStorage,
        sesionServicios,
        utilidades,
        flujoServicios,
            ...
            comunesServicio.obtenerProyectosTramite(vm.tramiteid)
                .then(function (response) {
                    if (response.data !== null && response.data.length > 0) {
                        ...
                        if (vm.tipotramiteid == "9" && vm.cantProyectosAsociados > 0) {//Adicion
    ...
    angular.module('backbone').component('detalleProyectosUnTipoFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/asociarProyectosUnTipo/detalleProyectosUnTipo/detalleProyectosUnTipoFormulario.html",
        controller: detalleProyectosUnTipoFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
