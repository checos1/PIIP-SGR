(function () {
	'use strict';
	angular.module('backbone').factory('localizacionJustificacionServicio', localizacionJustificacionServicio);

	localizacionJustificacionServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone', '$sessionStorage'];

	function localizacionJustificacionServicio($q, $http, $location, constantesBackbone,$sessionStorage) {
		return {
