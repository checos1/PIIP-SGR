(function () {
    ...
    aproentDistribucionController.$inject = ['$scope',];

    function aproentDistribucionController(
        $scope,
    ...
    angular.module('backbone').component('aproentDistribucion', {
        templateUrl: "/src/app/formulario/ventanas/tramiteDistribucion/componentes/aprobacionEntidad/aproentDistribucion.html",
        controller: aproentDistribucionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
