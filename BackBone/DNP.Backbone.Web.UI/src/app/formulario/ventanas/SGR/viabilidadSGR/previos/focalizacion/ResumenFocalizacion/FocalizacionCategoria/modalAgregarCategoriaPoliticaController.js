(function () {
    ...
    function modalAgregarCategoriaPoliticaController(    
        ...
        function consultarCategoriasPolitica(idPadre,nombrePolitica) {
            ...
            vm.politica = idPadre;
            return focalizacionAjustesSgrServicio.ConsultarCategoriasSubcategorias(idPadre, idEntidad, 1, esGrupoEtnico, usuarioDNP).then(
        ...
        function consultarSubcategorias(idCategoria) {
            ...
            return focalizacionAjustesSgrServicio.ConsultarCategoriasSubcategorias(idCategoria, idEntidad, 0, esGrupoEtnico, usuarioDNP).then(
        ...
        function guardar() {
            ...
            return focalizacionAjustesSgrServicio.guardarFocalizacionCategoriasPolitica(parametros, usuarioDNP)
