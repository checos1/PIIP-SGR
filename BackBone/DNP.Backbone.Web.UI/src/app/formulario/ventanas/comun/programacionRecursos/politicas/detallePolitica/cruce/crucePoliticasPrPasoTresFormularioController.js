var crucePoliticasPrPasoTresFormularioControllerCtrl = null;

(function () {
    'use strict';
    angular.module('backbone').controller('crucePoliticasPrPasoTresFormularioController', crucePoliticasPrPasoTresFormularioController);
    crucePoliticasPrPasoTresFormularioController.$inject = [
        '$scope',
        '$uibModal',
        '$log',
        '$q',
    ...
    function crucePoliticasPrPasoTresFormularioController(
        $scope,
        $uibModal,
        $log,
        $q,
        ...
        utilidades) {
        var vm = this;
        crucePoliticasPrPasoTresFormularioControllerCtrl = vm;
        //variables
        vm.lang = "es";
        vm.TabActivo = 1;
        ...
        function GuardarValores(regionalizacion) {
            ...
            angular.forEach(regionalizacion.Recursos, function (series) {
                let valores = {
                    ...
                    PeriodoProyectoId: 0,
                    Vigencia: 0,
                    ValorPoliticaPrincipal: series.ValorA,
                    ValorCruceDependientePrincipal: series.Valor,
        ...
        vm.actualizaFila = function (event, regionalizacion) {
            ...
            angular.forEach(regionalizacion.Recursos, function (series) {
                ...
                TValorA += parseFloat(series.ValorA);
            });
            ...
            regionalizacion.TValorA = TValorA;
    ...
    angular.module('backbone')
        .component('crucePoliticasPrPasoTresFormulario', {
            templateUrl: 'src/app/formulario/ventanas/comun/programacionRecursos/politicas/detallePolitica/cruce/crucePoliticasPrPasoTresFormulario.html',
            controller: 'crucePoliticasPrPasoTresFormularioController',
            controllerAs: 'vm',
            bindings: {
                callback: '&',
