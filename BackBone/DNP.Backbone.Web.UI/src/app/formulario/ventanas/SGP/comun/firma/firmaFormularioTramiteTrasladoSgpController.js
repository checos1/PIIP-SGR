(function () {
    ...
    firmaFormularioTramiteTrasladoSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
    ...
    function firmaFormularioTramiteTrasladoSgpController(
        $scope,
        $sessionStorage,
        utilidades,
        firmaFormularioSgpServicio,
    ...
    angular.module('backbone').component('firmaFormularioTramiteTrasladoSgp', {

        templateUrl: "src/app/formulario/ventanas/SGP/comun/firma/firmaFormularioTramiteTrasladoSgp.html",
        controller: firmaFormularioTramiteTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
