...
namespace DNP.Backbone.Web.API.Test.Mocks
{
    public class ProgramacionServiciosMock : IProgramacionServicios
    {
        ...
        public Task<RespuestaGeneralDto> GuardarModificacionesAsociarIndicadorPolitica(int proyectoId, int politicaId, int categoriaId, int indicadorId, string accion, string usuario)
        {
            var resultado = new RespuestaGeneralDto();
