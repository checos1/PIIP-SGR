(function () {
    ...
    asociarProyectoalController.$inject = [
        '$sessionStorage',
        '$scope',

    ];

    function asociarProyectoalController(
        $sessionStorage,
        $scope,
    ) {
        var vm = this;
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'asociarproyectoseleccionproyec', handlerValidacion: null, handlerCambios: null, esValido: true },
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'asociarproyectoseleccionproyec': true,
    ...
    angular.module('backbone').component('asociarProyectoal', {
        templateUrl: "src/app/formulario/ventanas/tramiteLeyenda/componentes/asociarProyectoal/asociarProyectoal.html",
        controller: asociarProyectoalController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
