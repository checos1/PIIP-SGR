(function () {
    ...
    angular.module('backbone').component('firmaRvf', {

        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/componentes/firmaRvf/firmaRvf.html",
        controller: firmaRvfController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
