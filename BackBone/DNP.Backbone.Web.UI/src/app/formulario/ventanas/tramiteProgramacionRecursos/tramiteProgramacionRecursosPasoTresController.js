(function () {
    ...
    tramiteProgramacionRecursosPasoTresController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
    ...
    function tramiteProgramacionRecursosPasoTresController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
    ...
    angular.module('backbone').component('tramiteProgramacionRecursosPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteProgramacionRecursos/tramiteProgramacionRecursosPasoTres.html",
        controller: tramiteProgramacionRecursosPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&',
