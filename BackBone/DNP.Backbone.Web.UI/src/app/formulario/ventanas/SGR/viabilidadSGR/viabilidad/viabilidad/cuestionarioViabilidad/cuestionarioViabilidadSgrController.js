(function () {
    'use strict';
    cuestionarioViabilidadSgrController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function cuestionarioViabilidadSgrController(
        utilidades,
        $sessionStorage,
        viabilidadSgrServicio,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "sgrviabilidadcuestionarioviabilidad";
        ...
        vm.ActivarEditar = function () {
            if (vm.activar == true) {
                $("#EditarReqViabilidad").html("CANCELAR");
                vm.activar = false;
            }
            else {
                utilidades.mensajeWarning("¿Está seguro de continuar?", function funcionContinuar() {
                    ...
                    $("#EditarReqViabilidad").html("EDITAR");
                    vm.activar = true;
                    vm.init();
        ...
        function OkCancelar() {
            ...
            vm.elementJustificacion.forEach(element => {
        ...
        function validarCuestionario() {
                        ...
                        preguntas.ObligaObservacion.forEach(ObligaObservacionValue => {
                            ...
                            if (ObligaObservacionValue.OpcionId == preguntas.Respuesta && tmpJustifica.length <= 5) {
                                if (obsObligatoria != undefined) {
                                    ...
                                    validopregunta = true;
                                    vm.elementJustificacion.push(obsObligatoria)
                                }
                            }
                            else {
            ...
            vm.PreguntasPersonalizadas.PreguntasGenerales.forEach(generales => {
                generales.Preguntas.forEach(pregunta => {
                    ...
                    if (pregunta?.Respuesta?.length == 0) {
        ...
        vm.notificacionValidacionPadre = function (errores) {
            ...
            //alert-viabilidadgenerales23917
            vm.limpiarErrores();
            if (errores != undefined) {
                ...
                if (!isValid) {
                    erroresJson[vm.nombreComponente].forEach(p => {
                        ...
                        var IdPregunta = `alert-viabilidadgenerales${nameArr.slice(1, 3).join('')}`;
                        if (TipoError == 'ErrorG') {
                            ...
                            vm.validarValoresTematica(nameArr[0].toString(), false, IdPregunta);
                            vm.validarValores(nameArr[0].toString(), nameArr[1].toString(), p.Descripcion, false, IdPregunta);
                        }
                    });
                }
        ...
        vm.validarValoresTematica = function (tematica, esValido, IdPregunta = null) {
            var idSpanAlertComponent = document.getElementById("alert-" + vm.nombreComponente + tematica);

            if (idSpanAlertComponent === null)
                idSpanAlertComponent = document.getElementById(IdPregunta);
        ...
        vm.validarValores = function (tematica, pregunta, errores, esValido, IdPregunta = null) {
                ...
                vm.PreguntasPersonalizadas.PreguntasGenerales.forEach(generales => {
                    generales.Preguntas.forEach(preguntas => {
                        if (generales.OrdenTematica !== null) {
                            ...
                            if (idSpanAlertComponent === null)
                                idSpanAlertComponent = document.getElementById("alert-viabilidadgenerales" + generales.OrdenTematica + preguntas.IdPregunta);
    ...
    angular.module('backbone').component('cuestionarioViabilidadSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/viabilidad/viabilidad/cuestionarioViabilidad/cuestionarioViabilidadSgr.html",
        controller: cuestionarioViabilidadSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
