(function () {
    ...
    enviarProgramacionSgpController.$inject = ['$scope'];

    function enviarProgramacionSgpController(
        $scope
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgpgraprobaciondefinitiva";
        vm.nombreComponenteHijo = "sgpgraprobaciondefinitivaaprobaciondefinitivagrsgp";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'sgpgraprobaciondefinitivaaprobaciondefinitivagrsgp', handlerValidacion: null, handlerCambios: null, esValido: true },          
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpgraprobaciondefinitivaaprobaciondefinitivagrsgp': true,                
            };
        }
        ...
        */
        ...
        vm.capitulos = function (listadoCapitulos) {
            ...
            if (listadoCapRecursos !== undefined && listadoCapRecursos !== null && listadoCapRecursos.length > 0)
    ...
    angular.module('backbone').component('enviarProgramacionSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/recursos/enviarProgramacion/enviarProgramacionSgp.html",
        controller: enviarProgramacionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
