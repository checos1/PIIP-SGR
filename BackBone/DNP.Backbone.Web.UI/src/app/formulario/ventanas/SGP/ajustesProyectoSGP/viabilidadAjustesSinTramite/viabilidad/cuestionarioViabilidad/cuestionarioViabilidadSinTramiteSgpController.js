(function () {
    'use strict';
    cuestionarioViabilidadSinTramiteSgpController.$inject = [
        'utilidades',
        '$sessionStorage',
        'viabilidadSinTramiteSgpServicio',
        'justificacionCambiosServicio',
    ];

    function cuestionarioViabilidadSinTramiteSgpController(
        utilidades,
        $sessionStorage,
        viabilidadSinTramiteSgpServicio,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "sgpviabilidadcuestionarioviabilidadsintramitesgp";
        ...
        function DevolverCuestionarioProyecto() {
            viabilidadSinTramiteSgpServicio.ConsultarAccionPorInstancia(vm.idInstancia, vm.idAccion).then(
                function (result) {
                    viabilidadSinTramiteSgpServicio.DevolverCuestionarioProyecto(vm.IdNivel, vm.idInstancia, result.data.EstadoAccionPorInstanciaId).then(
                        function (response) {
        ...
        function obtenerPreguntasPersonalizadas(bPin, nivelId, instanciaId, listaRoles) {
            return viabilidadSinTramiteSgpServicio.obtenerPreguntasPersonalizadasComponente(bPin, nivelId, instanciaId, vm.nombreComponente, listaRoles).then(
                function (respuesta) {
        ...
        function Guardar() {
            return viabilidadSinTramiteSgpServicio.guardarRespuestasCustomSGP(vm.PreguntasPersonalizadas).then(
                function (response) {
    ...
    angular.module('backbone').component('cuestionarioViabilidadSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/viabilidadAjustesSinTramite/viabilidad/cuestionarioViabilidad/cuestionarioViabilidadSinTramiteSgp.html",
        controller: cuestionarioViabilidadSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
