(function () {
    ...
    alojarDocumentosAprobacionSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function alojarDocumentosAprobacionSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgraprobacion1soportes";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgraprobacion1soportesalojararchivo";
        vm.notificacionCambiosCapitulos = null;
        vm.rol = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'sgraprobacion1soportesalojararchivo', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('alojarDocumentosAprobacionSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/gestionRecursos/aprobacion/F1/soportes/alojarDocumentosAprobacionSgr.html",
        controller: alojarDocumentosAprobacionSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
