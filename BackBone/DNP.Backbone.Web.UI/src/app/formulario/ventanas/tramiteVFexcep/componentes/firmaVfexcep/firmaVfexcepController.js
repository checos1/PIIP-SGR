(function () {
    ...
    function firmaVfexcepController(
        $scope,
        $sessionStorage,
        trasladosServicio,
        utilidades,
        ...
        vm.nombreComponenteHijo = "aprobacionfinalfirmaconceptote";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'aprobacionfinalfirmaconceptote', handlerValidacion: null, handlerCambios: null, esValido: true },
    ...
    angular.module('backbone').component('firmaVfexcep', {
        templateUrl: "src/app/formulario/ventanas/tramiteVFexcep/componentes/firmaVfexcep/firmaVfexcep.html",

        controller: firmaVfexcepController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
