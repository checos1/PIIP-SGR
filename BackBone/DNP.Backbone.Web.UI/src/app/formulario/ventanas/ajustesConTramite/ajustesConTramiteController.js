(function () {
    ...
    ajustesConTramiteController.$inject = [
        '$scope',        
        '$sessionStorage',
        'constantesBackbone',       
        'ajustesConTramiteServicio',
        'viabilidadServicio',
        'utilidades',
    ...
    function ajustesConTramiteController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        ajustesConTramiteServicio,
        ...
        vm.handlerComponentes = [
            ...
            { id: 4, componente: 'focalizacionpol', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
            { id: 5, componente: 'ajustesvigenciasfuturas', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
            { id: 5, componente: 'soporte', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
            { id: 6, componente: 'reprogramacionvf', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] }
        ];
        ...
        vm.abrirMGA = function () {
            ajustesConTramiteServicio.ObtenerTokenMGA(vm.BPIN, tipoUsuarioAutenticado).then(function (respuesta) {
        ...
        vm.obtenerDetalleTramiteyRol = function () {
            ...
            ajustesConTramiteServicio.datosTramites = {
                tramiteId: vm.tramiteId,
                tipoTramiteId: $sessionStorage.tipoTramiteId,
        ...
        function eventoValidar() {
            ...
            ajustesConTramiteServicio.obtenerErroresProyecto(vm.guiMacroproceso, vm.ProyectoId, vm.idInstancia).then(function (respuesta) {
                vm.notificacionValidacionHijos(respuesta.data);
                var findErrors = respuesta.data.findIndex(p => p.Errores != null && p.Capitulo !="localizaciones");
        ...
        */
        ...
        vm.guardadohijos = function (nombreComponente, nombreComponenteHijo, data) {
            vm.siguienteDisabled = true
            vm.callback({ arg: vm.siguienteDisabled, aprueba: false, titulo: '' });
            vm.notificacionCambios(nombreComponente, nombreComponenteHijo, data);
        }

        vm.notificacionCambios = function (nombreComponente, nombreComponenteHijo, data) {
            for (var i = 0; i < vm.handlerComponentes.length; i++) {
                if (vm.handlerComponentes[i].handlerCambios != null) vm.handlerComponentes[i].handlerCambios({ nombreComponente: nombreComponente, nombreComponenteHijo: nombreComponenteHijo, data: data});
            }
        };
    ...
    angular.module('backbone').component('ajustesConTramite', {
