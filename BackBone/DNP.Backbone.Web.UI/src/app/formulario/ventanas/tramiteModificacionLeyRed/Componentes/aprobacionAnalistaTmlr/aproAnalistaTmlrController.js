(function () {
    ...
    aproAnalistaTmlrController.$inject = ['$scope',];

    function aproAnalistaTmlrController(
        $scope,
    ...
    angular.module('backbone').component('aproAnalistaTmlr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionLeyRed/componentes/aprobacionAnalistaTmlr/aproAnalistaTmlr.html",
        controller: aproAnalistaTmlrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
