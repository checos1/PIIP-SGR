(function () {
    ...
    programacionProductosFormulario.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
        '$timeout',
    ...
    function programacionProductosFormulario(
        $scope,
        $sessionStorage,
        utilidades,
        $timeout,
        ...
        function GuardarValores(productos) {
            ...
            angular.forEach(productos.Productos, function (series) {
                let valores = {
                    ...
                    Meta: series.MetaProgramada,
                    Recurso: series.RecursoProgramado
                };
        ...
        vm.actualizaFila = function (event, productos, campo, index) {
            ...
            if (campo === 'MetaProgramada') productos.Productos[index].MetaProgramada = event.target.value;
            if (campo === 'RecursoProgramado') productos.Productos[index].RecursoProgramado = event.target.value;
    ...
    angular.module('backbone').component('programacionProductosFormulario', {

        templateUrl: "src/app/formulario/ventanas/comun/programacionRecursos/productos/programacionProductosFormulario.html",
        controller: programacionProductosFormulario,
        controllerAs: "vm",
        bindings: {
            tramiteproyectoid: '@',
            origen: '@',
