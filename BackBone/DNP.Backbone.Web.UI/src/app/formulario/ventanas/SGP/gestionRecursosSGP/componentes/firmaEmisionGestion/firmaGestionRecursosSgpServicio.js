(function () {
    ...
    angular.module('backbone').factory('firmaGestionRecursosSgpServicio', firmaGestionRecursosSgpServicio);

    firmaGestionRecursosSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function firmaGestionRecursosSgpServicio($http, constantesBackbone) {
