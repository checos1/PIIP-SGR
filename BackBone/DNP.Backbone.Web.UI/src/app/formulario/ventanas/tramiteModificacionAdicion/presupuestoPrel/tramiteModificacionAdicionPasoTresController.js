(function () {
    ...
    tramiteModificacionAdicionPasoTresController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionAdicionPasoTresController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionAdicionPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionAdicion/presupuestoPrel/tramiteModificacionAdicionPasoTres.html",
        controller: tramiteModificacionAdicionPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
