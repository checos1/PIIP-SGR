(function () {
    ...
    tramiteReprogramacionVfPasoTresController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteReprogramacionVfPasoTresController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteReprogramacionVfPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/tramiteReprogramacionVfPasoTres.html",
        controller: tramiteReprogramacionVfPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
