(function () {
    ...
    tramiteAdicionDonacionPasoCincoController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteAdicionDonacionPasoCincoController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteAdicionDonacionPasoCinco', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/tramiteAdicionDonacionPasoCinco.html",
        controller: tramiteAdicionDonacionPasoCincoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
