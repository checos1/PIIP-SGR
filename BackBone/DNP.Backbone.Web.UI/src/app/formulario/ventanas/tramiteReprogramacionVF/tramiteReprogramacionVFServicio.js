(function () {
    ...
    angular.module('backbone').factory('tramiteReprogramacionVfServicio', tramiteReprogramacionVfServicio);

    tramiteReprogramacionVfServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone', 'servicioFichasProyectos', 'utilidades', 'FileSaver'];


    function tramiteReprogramacionVfServicio($q, $http, $location, constantesBackbone, servicioFichasProyectos, utilidades, FileSaver) {
        return {
