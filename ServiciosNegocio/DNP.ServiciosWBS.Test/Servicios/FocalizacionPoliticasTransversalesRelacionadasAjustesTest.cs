...
namespace DNP.ServiciosWBS.Test.Servicios
{
    ...
    using Unity;
    /// <summary>
    /// Summary description for FocalizacionPoliticasTransversalesTest
    /// </summary>
    [TestClass]
    public class FocalizacionPoliticasTransversalesRelacionadasAjustesTest : 
    {
        private IPersistenciaTemporal PersistenciaTemporal { get; set; }
        private IAuditoriaServicios AuditoriaServicio { get; set; }
        private IFocalizacionPoliticasTransversalesRelacionadasAjustesPersistencia _focalizacionPoliticasTransversalesAjustesPersistencia { get; set; }
        private FocalizacionPoliticasTransversalesRelacionadasAjutesServicios _focalizacionPoliticasTransversalesRelacionadasAjustesServicios { get; set; }
        ...
        public void Init()
        {
            ...
            _focalizacionPoliticasTransversalesAjustesPersistencia = contenedor.Resolve<IFocalizacionPoliticasTransversalesRelacionadasAjustesPersistencia>();
            PersistenciaTemporal = contenedor.Resolve<IPersistenciaTemporal>();
            AuditoriaServicio = contenedor.Resolve<IAuditoriaServicios>();
            _focalizacionPoliticasTransversalesRelacionadasAjustesServicios = new FocalizacionPoliticasTransversalesRelacionadasAjutesServicios(_focalizacionPoliticasTransversalesAjustesPersistencia, PersistenciaTemporal, AuditoriaServicio);
        ...
        public FocalizacionPoliticasTransversalesRelacionadasAjustesTest()
        {
            //
        ...
        //[TestMethod]
        //public void ObtenerFocalizacionPoliticasTransversalesRelacionadasAjustes()
        //{
        ...
        //    };
        //    var result = _focalizacionPoliticasTransversalesRelacionadasAjustesServicios.ObtenerFocalizacionPoliticasTransversalesRelacionadasAjustesServicios(parametrosConsulta);
