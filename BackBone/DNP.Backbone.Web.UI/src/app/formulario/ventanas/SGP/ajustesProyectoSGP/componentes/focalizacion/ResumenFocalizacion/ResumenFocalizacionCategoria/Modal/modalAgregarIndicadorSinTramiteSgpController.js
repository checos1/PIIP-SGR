(function () {
	...
	modalAgregarIndicadorSinTramiteSgpController.$inject = [
		'$sessionStorage',
		'$uibModalInstance',
		'utilidades',
		'$filter',
	...
	function modalAgregarIndicadorSinTramiteSgpController(
		$uibModalInstance,
		$sessionStorage,
		utilidades,
		$filter,
		...
		function ConsultarPoliticasCategoriasIndicadores() {
			...
			return focalizacionAjustesSinTramiteSgpServicio.ConsultarPoliticasCategoriasIndicadores(vm.BPIN, vm.Usuario, vm.idInstancia).then(
				function (respuesta) {
		...
		vm.guardar = function () {
			...
			focalizacionAjustesSinTramiteSgpServicio.ModificarPoliticasCategoriasIndicadores(indicadoresCategoriasGuardar, usuarioDNP, vm.idInstancia).then(function (response) {
	...
	angular.module('backbone').controller('modalAgregarIndicadorSinTramiteSgpController', modalAgregarIndicadorSinTramiteSgpController);
})();
