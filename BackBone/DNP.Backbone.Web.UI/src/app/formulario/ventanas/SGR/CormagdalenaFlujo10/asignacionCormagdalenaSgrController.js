(function () {
    ...
    asignacionCormagdalenaSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
        'previosSgrServicio',
    ...
    function asignacionCormagdalenaSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        previosSgrServicio,
        ...
        if ($sessionStorage.TipoProyectoCTUSId == 1)
            vm.CapUso = 'sgrentidadnacionalasignacion';
        else if ($sessionStorage.TipoProyectoCTUSId == 3)
            vm.CapUso = 'sgrctusintegradoasignacion';
        ...
        vm.$onDestroy = function () {
            if (vm.ProyectoTipoCtusId == 3)
                ...
                asignacionEntidadNacionalSgrServicio.limpiarObservadores();
        };
        ...
        * */
        ...
        if (vm.ProyectoTipoCtusId == 3) {
            ...
            vm.handlerComponentes = [
                { id: 1, componente: 'sgrentidadnacionalasignacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 2, componente: 'sgrviabilidadpreviossoporte', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null }
            ];
        }
        ...
        vm.inicializarComponenteCheck = function (estado) {
            ...
            if (vm.ProyectoTipoCtusId == 3) {
                ...
                vm.handlerComponentesChecked = {
                    'sgrentidadnacionalasignacion': true,
        ...
        function eventoValidar() {
            ...
            previosSgrServicio.obtenerErroresviabilidadSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia)
                .then(respuesta => {
                    ...
                    //Importante para control de errores de controladores de abuelos dobles
    ...
    angular.module('backbone').component('asignacionCormagdalenaSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/CormagdalenaFlujo10/asignacionCormagdalenaSgr.html",
        controller: asignacionCormagdalenaSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
