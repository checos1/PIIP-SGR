...
namespace DNP.ServiciosWBS.Test.Servicios
{
    ...
    [TestClass]
    public class RegionalizacionIndicadoresServicioTest
    {

        private IRegionalizacionIndicadoresPersistencia RegionalizacionIndicadoresPersistencia { get; set; }
        private IPersistenciaTemporal PersistenciaTemporal { get; set; }
        private IAuditoriaServicios AuditoriaServicio { get; set; }
        private RegionalizacionIndicadoresServicios RegionalizacionIndicadoresServicios { get; set; }
        ...
        public void Init()
        {
            ...
            RegionalizacionIndicadoresPersistencia = contenedor.Resolve<IRegionalizacionIndicadoresPersistencia>();
            PersistenciaTemporal = contenedor.Resolve<IPersistenciaTemporal>();
            AuditoriaServicio = contenedor.Resolve<IAuditoriaServicios>();
            RegionalizacionIndicadoresServicios = new RegionalizacionIndicadoresServicios(RegionalizacionIndicadoresPersistencia, PersistenciaTemporal, AuditoriaServicio);

            var data = new List<AlmacenamientoTemporal>().AsQueryable();

            var objetoRetornoRegionalizacionIndicadoresProgramacion = new uspGetRegionalizacionIndicadoresProgramacion_Result();
            var mockRegionalizacionIndicadoresProgramacion = new Mock<ObjectResult<uspGetRegionalizacionIndicadoresProgramacion_Result>>();
            mockRegionalizacionIndicadoresProgramacion.SetupReturn(objetoRetornoRegionalizacionIndicadoresProgramacion);
            ...
            _mockContext.Setup(mc => mc.uspGetRegionalizacionIndicadoresProgramacion(Bpin)).Returns(mockRegionalizacionIndicadoresProgramacion.Object);
        ...
        [TestMethod]
        public void RegionalizacionIndicadoresServicios_Guardar_MarcadoComoTemporal_InsertaRegistro()
        {
            RegionalizacionIndicadoresServicios = new RegionalizacionIndicadoresServicios(new RegionalizacionIndicadoresPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), AuditoriaServicio);
            //Escenario: los parametros de insercion son validos y ademas viene marcado como guardado temporal
            var parametrosGuardarRegionalizaconIndicador = new ParametrosGuardarDto<RegionalizacionIndicadorDto>
            {
                InstanciaId = Guid.NewGuid(),
                AccionId = Guid.NewGuid(),
                Contenido = new RegionalizacionIndicadorDto()
            };

            var parametrosAuditoria = new ParametrosAuditoriaDto();

            //Ejecucion
            RegionalizacionIndicadoresServicios.Guardar(parametrosGuardarRegionalizaconIndicador, parametrosAuditoria, true);
        }

        [TestMethod]
        [ExpectedException(typeof(ServiciosNegocioException), "Parámetro piip-idInstanciaFlujoFlujo no recibido.")]
        public void _RegionalizacionIndicadoresServicios_ConstruirParametrosGuardado_IdInstanciaFlujoNoEnviado_Excepcion()
        {
            RegionalizacionIndicadoresServicios = new RegionalizacionIndicadoresServicios(new RegionalizacionIndicadoresPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), AuditoriaServicio);
            //Escenario: InstanciaId no enviado
            var contenido = new RegionalizacionIndicadorDto();

            HttpRequestMessage request = new HttpRequestMessage();
            request.Headers.Add("piip-idAccion", Guid.NewGuid().ToString());

            //Ejecucion
            RegionalizacionIndicadoresServicios.ConstruirParametrosGuardado(request, contenido);
        }

        [TestMethod]
        [ExpectedException(typeof(ServiciosNegocioException), "Parámetro piip-idAccion no recibido.")]
        public void _RegionalizacionIndicadoresServicios_Guardar_IdAccionNoEnviado_Excepcion()
        {
            RegionalizacionIndicadoresServicios = new RegionalizacionIndicadoresServicios(new RegionalizacionIndicadoresPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), AuditoriaServicio);
        ...
        public void _RegionalizacionIndicadoresServicios_Guardar_RegionalizacionIndicadoresDtoNoEnviado_Excepcion()
        {
            RegionalizacionIndicadoresServicios = new RegionalizacionIndicadoresServicios(new RegionalizacionIndicadoresPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), AuditoriaServicio);
            ...
            //Ejecucion
            RegionalizacionIndicadoresServicios.ConstruirParametrosGuardado(request, null);
        }

        [TestMethod]
        [ExpectedException(typeof(ServiciosNegocioException), "Parámetro piip-idInstanciaFlujo inválido")]
        public void _RegionalizacionIndicaoresServicios_Guardar_IdInstanciaFlujoConValorInvalido_Excepcion()
        {
            RegionalizacionIndicadoresServicios = new RegionalizacionIndicadoresServicios(new RegionalizacionIndicadoresPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), AuditoriaServicio);
        ...
        public void _RegionalizacionIndicadoresServicios_Guardar_IdAccionConValorInvalido_Excepcion()
        {
            RegionalizacionIndicadoresServicios = new RegionalizacionIndicadoresServicios(new RegionalizacionIndicadoresPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), AuditoriaServicio);
        ...
        [TestMethod]
        public void RegionalizacionIndicadoresTest()
        {
            RegionalizacionIndicadoresServicios = new RegionalizacionIndicadoresServicios(new RegionalizacionIndicadoresPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), AuditoriaServicio);
            ...
            var result = RegionalizacionIndicadoresServicios.ObtenerRegionalizacionIndicadores(parametrosConsulta);
            Assert.IsNotNull(result);
        }


        [TestMethod]
        public void RegionalizacionIndicadoresMockTest()
        {
            RegionalizacionIndicadoresServicios = new RegionalizacionIndicadoresServicios(new RegionalizacionIndicadoresPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), AuditoriaServicio);
            var parametrosConsulta = new ParametrosConsultaDto()
            {
        ...
        {
            var result = RegionalizacionIndicadoresServicios.ObtenerRegionalizacionIndicadoresPreview();
            Assert.IsNotNull(result);
        }
