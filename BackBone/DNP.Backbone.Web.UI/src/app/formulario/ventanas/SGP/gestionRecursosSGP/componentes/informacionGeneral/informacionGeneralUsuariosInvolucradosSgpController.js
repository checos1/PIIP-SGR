(function () {
    ...
    informacionGeneralUsuariosInvolucradosSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function informacionGeneralUsuariosInvolucradosSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpgraprobaciondefinitivausuarios";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgpgraprobaciondefinitivausuariosusuariosinvolucradossgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpgraprobaciondefinitivausuariosusuariosinvolucradossgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpgraprobaciondefinitivausuariosusuariosinvolucradossgp': true
            };
        }
    ...
    angular.module('backbone').component('informacionGeneralUsuariosInvolucradosSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/informacionGeneral/informacionGeneralUsuariosInvolucradosSgp.html",
        controller: informacionGeneralUsuariosInvolucradosSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
