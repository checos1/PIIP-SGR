(function () {
    ...
    aproSuperAdController.$inject = ['$scope',];

    function aproSuperAdController(
        $scope,
    ...
    angular.module('backbone').component('aproSuperAd', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionAdicion/componentes/aprobacionSupervisor/aproSuperAd.html",
        controller: aproSuperAdController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
