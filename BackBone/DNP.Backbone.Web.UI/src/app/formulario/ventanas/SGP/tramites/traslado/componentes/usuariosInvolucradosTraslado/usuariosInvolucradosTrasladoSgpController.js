(function () {
    ...
    usuariosInvolucradosTrasladoSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function usuariosInvolucradosTrasladoSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "usuariosinvolucradossgptramiteproyectosgp";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "usuariosinvolucradossgptramiteproyectosgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'usuariosinvolucradossgptramiteproyectosgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        */
        ...
        vm.validarSeccion = function (tipoError, seccion, errores, esValido) {
            var campomensajeerror = document.getElementById("SGPERRSEC-usuariosinvolucradossgp");
    ...
    angular.module('backbone').component('usuariosInvolucradosTrasladoSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/traslado/componentes/usuariosInvolucradosTraslado/usuariosInvolucradosTrasladoSgp.html",
        controller: usuariosInvolucradosTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
