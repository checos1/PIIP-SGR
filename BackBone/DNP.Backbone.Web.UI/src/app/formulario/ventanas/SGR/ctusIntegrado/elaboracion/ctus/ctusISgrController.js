(function () {
    ...
    ctusISgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function ctusISgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrctusintegradoselaboracionctus";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrctusintegradoselaboracionctusconcepto";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctusintegradoselaboracionctusconcepto', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrctusintegradoselaboracionctusresultadoconceptointegrado', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrctusintegradoselaboracionctusconcepto': true,
                'sgrctusintegradoselaboracionctusresultadoconceptointegrado': true
            };
        }
        ...
        */
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (erroresList.length > 0) {
                ...
                const keys = Object.keys(vm.handlerComponentesChecked);
                keys.forEach(item => {
                    vm.notificacionestado({ estado: true, nombreComponente: item });
                });                
            }
        }
    ...
    angular.module('backbone').component('ctusISgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/elaboracion/ctus/ctusISgr.html",
        controller: ctusISgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
