(function () {
    ...
    aproSuperTmlrController.$inject = ['$scope',];

    function aproSuperTmlrController(
        $scope,
    ...
    angular.module('backbone').component('aproSuperTmlr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionLeyRed/componentes/aprobacionSupervisorTmlr/aproSuperTmlr.html",
        controller: aproSuperTmlrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
