(function() {
    ...
    costosFuentesAjustesSinTramiteSgpController.$inject = [
    ...
    function costosFuentesAjustesSinTramiteSgpController(
        costosFuentesAjustesSinTramiteSgpServicio,
        $sessionStorage,
        constantesBackbone,
        $scope,
        ...
        $sessionStorage.pruba = "Lucas Pineda";
        vm.listaResumen_inv = [];
        ...
        vm.inicializar = function() {
            ...
            localStorage.removeItem("preinversion")
                                ...
                                case 'Operación':
                                    {
                                        ...
                                        if (total_opeAjuste > 0) {
                                            vm.operacion = true;
                                            vm.tipoOperacion = 3;
                                            localStorage.setItem("operacion", "true");
                                        } else {
                                            vm.operacion = false;
                                            localStorage.setItem("operacion", "false");
                                        }
                                        resumenSubtotal_ope = {
                                            icono: "=",
                                ...
                                case 'Preinversión':
                                    {
                                        ...
                                        if (total_preiAjuste > 0) {
                                            ...
                                            vm.tipoOperacion = 1;
                                            localStorage.setItem("preinversion", "true");
                                        } else {
                                            vm.preinversion = false;
                                            localStorage.setItem("preinversion", "false")
                                        }
                                ...
                                case 'Inversión':
                                    {
                                        ...
                                        if (total_invAjuste > 0) {
                                            vm.inversion = true;
                                            localStorage.setItem("inversion", "true");
                                            vm.tipoOperacion = 2;
                                        } else {
                                            vm.inversion = false;
                                            localStorage.setItem("inversion", "false");
                                        }
                                        resumenSubtotal_inv = {
                                            icono: "=",
    ...
    angular.module('backbone').component('costosFuentesAjustesSinTramiteSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/ajustesProyectoSGP/componentes/recursosSGP/Fuentes/ResumenCostosAjustes/costosFuentesAjustesSinTramiteSgp.html",
        controller: costosFuentesAjustesSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
