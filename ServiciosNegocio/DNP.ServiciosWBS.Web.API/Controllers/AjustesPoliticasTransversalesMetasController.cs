...
{
    public class AjustesPoliticasTransversalesMetasController : ApiController
    {
        private readonly IAutorizacionUtilidades _autorizacionUtilidades;
        private readonly IAjustesPoliticasTransversalesMetasServicios _ajustesPoliticasTransversalesMetasServicios;
        public AjustesPoliticasTransversalesMetasController(IAutorizacionUtilidades autorizacionUtilidades, IAjustesPoliticasTransversalesMetasServicios ajustesPoliticasTransversalesMetasServicios)
        {
            _autorizacionUtilidades = autorizacionUtilidades;
            _ajustesPoliticasTransversalesMetasServicios = ajustesPoliticasTransversalesMetasServicios;
        }
        [System.Web.Http.Route("api/DNP_SN_Eje_Ajustes_PoliticaTMetasDto")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion del proyecto Focalización Políticas Transversales Metas", typeof(AjustesPoliticaTMetasDto))]
        ...
        public async Task<IHttpActionResult> Consultar(string bpin)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.
                                                               AppSettings["consultarAjustesPoliticaTransversalMetas"]).
                                            Result;
                ...
                var result =
                    await Task.Run(() => _ajustesPoliticasTransversalesMetasServicios.ObtenerAjustesPoliticasTransversalesMetas(new ParametrosConsultaDto
                    {
                        Bpin
                                                                                                  =
                                                                                                  bpin,
                ...
                if (result != null) return Ok<AjustesPoliticaTMetasDto>(result);
        ...
        [System.Web.Http.Route("api/DNP_SN_Eje_Ajustes_PoliticaTMetasDto/Preview")]
        [SwaggerResponse(HttpStatusCode.OK, "Información del proyecto detallando su focalización Politicas Transversales Metas con información dummy", typeof(AjustesPoliticaTMetasDto))]
        [System.Web.Http.HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["previewAjustesPoliticaTransversalMetas"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var result = await Task.Run(() => _ajustesPoliticasTransversalesMetasServicios.ObtenerAjustesPoliticasTransversalesMetasPreview());

                return Ok<AjustesPoliticaTMetasDto>(result);
            }
            catch (AutorizacionException e)
            {
                throw new HttpResponseException(Request.CreateErrorResponse(HttpStatusCode.Unauthorized, e));
        ...
        [System.Web.Http.Route("api/DNP_SN_Eje_Ajustes_PoliticaTMetasDto/Temporal")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion devuelta por guardado temporal", typeof(HttpResponseMessage))]
        [System.Web.Http.HttpPost]
        public async Task<IHttpActionResult> Temporal(AjustesPoliticaTMetasDto contenido)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings
                                                               ["postAjustesPoliticaTransversalMetasTemporal"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var parametrosGuardar = _ajustesPoliticasTransversalesMetasServicios.ConstruirParametrosGuardado(Request, contenido);
                ...
                await Task.Run((Action)(() => _ajustesPoliticasTransversalesMetasServicios.Guardar(parametrosGuardar, parametrosAuditoria, true)));
        ...
        [System.Web.Http.HttpPost]
        public async Task<IHttpActionResult> Definitivo([FromBody] AjustesPoliticaTMetasDto proyecto)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings
                                                               ["postAjustesPoliticaTransversalMetasDefinitivo"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);


                var parametrosGuardar = _ajustesPoliticasTransversalesMetasServicios.ConstruirParametrosGuardado(Request, proyecto);
                ...
                await Task.Run((Action)(() => _ajustesPoliticasTransversalesMetasServicios.Guardar(parametrosGuardar, parametrosAuditoria, false)));
