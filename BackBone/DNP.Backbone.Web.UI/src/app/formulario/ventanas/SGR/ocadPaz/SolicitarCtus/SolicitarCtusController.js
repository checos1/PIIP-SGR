(function () {
    'use strict';
    solicitarCtusController.$inject = [
        '$scope',
        '$sessionStorage'
    ];

    function solicitarCtusController(
        $scope,
        $sessionStorage
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrocadpazsolicitarCtus";
        vm.nombreComponenteHijo = "sgrocadpazsolicitarCtussolicitar";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrocadpazsolicitarCtussolicitar', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrocadpazsolicitarCtussolicitar': true
            };
        }
    ...
    angular.module('backbone').component('solicitarCtus', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ocadPaz/SolicitarCtus/solicitarCtus.html",
        controller: solicitarCtusController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
