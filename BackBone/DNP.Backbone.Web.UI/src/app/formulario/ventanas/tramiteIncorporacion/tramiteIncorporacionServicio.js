(function () {
    ...
    angular.module('backbone').factory('tramiteIncorporacionServicio', tramiteIncorporacionServicio);

    tramiteIncorporacionServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone', 'servicioFichasProyectos', 'utilidades', 'FileSaver'];


    function tramiteIncorporacionServicio($q, $http, $location, constantesBackbone, servicioFichasProyectos, utilidades, FileSaver) {
        return {
        ...
        function generarPdfCartaTramite(tramiteId, borrador = true, nombrearchivo) {
            ...
            nombreFichaTramite = constantesBackbone.apiBackBoneNombrePDFCartaIncorporacion;// Incorporacion
