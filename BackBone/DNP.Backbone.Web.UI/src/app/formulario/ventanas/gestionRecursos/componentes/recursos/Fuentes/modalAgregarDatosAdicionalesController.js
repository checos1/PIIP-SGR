(function() {
    ...
    modalAgregarDatosAdicionalesController.$inject = [
        '$sessionStorage',
        '$uibModalInstance',
    ...
    function modalAgregarDatosAdicionalesController(
        $uibModalInstance,
        $sessionStorage,
        gestionRecursosServicio,
        utilidades
        ...
        function consultarDatos() {
            ...
            return gestionRecursosServicio.obtenerDatosAdicionales(vm.idFuente, usuarioDNP, $uibModalInstance.idInstancia)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        function obtenerTipoCofinanciador() {
            ...
            return gestionRecursosServicio.obtenerTipoCofinanciador(parametros)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        function obtenerFondo() {
            var listaFondos = [];
            return gestionRecursosServicio.obtenerFondos(parametros)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        function obtenerRubro() {
            var listaRubro = [];
            return gestionRecursosServicio.obtenerRubros(parametros)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
                    vm.fondoVisible = false;
        ...
        function buscarProyecto() {
            ...
            return gestionRecursosServicio.obtenerProyectos(parametros, vm.model.BpinBusqueda)
                .then(respuesta => {
                    if (!respuesta.data) {
        ...
        function guardar() {
            ...
            gestionRecursosServicio.agregarDatosAdicionales(params, usuarioDNP, $uibModalInstance.idInstancia, $uibModalInstance.idAccion, $uibModalInstance.idNivel)
        ...
        function eliminarDatoAdicional(cofinanciadorId) {
            ...
            return gestionRecursosServicio.eliminarDatosAdicionales(cofinanciadorId, usuarioDNP, idInstancia)
                .then(function(response) {
                    let exito = response.data;
                    if (exito) {
                        utilidades.mensajeSuccess("Operación realizada con éxito!", false, false, false);
    ...
    angular.module('backbone').controller('modalAgregarDatosAdicionalesController', modalAgregarDatosAdicionalesController);
