(function () {
    ...
    enviarProgramacionController.$inject = ['$scope', 'gestionRecursosServicio', '$sessionStorage', 'utilidades', 'constantesBackbone'];

    function enviarProgramacionController(
        $scope,
        ...
        var vm = this;
        vm.nombreComponente = "aprobacionpegr";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'aprobacionpegraprobacionpegr', handlerValidacion: null, handlerCambios: null, esValido: true },
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'aprobacionpegraprobacionpegr': true,
            };
        }
    ...
    angular.module('backbone').component('enviarProgramacion', {
        templateUrl: "src/app/formulario/ventanas/gestionRecursos/componentes/recursos/enviarprogramacion/enviarProgramacion.html",
        controller: enviarProgramacionController,
        controllerAs: "vm",
        bindings: {
