(function () {
    ...
    fuentesPrController.$inject = ['$scope', '$sessionStorage','comunesServicio'];

    function fuentesPrController(
        $scope,
        $sessionStorage,
        comunesServicio
    ) {
    ...
    angular.module('backbone').component('fuentesPr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/componentes/fuentesPr/fuentesPr.html",
        controller: fuentesPrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
