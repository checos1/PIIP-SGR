(function (usuarioDNP, idTipoProyecto, idTipoTramite) {
    ...
    angular.module('backbone').component('notificacionCantidadMisProcesosSubdirectorVerificacionSgr', {
        templateUrl: '/src/app/comunes/notificaciones/notificacionCantidadMisProcesosSubdirectorVerificacionSgr/pantallaCantidadMisProcesosSubdirectorVerificacionSgr.html',
        controller: controladorNotificacionCantidadMisProcesosSubdirectorVerificacionSgr,
        controllerAs: 'vm',
        bindings: {
            useHtmlMenu: '=',
            useHtmlNotification: '='
    ...
    controladorNotificacionCantidadMisProcesosSubdirectorVerificacionSgr.$inject = [
        '$q',
    ...
    function controladorNotificacionCantidadMisProcesosSubdirectorVerificacionSgr(
        $q,
        serviciosComponenteNotificacionCantidadProyectos,
        serviciosComponenteNotificacionCantidadTramites,
        $scope,
