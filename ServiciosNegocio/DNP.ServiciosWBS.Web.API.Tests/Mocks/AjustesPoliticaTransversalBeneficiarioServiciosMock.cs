namespace DNP.ServiciosWBS.Web.API.Tests.Mocks
{
    ...
    public class AjustesPoliticaTransversalBeneficiarioServiciosMock : IAjustesPoliticaTransversalBeneficiarioServicios
    {
        public AjustesPoliticaTBeneficiarioDto ObtenerAjustesPoliticaTransversalBeneficiario(ParametrosConsultaDto parametrosConsulta)
        {
            if (parametrosConsulta.Bpin == "202000000000005")
            {
                return new AjustesPoliticaTBeneficiarioDto()
                {
                    Focalizacion_Beneficiarios_y_Recursos = new List<FocalizacionAjustesPoliticaTBeneficiarioDto>()
                                       {
                                           new FocalizacionAjustesPoliticaTBeneficiarioDto()
                                       }
                };
            }
        ...
        public ParametrosGuardarDto<AjustesPoliticaTBeneficiarioDto> ConstruirParametrosGuardado(
            HttpRequestMessage request, AjustesPoliticaTBeneficiarioDto contenido)
        {
            var parametrosGuardar = new ParametrosGuardarDto<AjustesPoliticaTBeneficiarioDto>();
        ...
        public void Guardar(ParametrosGuardarDto<AjustesPoliticaTBeneficiarioDto> parametrosGuardar, ParametrosAuditoriaDto parametrosAuditoria,
