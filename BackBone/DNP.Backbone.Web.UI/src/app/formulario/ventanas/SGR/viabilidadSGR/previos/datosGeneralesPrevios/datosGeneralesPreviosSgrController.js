(function () {
    'use strict';
    datosGeneralesPreviosSgrController.$inject = [
        '$scope',
        '$sessionStorage'
    ];

    function datosGeneralesPreviosSgrController(
        $scope,
        $sessionStorage
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrviabilidadpreviosdatosgenerales";
        vm.nombreComponenteHijo = "sgrviabilidadpreviosdatosgeneralesdatospresentacion";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadpreviosdatosgeneralesdatospresentacion', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadpreviosdatosgeneralesdatospresentacion': true,
            };
        }
    ...
    angular.module('backbone').component('datosGeneralesPreviosSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/previos/datosGeneralesPrevios/datosGeneralesPreviosSgr.html",
        controller: datosGeneralesPreviosSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
