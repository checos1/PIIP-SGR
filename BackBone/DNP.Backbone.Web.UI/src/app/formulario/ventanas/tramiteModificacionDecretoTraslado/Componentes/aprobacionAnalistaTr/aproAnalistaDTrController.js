(function () {
    ...
    aproAnalistaDTrController.$inject = ['$scope',];

    function aproAnalistaDTrController(
        $scope,
    ...
    angular.module('backbone').component('aproAnalistaDTr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/componentes/aprobacionAnalistaTr/aproAnalistaDTr.html",
        controller: aproAnalistaDTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
