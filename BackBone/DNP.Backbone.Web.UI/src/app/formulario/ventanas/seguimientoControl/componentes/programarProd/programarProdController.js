(function () {
    ...
    programarProdController.$inject = [
        '$scope',
        '$sessionStorage',
        'justificacionCambiosServicio',
    ];

    function programarProdController(
        $scope,
        $sessionStorage,
        justificacionCambiosServicio
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "programarprod";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'programarprodprogramarprodcap', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'programarprodprogramarprodcap': true
            };
        }
    ...
    angular.module('backbone').component('programarprod', {

        templateUrl: "src/app/formulario/ventanas/seguimientoControl/componentes/programarProd/programarProd.html",
        controller: programarProdController,
        controllerAs: "vm",
        bindings: {
            verificacion: '&',
            notificacioncambios: '&',
