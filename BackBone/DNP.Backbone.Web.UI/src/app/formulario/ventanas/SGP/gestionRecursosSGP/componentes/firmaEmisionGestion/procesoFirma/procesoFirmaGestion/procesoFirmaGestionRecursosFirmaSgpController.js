(function () {
    'use strict';
    procesoFirmaGestionRecursosFirmaSgpController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function procesoFirmaGestionRecursosFirmaSgpController(
        utilidades,
        $sessionStorage,
        justificacionCambiosServicio,
        firmaGestionRecursosSgpServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgpsolicitudrecursosfirmaresponsablesprocesofirmasgrsgp';
        vm.ventanaPadre = 'gestionRecursosSgp';
        ...
        vm.mostrarBotonPdf = function () {
            var mostrar = false;
            if (vm.nombreComponente == "sgpsolicitudrecursosfirmaresponsablesprocesofirmasgrsgp") { mostrar = true; }
            return mostrar;
            ;
    ...
    angular.module('backbone').component('procesoFirmaGestionRecursosFirmaSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/firmaEmisionGestion/procesoFirma/procesoFirmaGestion/procesoFirmaGestionRecursosFirmaSgp.html",
        controller: procesoFirmaGestionRecursosFirmaSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
