(function () {
    ...
    documentoSoporteVfexcepController.$inject = ['$scope',];

    function documentoSoporteVfexcepController(
        $scope,
        ...
        vm.nombreComponenteHijo = "documentossoportealojararchivo";
    ...
    angular.module('backbone').component('documentoSoporteVfexcep', {
        templateUrl: "src/app/formulario/ventanas/tramiteVFexcep/componentes/documentoSoporte/documentoSoporteVfexcep.html",
        controller: documentoSoporteVfexcepController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
