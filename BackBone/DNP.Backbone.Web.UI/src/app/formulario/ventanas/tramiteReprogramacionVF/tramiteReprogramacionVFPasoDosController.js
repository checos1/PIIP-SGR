(function () {
    ...
    tramiteReprogramacionVfPasoDosController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteReprogramacionVfPasoDosController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteReprogramacionVfPasoDos', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/tramiteReprogramacionVfPasoDos.html",
        controller: tramiteReprogramacionVfPasoDosController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
