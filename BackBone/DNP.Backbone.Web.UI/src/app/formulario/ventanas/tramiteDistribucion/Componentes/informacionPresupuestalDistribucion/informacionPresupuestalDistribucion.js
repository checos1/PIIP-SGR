(function () {
    ...
    informacionPresupuestalDistribucion.$inject = [
        '$sessionStorage',
        'utilidades',
        'constantesBackbone',
        '$scope'
    ...
    function informacionPresupuestalDistribucion(
        $sessionStorage,
        utilidades,
        constantesBackbone,
        $scope
    ...
    angular.module('backbone').component('informacionPresupuestalDistribucion', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "src/app/formulario/ventanas/tramiteDistribucion/componentes/informacionPresupuestalDistribucion/informacionPresupuestalDistribucion.html",
        controller: informacionPresupuestalDistribucion,
        controllerAs: "vm",
        bindings: {
            callback: '&',
