(function () {
    'use strict';
    procesoFirmaCtusSgrSgrController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function procesoFirmaCtusSgrSgrController(
        utilidades,
        $sessionStorage,
        justificacionCambiosServicio,
        servicioFichasProyectos,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgrctusfirmaprocesofirma';
        vm.ventanaPadre = 'ctusFirmaEmisionSgr';
        ...
        vm.mostrarBotonPdf = function () {
            var mostrar = false;
            if (vm.nombreComponente == "sgrctusfirmaprocesofirma") { mostrar = true; }
            return mostrar;
            ;
        ...
        vm.verPdf = function () {
            transversalSgrServicio.SGR_Transversal_LeerParametro("GenerarFichaCTUSSGR")
                .then(function (respuestaParametro) {
                    if (respuestaParametro.data.Valor == 'S') {
                        const nombreFichaTramite = "sgr_ficha_CTUS";
                        const borrador = true;
    ...
    angular.module('backbone').component('procesoFirmaCtusSgrSgr', {
        templateUrl: "src/app/formulario/ventanas/SGR/ctus/firmaEmision/procesoFirma/procesoFirmaSgr/procesoFirmaCtusSgrSgr.html",
        controller: procesoFirmaCtusSgrSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
