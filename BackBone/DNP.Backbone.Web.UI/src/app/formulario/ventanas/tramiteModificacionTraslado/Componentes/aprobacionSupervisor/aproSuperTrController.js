(function () {
    ...
    aproSuperTrController.$inject = ['$scope',];

    function aproSuperTrController(
        $scope,
        ...
        vm.nombreComponenteHijo = "aprobacionfinalconfirmacionapr";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'aprobacionfinalconfirmacionapr', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'aprobacionfinalconfirmacionapr': true
            };
        }
    ...
    angular.module('backbone').component('aproSuperTr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionTraslado/componentes/aprobacionSupervisor/aproSuperTr.html",
        controller: aproSuperTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
