(function () {
    ...
    datosProyectoRvfController.$inject = ['$scope', 'tramiteVigenciaFuturaServicio', '$sessionStorage', 'utilidades', 'constantesBackbone'];

    function datosProyectoRvfController(
        $scope,
    ...
    angular.module('backbone').component('datosProyectoRvf', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/componentes/seleccionProyectoRvf/datosProyectoRvf/datosProyectoRvf.html",
        controller: datosProyectoRvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            datosproyecto: '@'
