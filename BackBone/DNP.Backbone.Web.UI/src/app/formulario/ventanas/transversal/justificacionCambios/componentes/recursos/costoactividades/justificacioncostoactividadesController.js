(function () {
    ...
    justificacioncostoactividadesController.$inject = [
        '$scope',
        '$sessionStorage',
        'justificacioncostoactividadesServicio',
        'utilidades',
        'justificacionCambiosServicio'
    ];

    function justificacioncostoactividadesController(
        $scope,
        $sessionStorage,
        justificacioncostoactividadesServicio,
        utilidades,
        ...
        function obtenerDetalleAjustes() {
            return justificacioncostoactividadesServicio.ObtenerResumenObjetivosProductosActividadesJustificacion(vm.BPIN).then(
                function (respuesta) {
    ...
    angular.module('backbone').component('recursoscostosdelasacti', {
        templateUrl: "src/app/formulario/ventanas/transversal/justificacionCambios/componentes/recursos/costoactividades/justificacioncostoactividades.html",
        controller: justificacioncostoactividadesController,
        controllerAs: "vm",
        location: "es-COP",
        bindings: {
