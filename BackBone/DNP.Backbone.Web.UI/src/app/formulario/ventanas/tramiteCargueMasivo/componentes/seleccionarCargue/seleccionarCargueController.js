(function () {
    ...
    seleccionarCargueController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
        'justificacionCambiosServicio',
        'seleccionarCargueServicio'
    ];

    function seleccionarCargueController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        justificacionCambiosServicio,
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "seleccionarcargue";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'seleccionarcarguecarguearchivocap', handlerValidacion: null, handlerCambios: null, esValido: true },
    ...
    angular.module('backbone').component('seleccionarCargue', {

        templateUrl: "src/app/formulario/ventanas/tramiteCargueMasivo/componentes/seleccionarCargue/seleccionarCargue.html",
        controller: seleccionarCargueController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
