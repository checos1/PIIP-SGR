(function () {
    ...
    ajustesProyectoSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
        'ajustesProyectoSinTramiteSgpServicio',
        'viabilidadServicio',
        'utilidades',
    ...
    function ajustesProyectoSinTramiteSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        ajustesProyectoSinTramiteSgpServicio,
        ...
        vm.abrirMGA = function () {
            ajustesProyectoSinTramiteSgpServicio.ObtenerTokenMGA(vm.BPIN, tipoUsuarioAutenticado).then(function (respuesta) {
        ...
        function eventoValidar() {
            ...
            ajustesProyectoSinTramiteSgpServicio.obtenerErroresProyecto(vm.guiMacroproceso, vm.ProyectoId, vm.idInstancia).then(function (respuesta) {
                if (respuesta.data) {
    ...
    angular.module('backbone').component('ajustesProyectoSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/ajustesProyectoSinTramiteSgp.html",
        controller: ajustesProyectoSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
