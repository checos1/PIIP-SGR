(function () {
    ...
    viabilidadSgpController.$inject = [
        '$scope',
        '$location',
        'utilidades',
        '$sessionStorage',
    ...
    function viabilidadSgpController(
        $scope,
        $location,
        utilidades,
        $sessionStorage,
        ...
        * */
        ...
        function eventoValidar() {
            ...
            vm.validaCuestionario = false;
            viabilidadSgpServicio.obtenerErroresviabilidadSgp(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {

                //const dataArchivo = {
                //    idnivel: vm.IdNivel,
                //    idinstancia: vm.idInstancia,
                //    tipodocumentocodigo: "DAOCP",
                ...
                viabilidadSgpServicio.SGPViabilidadValidarCargueDocumentoObligatorio(dataArchivo, "tramites").then(function (response) {
                    if (respuesta.data) {

                        //Validar respuestas cuestionario viabilidad y cuestionario viabilidad sectorial
                        ...
                        if (!vm.accionPendiente) {
                            ...
                            if (error == -1 &&
                                ...
                                vm.callback({ validacion: null, arg: vm.siguienteDisabled, aprueba: false, titulo: '', ocultarDevolver: false });
                                return;
                            }
                        }
            ...
            if (Observacion.value != null) {
                ...
                utilidades.mensajeWarning(
                    ...
                    function funcionContinuar() {
                        ...
                        return viabilidadSgpServicio.devolverProyectoSGP(vm.DevolverProyecto).then(
                            function (response) {
       ...
       */
        ...
        vm.guardadohijos = function (nombreComponente, nombreComponenteHijo) {
            vm.callback({ arg: true, aprueba: false, titulo: '', ocultarDevolver: true });
    ...
    angular.module('backbone').component('viabilidadSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/viabilidadSGP/viabilidadSgp.html",
        controller: viabilidadSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
