/// <reference path="modaldatosadiciondonacioncontroller.js" />
(function () {
    'use strict';

    datosAdicionDonacionController.$inject = ['datosAdicionDonacionServicio', '$sessionStorage', '$uibModal', 'utilidades', 'constantesBackbone', '$scope', 'justificacionCambiosServicio'
    ];

    function datosAdicionDonacionController(
        datosAdicionDonacionServicio, $sessionStorage, $uibModal, utilidades, constantesBackbone, $scope, justificacionCambiosServicio
    ) {
        var vm = this;
        vm.init = init;
        ...
        vm.obtenerDatosAdicionDonacion = function () {
            ...
            datosAdicionDonacionServicio.ObtenerDatosAdicionDonacion(tramiteId)
        ...
        function abrirModalAgregarDatosAdicionDonacion() {
            ...
            $uibModal.open({
                templateUrl: 'src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/proyectosTad/datosAdicionDonacion/modalDatosAdicionDonacion.html',
                controller: 'modalDatosAdicionDonacionController',
        ...
        function eliminarDatosAdicionDonacion(convenioId) {
            ...
            utilidades.mensajeWarning("Si se realiza esta acción, todos los posibles datos diligenciados en la sección 'Datos de la adición por donación' se perderán. Usted deberá verficar la información incluida previamente en otros espacios sea coherente con la modificación. Esta seguro de continuar?",
                function funcionContinuar() {
                    ...
                    return datosAdicionDonacionServicio.eliminarDatosAdicionDonacion(params, usuarioDNP)
                        .then(function (response) {
        ...
        function eventoValidar() {
            ...
            datosAdicionDonacionServicio.obtenerErroresProyecto(vm.guiMacroproceso, vm.ProyectoId, vm.idInstancia).then(function (respuesta) {
    ...
    angular.module('backbone').component('datosAdicionDonacion', {
        templateUrl: 'src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/proyectosTad/datosAdicionDonacion/datosAdicionDonacion.html',
        controller: datosAdicionDonacionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
