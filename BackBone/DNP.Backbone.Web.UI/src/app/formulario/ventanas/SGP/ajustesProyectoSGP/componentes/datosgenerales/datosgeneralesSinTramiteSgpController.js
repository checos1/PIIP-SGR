(function () {
    ...
    datosgeneralesSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
        'datosgeneralesSinTramiteSgpServicio',
    ];

    function datosgeneralesSinTramiteSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        datosgeneralesSinTramiteSgpServicio
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "datosgeneralessgp";
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'datosgeneralessgphorizontesintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'datosgeneralessgprelacionconlaplsgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'datosgeneralessgpindicadoresdeprsintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 4, componente: 'datosgeneralessgplocalizacionessintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 5, componente: 'datosgeneralessgpbeneficiariosTotalessintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {                
                'datosgeneralessgphorizontesintramitesgp': true,
                'datosgeneralessgprelacionconlaplsgp': true,
                'datosgeneralessgpindicadoresdeprsintramitesgp': true,
                'datosgeneralessgplocalizacionessintramitesgp': true,
                'datosgeneralessgpbeneficiariosTotalessintramitesgp': true,
            };
        }
    ...
    angular.module('backbone').component('datosgeneralesSinTramiteSgp', {

        templateUrl: "src/app/formulario/ventanas/SGP/ajustesProyectoSGP/componentes/datosgenerales/datosgeneralesSinTramiteSgp.html",
        controller: datosgeneralesSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            verificacion: '&',
            modelo: '=',
