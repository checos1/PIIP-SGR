(function () {
    'use strict';
    liderGeneralesController.$inject = [
        'utilidades',
        '$sessionStorage',
        'viabilidadServicio',
    ...
    function liderGeneralesController(
        utilidades,
        $sessionStorage,
        viabilidadServicio,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "viabilidadgenerales";
                ...
                function (response) {
                    if (response.data && response.status === 200) {
                        if (response.data.Exito) {
                            ...
                            if (vm.SinPreguntasEspecificas) guardarCapituloModificado('viabilidadespecificas');
    ...
    angular.module('backbone').component('liderGenerales', {
        templateUrl: "src/app/formulario/ventanas/viabilidad/componentes/preguntasLider/generales/liderGenerales.html",
        controller: liderGeneralesController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
