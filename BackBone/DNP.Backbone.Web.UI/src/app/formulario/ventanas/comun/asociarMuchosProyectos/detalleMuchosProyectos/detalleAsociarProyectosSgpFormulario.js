(function () {
    ...
    detalleAsociarProyectosSgpFormulario.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
        'flujoServicios',
    ...
    function detalleAsociarProyectosSgpFormulario(
        $sessionStorage,
        sesionServicios,
        utilidades,
        flujoServicios,
        ...
        vm.init = function () {
            ...
            transversalSgpServicio.registrarObservador(function (datos) {
                if (datos.creaProcesoAjusteProyectoSgp === true) {
                    ObtenerProyectosTramite();
                }
            });
            ...
            if (proyectoId === undefined || proyectoId === '' || proyectoId === 0) {
                ...
                utilidades.mensajeWarning("Esto eliminará la información correspondiente al BPIN " + bpin
                    ...
                    function funcionContinuar() {
                        ...
                        tramiteSGPServicio.eliminarProyectoTramite(eliminarAsociacionDto, eliminarAsociacionDto)
                            .then(function (response) {
    ...
    angular.module('backbone').component('detalleAsociarProyectosSgpFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/detalleMuchosProyectos/detalleAsociarProyectosSgpFormulario.html",
        controller: detalleAsociarProyectosSgpFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
