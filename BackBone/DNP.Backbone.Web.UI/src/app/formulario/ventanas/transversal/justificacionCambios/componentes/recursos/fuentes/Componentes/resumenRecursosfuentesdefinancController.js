(function () {
    ...
    resumenRecursosfuentesdefinancController.$inject = [
    ...
    function resumenRecursosfuentesdefinancController(
        resumenFuentesServicio,
        $sessionStorage,
        constantesBackbone,
        $scope,
    ...
    angular.module('backbone').component('resumenRecursosfuentesdefinanc', {
        templateUrl: "src/app/formulario/ventanas/transversal/justificacionCambios/componentes/recursos/fuentes/Componentes/resumenRecursosfuentesdefinanc.html",
        controller: resumenRecursosfuentesdefinancController,
        controllerAs: "vm",
        bindings: {
            guardadoevent: '&',
