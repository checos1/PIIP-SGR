(function () {
    ...
    ctusIntegradoSolicitarSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function ctusIntegradoSolicitarSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        solicitarCtusSgrServicio,
        ...
        * */
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrsolicitarctusintegrado', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
        ];
        ...
        vm.inicializarComponenteCheck = function (estado) {
            ...
            vm.handlerComponentesChecked = {
                'sgrsolicitarctusintegrado': true,
            };
        }
        ...
        function eventoValidar() {
            ...
            solicitarCtusSgrServicio.obtenerErroresviabilidadSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {
    ...
    angular.module('backbone').component('ctusIntegradoSolicitarSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/ctusIntegradoSolicitarSgr.html",
        controller: ctusIntegradoSolicitarSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
