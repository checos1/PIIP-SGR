(function () {
    ...
    ejecutorDesignacionCostosSgrController.$inject = [
        '$scope'
    ];

    function ejecutorDesignacionCostosSgrController(
        $scope
    ) {
        var vm = this;
        vm.nombreComponente = "sgrejecutordesignacioncostos";
        vm.nombreComponenteHijo = "sgrejecutordesignacioncostosgiroreconocimiento";
        vm.notificacionCambiosCapitulos = null;
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";

        vm.handlerComponentes = [
            { id: 1, componente: 'sgrejecutordesignacioncostosgiroreconocimiento', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrejecutordesignacioncostosreconocimientocostos', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'sgrejecutordesignacioncostosvalorestructuracion', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrejecutordesignacioncostosgiroreconocimiento': true,
                'sgrejecutordesignacioncostosreconocimientocostos': true,
                'sgrejecutordesignacioncostosvalorestructuracion': true
            };
        };
    ...
    angular.module('backbone').component('ejecutorDesignacionCostosSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/gestionRecursos/ejecutor/costosEstructuracion/ejecutorDesignacionCostosSgr.html",
        controller: ejecutorDesignacionCostosSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
