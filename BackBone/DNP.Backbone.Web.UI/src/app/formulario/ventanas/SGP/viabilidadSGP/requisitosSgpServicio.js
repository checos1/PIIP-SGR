(function () {
    ...
    angular.module('backbone').factory('requisitosSgpServicio', requisitosSgpServicio);

    requisitosSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function requisitosSgpServicio($http, constantesBackbone) {
        ...
        return {
            ...
            SGPAcuerdoLeerProyecto: SGPAcuerdoLeerProyecto,
            SGPAcuerdoGuardarProyecto: SGPAcuerdoGuardarProyecto,
            SGPProyectosLeerListas: SGPProyectosLeerListas,            
        ...
        function SGPAcuerdoLeerProyecto(proyectoId, nivelId) {
            var url = apiBackboneServicioBaseUri + constantesBackbone.apiBackboneSGPAcuerdoLeerProyecto + "?proyectoId=" + proyectoId + "&nivelId=" + nivelId;
            return $http.get(url);
        }

        function SGPAcuerdoGuardarProyecto(data) {
            return $http.post(apiBackboneServicioBaseUri + constantesBackbone.apiBackboneSGPAcuerdoGuardarProyecto, data);
        }       

        function SGPProyectosLeerListas(nivelId, proyectoId, nombreLista) {
            var url = apiBackboneServicioBaseUri + constantesBackbone.apiBackboneSGPProyectosLeerListas + "?nivelId=" + nivelId + "&proyectoId=" + proyectoId + "&nombreLista=" + nombreLista;
            return $http.get(url);
        }
