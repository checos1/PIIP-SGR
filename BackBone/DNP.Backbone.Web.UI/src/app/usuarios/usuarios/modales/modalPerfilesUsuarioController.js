(function () {
    ...
    modalPerfilesUsuarioController.$inject = [
        'obj',
        'servicioEntidades',
        '$uibModalInstance',
        'constantesBackbone',
    ...
    function modalPerfilesUsuarioController(
        obj,
        servicioEntidades,
        $uibModalInstance,
        constantesBackbone,
    ...
    angular.module('backbone.usuarios').controller('modalPerfilesUsuarioController', modalPerfilesUsuarioController);
})();