(function () {
    ...
    programacionRegionalizacionFormularioPasoTres.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
        '$uibModal',
    ...
    function programacionRegionalizacionFormularioPasoTres(
        $scope,
        $sessionStorage,
        utilidades,
        $uibModal,
        ...
        function ObtenerDatosProgramacionDetalleReg() {
            return comunesServicio.ObtenerDatosProgramacionDetalle(vm.tramiteproyectoid, 'regionalizacionaprobado').then(
                function (respuesta) {
                    if (respuesta.data !== '') {
        ...
        vm.actualizaFila = function (event, regionalizacion) {
            ...
            regionalizacion.TNacionCSFA = TNacionCSFA;
            regionalizacion.TNacionSSFA = TNacionSSFA;
            regionalizacion.TPropiosA = TPropiosA;
            ...
            utilidades.mensajeWarning("Si ocurren inconvenientes de descarga o visualización, es necesario actualizar la aplicación.", function funcionContinuar() {
                ...
                $scope.regionalizacion.Recursos.forEach(regionalizar => {
                    data.push({
                        ...
                        NacionCSF: regionalizar.NacionCSFA,
                        NacionSSF: regionalizar.NacionSSFA,
                        Propios: regionalizar.PropiosA
                    });
                });
    ...
    angular.module('backbone').component('programacionRegionalizacionFormularioPasoTres', {

        templateUrl: "/src/app/formulario/ventanas/comun/programacionRecursos/regionalizacion/programacionRegionalizacionFormularioPasoTres.html",
        controller: programacionRegionalizacionFormularioPasoTres,
        controllerAs: "vm",
        bindings: {
            tramiteproyectoid: '@',
            origen: '@',
