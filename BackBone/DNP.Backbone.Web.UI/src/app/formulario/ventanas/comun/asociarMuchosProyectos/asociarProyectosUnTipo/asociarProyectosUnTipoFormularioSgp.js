(function () {
    ...
    asociarProyectosUnTipoFormularioSgp.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarProyectosUnTipoFormularioSgp(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
    ...
    angular.module('backbone').component('asociarProyectosUnTipoFormularioSgp', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/asociarProyectosUnTipo/asociarProyectosUnTipoFormularioSgp.html",
        controller: asociarProyectosUnTipoFormularioSgp,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
