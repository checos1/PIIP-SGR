(function (usuarioDNP, idTipoProyecto, idTipoTramite) {
    ...
    angular.module('backbone').component('notificacionCantidadMisProcesosRevisionCoordinadorVerificacionSgr', {
        templateUrl: '/src/app/comunes/notificaciones/notificacionCantidadMisProcesosRevisionCoordinadorVerificacionSgr/pantallaCantidadMisProcesosRevisionCoordinadorVerificacionSgr.html',
        controller: controladorNotificacionCantidadMisProcesosRevisionCoordinadorVerificacionSgr,
        controllerAs: 'vm',
        bindings: {
            useHtmlMenu: '=',
            useHtmlNotification: '='
    ...
    controladorNotificacionCantidadMisProcesosRevisionCoordinadorVerificacionSgr.$inject = [
        '$q',
    ...
    function controladorNotificacionCantidadMisProcesosRevisionCoordinadorVerificacionSgr(
        $q,
        serviciosComponenteNotificacionCantidadProyectos,
        serviciosComponenteNotificacionCantidadTramites,
        $scope,
