(function () {
    'use strict';
    verificacionSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'requisitosSgpServicio'
    ];

    function verificacionSgpController(
        $scope,
        $sessionStorage,
        requisitosSgpServicio
    ) {
        ...
        vm.nombreComponenteHijo = "sgpviabilidadrequisitosverificacionrequisitossgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpviabilidadrequisitosverificacionrequisitossgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpviabilidadrequisitosverificacionrequisitossgp': true
            };
        }
        ...
        vm.notificacionCambios = function (handler, nombreComponenteHijo) {
            ...
            if (nombreComponenteHijo == "sgpviabilidadrequisitosverificacionrequisitossgp") {
    ...
    angular.module('backbone').component('verificacionSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/viabilidadSGP/requisitos/verificacion/verificacionSgp.html",
        controller: verificacionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
