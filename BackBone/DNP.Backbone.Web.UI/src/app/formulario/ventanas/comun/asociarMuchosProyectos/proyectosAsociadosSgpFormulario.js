(function () {
    ...
    proyectosAsociadosSgpFormulario.$inject = [
        '$sessionStorage',
        'utilidades',
        '$scope',
        'constantesBackbone',
    ...
    function proyectosAsociadosSgpFormulario(
        $sessionStorage,
        utilidades,
        $scope,
        constantesBackbone,
        ...
        vm.nombreComponente = 'informacionpresupuestalsgpproyectosasociadossgp';
        vm.textoBuscar = '';
        ...
        function obtenerTramite() {
            ...
            comunesServicio.obtenerEntidadAsociarProyecto(vm.instanciaId, 'C').then(
                function (respuesta) {
                    ...
                    if (vm.tipotramiteid == 90) {//trasl ordinario
            ...
            if (vm.ProyectosSeleccionadosD && vm.ProyectosSeleccionadosD.length > 0) {
                vm.ProyectosSeleccionadosD.forEach(proyecto => {
                    ...
                    datoproyectoD.forEach(p => {
                        ...
                        if (vm.tipotramiteid == 90) { // solo para tramite de traslado ordinario
    ...
    angular.module('backbone').component('proyectosAsociadosSgpFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/proyectosAsociadosSgpFormulario.html",
        controller: proyectosAsociadosSgpFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
