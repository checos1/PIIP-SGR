(function () {
    ...
    conceptoTadController.$inject = [
        '$scope',
        '$sessionStorage',

    ];

    function conceptoTadController(
        $scope,
        $sessionStorage,
    ...
    angular.module('backbone').component('conceptoTad', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/conceptoTad/conceptoTad.html",


        controller: conceptoTadController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
