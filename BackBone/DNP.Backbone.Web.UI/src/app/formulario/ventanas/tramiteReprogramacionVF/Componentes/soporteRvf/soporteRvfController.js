(function () {
    ...
    soporteRvfController.$inject = [
        '$scope',

    ];

    function soporteRvfController(
        $scope,
    ...
    angular.module('backbone').component('soporteRvf', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/Componentes/soporteRvf/soporteRvf.html",


        controller: soporteRvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
