(function () {
    ...
    aproAnalistaAdController.$inject = ['$scope',];

    function aproAnalistaAdController(
        $scope,
    ...
    angular.module('backbone').component('aproAnalistaAd', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionAdicion/componentes/aprobacionAnalista/aproAnalistaAd.html",
        controller: aproAnalistaAdController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
