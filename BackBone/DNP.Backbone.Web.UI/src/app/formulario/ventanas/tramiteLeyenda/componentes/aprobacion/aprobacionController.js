(function () {
    ...
    function aprobacionController(
       ...
       * */
        ...
        * @param {any} nombreComponente nombre configurado en cada uno de los componentes hijos vm.nombreComponente = 'datosgenerales'
        */
        //vm.notificacionEstado = function (nombreComponente, esValido, esValidoPaso4) {
    ...
    angular.module('backbone').component('aprobacionpaso4', {
        templateUrl: "src/app/formulario/ventanas/tramiteLeyenda/componentes/aprobacion/aprobacion.html",
