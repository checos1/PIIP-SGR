(function () {
    ...
    politicasTransversalesMlController.$inject = ['$scope', '$sessionStorage', '$uibModal', 'utilidades',
        'constantesBackbone', '$timeout', 'focalizacionAjustesServicio', 'justificacionCambiosServicio'
    ];

    function politicasTransversalesMlController(
        $scope,
        $sessionStorage,
        $uibModal,
        utilidades,
        ...
        var vm = this;
        vm.init = init;
        vm.nombreComponente = "focalizacionpolpoliticastransv";
        ...
        function abrirModalAgregarPoliticaTrans() {
            $uibModal.open({
                templateUrl: 'src/app/formulario/ventanas/comun/modificacionLey/politicas/detallePolitica/politica/modal/modalAgregarPoliticaTransversalMI.html',
                controller: 'modalAgregarPoliticaTransversalMIController',
            ...
            //    templateUrl: 'src/app/formulario/ventanas/ajustes/componentes/focalizacion/PoliticasTransversales/modalAgregarPoliticaTransversal.html',
        ...
        function eliminarPolitica(politicaId, politica) {
            ...
            utilidades.mensajeWarning("¿Está seguro de continuar?", function funcionContinuar() {
                ...
                return focalizacionAjustesServicio.eliminarPoliticasProyecto(proyectoId, politicaId, usuarioDNP, idInstancia).then(
                    function (respuesta) {
    ...
    angular.module('backbone').component('politicasTransversalesMl', {
        templateUrl: "src/app/formulario/ventanas/comun/modificacionLey/politicas/detallePolitica/politica/detallePoliticasTransversalesMl.html",
        controller: politicasTransversalesMlController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
