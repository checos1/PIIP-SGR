(function () {
    ...
    aprobarConceptoVictimasMl.$inject = ['$scope', '$sessionStorage', '$uibModal', 'utilidades',
    ...
    function aprobarConceptoVictimasMl(
        $scope,
        $sessionStorage,
        $uibModal,
        utilidades,
        ...
        var vm = this;
        vm.init = init;
        vm.nombreComponente = "aprobarConceptoVictimasMlFormulario";
    ...
    angular.module('backbone').component('aprobarConceptoVictimasMl', {
        templateUrl: "src/app/formulario/ventanas/comun/modificacionLey/politicas/aprobarConcepto/aprobarConceptoVictimasMlFormulario.html",
        controller: aprobarConceptoVictimasMl,
        controllerAs: "vm",
        bindings: {
            callback: '&',
