(function () {
    ...
    usuariosInvolucradosTramiteAdicionSgpController.$inject = [
        '$scope',
    ...
    function usuariosInvolucradosTramiteAdicionSgpController(
        $scope,
        usuariosInvolucradosSgpServicio,
        $sessionStorage,
        utilidades,
        ...
        function abrirModalAgregarInvolucrado(TipoRolConcepto) {
            ...
            let modalInstance = $uibModal.open({
                ...
                templateUrl: "/src/app/formulario/ventanas/SGP/comun/usuariosInvolucrados/modalAgregarInvolucradosTramiteAdicionSgp.html",
                controller: 'modalAgregarInvolucradosTramiteAdicionSgpController',
                controllerAs: "vm",
    ...
    angular.module('backbone').component('usuariosInvolucradosTramiteAdicionSgp', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "/src/app/formulario/ventanas/SGP/comun/usuariosInvolucrados/usuariosInvolucradosTramiteAdicionSgp.html",
        controller: usuariosInvolucradosTramiteAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
