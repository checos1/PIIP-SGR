(function () {
    ...
    informacionPresupuestalIncController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone'
    ...
    function informacionPresupuestalIncController(
        $scope,
        $sessionStorage,
        constantesBackbone
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'informacionpresupuestalsolicitudincorporacion', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
    ...
    angular.module('backbone').component('informacionPresupuestalInc', {
        templateUrl: "/src/app/formulario/ventanas/tramiteIncorporacion/componentes/informacionPresupuestalInc/informacionPresupuestalInc.html",
                   
               
        controller: informacionPresupuestalIncController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
