(function () {
    ...
    procesoFirmaCtusIntegradoSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function procesoFirmaCtusIntegradoSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrctusintegradofirma";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrctusintegradofirmaprocesofirma";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctusintegradofirmaprocesofirma', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrctusintegradofirmaprocesofirma': true
            };
        }
    ...
    angular.module('backbone').component('procesoFirmaCtusIntegradoSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/firmaEmision/procesoFirma/procesoFirmaCtusIntegradoSgr.html",
        controller: procesoFirmaCtusIntegradoSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
