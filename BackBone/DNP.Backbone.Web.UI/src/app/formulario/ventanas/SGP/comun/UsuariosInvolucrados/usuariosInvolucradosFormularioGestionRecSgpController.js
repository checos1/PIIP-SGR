(function () {
    ...
    usuariosInvolucradosFormularioGestionRecSgpController.$inject = [
        '$scope',
    ...
    function usuariosInvolucradosFormularioGestionRecSgpController(
        $scope,
        usuariosInvolucradosSgpServicio,
        $sessionStorage,
        utilidades,
        ...
        function consultar() { 
            ObtenerProyectoViabilidadInvolucrados($sessionStorage.proyectoId, vm.IdInstancia, 4);
        }
        ...
        function abrirModalAgregarInvolucrado(TipoRolConcepto) {
            ...
            let modalInstance = $uibModal.open({
                ...
                templateUrl: "/src/app/formulario/ventanas/SGP/comun/UsuariosInvolucrados/modalAgregarInvolucradosGestionRecursosSgp.html",
                controller: 'modalAgregarInvolucradosGestionRecursosSgpController',
                controllerAs: "vm",
    ...
    angular.module('backbone').component('usuariosInvolucradosFormularioGestionRecSgp', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "/src/app/formulario/ventanas/SGP/comun/usuariosInvolucrados/usuariosInvolucradosFormularioGestionRecSgp.html",
        controller: usuariosInvolucradosFormularioGestionRecSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
