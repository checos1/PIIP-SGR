(function () {
    ...
    documentosSoporteViSinTramiteSgpController.$inject = ['$scope','$sessionStorage'];

    function documentosSoporteViSinTramiteSgpController(
        $scope,
        $sessionStorage,
        ...
        var vm = this;
        vm.nombreComponente = "soportesintramitesgp";
        vm.nombreComponenteHijo = "soportesintramitesgpsoportessgp";
        vm.notificacionCambiosCapitulos = null;
        vm.objetonegocioid = $sessionStorage.idObjetoNegocio;

        vm.handlerComponentes = [
            { id: 1, componente: 'soportesintramitesgpsoportessgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'soportesintramitesgpsoportessgp': true
            };
        }
    ...
    angular.module('backbone').component('documentosSoporteViSinTramiteSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/comun/documentoSoporte/documentosSoporteViSinTramiteSgp.html",
        controller: documentosSoporteViSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
