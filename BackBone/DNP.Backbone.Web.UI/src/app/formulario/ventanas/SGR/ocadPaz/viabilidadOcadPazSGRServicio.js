(function () {
    ...
    angular.module('backbone').factory('viabilidadOcadPazSgrServicio', viabilidadOcadPazSgrServicio);

    viabilidadOcadPazSgrServicio.$inject = ['$http', 'constantesBackbone'];

    function viabilidadOcadPazSgrServicio($http, constantesBackbone) {
        ...
        return {
            ...
            obtenerErroresviabilidadOcadPazSgr: obtenerErroresviabilidadOcadPazSgr,
        ...
        function obtenerErroresviabilidadOcadPazSgr(guiMacroproceso, idProyecto, idNivel, idInstancia) {
