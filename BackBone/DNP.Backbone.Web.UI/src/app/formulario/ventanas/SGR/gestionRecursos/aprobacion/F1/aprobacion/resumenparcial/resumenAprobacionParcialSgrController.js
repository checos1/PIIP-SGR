(function () {
    ...
    resumenAprobacionParcialSgrController.$inject = [
        'utilidades',
        '$sessionStorage',
        'aprobacionSgrServicio'
    ];

    function resumenAprobacionParcialSgrController(
        utilidades,
        $sessionStorage,
        aprobacionSgrServicio,
    ) {
        ...
        vm.init = function () {
            aprobacionSgrServicio.ObtenerProyectoResumenAprobacionCreditoParcialSGR(vm.proyectoId).then(
                function (res) {
                    var flat = res.data;
                    var grouped = {};
    ...
    angular.module('backbone').component('resumenAprobacionParcialSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/gestionRecursos/aprobacion/F1/aprobacion/resumenparcial/resumenAprobacionParcialSgr.html",
        controller: resumenAprobacionParcialSgrController,
        controllerAs: "vm",
    });
