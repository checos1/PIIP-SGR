(function () {
    ...
    politicasTransversalesPrController.$inject = ['$scope', '$sessionStorage','comunesServicio'];

    function politicasTransversalesPrController(
        $scope,
        $sessionStorage,
        comunesServicio
    ) {
    ...
    angular.module('backbone').component('politicasTransversalesPr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/Componentes/politicasTransversalesPr/politicasTransversalesPr.html",
        controller: politicasTransversalesPrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
