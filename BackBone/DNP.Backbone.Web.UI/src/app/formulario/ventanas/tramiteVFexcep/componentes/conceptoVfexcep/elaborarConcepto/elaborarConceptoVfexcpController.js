(function () {
    ...
    elaborarConceptoVfexcpController.$inject = [
        '$sessionStorage',
        'archivoServicios',
        '$scope',
        'servicioAcciones',
    ...
    function elaborarConceptoVfexcpController(
        $sessionStorage,
        archivoServicios,
        $scope,
        servicioAcciones,
        ...
        */
        ...
        vm.verPdf = function () {
            ...
            tramiteVigenciaFuturaServicio.generarPdfCartaTramiteVf(tramiteId, true, "VFE");
        }

    }

    angular.module('backbone').component('elaborarConceptoVfexcp', {
        templateUrl: "src/app/formulario/ventanas/tramiteVfexcep/componentes/conceptoVfexcep/elaborarConcepto/elaborarConceptoVfexcp.html",
        controller: elaborarConceptoVfexcpController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
