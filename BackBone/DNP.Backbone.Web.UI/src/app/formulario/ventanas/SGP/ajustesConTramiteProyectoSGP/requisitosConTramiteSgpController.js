(function () {
    ...
    requisitosConTramiteSgpController.$inject = [
        '$scope',
        '$location',
        'utilidades',
        '$sessionStorage',
        'requisitosConTramiteSgpServicio',
    ...
    function requisitosConTramiteSgpController(
        $scope,
        $location,
        utilidades,
        $sessionStorage,
        ...
        * */
        ...
        function eventoValidar() {
            ...
            requisitosConTramiteSgpServicio.obtenerErroresviabilidadSgp(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {
                ...
                if (respuesta.data) {
                    ...
                    requisitosConTramiteSgpServicio.ConsultarAccionPorInstancia(vm.idInstancia, vm.IdAccion).then(function (result) {

                        requisitosConTramiteSgpServicio.obtenerPreguntasPersonalizadas(vm.Bpin, vm.IdNivel, vm.idInstancia, result.data.EstadoAccionPorInstanciaId).then(function (retorno) {
    ...
    angular.module('backbone').component('requisitosConTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesConTramiteProyectoSGP/requisitosConTramiteSgp.html",
        controller: requisitosConTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
