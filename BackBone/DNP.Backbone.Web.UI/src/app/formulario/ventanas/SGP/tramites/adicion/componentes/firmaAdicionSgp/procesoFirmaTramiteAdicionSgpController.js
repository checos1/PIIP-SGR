(function () {
    ...
    procesoFirmaTramiteAdicionSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function procesoFirmaTramiteAdicionSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
    ...
    angular.module('backbone').component('procesoFirmaTramiteAdicionSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/adicion/componentes/firmaAdicionSgp/procesoFirmaTramiteAdicionSgp.html",
        controller: procesoFirmaTramiteAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
