(function() {
    ...
    resumenFuentesSinTramiteSgpController.$inject = [
    ...
    function resumenFuentesSinTramiteSgpController(
        resumenFuentesSinTramiteSgpServicio,
        $sessionStorage,
        constantesBackbone,
        $scope,
        ...
        vm.mensaje = "";
        vm.ocultar_preinversion = true;
        vm.ocultar_inversion = true;
        vm.ocultar_operacion = true;
        ...
        function obtenerResumenFuentes() {
            ...
            vm.listaResumen_ope = [];
            vm.listaResumen;
            return resumenFuentesSinTramiteSgpServicio.obtenerResumenFuentesFinanciacion($sessionStorage.idInstancia, vm.idUsuario, vm.idInstancia).then(
                function(respuesta) {
                    if (respuesta.data != null && respuesta.data != "") {
                                ...
                                case 'Operación':
                                    {
                                        ...
                                        if (total_opeSolicitados <= 0) vm.ocultar_operacion = false;
                                        break;
                                    }
                                case 'Preinversión':
                                    {
                                        ...
                                        if (total_preiSolicitados <= 0)
                                            vm.ocultar_preinversion = false;
                                        break;
                                    }
                                case 'Inversión':
                                    {
                                        ...
                                        if (total_invSolicitados <= 0) vm.ocultar_inversion = false;
                                        break;
                                    }
                            }
                        }
                        ...
                        if (vm.ocultar_preinversion == true) {
                            vm.mostrarTab(1);
                        }
                        else if (vm.ocultar_inversion == true) {
                            vm.mostrarTab(2);
                        } 
                        else {
                            vm.mostrarTab(3);
    ...
    angular.module('backbone').component('resumenFuentesSinTramiteSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/ajustesProyectoSGP/componentes/recursosSGP/Fuentes/totalesFuentes/resumenFuentesSinTramiteSgp.html",
        controller: resumenFuentesSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            guardadoevent: '&',
