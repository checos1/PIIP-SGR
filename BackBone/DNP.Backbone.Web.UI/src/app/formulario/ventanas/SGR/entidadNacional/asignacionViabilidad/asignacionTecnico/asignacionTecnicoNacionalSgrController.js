(function () {
    ...
    asignacionTecnicoNacionalSgrController.$inject = [
        '$scope',
        '$sessionStorage',
        'asignacionEntidadNacionalSgrServicio'
    ];

    function asignacionTecnicoNacionalSgrController(
        $scope,
        $sessionStorage,
        asignacionEntidadNacionalSgrServicio
    ) {
        ...
        vm.nombreComponente = "sgrentidadnacionalasignacion";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrentidadnacionalasignaciondelegarviabilidad";
        vm.notificacionCambiosCapitulos = null;
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";
        vm.reqEntidad = true;
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrentidadnacionalasignaciondelegarviabilidad', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrentidadnacionalasignacionasignarviabilidad', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrentidadnacionalasignaciondelegarviabilidad': true,
                'sgrentidadnacionalasignacionasignarviabilidad': true
            };
        }
        ...
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (vm.reqEntidad) {
                var listErrorest = {
                    errores: [
                        {
                            Seccion: 'sgrentidadnacionalasignacion',
                            Capitulo: 'delegarviabilidad',
                            Errores: '{"sgrentidadnacionalasignaciondelegarviabilidad":[{"Error":"DELEGEN-sgrentidadnacionalasignaciondelegarviabilidad","Descripcion":"Debe responder esta pregunta."}]}'
                        }
                    ]
                };
                erroresList = listErrorest.errores.filter(p => p.Seccion == vm.nombreComponente);
                vm.inicializarComponenteCheck();
                vm.esValido = true;
            } else {
    ...
    angular.module('backbone').component('asignacionTecnicoNacionalSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/entidadNacional/asignacionViabilidad/asignacionTecnico/asignacionTecnicoNacionalSgr.html",
        controller: asignacionTecnicoNacionalSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
