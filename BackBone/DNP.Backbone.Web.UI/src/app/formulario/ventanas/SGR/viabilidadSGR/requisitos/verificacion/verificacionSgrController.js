(function () {
    'use strict';
    verificacionSgrController.$inject = [
        '$scope',
        '$sessionStorage',
        'requisitosSgrServicio'
    ];

    function verificacionSgrController(
        $scope,
        $sessionStorage,
        requisitosSgrServicio
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrviabilidadrequisitosverificacion";
        vm.nombreComponenteHijo = "sgrviabilidadrequisitosverificacionrequisitos";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadrequisitosverificacionrequisitos', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadrequisitosverificacionrequisitos': true
            };
        }
        ...
        vm.notificacionCambios = function (handler, nombreComponenteHijo) {
            ...
            if (nombreComponenteHijo == "sgrviabilidadrequisitosverificacionrequisitos") {
        ...
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (erroresList.length > 0) {
                ...
                vm.erroresComponente = [];
                var errorMensajes = document.getElementsByClassName('divMenssageAlertDnp');
                Array.prototype.filter.call(errorMensajes, function (errorElement) {
    ...
    angular.module('backbone').component('verificacionSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/requisitos/verificacion/verificacionSgr.html",
        controller: verificacionSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
