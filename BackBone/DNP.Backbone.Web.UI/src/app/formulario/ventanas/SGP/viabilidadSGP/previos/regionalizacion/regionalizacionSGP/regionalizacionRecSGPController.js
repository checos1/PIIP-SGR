(function () {
    ...
    regionalizacionRecSGPController.$inject = [
        '$sessionStorage',
        'previosSGPServicio',
    ...
    function regionalizacionRecSGPController(
        $sessionStorage,
        previosSGPServicio,
        justificacionCambiosServicio,
        $scope,
        ...
        vm.nombreComponente = "sgpviabilidadpreviosregionalizacionregionalizacion";
        ...
        vm.componentesRefresh = [
            "sgpviabilidadpreviosrecursosfuentessgp",
            "sgpviabilidadpreviosrecursosfuentesnosgp"
        ];
        ...
        function ObtenerSeccionCapitulo() {
            const span = document.getElementById('id-capitulo-sgpviabilidadpreviosregionalizacionregionalizacion');
        ...
        vm.obtenerRegionalizacionFuentes = function (Bpin) {
            ...
            return previosSGPServicio.obtenerDesagregarRegionalizacionSGP(idInstancia).then(
                function (respuesta) {
        ...
        vm.actualizarRegionalizacionFuente = function (response) {
            ...
            previosSGPServicio.actualizarDesagregarRegionalizacionSGP(desagregarRegionalizacionDto).then(function (response) {
            ...
            try {
                ...
                vm.listaProductos.forEach(producto => {
                    producto.Fuentes.forEach(fuente => {
                        fuente.Localizacion.forEach(localizacion => {
                            localizacion.Vigencias.forEach(vigencia => {
                                var fila = producto.ProductoId + fuente.FuenteId + localizacion.LocalizacionId + vigencia.Vigencia;
                                ...
                                var campomensajeerror = document.getElementById('SGPERRSEC' + producto.ProductoId);
                                if (campomensajeerror != undefined) {
    ...
    angular.module('backbone').component('regionalizacionRecSGP', {
        templateUrl: "/src/app/formulario/ventanas/SGP/viabilidadSGP/previos/regionalizacion/regionalizacionSGP/regionalizacionRecSGP.html",
        controller: regionalizacionRecSGPController,
        controllerAs: "vm",
        bindings: {
            guardadoevent: '&',
