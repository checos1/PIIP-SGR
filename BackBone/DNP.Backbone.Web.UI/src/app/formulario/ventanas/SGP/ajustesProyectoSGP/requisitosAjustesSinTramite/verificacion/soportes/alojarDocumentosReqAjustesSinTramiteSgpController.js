(function () {
    ...
    alojarDocumentosReqAjustesSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function alojarDocumentosReqAjustesSinTramiteSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpviabilidadrequisitossoportes";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgpviabilidadrequisitossoportesalojararchivossintramitesgp";
        vm.notificacionCambiosCapitulos = null;
        vm.rol = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'sgpviabilidadrequisitossoportesalojararchivossintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.init = function () {
            ...
            if (accionRequisitos != null && accionRequisitos.Roles.length > 0) {
                vm.rol = accionRequisitos.Roles[0].IdRol;
            }
    ...
    angular.module('backbone').component('alojarDocumentosReqAjustesSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/requisitosAjustesSinTramite/verificacion/soportes/alojarDocumentosReqAjustesSinTramiteSgp.html",
        controller: alojarDocumentosReqAjustesSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
