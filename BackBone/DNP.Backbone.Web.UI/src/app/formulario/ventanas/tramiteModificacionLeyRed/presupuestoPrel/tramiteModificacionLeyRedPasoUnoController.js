(function () {
    ...
    tramiteModificacionLeyRedPasoUnoController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
    ...
    function tramiteModificacionLeyRedPasoUnoController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
    ...
    angular.module('backbone').component('tramiteModificacionLeyRedPasoUno', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionLeyRed/presupuestoPrel/tramiteModificacionLeyRedPasoUno.html",
        controller: tramiteModificacionLeyRedPasoUnoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
