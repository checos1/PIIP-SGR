(function () {
    ...
    informacionPresupuestalMlaController.$inject = [
        '$sessionStorage',
        '$scope',
        'utilidades',
        '$uibModal',
    ...
    function informacionPresupuestalMlaController(
        $sessionStorage,
        $scope,
        utilidades,
        $uibModal,
        ...
        vm.mostrarRPasoUno = false;
        vm.mostrarRPasoTres = false;
        vm.mostrarRPasoTresA = false;
    ...
    angular.module('backbone').component('informacionPresupuestalMla', {
        templateUrl: "src/app/formulario/ventanas/comun/modificacionLey/informacionPresupuestalMla.html",
        controller: informacionPresupuestalMlaController,
        controllerAs: "vm",
        bindings: {
            guardadoevent: '&',
            notificacioncambios: '&',
