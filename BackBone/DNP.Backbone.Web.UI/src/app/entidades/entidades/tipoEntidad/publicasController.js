(function () {
    'use strict';
    angular.module('backbone.entidades').controller('publicasController', publicasController);

    publicasController.$inject = [
        '$scope',
        'servicioEntidades',
    ...
    function publicasController($scope, servicioEntidades, constantesAutorizacion, $uibModal, backboneServicios) {
        ...
        function listarEntidades(entidadeFiltro, cabezaSector, actualizar) {
            if (vm.listaEntidadesOrigem && !actualizar) {
                ...
                servicioEntidades.obtenerEntidadesPorTipo('Publicas')
                    .then(function (response) {
