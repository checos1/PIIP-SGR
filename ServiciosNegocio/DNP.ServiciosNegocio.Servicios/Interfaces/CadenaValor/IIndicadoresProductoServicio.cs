...
namespace DNP.ServiciosNegocio.Servicios.Interfaces.CadenaValor
{
    public interface IIndicadoresProductoServicio
    {
        ...
        RespuestaGeneralDto GuardarFocalizacionCategoriasAjustes(List<FocalizacionCategoriasAjusteDto> focalizacionCategoriasAjuste, string name);
