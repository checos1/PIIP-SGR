namespace DNP.ServiciosWBS.Test.Servicios
{
    ...
    [TestClass]
    public class RegionalizaFuentesServicioTest
    {
        private string BpinBase { get; set; }
        private IRegionalizaFuentesServicio _regionalizaFuentesServicio { get; set; }
        private RegionalizaFuentesServicio RegionalizaFuentesServicio { get; set; }
        ...
        private IRegionalizaFuentesPersistencia RegionalizaFuentesPersistencia { get; set; }
        ...
        public void Init()
        {
            ...
            _regionalizaFuentesServicio = contenedor.Resolve<IRegionalizaFuentesServicio>();
            RegionalizaFuentesPersistencia = UnityContainerExtensions.Resolve<IRegionalizaFuentesPersistencia>(contenedor);
            PersistenciaTemporal = contenedor.Resolve<IPersistenciaTemporal>();
            AuditoriaServicio = contenedor.Resolve<IAuditoriaServicios>();
            RegionalizaFuentesServicio = new RegionalizaFuentesServicio(RegionalizaFuentesPersistencia, PersistenciaTemporal, AuditoriaServicio);
            ...
            _mockContext.Setup(mc => mc.UspGetRegionalizaicion_JSON(BpinBase)).Returns(mockFuentes.Object);
        ...
        {
            _regionalizaFuentesServicio = new RegionalizaFuentesServicio(new RegionalizaFuentesPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), new AuditoriaServicios());
            var result = _regionalizaFuentesServicio.ObtenerFuenteFinanciacionRegionalizacion(new ParametrosConsultaDto
            {
                Bpin = BpinBase,
                AccionId = new Guid("E00485B4-34D9-495A-82CF-7F7F477FD16F"),
                InstanciaId = new Guid("76A7958B-D20A-48AD-87C9-917D3B388E21")
        ...
        public void FuenteCofinanciacionPreviewTest()
        {
            ...
            var result = _regionalizaFuentesServicio.ObtenerFuenteFinanciacionRegionalizacionPreview();
            Assert.IsNotNull(result);
            Assert.IsTrue(result.Regionalizacion.Count >= 1);
        }

        [TestMethod]
        public void FuenteCofinanciacion_ObtenerDefinitivo_Test()
        {
            RegionalizaFuentesServicio = new RegionalizaFuentesServicio(new RegionalizaFuentesPersistencia(_mockContextFactory.Object), new PersistenciaTemporal(_mockContextFactory.Object), new AuditoriaServicios());
            ...
            var resultado = RegionalizaFuentesServicio.Obtener(parametrosConsulta);
        ...
        public void FuenteCofinanciacion_Obtener_Test()
        {
            ...
            var resultado = RegionalizaFuentesServicio.ObtenerFuenteFinanciacionRegionalizacion(parametrosConsulta);
            Assert.IsNotNull(resultado);
        }
        ...
        public void FuenteCofinanciacion_GuardarDefinitivo()
        {
            var parametrosGuardar = new ParametrosGuardarDto<FuenteFinanciacionRegionalizacionDto>()
            {
                ...
                InstanciaId = new Guid("76A7958B-D20A-48AD-87C9-917D3B388E21"),
                Usuario = "Leticia01",
                Contenido = new FuenteFinanciacionRegionalizacionDto()
                {
                    ProyectoId = 72210,
                    BPIN = "202000000000005",
                    CR = 2,
            ...
            RegionalizaFuentesServicio.Guardar(parametrosGuardar, parametroAuditoria, false);
        }
    }
}
