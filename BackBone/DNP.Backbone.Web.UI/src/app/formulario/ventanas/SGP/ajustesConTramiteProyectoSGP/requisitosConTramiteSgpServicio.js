(function () {
    ...
    angular.module('backbone').factory('requisitosConTramiteSgpServicio', requisitosConTramiteSgpServicio);

    requisitosConTramiteSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function requisitosConTramiteSgpServicio($http, constantesBackbone) {
