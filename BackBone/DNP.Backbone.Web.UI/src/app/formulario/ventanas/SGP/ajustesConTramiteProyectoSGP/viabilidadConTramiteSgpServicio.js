(function () {
    ...
    angular.module('backbone').factory('viabilidadConTramiteSgpServicio', viabilidadConTramiteSgpServicio);

    viabilidadConTramiteSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function viabilidadConTramiteSgpServicio($http, constantesBackbone) {
