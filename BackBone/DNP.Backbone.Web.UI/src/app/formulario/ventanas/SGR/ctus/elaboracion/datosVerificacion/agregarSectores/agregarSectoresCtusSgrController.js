(function () {
    ...
    agregarSectoresCtusSgrController.$inject = ['$scope', 'requisitosSgrServicio', 'justificacionCambiosServicio','utilidades', '$sessionStorage'];

    function agregarSectoresCtusSgrController(
        $scope,
        ...
        var vm = this;
        vm.nombreComponente = "sgrctuselaboraciondatosverificacionagregarsectores";
        vm.Bpin = null;
    ...
    angular.module('backbone').component('agregarSectoresCtusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctus/elaboracion/datosVerificacion/agregarSectores/agregarSectoresCtusSgr.html",

        controller: agregarSectoresCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
