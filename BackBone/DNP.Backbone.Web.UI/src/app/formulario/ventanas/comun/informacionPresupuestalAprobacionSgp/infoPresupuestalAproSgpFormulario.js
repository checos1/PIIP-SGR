(function () {
    ...
    infoPresupuestalAproSgpFormulario.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
        'constantesBackbone',
    ...
    function infoPresupuestalAproSgpFormulario(
        $scope,
        $sessionStorage,
        utilidades,
        constantesBackbone,
    ...
    angular.module('backbone').component('infoPresupuestalAproSgpFormulario', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "src/app/formulario/ventanas/comun/informacionPresupuestalAprobacionSgp/infoPresupuestalAproSgpFormulario.js",        
        controller: infoPresupuestalAproSgpFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
