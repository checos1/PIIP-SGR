(function () {
    ...
    usuariosInvolucradosViabilidadSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function usuariosInvolucradosViabilidadSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpviabilidadviabilidadInformacionBasicausuariosinvolucradossgp";
       ...
       * */
        ...
        */
        ...
        vm.limpiarErrores = function () {
            var campomensajeerror = document.getElementById("SGRERRSECsgpviabilidadviabilidadInformacionBasica");
            if (campomensajeerror != undefined) {
    ...
    angular.module('backbone').component('usuariosInvolucradosViabilidadSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/viabilidadSGP/viabilidad/informacionGeneral/usuariosInvolucrados/usuariosInvolucradosViabilidadSgp.html",
        controller: usuariosInvolucradosViabilidadSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
