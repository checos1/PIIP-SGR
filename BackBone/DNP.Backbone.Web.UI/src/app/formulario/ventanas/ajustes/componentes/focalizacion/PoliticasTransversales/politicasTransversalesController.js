(function() {
    ...
    politicasTransversalesController.$inject = ['$scope', '$sessionStorage', '$uibModal', 'utilidades',
        'constantesBackbone', '$timeout', 'focalizacionAjustesServicio', 'justificacionCambiosServicio'
    ];

    function politicasTransversalesController(
        $scope,
        $sessionStorage,
        $uibModal,
        utilidades,
        ...
        function abrirModalAgregarPoliticaTrans() {
            $uibModal.open({
                ...
                controller: 'modalAgregarPoliticaTransversalAjustesController',
    ...
    angular.module('backbone').component('politicasTransversales', {
            templateUrl: "src/app/formulario/ventanas/ajustes/componentes/focalizacion/PoliticasTransversales/politicasTransversales.html",
            controller: politicasTransversalesController,
            controllerAs: "vm",
            bindings: {
                callback: '&',
