(function () {
    ...
    datosInicialesFormulario.$inject = [
        'backboneServicios',
        'sesionServicios',
    ...
    function datosInicialesFormulario(
        backboneServicios,
        sesionServicios,
        configurarEntidadRolSectorServicio,
        $scope,
        ...
        function cargarusuariosdestinatarios(value) {
            ...
            else if (vm.carta.ListaCartaSecciones[0].ListaCartaCampos[2].DatoValor == 1) // tipousuarioid
            {
                ...
                var panel = acc;
                //if (panel.style.maxHeight == "620px") {
                    var alto = panel.style.maxHeight.substring(0, 3);
                    var medida = parseInt(alto) +50;
    ...
    angular.module('backbone').component('datosInicialesFormulario', {

        templateUrl: "src/app/formulario/ventanas/comun/elaborarConcepto/datosInicialesFormulario.html",
        controller: datosInicialesFormulario,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
