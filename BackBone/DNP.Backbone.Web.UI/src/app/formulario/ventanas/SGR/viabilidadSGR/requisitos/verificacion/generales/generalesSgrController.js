(function () {
    ...
    function generalesSgrController(
        utilidades,
        $sessionStorage,
        requisitosSgrServicio,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "sgrviabilidadrequisitosverificacionrequisitos";
    ...
    angular.module('backbone').component('generalesSgr', {
        templateUrl: "src/app/formulario/ventanas/SGR/viabilidadSGR/requisitos/verificacion/generales/generalesSgr.html",
        controller: generalesSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
