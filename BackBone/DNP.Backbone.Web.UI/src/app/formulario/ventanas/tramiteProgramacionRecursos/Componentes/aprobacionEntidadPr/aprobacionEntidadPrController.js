(function () {
    ...
    aprobacionEntidadPrController.$inject = ['$scope',];

    function aprobacionEntidadPrController(
        $scope,
    ...
    angular.module('backbone').component('aprobacionEntidadPr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/Componentes/aprobacionEntidadPr/aprobacionEntidadPr.html",

        controller: aprobacionEntidadPrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
