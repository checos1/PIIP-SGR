(function () {
    ...
    angular.module('backbone').factory('ctusElaboracionSgrServicio', ctusElaboracionSgrServicio);

    ctusElaboracionSgrServicio.$inject = ['$http', 'constantesBackbone'];

    function ctusElaboracionSgrServicio($http, constantesBackbone) {
        ...
        return {
            ...
            SGR_Proyectos_CumplimentoFlujoSGR: SGR_Proyectos_CumplimentoFlujoSGR
        };
        ...
        function SGR_Proyectos_CumplimentoFlujoSGR(instanciaId) {
            var url = apiBackboneServicioBaseUri + constantesBackbone.apiBackBoneValidarViavilidadCumplimentoFlujoSGR + "?instanciaId=" + instanciaId;
            return $http.get(url);
        }
    }
})();