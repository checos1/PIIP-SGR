(function () {
    ...
    soporteTadController.$inject = [
        '$scope',

    ];

    function soporteTadController(
        $scope,
    ...
    angular.module('backbone').component('soporteTad', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/soporteTad/soporteTad.html",


        controller: soporteTadController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
