(function () {
    ...
    usuariosInvolucradosCtusSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function usuariosInvolucradosCtusSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrctuselaboracioninfogeneralusuariosinvolucrados";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrctuselaboracioninfogeneralusuariosinvolucrados";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctuselaboracioninfogeneralusuariosinvolucrados', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('usuariosInvolucradosCtusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctus/elaboracion/informacionGeneral/usuariosInvolucrados/usuariosInvolucradosCtusSgr.html",
        controller: usuariosInvolucradosCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
