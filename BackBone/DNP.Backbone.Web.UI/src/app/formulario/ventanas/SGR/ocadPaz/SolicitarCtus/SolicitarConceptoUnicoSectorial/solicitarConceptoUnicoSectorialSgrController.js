(function () {
    'use strict';
    solicitarConceptoUnicoSectorialSgrController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function solicitarConceptoUnicoSectorialSgrController(
        utilidades,
        $sessionStorage,
        solicitarCtusSgrServicio,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgrocadpazsolicitarCtussolicitar';
            ...
            if (!validar()) {
                ...
                if (vm.ProyectoCtus.SolicitaCtus == 'true' || vm.ProyectoCtus.SolicitaCtus == true) {
                    utilidades.mensajeWarning("La solicitud no podrá ser modificada ni eliminada. ¿Está seguro de continuar?", function funcionContinuar() {
                        ...
                        return;
                    }, null, null, `Se creará una solicitud para emitir un CTUS a la entidad ${vm.nombreEntidadSeleccionada}.`);
                }
                else {
                    Guardar();
                }
    ...
    angular.module('backbone').component('solicitarConceptoUnicoSectorialSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ocadPaz/SolicitarCtus/SolicitarConceptoUnicoSectorial/solicitarConceptoUnicoSectorialSgr.html",
        controller: solicitarConceptoUnicoSectorialSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
