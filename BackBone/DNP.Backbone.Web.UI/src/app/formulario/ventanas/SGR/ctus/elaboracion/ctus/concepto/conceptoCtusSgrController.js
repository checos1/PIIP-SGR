(function () {
    'use strict';
    conceptoCtusSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function conceptoCtusSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgrctuselaboracionctusconcepto';
        ...
        vm.init = function () {
            ...
            var observador = transversalSgrServicio.registrarObservador(function (datos) {
                ...
                ObtenerProyectoCtus(vm.ProyectoCtusId);
            });
        ...
        function ObtenerProyectoCtus(proyectoCtusId) {
    ...
    angular.module('backbone').component('conceptoCtusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctus/elaboracion/ctus/concepto/conceptoCtusSgr.html",
        controller: conceptoCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
