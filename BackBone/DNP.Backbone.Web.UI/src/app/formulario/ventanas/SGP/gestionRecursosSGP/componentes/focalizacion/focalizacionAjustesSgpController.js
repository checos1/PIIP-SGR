(function () {
    ...
    focalizacionAjustesSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
    ...
    function focalizacionAjustesSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        ...
        vm.nombreComponente = "sgpsolicitudrecursosfocalizacion";
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpsolicitudrecursosfocalizacionpoliticassgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgpsolicitudrecursosfocalizacioncategoriapoliticassgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'sgpsolicitudrecursosfocalizacioncrucepoliticassgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 4, componente: 'sgpsolicitudrecursosfocalizacionresumenfocalizacionsgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpsolicitudrecursosfocalizacionpoliticassgp': true,
                'sgpsolicitudrecursosfocalizacioncategoriapoliticassgp': true,
                'sgpsolicitudrecursosfocalizacioncrucepoliticassgp': true,
                'sgpsolicitudrecursosfocalizacionresumenfocalizacionsgp': true
            };
        }


        vm.notificarRefrescoHijo1 = null;
        vm.notificarRefrescoHijo2 = null;
        ...
        vm.guardado = function (nombreComponenteHijo) {
            ...
            if (nombreComponenteHijo == "sgpsolicitudrecursosfocalizacionpoliticassgp") {
                vm.notificarRefrescoHijo1();
            }
        }
        ...
        */
        ...
        vm.notificarRefresco = function (handler, nombreComponente) {
            if (nombreComponente == "sgpsolicitudrecursosfocalizacion") {
                vm.notificarRefrescoFuentes = handler;
            }

            if (nombreComponente == "sgpsolicitudrecursosfocalizacioncategoriapoliticassgp") {
                vm.notificarRefrescoHijo1 = handler;
            }
        };
    ...
    angular.module('backbone').component('focalizacionAjustesSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/focalizacion/focalizacionAjustesSgp.html",
        controller: focalizacionAjustesSgpController,
        controllerAs: "vm",
        bindings: {
