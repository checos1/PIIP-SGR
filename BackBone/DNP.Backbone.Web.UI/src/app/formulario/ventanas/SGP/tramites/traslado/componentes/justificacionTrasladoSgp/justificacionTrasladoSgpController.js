(function () {
    ...
    justificacionTrasladoSgpController.$inject = ['$scope', '$sessionStorage','constantesBackbone'];

    function justificacionTrasladoSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone
    ) {
        var vm = this;
        vm.nombreComponente = "justificacionsgp";
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";

        vm.nombreComponenteHijo = "justificacionsgpjustificaciontramitesgp";
        vm.notificacionCambiosCapitulos = null;
        vm.mostrarjustificacion = false;


        vm.handlerComponentes = [
            { id: 1, componente: 'justificacionsgpjustificaciontramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true },
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'justificacionsgpjustificaciontramitesgp': true
            };
        }

        vm.initJustificacion = function () {                      
       ...
       * */
        ...
        vm.guardado = function (nombreComponenteHijo) {
            vm.callback({ botonDevolver: false, botonSiguiente: false});
        ...
        */
        ...
        vm.capitulos = function (listadoCapitulos) {
            ...
            listadoCapRecursos.forEach(function (item) {
                ...
                var elidSeccionCapitulo2 = document.getElementById("id-capitulo-justificacionjustificacion");
                ...
                if (elidSeccionCapitulo2 != undefined && elidSeccionCapitulo2 != null) {
                    elidSeccionCapitulo2.innerHTML = item.SeccionCapituloId;
                }
            });
        };
    ...
    angular.module('backbone').component('justificacionTrasladoSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/traslado/componentes/justificacionTrasladoSgp/justificacionTrasladoSgp.html",        
        controller: justificacionTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
