(function () {
    ...
    elaborarConceptoIncController.$inject = [
        '$sessionStorage',
        'archivoServicios',
        '$scope',
        'servicioAcciones',
        ...
        'utilidades',
        'FileSaver',
        'tramiteIncorporacionServicio'
    ];

    function elaborarConceptoIncController(
        $sessionStorage,
        archivoServicios,
        $scope,
        servicioAcciones,
        ...
        */
        ...
        vm.verPdf = function () {
            ...
            tramiteIncorporacionServicio.generarPdfCartaTramite(tramiteId, true,'Incorporacion');
        }

    }

    angular.module('backbone').component('elaborarConceptoInc', {
        templateUrl: "src/app/formulario/ventanas/tramiteIncorporacion/componentes/conceptoInc/elaborarConcepto/elaborarConceptoInc.html",
        controller: elaborarConceptoIncController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
