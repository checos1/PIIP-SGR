(function () {
    'use strict';
    firmarAjustesSinTramiteSgpController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function firmarAjustesSinTramiteSgpController(
        utilidades,
        $sessionStorage,
        justificacionCambiosServicio,
        firmaEmisionSinTramiteSgpServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgpfirmaresponsablesprocesofirmassintramitesgp';
        vm.ventanaPadre = 'viabilidadAjustesSinTramiteSgp';
        ...
        vm.mostrarBotonPdf = function () {
            var mostrar = false;
            if (vm.nombreComponente == "sgpfirmaresponsablesprocesofirmassintramitesgp") { mostrar = true; }
            return mostrar;
            ;
    ...
    angular.module('backbone').component('firmarAjustesSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/firmaEmisionAjustesSinTramite/firmar/firmarAjustesSinTramiteSgp.html",
        controller: firmarAjustesSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
