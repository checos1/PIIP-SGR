(function () {
    ...
    firmaEmisionSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function firmaEmisionSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        firmaEmisionSgrServicio,
    ...
    angular.module('backbone').component('firmaEmisionSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/firmaEmisionSgr.html",
        controller: firmaEmisionSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
