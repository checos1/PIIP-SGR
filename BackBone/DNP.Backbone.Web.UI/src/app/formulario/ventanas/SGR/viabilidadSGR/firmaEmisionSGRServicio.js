(function () {
    ...
    angular.module('backbone').factory('firmaEmisionSgrServicio', firmaEmisionSgrServicio);

    firmaEmisionSgrServicio.$inject = ['$http', 'constantesBackbone'];

    function firmaEmisionSgrServicio($http, constantesBackbone) {
