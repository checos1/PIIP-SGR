(function () {
    'use strict';
    politicaCrucePoliticaController.$inject = [
        '$sessionStorage',
    ...
    function politicaCrucePoliticaController(
        $sessionStorage,
        gestionRecursosServicio,
        $scope,
        $anchorScroll,
        ...
        function obtenerPoliticasTransversalesCrucePoliticas() {
            ...
            if (vm.IdFuente != null)
                gestionRecursosServicio.obtenerPoliticasTransversalesCrucePoliticas($sessionStorage.idInstancia, vm.IdFuente)
                    .then(resultado => {
        ...
        vm.actualizarCrucePolitica = function (response) {
            ...
            //    })
            //})
            gestionRecursosServicio.actualizarPoliticasTransversalesCrucePoliticas(vm.PoliticasTCrucePoliticas).then(function (response) {
    ...
    angular.module('backbone').component('politicaCrucePolitica', {

        templateUrl: "src/app/formulario/ventanas/gestionRecursos/componentes/politicacrucepolitica/politicaCrucePolitica.html",
        controller: politicaCrucePoliticaController,
        controllerAs: "vm",
        bindings: {
            guardadoevent: '&',
