(function () {
    ...
    angular.module('backbone').factory('tramiteModificacionLeyRedServicio', tramiteModificacionLeyRedServicio);

    tramiteModificacionLeyRedServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone', 'servicioFichasProyectos', 'utilidades', 'FileSaver'];


    function tramiteModificacionLeyRedServicio($q, $http, $location, constantesBackbone, servicioFichasProyectos, utilidades, FileSaver) {
        return {
