(function () {
    ...
    tramiteModificacionAdicionPasoDosController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionAdicionPasoDosController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionAdicionPasoDos', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionAdicion/presupuestoPrel/tramiteModificacionAdicionPasoDos.html",
        controller: tramiteModificacionAdicionPasoDosController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
