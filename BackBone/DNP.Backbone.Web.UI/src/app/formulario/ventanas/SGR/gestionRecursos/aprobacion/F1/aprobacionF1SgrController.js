(function () {
    ...
    aprobacionF1SgrController.$inject = ['$scope', 'aprobacionSgrServicio', 'utilidades', '$sessionStorage', 'sesionServicios', 'utilsValidacionSeccionCapitulosServicio', 'constantesBackbone', 'validacionArchivosServicio'];

    function aprobacionF1SgrController(
        $scope,
        ...
        vm.TieneOPC = $sessionStorage.TieneOPC;
        vm.PorcentajeCredito = $sessionStorage.PorcentajeCredito;
        ...
        //sgraprobacion1aprobacion	            1: TieneOPC == 0 || (TieneOPC == 1 && PorcentajeCredito == 0)
        //sgrviabilidadpreviosoperacioncredito	2: TieneOPC == 1
        //sgraprobacion1aprobacionopc           2: TieneOPC == 1 && PorcentajeCredito > 0
        //sgrviabilidadpreviosrecursos	        3: TieneOPC == 0 || PorcentajeCredito < 100
        if (vm.TieneOPC == 1 && vm.PorcentajeCredito > 0 && vm.PorcentajeCredito < 100) {
            vm.handlerComponentes = [
                { id: 1, componente: 'sgrviabilidadpreviosregionalizacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 2, componente: 'sgrviabilidadpreviosfocalizacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 3, componente: 'sgrviabilidadpreviosrecursos', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 4, componente: 'sgrviabilidadpreviosoperacioncredito', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 5, componente: 'sgraprobacion1aprobacionopc', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 6, componente: 'sgraprobacion1soportes', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
            ];
        } else if (vm.TieneOPC == 1 && vm.PorcentajeCredito < 100 && vm.PorcentajeCredito == 0) {
            vm.handlerComponentes = [
                { id: 1, componente: 'sgrviabilidadpreviosregionalizacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 2, componente: 'sgrviabilidadpreviosfocalizacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 3, componente: 'sgrviabilidadpreviosrecursos', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 4, componente: 'sgraprobacion1aprobacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 5, componente: 'sgraprobacion1soportes', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
            ];
        } else if (vm.TieneOPC == 1 && vm.PorcentajeCredito > 0 && vm.PorcentajeCredito >= 100) {
            vm.handlerComponentes = [
                { id: 1, componente: 'sgrviabilidadpreviosregionalizacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 2, componente: 'sgrviabilidadpreviosfocalizacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 3, componente: 'sgrviabilidadpreviosoperacioncredito', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 4, componente: 'sgraprobacion1aprobacionopc', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
                { id: 5, componente: 'sgraprobacion1soportes', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
            ];
        } else {
            vm.handlerComponentes = [
        ...
        vm.inicializarComponenteCheck = function (estado) {
            ...
            vm.handlerComponentesChecked = {
                'sgraprobacion1aprobacion': true,
                'sgraprobacion1soportes': true,
            };
        }
        ...
        function eventoValidar() {
            ...
            const seccionCap = 'sgraprobacion1soportes';

            //validar que obtenerErroresProyecto sea del servico correcto
            aprobacionSgrServicio.obtenerErroresProyecto(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        //function eventoValidar() {
        //    vm.inicializarComponenteCheck();
        //    aprobacionSgrServicio.obtenerErroresProyecto(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {
        ...
        //                        var seccion = 'sgraprobacion1soportes';
    ...
    angular.module('backbone').component('aprobacionF1Sgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/gestionRecursos/aprobacion/F1/aprobacionF1Sgr.html",

        controller: aprobacionF1SgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
