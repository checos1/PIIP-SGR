(function () {
    ...
    angular.module('backbone').factory('requisitosSgrServicio', requisitosSgrServicio);

    requisitosSgrServicio.$inject = ['$http', 'constantesBackbone'];

    function requisitosSgrServicio($http, constantesBackbone) {
