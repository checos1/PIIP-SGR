(function () {
   ...
   proyectosIncController.$inject = [
    ...
    function proyectosIncController(
        $scope,
        $sessionStorage,
        tramiteVigenciaFuturaServicio,
        utilidades,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'proyectodatosincorporacion', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'proyectoasociarproyecto', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'proyectoproyectosaportantes', handlerValidacion: null, handlerCambios: null, esValido: true },
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'proyectodatosadicionpordonacion': true,
    ...
    angular.module('backbone').component('proyectosInc', {
        templateUrl: "src/app/formulario/ventanas/tramiteIncorporacion/componentes/proyectosInc/proyectosInc.html",
               
        controller: proyectosIncController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
