...
namespace DNP.ServiciosNegocio.Servicios.Interfaces.SGR.Procesos
{
    public interface IProcesosSgrServicio
    {
        Task<IEnumerable<PriorizacionProyectoDto>> ObtenerPriorizacionProyecto(Nullable<Guid> instanciaId);
        Task<IEnumerable<AprobacionProyectoDto>> ObtenerAprobacionProyecto(Nullable<Guid> instanciaId);
        ...
        Task<List<ProyectoResumenEstadoAprobacionCreditoDto>> SGR_Proyectos_ResumenEstadoAprobacionCredito(int proyectoId);
        ...
        Task<List<EjecutorEntidadAsociado>> SGR_Procesos_ConsultarEjecutorbyTipo(int proyectoId, int tipoEjecutorId);
