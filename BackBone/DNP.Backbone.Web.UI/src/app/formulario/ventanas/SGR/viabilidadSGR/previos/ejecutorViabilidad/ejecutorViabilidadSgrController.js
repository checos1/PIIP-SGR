(function () {
    'use strict';
    ejecutorViabilidadSgrController.$inject = [
        '$scope',
        '$sessionStorage'
    ];

    function ejecutorViabilidadSgrController(
        $scope,
        $sessionStorage
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrviabilidadpreviosejecutor";
        //vm.nombreComponenteHijo = "sgrviabilidadpreviosejecutorejecutorpropuesto";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadpreviosejecutorejecutorpropuesto', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadpreviosejecutorejecutorpropuesto': true
            };
        }
    ...
    angular.module('backbone').component('ejecutorViabilidadSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/previos/ejecutorViabilidad/ejecutorViabilidadSgr.html",
        controller: ejecutorViabilidadSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
