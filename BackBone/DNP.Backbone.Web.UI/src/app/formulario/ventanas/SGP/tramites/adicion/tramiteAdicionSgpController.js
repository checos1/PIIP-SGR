(function () {
    ...
    tramiteAdicionSgpController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
    ...
    function tramiteAdicionSgpController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
        ...
        vm.guiMacroproceso = constantesBackbone.idEtapaEjecucion;
       ...
       * */
        vm.handlerComponentes = [
            { id: 1, componente: 'proyectostramitesgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [], esValido: true, errores: null },
            { id: 2, componente: 'informacionpresupuestalsgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [], esValido: true, errores: null },
            { id: 3, componente: 'justificacionsgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [], esValido: true, errores: null },
            { id: 4, componente: 'soportestramitesgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [], esValido: true, errores: null }
        ];
        ...
        vm.inicializarComponenteCheck = function (estado) {
            ...
            vm.handlerComponentesChecked = {
                'proyectostramitesgp': true,
                'informacionpresupuestalsgp': true,
                'justificacionsgp': true,
                'soportestramitesgp': true
            };
        }
        ...
        vm.notificacionValidacionHijos = function (errores) {
            ...
            if (($sessionStorage.sessionDocumentos < 100 || $sessionStorage.sessionDocumentos === undefined) && $sessionStorage.idNivel.toUpperCase() === constantesBackbone.idNivelSeleccionProyectos) {
                error = {
                    Seccion: "soportestramitesgp",
                    Capitulo: "documentotramitesgp",
                    Errores: '{"soportestramitesgpdocumentotramitesgp":[{"Error":"VFO006","Descripcion":"Diligencie los documentos obligatorios"}]}',
                }
            }
            else {
                error = {
       ...
       */
        ...
        vm.notificacionCambiosAsociarProyecto = function (nombreComponente, nombreComponenteHijo) {
            var componente = vm.handlerComponentes.find(p => p.componente == 'asociarproyectotramitesgp');
    ...
    angular.module('backbone').component('tramiteAdicionSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/tramites/adicion/tramiteAdicionSgp.html",
        controller: tramiteAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&',
