(function () {
    ...
    angular.module('backbone').factory('viabilidadVotosSgrServicio', viabilidadVotosSgrServicio);

    viabilidadVotosSgrServicio.$inject = ['$http', 'constantesBackbone'];

    function viabilidadVotosSgrServicio($http, constantesBackbone) {
