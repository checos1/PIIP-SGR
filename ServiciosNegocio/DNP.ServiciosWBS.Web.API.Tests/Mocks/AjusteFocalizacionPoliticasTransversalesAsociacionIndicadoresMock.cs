...
{
    public class AjusteFocalizacionPoliticasTransversalesAsociacionIndicadoresMock : IAjusteFocalizacionPoliticasTransversalesAsociacionIndicadoresServicios
    {
        public ParametrosGuardarDto<PoliticaTIndicadoresAjusteDto> ConstruirParametrosGuardado(HttpRequestMessage request, PoliticaTIndicadoresAjusteDto contenido)
        {
            var parametrosGuardar = new ParametrosGuardarDto<PoliticaTIndicadoresAjusteDto>();
        ...
        public void Guardar(ParametrosGuardarDto<PoliticaTIndicadoresAjusteDto> parametrosGuardar, ParametrosAuditoriaDto parametrosAuditoria, bool guardarTemporalmente)
        {
        ...
        public PoliticaTIndicadoresAjusteDto ObtenerAjusteFocalizacionPoliticasTransversalesAsociacionIndicadores(ParametrosConsultaDto parametrosConsulta)
        {
            ...
            {
                return new PoliticaTIndicadoresAjusteDto()
                {
                    ProyectoId = 72210,
