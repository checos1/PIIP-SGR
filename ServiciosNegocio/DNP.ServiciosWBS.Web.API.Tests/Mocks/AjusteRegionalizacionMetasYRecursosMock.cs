...
{
    public class AjusteRegionalizacionMetasYRecursosMock : IAjusteRegionalizacionMetasyRecursosServicios
    {
        public ParametrosGuardarDto<AjusteRegMetasRecursosDto> ConstruirParametrosGuardado(HttpRequestMessage request, AjusteRegMetasRecursosDto contenido)
        {
            var parametrosGuardar = new ParametrosGuardarDto<AjusteRegMetasRecursosDto>();
        ...
        public void Guardar(ParametrosGuardarDto<AjusteRegMetasRecursosDto> parametrosGuardar, ParametrosAuditoriaDto parametrosAuditoria, bool guardarTemporalmente)
        {
        ...
        public AjusteRegMetasRecursosDto ObtenerRegionalizacionMetasyRecursosAjusteServicios(ParametrosConsultaDto parametrosConsulta)
        {
            ...
            {
                return new AjusteRegMetasRecursosDto()
                {
                    ProyectoId = 72210,
