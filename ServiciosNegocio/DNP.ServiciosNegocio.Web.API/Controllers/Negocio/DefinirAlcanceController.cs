...
namespace DNP.ServiciosNegocio.Web.API.Controllers.Negocio
{
    ...
    {
        private readonly IDefinirAlcanceServicios _AlcanceServicios;
        private readonly IAutorizacionUtilidades _autorizacionUtilidades;

        public DefinirAlcanceController(IDefinirAlcanceServicios alcancaServicios, IAutorizacionUtilidades autorizacionUtilidades)
        {
            _AlcanceServicios = alcancaServicios;
            _autorizacionUtilidades = autorizacionUtilidades;
        }

        [Route("api/DNP_SN_Seg_PlaEjec_DefinirAlcanceDto")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion de Definir Alcance", typeof(AlcanceDto))]
        [HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings["consultarAlcance"]).
                                            Result;
                ...
                var result =
                    await Task.Run(() => _AlcanceServicios.ObtenerDefinirAlcance(new ParametrosConsultaDto
                    {
                        Bpin =
                                                                                          bpin,
                        AccionId
                ...
                if (result != null) return Ok<AlcanceDto>(result);
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["previewAlcance"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var result = await Task.Run(() => _AlcanceServicios.ObtenerDefinirAlcancePreview());

                return Ok<AlcanceDto>(result);
            }
            catch (AutorizacionException e)
            {
                throw new HttpResponseException(Request.CreateErrorResponse(HttpStatusCode.Unauthorized, e));
        ...
        [Route("api/DNP_SN_Seg_PlaEjec_DefinirAlcanceDto/Temporal")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion devuelta por guardado temporal", typeof(HttpResponseMessage))]
        [HttpPost]
        public async Task<IHttpActionResult> Temporal(AlcanceDto contenido)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["postAlcanceTemporal"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var parametrosGuardar = _AlcanceServicios.ConstruirParametrosGuardado(Request, contenido);
                ...
                await Task.Run((Action)(() => _AlcanceServicios.Guardar(parametrosGuardar, parametrosAuditoria, true)));
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Definitivo([FromBody] AlcanceDto proyecto)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings
                                                               ["postAlcanceDefinitivo"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);


                var parametrosGuardar = _AlcanceServicios.ConstruirParametrosGuardado(Request, proyecto);
                ...
                await Task.Run((Action)(() => _AlcanceServicios.Guardar(parametrosGuardar, parametrosAuditoria, false)));
