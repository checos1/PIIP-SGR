...
namespace DNP.ServiciosNegocio.Web.API.Controllers.Negocio
{
    ...
    public class IncluirPoliticasController : ApiController
    {
        ...
        public IncluirPoliticasController(IIncluirPoliticasServicios incluirPoliticasServicios, IAutorizacionUtilidades autorizacionUtilidades)
        {
            _autorizacionUtilidades = autorizacionUtilidades;
            _incluirPoliticasServicios = incluirPoliticasServicios;
        }

        [Route("api/DNP_SN_Pla_DistriRec_IncluirPoliticasJerarquiaDto")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion del proyecto Agregar Politicas", typeof(IncluirPoliticasDto))]
        [HttpGet]
        public async Task<IHttpActionResult> Consultar(string bpin)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.
                                                               AppSettings["consultarAgregarPoliticasJerarquia"]).
                                            Result;
                ...
                if (result != null) return Ok<IncluirPoliticasDto>(result);
        ...
        [Route("api/DNP_SN_Pla_DistriRec_IncluirPoliticasJerarquiaDto/Preview")]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["previewAgregarPoliticasJerarquia"]).
                                            Result;
        ...
        [Route("api/DNP_SN_Pla_DistriRec_IncluirPoliticasJerarquiaDto/Temporal")]
                ...
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings
                                                               ["postAgregarPoliticasJerarquiaTemporal"]).
                                            Result;
