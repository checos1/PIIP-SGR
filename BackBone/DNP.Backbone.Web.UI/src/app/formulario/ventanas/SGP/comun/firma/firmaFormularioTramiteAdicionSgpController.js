(function () {
    ...
    firmaFormularioTramiteAdicionSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
    ...
    function firmaFormularioTramiteAdicionSgpController(
        $scope,
        $sessionStorage,
        utilidades,
        firmaFormularioSgpServicio,
    ...
    angular.module('backbone').component('firmaFormularioTramiteAdicionSgp', {

        templateUrl: "src/app/formulario/ventanas/SGP/comun/firma/firmaFormularioTramiteAdicionSgp.html",
        controller: firmaFormularioTramiteAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
