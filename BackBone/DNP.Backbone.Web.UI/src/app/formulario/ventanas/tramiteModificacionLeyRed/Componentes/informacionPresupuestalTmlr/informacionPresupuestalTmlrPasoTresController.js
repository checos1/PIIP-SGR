(function () {
    ...
    informacionPresupuestalTmlrPasoTresController.$inject = [
        '$scope'
    ];

    function informacionPresupuestalTmlrPasoTresController(
        $scope
    ) {
        var vm = this;
        vm.lang = "es";
    ...
    angular.module('backbone').component('informacionPresupuestalTmlrPasoTres', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionLeyRed/Componentes/informacionPresupuestalTmlr/informacionPresupuestalTmlrPasoTres.html",
        controller: informacionPresupuestalTmlrPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
