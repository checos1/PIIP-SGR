(function () {
    ...
    tramiteModificacionDTrasladoPasoDosController.$inject = [
        '$sessionStorage',
        '$scope',
        ...
        'sesionServicios',
        'trasladosServicio',
        'tramiteModificacionDTrasladoServicio',

    ];

    function tramiteModificacionDTrasladoPasoDosController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
        ...
        vm.init = function () {
            ...
            var rol = roles.find(x => x === constantesBackbone.idRolPresupuesto.toLowerCase());
            if (rol !== undefined)
                vm.IdRol = rol;
            ...
            if ((vm.IdNivel.toLowerCase() === constantesBackbone.idNivelAprobacionEntidadAdicion.toLowerCase() || vm.IdNivel.toLowerCase() === constantesBackbone.idNivelRevisionConcepto.toLowerCase())) {
        ...
        * */
        ...
        function eventoValidar() {
            ...
            tramiteModificacionDTrasladoServicio.obtenerErroresProgramacion(vm.instanciaId, vm.accionId).then(function (respuesta) {
        ...
        vm.visualizarAlerta = function (error, errorObservacion) {
            ...
            if ($sessionStorage.Respuesta !== undefined
                && (vm.IdNivel.toLowerCase() === constantesBackbone.idNivelAprobacionEntidadAdicion.toLowerCase() || vm.IdNivel.toLowerCase() === constantesBackbone.idNivelRevisionConcepto.toLowerCase())) {
            ...
            if ((vm.IdNivel.toLowerCase() === constantesBackbone.idNivelAprobacionEntidadAdicion.toLowerCase() || vm.IdNivel.toLowerCase() === constantesBackbone.idNivelRevisionConcepto.toLowerCase()) && vm.siguienteDisabled) {
                vocultarDevolver = true;
            }
    ...
    angular.module('backbone').component('tramiteModificacionDTrasladoPasoDos', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/presupuestoPrel/tramiteModificacionDTrasladoPasoDos.html",
        controller: tramiteModificacionDTrasladoPasoDosController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
