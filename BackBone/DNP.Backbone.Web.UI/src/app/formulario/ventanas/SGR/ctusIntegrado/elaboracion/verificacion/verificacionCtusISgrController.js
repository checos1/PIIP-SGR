(function () {
    'use strict';
    verificacionCtusISgrController.$inject = [
        '$scope',
        '$sessionStorage',
        'requisitosSgrServicio'
    ];

    function verificacionCtusISgrController(
        $scope,
        $sessionStorage,
        requisitosSgrServicio
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrctusintegradoelaboracionverificacion";
        vm.nombreComponenteHijo = "sgrctusintegradoelaboracionverificacionrequisitos";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctusintegradoelaboracionverificacionrequisitos', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrctusintegradoelaboracionverificacionrequisitos': true
            };
        }
        ...
        vm.notificacionCambios = function (handler, nombreComponenteHijo) {
            ...
            if (nombreComponenteHijo == "sgrctusintegradoelaboracionverificacionrequisitos") {
    ...
    angular.module('backbone').component('verificacionCtusISgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/elaboracion/verificacion/verificacionCtusISgr.html",
        controller: verificacionCtusISgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
