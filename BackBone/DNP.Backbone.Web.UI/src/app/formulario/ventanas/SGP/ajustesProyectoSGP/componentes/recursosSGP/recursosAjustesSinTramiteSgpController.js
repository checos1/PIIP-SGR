(function () {
    ...
    recursosAjustesSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
    ...
    function recursosAjustesSinTramiteSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        recursosAjustesSinTramiteSgpServicio
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "recursossgp";
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";
        vm.handlerComponentes = [
            { id: 1, componente: 'recursossgpfuentesdefinancsintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'recursossgpcostosdelasactisintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'recursossgpregionalizacionsintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.guardado = function (nombreComponenteHijo) {
            ...
            if (nombreComponenteHijo == "recursossgpfuentesdefinancsintramitesgp") {
                vm.notificarRefrescoFuentes();
            }
            else if (nombreComponenteHijo == "recursossgpcostosdelasactisintramitesgp") {
                vm.notificarRefrescoCostos();
            }
            else if (nombreComponenteHijo == "recursossgpregionalizacionsintramitesgp") {
                vm.notificarRefrescoRegionalizacion();
            }
        }
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'recursossgpfuentesdefinancsintramitesgp': true,
                'recursossgpcostosdelasactisintramitesgp': true,
                'recursossgpregionalizacionsintramitesgp': true
            };
        }
       ...
       */
        ...
        vm.notificarRefresco = function (handler, nombreComponente) {
            ...
            if (nombreComponente == "recursossgpfuentesdefinancsintramitesgp") {
                vm.notificarRefrescoCostos = handler;
            }
            else if (nombreComponente == "recursossgpcostosdelasactisintramitesgp") {
                vm.notificarRefrescoFuentes = handler;
            }
            else if (nombreComponente == "recursossgpregionalizacionsintramitesgp") {
    ...
    angular.module('backbone').component('recursosAjustesSinTramiteSgp', {

        templateUrl: "src/app/formulario/ventanas/SGP/ajustesProyectoSGP/componentes/recursosSGP/recursosAjustesSinTramiteSgp.html",
        controller: recursosAjustesSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
