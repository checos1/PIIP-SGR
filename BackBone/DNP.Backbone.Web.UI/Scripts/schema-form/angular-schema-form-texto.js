(function () {
    ...
    angular.module("backbone").config(["schemaFormProvider", "schemaFormDecoratorsProvider", "sfPathProvider", "constantesFormularios",
        function (schemaFormProvider, schemaFormDecoratorsProvider, sfPathProvider, constantesFormularios) {
            ...
            var control = constantesFormularios.controlTextoSchemaForm;
            ...
            schemaFormDecoratorsProvider.addMapping(
                "bootstrapDecorator",
                control,
                "/Scripts/schema-form/directives/texto.html"
            );
        }
    ]);

    angular.module("backbone").controller("textoController", ["$scope",
        function ($scope) {
            $scope.opciones = {
