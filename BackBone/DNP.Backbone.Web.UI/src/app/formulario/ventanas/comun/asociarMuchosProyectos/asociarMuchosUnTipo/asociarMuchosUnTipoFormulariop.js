(function () {
    ...
    asociarMuchosUnTipoFormulariop.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarMuchosUnTipoFormulariop(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
        ...
        vm.estadoTramite = '';
        vm.mostrarBandTramiteML = false;
        vm.estadoTramiteC = 'Sin asociación';
        vm.estadoAjusteCreadoC = false;
        ...
        vm.init = function () {
                    ...
                    if (newVal) {
                        ...
                        switch (vm.tipotramiteid) {
                            case "7"://Incorporaciones
                                tipoProyecto = 'D';
                                break;
                            case "50"://ML adicion - analista
                                tipoProyecto = 'D';
                                vm.mostrarBandTramiteML = true;
                                break;
                            case "53"://ML adicion - presupuesto preliminar
                                tipoProyecto = 'D';
                                vm.mostrarBandTramiteML = true;
                                break;
                            case "51"://ML REDUCCION - presupuesto preliminar
                                tipoProyecto = 'C';
                                vm.mostrarBandTramiteML = true;
                                break;
                            case "54"://ML REDUCCION - presupuesto preliminar
                                tipoProyecto = 'C';
                                vm.mostrarBandTramiteML = true;
                                break;
                            case "55"://ML REDUCCION - presupuesto preliminar
                                tipoProyecto = 'C';
                                vm.mostrarBandTramiteML = true;
                                break;
                            case "56"://ML REDUCCION - presupuesto preliminar
                                tipoProyecto = 'C';
                                vm.mostrarBandTramiteML = true;
                                break;
                        }
            ...
            if (vm.tramiteid !== undefined && vm.tramiteid !== '') {
                ObtenerProyectosTramiteC();
            }

        }
        function ObtenerProyectosTramiteC() {
            comunesServicio.obtenerProyectosTramite(vm.tramiteid)
                .then(function (response) {
                    if (response.data !== null && response.data.length > 0) {
                        vm.estadoTramiteC = "con asociación";
                        vm.estadoAjusteCreadoC = true;
                    }
                });
        }
    ...
    angular.module('backbone').component('asociarMuchosUnTipoFormulariop', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/asociarMuchosUnTipo/asociarMuchosUnTipoFormulariop.html",
        controller: asociarMuchosUnTipoFormulariop,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
