(function () {
    ...
    tramiteTrasladoLeyController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteTrasladoLeyController(
        $sessionStorage,
        $scope,
        aclaracionLeyendaServicio,
        constantesBackbone,
        ...
        vm.init = function () {
            ...
            var roles = sesionServicios.obtenerUsuarioIdsRoles();
            var RolAnalistaSinMinuscula = roles.find(x => x === constantesBackbone.idRAnalistaDIFP.toLowerCase());
            if (RolAnalistaSinMinuscula != undefined)
                vm.rolAnalista = RolAnalistaSinMinuscula.toLowerCase() === constantesBackbone.idRAnalistaDIFP.toLowerCase() ? true : false;
       ...
       * */
        vm.handlerComponentes = [
            ...
            { id: 3, componente: 'informacionpresupuestal', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
    ...
    angular.module('backbone').component('tramiteTrasladoLey', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoLey/tramiteTrasladoLey.html",
        controller: tramiteTrasladoLeyController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
