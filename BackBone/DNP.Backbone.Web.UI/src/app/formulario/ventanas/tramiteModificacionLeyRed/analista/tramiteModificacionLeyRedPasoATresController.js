(function () {
    ...
    tramiteModificacionLeyRedPasoATresController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
    ...
    function tramiteModificacionLeyRedPasoATresController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
    ...
    angular.module('backbone').component('tramiteModificacionLeyRedPasoATres', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionLeyRed/analista/tramiteModificacionLeyRedPasoATres.html",
        controller: tramiteModificacionLeyRedPasoATresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
