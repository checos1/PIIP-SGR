(function () {
    ...
    usuariosInvolucradosGestionRecursosSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function usuariosInvolucradosGestionRecursosSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpgraprobaciondefinitivausuariosusuariosinvolucradossgp";
    ...
    angular.module('backbone').component('usuariosInvolucradosGestionRecursosSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/usuariosInvolucradosGestionRecursos/usuariosInvolucradosGestionRecursosSgp.html",
        controller: usuariosInvolucradosGestionRecursosSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
