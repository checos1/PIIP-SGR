(function () {
    ...
    documentoSoporteTramiteTrasladoLeyController.$inject = ['$scope'];

    function documentoSoporteTramiteTrasladoLeyController(
        $scope
    ) {
        var vm = this;
    ...
    angular.module('backbone').component('documentoSoporteTramiteTrasladoLey', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoLey/componentes/documentos/documentoSoporteTramiteTrasladoLey.html",
        controller: documentoSoporteTramiteTrasladoLeyController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
