(function () {
    ...
    conceptosLeyController.$inject = ['$scope', 'aclaracionLeyendaServicio'];

    function conceptosLeyController(
        $scope,
    ...
    angular.module('backbone').component('conceptosLey', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoLey/componentes/conceptosLey/conceptosLey.html",
        controller: conceptosLeyController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
