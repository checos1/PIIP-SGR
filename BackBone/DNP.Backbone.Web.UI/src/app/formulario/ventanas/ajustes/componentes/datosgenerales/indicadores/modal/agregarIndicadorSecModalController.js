(function () {
    ...
    angular.module('backbone')
        .controller('agregarIndicadorSecModalController', agregarIndicadorSecModalController);

    agregarIndicadorSecModalController.$inject = [
        '$scope',
        '$uibModalInstance',
    ...
    function agregarIndicadorSecModalController(
        $scope,
        $uibModalInstance,
        servicioActualizarFechasModal,
        Programacion,
