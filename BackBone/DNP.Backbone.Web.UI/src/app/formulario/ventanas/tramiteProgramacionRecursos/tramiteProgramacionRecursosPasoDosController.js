(function () {
    ...
    tramiteProgramacionRecursosPasoDosController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteProgramacionRecursosPasoDosController(
        $sessionStorage,
        $scope,
        tramiteProgramacionRecursosServicio,
        constantesBackbone,
        ...
        vm.init = function () {
            ...
            if ((vm.IdNivel.toLowerCase() === constantesBackbone.idNivelAprobacionProgramacion.toLowerCase() || vm.IdNivel.toLowerCase() === constantesBackbone.idNivelRevisionConcepto.toLowerCase())) {
    ...
    angular.module('backbone').component('tramiteProgramacionRecursosPasoDos', {
        templateUrl: "src/app/formulario/ventanas/tramiteProgramacionRecursos/tramiteProgramacionRecursosPasoDos.html",
        controller: tramiteProgramacionRecursosPasoDosController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
