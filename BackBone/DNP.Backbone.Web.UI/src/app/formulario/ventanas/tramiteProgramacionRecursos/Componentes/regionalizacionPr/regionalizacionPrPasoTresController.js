(function () {
    ...
    regionalizacionPrPasoTresController.$inject = ['$scope', '$sessionStorage', 'comunesServicio'];

    function regionalizacionPrPasoTresController(
        $scope,
        $sessionStorage,
        comunesServicio
        ...
        vm.nombreComponenteHijo = "regionalizacionregionalizacion";
        vm.notificacionCambiosCapitulos = null;
        vm.calendarioregionalizacion = undefined;

        vm.handlerComponentes = [
            { id: 1, componente: 'regionalizacionregionalizacion', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        vm.handlerComponentesChecked = {};

        vm.initRegionalizacion = function () {
        ...
        function validarVariables() {
            if (vm.IdNivel !== undefined && vm.IdEntidad !== undefined && vm.IdSeccionCapitulo !== undefined)
                vm.verificacalendario({ idEntidad: vm.IdEntidad, idNivel: vm.IdNivel, idSeccionCapitulo: vm.IdSeccionCapitulo, seccion: 'regionalizacion' });
        }
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'regionalizacionregionalizacion': true
            };
        }
    ...
    angular.module('backbone').component('regionalizacionPrPasoTres', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/Componentes/regionalizacionPr/regionalizacionPrPasoTres.html",
        controller: regionalizacionPrPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
