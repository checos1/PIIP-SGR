...
namespace DNP.ServiciosWBS.Test.Servicios
{
    ...
    /// </summary>
    [TestClass]
    public class FocalizacionPoliticasTransversalesTest
    {
        private IPersistenciaTemporal PersistenciaTemporal { get; set; }
        private IAuditoriaServicios AuditoriaServicio { get; set; }
        private IFocalizacionPoliticasTransversalesPersistencia _focalizacionPoliticasTransversalesPersistencia { get; set; }
        private FocalizacionPoliticasTransversalesServicios _focalizacionPoliticasTransversalesServicios { get; set; }
        ...
        public void Init()
        {
            ...
            _focalizacionPoliticasTransversalesPersistencia = contenedor.Resolve<IFocalizacionPoliticasTransversalesPersistencia>();
            PersistenciaTemporal = contenedor.Resolve<IPersistenciaTemporal>();
            AuditoriaServicio = contenedor.Resolve<IAuditoriaServicios>();
            _focalizacionPoliticasTransversalesServicios = new FocalizacionPoliticasTransversalesServicios(_focalizacionPoliticasTransversalesPersistencia, PersistenciaTemporal, AuditoriaServicio);
        ...
        public FocalizacionPoliticasTransversalesTest()
        {
            //
