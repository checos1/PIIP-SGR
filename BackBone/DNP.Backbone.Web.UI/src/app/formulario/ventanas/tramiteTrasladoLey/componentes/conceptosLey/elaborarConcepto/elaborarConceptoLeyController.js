(function () {
    ...
    elaborarConceptoLeyController.$inject = [
        '$sessionStorage',
        'archivoServicios',
        '$scope',
        'servicioAcciones',
    ...
    function elaborarConceptoLeyController(
        $sessionStorage,
        archivoServicios,
        $scope,
        servicioAcciones,
        ...
        */
        ...
        vm.verPdf = function () {
            ...
            tramiteTrasladoOrdinarioServicio.generarPdfCartaTramite(tramiteId, true, 'ConceptoTrasLey');
        }

    }

    angular.module('backbone').component('elaborarConceptoLey', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoLey/componentes/conceptosLey/elaborarConcepto/elaborarConceptoLey.html",
        controller: elaborarConceptoLeyController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
