(function () {
    ...
    ajustesModalAgregarDatosAdicionalesSinTramiteSgpController.$inject = [
        '$sessionStorage',
        '$uibModalInstance',
    ...
    function ajustesModalAgregarDatosAdicionalesSinTramiteSgpController(
        $uibModalInstance,
        $sessionStorage,
        recursosAjustesSinTramiteSgpServicio,
        utilidades
        ...
        function consultarDatos() {
            ...
            return recursosAjustesSinTramiteSgpServicio.obtenerDatosAdicionales(vm.idFuente, usuarioDNP, $uibModalInstance.idInstancia)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        function obtenerTipoCofinanciador() {
            ...
            return recursosAjustesSinTramiteSgpServicio.obtenerTipoCofinanciador(parametros)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        function obtenerFondo() {
            var listaFondos = [];
            return recursosAjustesSinTramiteSgpServicio.obtenerFondos(parametros)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        function obtenerRubro() {
            var listaRubro = [];
            return recursosAjustesSinTramiteSgpServicio.obtenerRubros(parametros)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
                    vm.fondoVisible = false;
        ...
        function buscarProyecto() {
            ...
            return recursosAjustesSinTramiteSgpServicio.obtenerProyectos(parametros, vm.model.BpinBusqueda)
                .then(respuesta => {
                    if (!respuesta.data) {
        ...
        function guardar() {
            ...
            recursosAjustesSinTramiteSgpServicio.agregarDatosAdicionales(params, usuarioDNP, $uibModalInstance.idInstancia, $uibModalInstance.idAccion, $uibModalInstance.idNivel)
        ...
        function eliminarDatoAdicional(cofinanciadorId) {
            ...
            return recursosAjustesSinTramiteSgpServicio.eliminarDatosAdicionales(cofinanciadorId, usuarioDNP, idInstancia)
                .then(function (response) {
                    let exito = response.data;
                    if (exito) {
                        utilidades.mensajeSuccess("Operación realizada con éxito!", false, false, false);
    ...
    angular.module('backbone').controller('ajustesModalAgregarDatosAdicionalesSinTramiteSgpController', ajustesModalAgregarDatosAdicionalesSinTramiteSgpController);
