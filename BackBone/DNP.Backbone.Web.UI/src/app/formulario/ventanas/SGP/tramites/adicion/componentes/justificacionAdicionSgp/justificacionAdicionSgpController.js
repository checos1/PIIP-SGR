(function () {
    ...
    justificacionAdicionSgpController.$inject = ['$scope', '$sessionStorage', 'constantesBackbone'];

    function justificacionAdicionSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone
    ) {
    ...
    angular.module('backbone').component('justificacionAdicionSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/adicion/componentes/justificacionAdicionSgp/justificacionAdicionSgp.html",
        controller: justificacionAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
