namespace DNP.ServiciosWBS.Web.API.Controllers
{
    ...
    public class FocalizacionPoliticasTransversalesFuentesController : ApiController
    {
        private readonly IFocalizacionPoliticasTransversalesFuentesServicios _focalizacionPoliticasTransversalesFuentesServicios;
        private readonly IAutorizacionUtilidades _autorizacionUtilidades;

        public FocalizacionPoliticasTransversalesFuentesController(IFocalizacionPoliticasTransversalesFuentesServicios focalizacionPoliticasTransversalesFuentesServicios, IAutorizacionUtilidades autorizacionUtilidades)
        {
            _focalizacionPoliticasTransversalesFuentesServicios = focalizacionPoliticasTransversalesFuentesServicios;
            _autorizacionUtilidades = autorizacionUtilidades;
        }

        [Route("api/DNP_Focalizacion_FocalizacionPoliticaTFuentesDto")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion Politicas Transversales Fuentes", typeof(FocalizacionPoliticaTFuentesDto))]
        [HttpGet]
        public async Task<IHttpActionResult> Consultar(string bpin)
        {
            try
            {
                ...
                //                                           ConfigurationManager.AppSettings["consultarFocalizacionPoliticaTransversalFuentes"]).
                //                            Result;

                //if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var result =
                    await Task.Run(() => _focalizacionPoliticasTransversalesFuentesServicios.ObtenerFocalizacionPoliticasTransversalesFuentes(new ParametrosConsultaDto { Bpin = bpin }));
        ...
        [Route("api/DNP_Focalizacion_FocalizacionPoliticaTFuentesDto/Preview")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion Politicas Transversales Fuentes dummy", typeof(FocalizacionPoliticaTFuentesDto))]
        [HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           RequestContext.Principal.Identity.GetHashCode().ToString(),
                                                           ConfigurationManager.AppSettings["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["previewPoliticaTransversalFuentes"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var result = await Task.Run(() => _focalizacionPoliticasTransversalesFuentesServicios.ObtenerFocalizacionPoliticasTransversalesFuentesPreview());

                return Ok<FocalizacionPoliticaTFuentesDto>(result);
            }
            catch (AutorizacionException e)
            {
                throw new HttpResponseException(Request.CreateErrorResponse(HttpStatusCode.Unauthorized, e));
        ...
        //[Route("api/DNP_SN_Eje_DatosConceptoDespedidaDto")]
        //[SwaggerResponse(HttpStatusCode.OK, "Informacion guardado definitivo", typeof(HttpResponseMessage))]
        //[HttpPost]
        //public async Task<IHttpActionResult> Definitivo([FromBody] DatosConceptoDespedidaDto datosConceptoDespedida)
        //{
        //    try
        //    {
        //        //var respuestaAutorizacion = _autorizacionUtilidades.
        ...
        //        //                                           RequestContext.Principal.Identity.GetHashCode().ToString(),
        //        //                                           ConfigurationManager.AppSettings["idAdministracionEnAutorizaciones"],
        //        //                                           ConfigurationManager.AppSettings["postCuerpoDatosDespedidaDefinitivo"]).
        //        //                            Result;

        //        //if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

        //        var parametrosGuardar = new ParametrosGuardarDto<DatosConceptoDespedidaDto>();

        //        parametrosGuardar.Contenido = datosConceptoDespedida;
        ...
        //        await Task.Run((Action)(() => _cartaCuerpoDatosDespedidaServicios.Guardar(parametrosGuardar, parametrosAuditoria, false)));
