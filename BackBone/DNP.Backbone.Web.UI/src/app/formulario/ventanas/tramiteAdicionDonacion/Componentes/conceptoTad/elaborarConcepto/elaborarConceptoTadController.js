(function () {
    ...
    elaborarConceptoTadController.$inject = [
        '$sessionStorage',
        'archivoServicios',
        '$scope',
        'servicioAcciones',
        ...
        'utilidades',
        'FileSaver',
        'tramiteAdicionDonacionServicio'
    ];

    function elaborarConceptoTadController(
        $sessionStorage,
        archivoServicios,
        $scope,
        servicioAcciones,
        ...
        */
        ...
        vm.verPdf = function () {
            ...
            tramiteAdicionDonacionServicio.generarPdfCartaTramite(tramiteId, true, 'AdicionDonacion');
        }

    }

    angular.module('backbone').component('elaborarConceptoTad', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/conceptoTad/elaborarConcepto/elaborarConceptoTad.html",
        controller: elaborarConceptoTadController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
