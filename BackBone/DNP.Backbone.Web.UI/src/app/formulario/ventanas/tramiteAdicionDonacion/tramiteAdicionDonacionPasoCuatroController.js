(function () {
    ...
    tramiteAdicionDonacionPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteAdicionDonacionPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteAdicionDonacionPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/tramiteAdicionDonacionPasoCuatro.html",
        controller: tramiteAdicionDonacionPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
