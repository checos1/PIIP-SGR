(function () {
	...
	justificacionIndicadoresSinTramiteSgpController.$inject = [
		'$scope',
		'$sessionStorage',
		'constantesBackbone',
		'justificacionIndicadoresSinTramiteSgpServicio',
		'utilidades',
	...
	function justificacionIndicadoresSinTramiteSgpController(
		$scope,
		$sessionStorage,
		constantesBackbone,
		justificacionIndicadoresSinTramiteSgpServicio,
		...
		function ObtenerSeccionCapitulo() {
			var seccionCapitulo = document.getElementById('id-capitulo-datosgeneralesindicadoresdepr');
			vm.seccionCapitulo = seccionCapitulo.value;
		}
		...
		function ObtenerAjustesIndicadoresPorBpin() {
			return justificacionIndicadoresSinTramiteSgpServicio.IndicadoresValidarCapituloModificado(vm.codigoBpin).then(
				function (respuesta) {
	...
	angular.module('backbone').component('datosgeneralessgpindicadoresdeprsintramitesgp', {
		templateUrl: "src/app/formulario/ventanas/SGP/comun/justificacionCambios/componentes/datosgenerales/justificacionIndicadores/justificacionIndicadoresSinTramiteSgp.html",
		controller: justificacionIndicadoresSinTramiteSgpController,
		controllerAs: "vm",
		bindings: {
