(function () {
    'use strict';
    angular.module('backbone').factory('focalizacionAjustesServicio', focalizacionAjustesServicio);

    focalizacionAjustesServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];

    function focalizacionAjustesServicio($q, $http, $location, constantesBackbone) {
        return {
