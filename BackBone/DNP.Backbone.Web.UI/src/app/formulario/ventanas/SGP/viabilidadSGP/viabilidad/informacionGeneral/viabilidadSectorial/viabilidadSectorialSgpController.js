(function () {
    ...
    viabilidadSectorialSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function viabilidadSectorialSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsgp";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('viabilidadSectorialSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/viabilidadSGP/viabilidad/informacionGeneral/viabilidadSectorial/viabilidadSectorialSgp.html",
        controller: viabilidadSectorialSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
