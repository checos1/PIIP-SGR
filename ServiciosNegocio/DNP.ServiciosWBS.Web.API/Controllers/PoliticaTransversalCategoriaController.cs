namespace DNP.ServiciosWBS.Web.API.Controllers
{
    ...
    public class PoliticaTransversalCategoriaController : ApiController
    {
        private readonly IPoliticaTransversalCategoriaServicios _politicaTransversalCategoriaServicios;
        private readonly IAutorizacionUtilidades _autorizacionUtilidades;

        public PoliticaTransversalCategoriaController(IPoliticaTransversalCategoriaServicios politicaTransversalCategoriaServicios, IAutorizacionUtilidades autorizacionUtilidades)
        {
            _politicaTransversalCategoriaServicios = politicaTransversalCategoriaServicios;
            _autorizacionUtilidades = autorizacionUtilidades;
        }

        [Route("api/DNP_SN_Pla_PriyAsiRec_PoliticaTCategoriasDto")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion de Políticas Transversales - Categorías", typeof(PoliticaTCategoriasDto))]
        [HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings["consultarPoliticaTransversalCategoria"]).
                                            Result;
                ...
                var result =
                    await Task.Run(() => _politicaTransversalCategoriaServicios.ObtenerPoliticaTransversalCategoria(new ParametrosConsultaDto
                    {
                        Bpin =
                                                                                          bpin,
                        AccionId
                ...
                if (result != null) return Ok<PoliticaTCategoriasDto>(result);
        ...
        [Route("api/DNP_SN_Pla_PriyAsiRec_PoliticaTCategoriasDto/Preview")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion de Políticas Transversales - Categorías priview", typeof(PoliticaTCategoriasDto))]
        [HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["previewPoliticaTransversalCategoria"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var result = await Task.Run(() => _politicaTransversalCategoriaServicios.ObtenerPoliticaTransversalCategoriaPreview());

                return Ok<PoliticaTCategoriasDto>(result);
            }
            catch (AutorizacionException e)
            {
                throw new HttpResponseException(Request.CreateErrorResponse(HttpStatusCode.Unauthorized, e));
        ...
        [Route("api/DNP_SN_Pla_PriyAsiRec_PoliticaTCategoriasDto/Temporal")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion devuelta por guardado temporal", typeof(HttpResponseMessage))]
        [HttpPost]
        public async Task<IHttpActionResult> Temporal(PoliticaTCategoriasDto contenido)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["postPoliticaTransversalCategoriaTemporal"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var parametrosGuardar = _politicaTransversalCategoriaServicios.ConstruirParametrosGuardado(Request, contenido);
                ...
                await Task.Run((Action)(() => _politicaTransversalCategoriaServicios.Guardar(parametrosGuardar, parametrosAuditoria, true)));
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Definitivo([FromBody] PoliticaTCategoriasDto proyecto)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings
                                                               ["postPoliticaTransversalCategoriaDefinitivo"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);


                var parametrosGuardar = _politicaTransversalCategoriaServicios.ConstruirParametrosGuardado(Request, proyecto);
                ...
                await Task.Run((Action)(() => _politicaTransversalCategoriaServicios.Guardar(parametrosGuardar, parametrosAuditoria, false)));
