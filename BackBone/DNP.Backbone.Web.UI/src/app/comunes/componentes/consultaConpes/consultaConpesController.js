(function () {
    ...
    consultaConpesController.$inject = [
        '$scope',
        'conpesServicio',
        'utilidades',
    ];

    function consultaConpesController(
        $scope,
        conpesServicio,
        utilidades
    ) {
    ...
    angular.module('backbone').component('consultaConpes', {
        templateUrl: "src/app/comunes/componentes/consultaConpes/consultaConpesController.html",
        controller: consultaConpesController,
        controllerAs: "vm",
        bindings: {
