(function () {
    ...
    elaborarConceptoTrasladoController.$inject = [
        '$sessionStorage',
        'archivoServicios',
        '$scope',
        'servicioAcciones',
    ...
    function elaborarConceptoTrasladoController(
        $sessionStorage,
        archivoServicios,
        $scope,
        servicioAcciones,
        ...
        */
        ...
        vm.verPdf = function () {
            ...
            tramiteTrasladoOrdinarioServicio.generarPdfCartaTramite(tramiteId, true,'ConceptoTraslOrdinario');
        }

    }

    angular.module('backbone').component('elaborarConceptoTraslado', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoOrdinario/componentes/conceptosTraslado/elaborarConcepto/elaborarConceptoTraslado.html",
        controller: elaborarConceptoTrasladoController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
