(function () {
    ...
    tramiteModificacionTrasladoPasoDosController.$inject = [
        '$sessionStorage',
        '$scope',
        ...
        'sesionServicios',
        'trasladosServicio',
        'tramiteModificacionTrasladoServicio',

    ];

    function tramiteModificacionTrasladoPasoDosController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
        ...
        * */
        ...
        function eventoValidar() {
            ...
            tramiteModificacionTrasladoServicio.obtenerErroresProgramacion(vm.instanciaId, vm.accionId).then(function (respuesta) {
    ...
    angular.module('backbone').component('tramiteModificacionTrasladoPasoDos', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionTraslado/presupuestoPrel/tramiteModificacionTrasladoPasoDos.html",
        controller: tramiteModificacionTrasladoPasoDosController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
