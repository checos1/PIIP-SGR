(function () {
    ...
    function cuerpoRvfController(
        ...
        function obtenerDatosIniciales() {
            ...
            cartaServicio.ConsultarCartaConcepto(vm.tramiteId).then(function (response) {
                if (response.statusText === "OK" || response.status === 200) {
                    {
                        vm.fechaRadicado = moment(response.data.FechaModificacion).format("DD/MM/YYYY")
        ...
        function obtenerFechaSinHoras(fecha) {
            ...
            vm.fechaRadicado = moment(fecha).format("DD/MM/YYYY")
        }
    ...
    angular.module('backbone').component('cuerpoRvf', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/Componentes/conceptoRvf/elaborarConcepto/Carta/cuerpoRvf.html",
        controller: cuerpoRvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
