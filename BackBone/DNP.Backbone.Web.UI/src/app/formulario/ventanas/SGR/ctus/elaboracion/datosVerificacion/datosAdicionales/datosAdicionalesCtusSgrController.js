(function () {
    'use strict';
    datosAdicionalesCtusSgrController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function datosAdicionalesCtusSgrController(
        utilidades,
        $sessionStorage,
        requisitosSgrServicio,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "sgrctuselaboraciondatosverificaciondatosadicionales";
    ...
    angular.module('backbone').component('datosAdicionalesCtusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctus/elaboracion/datosVerificacion/datosAdicionales/datosAdicionalesCtusSgr.html",
        controller: datosAdicionalesCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
