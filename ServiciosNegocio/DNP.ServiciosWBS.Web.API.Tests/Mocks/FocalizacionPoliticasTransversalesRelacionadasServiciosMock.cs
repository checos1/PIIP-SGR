...
{
    public class FocalizacionPoliticasTransversalesRelacionadasServiciosMock : IFocalizacionPoliticasTransversalesRelacionadasServicios
    {
        public ParametrosGuardarDto<PoliticaTransversalRelacionadaDto> ConstruirParametrosGuardado(HttpRequestMessage request, PoliticaTransversalRelacionadaDto contenido)
        {
            var parametrosGuardar = new ParametrosGuardarDto<PoliticaTransversalRelacionadaDto>();
        ...
        public void Guardar(ParametrosGuardarDto<PoliticaTransversalRelacionadaDto> parametrosGuardar, ParametrosAuditoriaDto parametrosAuditoria, bool guardarTemporalmente)
        {
        ...
        public PoliticaTransversalRelacionadaDto ObtenerFocalizacionPoliticasTransversalesRelacionadasServicios(ParametrosConsultaDto parametrosConsulta)
        {
            ...
            {
                return new PoliticaTransversalRelacionadaDto()
                {
