(function () {
	...
	justificacionAproFormularioController.$inject = [
		'$sessionStorage',
	...
	function justificacionAproFormularioController(
		$sessionStorage,
		aclaracionLeyendaServicio,
		justificacionCambiosServicio,
		utilidades,
		...
		vm.registrorespuesta = function (response) {
			...
			//			//Quito esto porque este control es solo para mostrar
  ...
  //                  }
	...
	angular.module('backbone').component('justificacionAproFormulario', {
		templateUrl: "src/app/formulario/ventanas/comun/justificacionAprobacion/justificacionAproFormulario.html",
		controller: justificacionAproFormularioController,
		controllerAs: "vm",
		bindings: {
			callback: '&',
			tramiteid: '@',
