(function () {
    ...
    alojarDocumentosRequisitosSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function alojarDocumentosRequisitosSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrviabilidadrequisitossoportes";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrviabilidadrequisitossoportesalojararchivo";
        vm.notificacionCambiosCapitulos = null;
        vm.rol = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadrequisitossoportesalojararchivo', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('alojarDocumentosRequisitosSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/requisitos/soportes/alojarDocumentosRequisitosSgr.html",
        controller: alojarDocumentosRequisitosSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
