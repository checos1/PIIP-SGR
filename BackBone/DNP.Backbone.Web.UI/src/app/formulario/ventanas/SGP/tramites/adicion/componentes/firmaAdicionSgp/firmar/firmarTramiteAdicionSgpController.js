(function () {
    'use strict';
    firmarTramiteAdicionSgpController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function firmarTramiteAdicionSgpController(
        utilidades,
        $sessionStorage,
        justificacionCambiosServicio,
        firmaEmisionTramiteTrasladoSgpServicio,
    ...
    angular.module('backbone').component('firmarTramiteAdicionSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/adicion/componentes/firmaAdicionSgp/firmar/firmarTramiteAdicionSgp.html",
        controller: firmarTramiteAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
