(function () {
    ...
    indicadoresPoliticaController.$inject = [
        '$scope',
        '$sessionStorage',
        'obtenerDatosIndicadoresPoliticaServicio',
        //'obtenerDatosIndicadoresPoliticaServicio2',
        //'blockUI',
        '$anchorScroll',
        '$location'
    ];

    function indicadoresPoliticaController(
        $scope,
        $sessionStorage,
        obtenerDatosIndicadoresPoliticaServicio,
        //obtenerDatosIndicadoresPoliticaServicio2,
        ...
        vm.obtenerDatosIP = function (id) {
            ...
            obtenerDatosIndicadoresPoliticaServicio
                .obtenerDatosIndicadoresPolitica($sessionStorage.idInstancia)
                .then(
                    (respuesta) => {
    ...
    angular.module('backbone').component('indicadoresPolitica', {
        templateUrl: "src/app/formulario/ventanas/gestionRecursos/componentes/indicadoresPolitica/indicadoresPolitica.html",
        controller: indicadoresPoliticaController,
        controllerAs: "vm",
        bindings: {
        }
    });
