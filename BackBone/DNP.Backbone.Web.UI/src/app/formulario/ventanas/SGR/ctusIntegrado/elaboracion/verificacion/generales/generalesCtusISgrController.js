(function () {
    'use strict';
    generalesCtusISgrController.$inject = [
        '$rootScope',
        'utilidades',
        '$sessionStorage',
    ...
    function generalesCtusISgrController(
        $rootScope,
        utilidades,
        $sessionStorage,
        requisitosSgrServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "sgrctusintegradoelaboracionverificacionrequisitos";
    ...
    angular.module('backbone').component('generalesCtusISgr', {
        templateUrl: "src/app/formulario/ventanas/SGR/ctusIntegrado/elaboracion/verificacion/generales/generalesCtusISgr.html",
        controller: generalesCtusISgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
