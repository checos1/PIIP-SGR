(function () {
    'use strict';
    viabilidadViabilidadOcadPazSgrController.$inject = [
        '$scope',
        '$sessionStorage',
        'viabilidadSgrServicio'
    ];

    function viabilidadViabilidadOcadPazSgrController(
        $scope,
        $sessionStorage,
        viabilidadSgrServicio
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrocadpazviabilidad";
        vm.nombreComponenteHijo = "sgrocadpazviabilidadregistrovotos";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrocadpazviabilidadregistrovotos', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrocadpazviabilidadregistrovotos': true
            };
        }
    ...
    angular.module('backbone').component('viabilidadViabilidadOcadPazSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ocadPaz/viabilidad/viabilidad/viabilidadViabilidadOcadPazSgr.html",
        controller: viabilidadViabilidadOcadPazSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
