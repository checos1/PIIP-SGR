(function () {
    'use strict';
    informacionBasicaViabilidadSgrController.$inject = [
        '$sce',
        '$rootScope',
        'utilidades',
        '$sessionStorage',
    ...
    function informacionBasicaViabilidadSgrController(
        $sce,
        $rootScope,
        utilidades,
        $sessionStorage,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgrviabilidadinformaciongeneralinformacionbasica';
        ...
        vm.init = function () {
            var tipoConceptoViabilidad = constantesTipoConceptoViabilidad.Viabilidad;
        ...
        vm.guardar = function (response) {
            ...
            if (vm.data.SectorApoyo1Id === undefined) vm.data.SectorApoyo1Id = 44;
            if (vm.data.SectorApoyo2Id === undefined) vm.data.SectorApoyo2Id = 44;
    ...
    angular.module('backbone').component('informacionBasicaViabilidadSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/viabilidad/informacionGeneral/informacionBasica/informacionBasicaViabilidadSgr.html",
        controller: informacionBasicaViabilidadSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
