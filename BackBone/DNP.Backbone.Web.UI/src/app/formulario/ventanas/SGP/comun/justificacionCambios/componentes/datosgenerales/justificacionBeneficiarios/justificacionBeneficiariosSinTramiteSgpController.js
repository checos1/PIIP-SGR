(function () {
    ...
    justificacionBeneficiariosSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
        'justificacionBeneficiariosSinTramiteSgpServicio',
    ...
    function justificacionBeneficiariosSinTramiteSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        justificacionBeneficiariosSinTramiteSgpServicio,
        ...
        function Guardar(idTab) {
            ...
            var seccionCapituloId = document.getElementById("id-capitulo-datosgeneralessgpbeneficiariosTotalessintramitesgp");
        ...
        vm.ObtenerbeneficiariosTotales = function (bpin) {
            ...
            return justificacionBeneficiariosSinTramiteSgpServicio.ObtenerbeneficiariosTotales(bpin, usuarioDNP, idInstancia).then(
                function (respuesta) {
                    if (respuesta.data != null && respuesta.data != "") {
                        vm.beneficiariosTotales = jQuery.parseJSON(jQuery.parseJSON(respuesta.data));
                        vm.justificaciones = vm.beneficiariosTotales.BeneficiariosProducto[0].CatalogoInterventionLocalizationType;
                        vm.justificacionBeneficiarioProducto = vm.justificaciones[2].Observaciones;
                        document.getElementById("justificacionBeneficiarioProducto").value = vm.justificacionBeneficiarioProducto;
                    }
                });
        };

        vm.opJustificacion = function (id) {
            return vm.justificaciones[id - 1];   
        }
        ...
        vm.obtenerJustificacion = function () {
            setTimeout(function () {
                ...
                vm.seccionCapituloId = 903;
                return justificacionBeneficiariosSinTramiteSgpServicio.obtenerCapitulosModificados(vm.guiMacroproceso, vm.idProyecto, vm.idInstancia, vm.seccionCapituloId).then(
                    function (respuesta) {
                        if (respuesta.data != null && respuesta.data != "") {
                            try {
                            ...
                            if (document.getElementById("justificacionBeneficiarioTotal") != null) {
                                document.getElementById("justificacionBeneficiarioTotal").value = vm.justificacionesBeneficiarios.Total;
                                
                            }
                            if (document.getElementById("justificacionBeneficiarioProducto") != null) {
                                document.getElementById("justificacionBeneficiarioProducto").value = vm.justificacionesBeneficiarios.Producto;
                                document.getElementById("justificacionBeneficiarioProducto").value = vm.justificacionBeneficiarioProducto;
                                console.log("Este es el producto");
                                console.log(vm.justificacionesBeneficiarios.Producto);
                            }
                            if (document.getElementById("justificacionBeneficiarioLocalizacion") != null) {
                                document.getElementById("justificacionBeneficiarioLocalizacion").value = vm.justificacionesBeneficiarios.Localizacion;
                            }                                                        
                        }
                        else {
        ...
        vm.limpiarErrores = function () {
            var campoObligatorioJustificacionLoc = document.getElementById("justificacionBeneficiariosSinTramiteSgp-justificacion-error");
            var ValidacionJustificacionLoc = document.getElementById("justificacionBeneficiariosSinTramiteSgp-justificacion-error-mns");
            ...
            var campoObligatorioJustificacionLocP = document.getElementById("justificacionBeneficiariosSinTramiteSgp-justificacionP-error");
            var ValidacionJustificacionLocP = document.getElementById("justificacionBeneficiariosSinTramiteSgp-justificacionP-error-mns");
            ...
            var campoObligatorioJustificacionLocL = document.getElementById("justificacionBeneficiariosSinTramiteSgp-justificacionL-error");
            var ValidacionJustificacionLocL = document.getElementById("justificacionBeneficiariosSinTramiteSgp-justificacionL-error-mns");
    ...
    angular.module('backbone').component('datosgeneralessgpbeneficiariostotalessintramitesgp', {

        templateUrl: "src/app/formulario/ventanas/SGP/comun/justificacionCambios/componentes/datosgenerales/justificacionBeneficiarios/justificacionBeneficiariosSinTramiteSgp.html",
        controller: justificacionBeneficiariosSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
