(function () {
    ...
    informacionGeneralCtusSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function informacionGeneralCtusSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrctuselaboracioninfogeneral";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrctuselaboracioninfogeneralinfobasica";
        vm.notificacionCambiosCapitulos = null;
        vm.rol = '00000000-0000-0000-0000-000000000000';
        vm.tipoConceptoViabilidadId = 2;
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";

        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctuselaboracioninfogeneralinfobasica', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrctuselaboracioninfogeneralconceptospreviosemitidos', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'sgrctuselaboracioninfogeneralusuariosinvolucrados', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrctuselaboracioninfogeneralinfobasica': true,
                'sgrctuselaboracioninfogeneralconceptospreviosemitidos': true,
                'sgrctuselaboracioninfogeneralusuariosinvolucrados': true
            };
        }
    ...
    angular.module('backbone').component('informacionGeneralCtusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctus/elaboracion/informacionGeneral/informacionGeneralCtusSgr.html",
        controller: informacionGeneralCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
