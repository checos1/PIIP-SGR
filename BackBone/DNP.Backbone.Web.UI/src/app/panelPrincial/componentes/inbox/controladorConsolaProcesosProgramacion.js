(function () {
    'use strict';
    angular.module('backbone').controller('consolaprocesosprogramacionController', consolaprocesosprogramacionController);

    consolaprocesosprogramacionController.$inject = [
        '$scope',
    ...
    function consolaprocesosprogramacionController(
        $scope,
        servicioPanelPrincipal,
        $uibModal,
        $log,
        ...
        function cargarEntidades(idObjeto) {
            ...
            return servicioPanelPrincipal.obtenerProgramacionConsolaProcesos(vm.peticionObtenerInbox, vm.tramiteFiltro, columnasVisibles).then(
                function (respuesta) {
                    // ReSharper disable once UndeclaredGlobalVariableUsing
                            ...
                            entidad.GrupoTramites.forEach(tramite => {
                                ...
                                tramite.ListaTramites.forEach(instancia => {
                                    ...
                                    vm.listaTramitesCompleta.push({
                                        ...
                                        permiteEliminar: (!valorDeshabilitar)
                                    });
    ...
    angular.module('backbone')
        .component('consolaprocesosprogramacion', {
            templateUrl: "/src/app/panelPrincial/componentes/inbox/consolaprocesosprogramacion.template.html",
            controller: 'consolaprocesosprogramacionController',
            controllerAs: 'vm'
        });
