namespace DNP.ServiciosWBS.Web.API.Tests.Mocks
{
    ...
    public class AjustesPoliticaTransversalCategoriaServiciosMock : IAjustesPoliticaTransversalCategoriaServicios
    {
        public AjustesPoliticaTCategoriasDto ObtenerAjustesPoliticaTransversalCategoria(ParametrosConsultaDto parametrosConsulta)
        {
            if (parametrosConsulta.Bpin == "202000000000005")
            {
                return new AjustesPoliticaTCategoriasDto()
                {
                    Politicas = new List<PoliticaAjustesPoliticaCategoriaDto>()
                                       {
                                           new PoliticaAjustesPoliticaCategoriaDto()
                                       }
                };
            }
        ...
        public ParametrosGuardarDto<AjustesPoliticaTCategoriasDto> ConstruirParametrosGuardado(
            HttpRequestMessage request, AjustesPoliticaTCategoriasDto contenido)
        {
            var parametrosGuardar = new ParametrosGuardarDto<AjustesPoliticaTCategoriasDto>();
        ...
        public void Guardar(ParametrosGuardarDto<AjustesPoliticaTCategoriasDto> parametrosGuardar, ParametrosAuditoriaDto parametrosAuditoria,
