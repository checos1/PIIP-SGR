(function () {
    ...
    tramiteAdicionDonacionController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteAdicionDonacionController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteAdicionDonacion', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/tramiteAdicionDonacion.html",
        controller: tramiteAdicionDonacionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
