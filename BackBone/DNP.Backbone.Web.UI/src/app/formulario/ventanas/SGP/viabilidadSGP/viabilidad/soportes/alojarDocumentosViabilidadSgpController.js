(function () {
    ...
    alojarDocumentosViabilidadSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function alojarDocumentosViabilidadSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponenteHijo = "sgpviabilidadsoportesalojararchivossgp";
        vm.notificacionCambiosCapitulos = null;
        vm.rol = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'sgpviabilidadsoportesalojararchivossgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        vm.handlerComponentesChecked = {};

        vm.init = function () {
            var accionViabilidad = $sessionStorage.listadoAccionesTramite.find(f => f.Ventana == 'viabilidadSgp');
    ...
    angular.module('backbone').component('alojarDocumentosViabilidadSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/viabilidadSGP/viabilidad/soportes/alojarDocumentosViabilidadSgp.html",
        controller: alojarDocumentosViabilidadSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
