(function () {
    'use strict';
    angular.module('backbone').factory('ajustesProyectoConTramiteSgpServicio', ajustesProyectoConTramiteSgpServicio);

    ajustesProyectoConTramiteSgpServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];

    function ajustesProyectoConTramiteSgpServicio($q, $http, $location, constantesBackbone) {
        return {
