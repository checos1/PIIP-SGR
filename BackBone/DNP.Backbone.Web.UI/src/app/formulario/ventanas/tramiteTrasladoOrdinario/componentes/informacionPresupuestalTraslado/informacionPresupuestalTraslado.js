(function () {
    ...
    informacionPresupuestalTraslado.$inject = [
        '$sessionStorage',
        'utilidades',
        '$scope',
        'constantesBackbone'
    ...
    function informacionPresupuestalTraslado(
        $sessionStorage,
        utilidades,
        $scope,
        constantesBackbone
    ...
    angular.module('backbone').component('informacionPresupuestalTraslado', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoOrdinario/componentes/informacionPresupuestalTraslado/informacionPresupuestalTraslado.html",
        controller: informacionPresupuestalTraslado,
        controllerAs: "vm",
        bindings: {
            callback: '&',
