(function () {
    ...
    focalizacionAjustesController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
    ...
    function focalizacionAjustesController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        focalizacionAjustesServicio
        ...
        vm.nombreComponente = "focalizacionpol";
        vm.handlerComponentes = [
            { id: 1, componente: 'focalizacionpolpoliticastransv', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'focalizacionpolresumendefocali', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'focalizacionpolcrucedepolitica', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 4, componente: 'focalizacionresumen', handlerValidacion: null, handlerCambios: null, esValido: true },           
            { id: 5, componente: 'focalizacionpolSolicitarConAju', handlerValidacion: null, handlerCambios: null, esValido: true }
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'focalizacionpolpoliticastransv': true,
                'focalizacionpolresumendefocali': true,
                'focalizacionpolcrucedepolitica': true,
                'focalizacionresumen': true,
                'focalizacionpolSolicitarConAju': true
            };
        }
    ...
    angular.module('backbone').component('focalizacionAjustes', {
        templateUrl: "src/app/formulario/ventanas/ajustes/componentes/focalizacion/focalizacionAjustes.html",
        controller: focalizacionAjustesController,
        controllerAs: "vm",
        bindings: {
