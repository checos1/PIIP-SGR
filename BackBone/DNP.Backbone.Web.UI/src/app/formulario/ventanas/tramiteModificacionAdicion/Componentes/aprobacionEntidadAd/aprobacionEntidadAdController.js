(function () {
    ...
    aprobacionEntidadAdController.$inject = ['$scope',];

    function aprobacionEntidadAdController(
        $scope,
    ...
    angular.module('backbone').component('aprobacionEntidadAd', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionAdicion/Componentes/aprobacionEntidadAd/aprobacionEntidadAd.html",

        controller: aprobacionEntidadAdController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
