(function () {
    ...
    regionalizacionSgrController.$inject = [
        '$scope',
        '$sessionStorage'
    ];
    ...
    function regionalizacionSgrController(
        $scope,
        $sessionStorage
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrviabilidadpreviosregionalizacion";
        vm.nombreComponenteHijo = "sgrviabilidadpreviosregionalizacionregionalizacion";
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";
        vm.erroresComponente = [];
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadpreviosregionalizacionregionalizacion', handlerValidacion: null, handlerCambios: null, esValido: true },            
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadpreviosregionalizacionregionalizacion': true
            };
        }
    ...
    angular.module('backbone').component('regionalizacionSgr', {

        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/previos/regionalizacion/regionalizacionSgr.html",

        controller: regionalizacionSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
