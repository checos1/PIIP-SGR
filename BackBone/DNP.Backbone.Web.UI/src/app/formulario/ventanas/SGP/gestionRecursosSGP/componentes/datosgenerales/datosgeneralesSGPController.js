(function () {
    ...
    datosgeneralesSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
    ...
    function datosgeneralesSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        gestionRecursosSGPServicio
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgpsolicitudrecursosdatosgenerales";
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";
        vm.seccionCapitulo = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'sgpsolicitudrecursosdatosgeneraleslocalizacionsgp', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpsolicitudrecursosdatosgeneraleslocalizacionsgp': true,
            };
        }
      ...
      */
        ...
        */
        ...
        function ObtenerSeccionCapitulo() {
            const span = document.getElementById('id-capitulo-sgpsolicitudrecursosdatosgeneraleslocalizacionsgp');
    ...
    angular.module('backbone').component('datosgeneralesSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/datosGenerales/datosgeneralesSgp.html",
        controller: datosgeneralesSgpController,
        controllerAs: "vm",
        bindings: {
            notificacioncambios: '&',
