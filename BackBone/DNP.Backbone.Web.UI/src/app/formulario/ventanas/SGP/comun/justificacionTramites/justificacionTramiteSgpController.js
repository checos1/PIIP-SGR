(function () {
	...
	justificacionTramiteSgpController.$inject = [
		'$sessionStorage',
	...
	function justificacionTramiteSgpController(
		$sessionStorage,
		aclaracionLeyendaServicio,
		justificacionCambiosServicio,
		utilidades,
		...
		this.nombreComponente = "justificacionsgpjustificaciontramitesgp";
		...
		vm.validarValoresVigenciaInformacionPresupuestalPregunta = function (errores) {
			...
			if (campoObligatorioJustificacion != undefined) {
				campoObligatorioJustificacion.innerHTML = "<span class='d-inline-block ico-advertencia'></span>El campo es de obligatorio diligenciamiento<span></span>";
				campoObligatorioJustificacion.classList.remove('hidden');
			}
			var idSpanAlertComponent = document.getElementById("alert-Justificaciondet");
			if (idSpanAlertComponent != undefined) {
	...
	angular.module('backbone').component('justificacionTramiteSgp', {
		templateUrl: "src/app/formulario/ventanas/SGP/comun/justificacionTramites/justificacionTramiteSgp.html",
		controller: justificacionTramiteSgpController,
		controllerAs: "vm",
		bindings: {
			callback: '&',
			tramiteid: '@',
