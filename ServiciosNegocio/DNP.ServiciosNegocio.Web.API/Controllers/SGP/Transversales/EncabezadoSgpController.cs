...
namespace DNP.ServiciosNegocio.Web.API.Controllers.SGP.Transversales
{
    public class EncabezadoSgpController : ApiController
    {
        private readonly ITransversalServicioSGP _datosServiciosSGP;
        private readonly IAutorizacionUtilidades _autorizacionUtilidades;

        public EncabezadoSgpController(IAutorizacionUtilidades autorizacionUtilidades, ITransversalServicioSGP datosServiciosSGP)
        {
            _datosServiciosSGP = datosServiciosSGP;
            _autorizacionUtilidades = autorizacionUtilidades;
        }

        [Route("api/SGP/Encabezado/LeerEncabezado")]
        [SwaggerResponse(HttpStatusCode.OK, "Lee la información del encabezado de un proyecto de SGR.", typeof(string))]
        [HttpPost]
        public async Task<IHttpActionResult> ObtenerEncabezadoSGP([FromBody] ParametrosEncabezadoSGP parametros)
        {
            try
            {
                ...
                var result = await Task.Run(() => _datosServiciosSGP.ObtenerEncabezadoSGP(parametros));
