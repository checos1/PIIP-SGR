(function () {
    ...
    modificacionLeyCreditosPasoTresAController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
    ...
    function modificacionLeyCreditosPasoTresAController(
        $scope,
        $sessionStorage,
        utilidades,
        modificacionLeyServicio
    ...
    angular.module('backbone').component('modificacionLeyCreditosPasoTresA', {

        templateUrl: "src/app/formulario/ventanas/comun/modificacionLey/creditos/modificacionLeyCreditosPasoTresA.html",
        controller: modificacionLeyCreditosPasoTresAController,
        controllerAs: "vm",
        bindings: {
            tramiteproyectoid: '@',
            origen: '@',
