(function () {
    ...
    tramiteModificacionTrasladoDPasoTresController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionTrasladoDPasoTresController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
        ...
        * */
        vm.handlerComponentes = [
            ...
            //{ id: 6, componente: 'aprobacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
    ...
    angular.module('backbone').component('tramiteModificacionDTrasladoPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/presupuestoPrel/tramiteModificacionDTrasladoPasoTres.html",
        controller: tramiteModificacionTrasladoDPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
