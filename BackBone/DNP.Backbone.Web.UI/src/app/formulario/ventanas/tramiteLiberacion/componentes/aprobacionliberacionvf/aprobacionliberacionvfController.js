(function () {
    ...
    aprobacionliberacionvfController.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function aprobacionliberacionvfController(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
        ...
        //Validaciones
        vm.nombreComponente = "aprobacionlbvf";

        vm.handlerComponentes = [
            { id: 1, componente: 'aprobacionlbvfaprobacionvalvf', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'aprobacionlbvfresumenlibvf', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'aprobacionlbvfaprobacionvalvf': true,
                'aprobacionlbvfresumenlibvf': true
            };
        }
    ...
    angular.module('backbone').component('aprobacionlbvf', {
        templateUrl: "src/app/formulario/ventanas/tramiteLiberacion/componentes/aprobacionliberacionvf/aprobacionliberacionvf.html",
        controller: aprobacionliberacionvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
