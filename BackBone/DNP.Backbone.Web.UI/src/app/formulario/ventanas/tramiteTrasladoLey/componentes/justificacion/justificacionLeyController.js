(function () {
    ...
    justificacionLeyController.$inject = ['$scope', '$sessionStorage', 'constantesBackbone'];

    function justificacionLeyController(
        $scope,
        $sessionStorage,
        constantesBackbone
    ...
    angular.module('backbone').component('justificacionLey', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoLey/componentes/justificacion/justificacionLey.html",
        controller: justificacionLeyController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
