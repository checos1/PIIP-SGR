(function () {
    ...
    justificacionTadPasoTresController.$inject = [
        '$scope',

    ];

    function justificacionTadPasoTresController(
        $scope,
    ...
    angular.module('backbone').component('justificacionTadPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/justificacionTad/justificacionTadPasoTres.html",
                   
               
        controller: justificacionTadPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
