(function () {
    ...
    justificacionTrasladoController.$inject = ['$scope', '$sessionStorage','constantesBackbone'];

    function justificacionTrasladoController(
        $scope,
        $sessionStorage,
        constantesBackbone
    ) {
    ...
    angular.module('backbone').component('justificacionTraslado', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoOrdinario/componentes/justificacion/justificacionTraslado.html",
        controller: justificacionTrasladoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
