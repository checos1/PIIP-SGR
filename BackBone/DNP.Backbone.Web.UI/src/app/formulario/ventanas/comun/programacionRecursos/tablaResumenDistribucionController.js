(function () {
    ...
    tablaResumenDistribucionController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
        '$timeout',
    ...
    function tablaResumenDistribucionController(
        $scope,
        $sessionStorage,
        utilidades,
        $timeout,
                ...
                return comunesServicio.ObtenerDatosProgramacionEncabezado(vm.EntidadDestinoId, vm.tramiteid, vm.section).then(
                    function (respuesta) {
                        if (respuesta.data !== '') {
                            ...
                            vm.TotalSaldo = vm.TotalCuotaComunicada - vm.TotalDistribucionCuotaComunicada;
                        }
                        else {
                            $scope.datos = [];
                        }
    ...
    angular.module('backbone').component('tablaResumenDistribucion', {

        templateUrl: "src/app/formulario/ventanas/comun/programacionRecursos/tablaResumenDistribucion.html",
        controller: tablaResumenDistribucionController,
        controllerAs: "vm",
        bindings: {
            guardadoevent: '&',
            notificacioncambios: '&',
