(function () {
    ...
    reprogramacionvigfuturaController.$inject = ['$scope', 'comunesServicio', '$sessionStorage'];

    function reprogramacionvigfuturaController(
        $scope,
        comunesServicio,
        $sessionStorage
    ) {
        var vm = this;
        vm.habilitaconpes = 0;
        vm.nombreComponente = "reprogramacionvf";
        vm.nombreComponenteHijo = "reprogramacionvfreprogramacionporproducto";
        vm.notificacionCambiosCapitulos = null;
        vm.vigenciaAdicionada = '0';

        vm.handlerComponentes = [
            { id: 1, componente: 'reprogramacionvfreprogramacionporvigencia', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'reprogramacionvfreprogramacionporproducto', handlerValidacion: null, handlerCambios: null, esValido: true },
            //{ id: 3, componente: 'reprogramacionvfcronograma', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'reprogramacionvfreprogramacionporvigencia': true,
                'reprogramacionvfreprogramacionporproducto_padre': true,
                'reprogramacionvfcronograma': true,
            };
        }
    ...
    angular.module('backbone').component('reprogramacionvigfutura', {
        templateUrl: "/src/app/formulario/ventanas/ajustesConTramite/componentes/reprogramacion/reprogramacionvigfutura.html",
        controller: reprogramacionvigfuturaController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
