(function () {
    ...
    aprobacionGrController.$inject = ['$scope', 'gestionRecursosServicio', '$sessionStorage', 'utilidades', 'constantesBackbone'];

    function aprobacionGrController(
        $scope,
        ...
        var vm = this;
        vm.nombreComponente = "aprobaciongr";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'aprobaciongraprobaciongr', handlerValidacion: null, handlerCambios: null, esValido: true },
    ...
    angular.module('backbone').component('aprobacionGr', {
        templateUrl: "src/app/formulario/ventanas/gestionRecursos/componentes/recursos/aprobaciongr/aprobaciongr.html",
        controller: aprobacionGrController,
        controllerAs: "vm",
        bindings: {
