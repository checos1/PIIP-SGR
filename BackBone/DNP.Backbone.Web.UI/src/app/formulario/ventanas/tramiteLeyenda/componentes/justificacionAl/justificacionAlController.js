(function () {
    ...
    justificacionAlController.$inject = ['$scope',];

    function justificacionAlController(
        $scope,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'justificacionjustificacionmo', handlerValidacion: null, handlerCambios: null, esValido: true },
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'justificacionjustificacionmo': true,
            };
        }
    ...
    angular.module('backbone').component('justificacionAl', {
        templateUrl: "src/app/formulario/ventanas/tramiteLeyenda/componentes/justificacionAl/justificacionAl.html",
        controller: justificacionAlController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
