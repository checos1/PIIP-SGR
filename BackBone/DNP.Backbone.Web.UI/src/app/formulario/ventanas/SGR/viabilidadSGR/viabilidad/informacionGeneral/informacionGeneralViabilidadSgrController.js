(function () {
    ...
    informacionGeneralViabilidadSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function informacionGeneralViabilidadSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrviabilidadinformaciongeneral";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrviabilidadinformaciongeneralinformacionbasica";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadinformaciongeneralinformacionbasica', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrviabilidadinformaciongeneralconceptospreviosemitidos', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'sgrviabilidadinformaciongeneralusuariosinvolucrados', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadinformaciongeneralinformacionbasica': true,
                'sgrviabilidadinformaciongeneralconceptospreviosemitidos': true,
                'sgrviabilidadinformaciongeneralusuariosinvolucrados': true
            };
        }
    ...
    angular.module('backbone').component('informacionGeneralViabilidadSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/viabilidad/informacionGeneral/informacionGeneralViabilidadSgr.html",
        controller: informacionGeneralViabilidadSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
