(function () {
    ...
    firmaEmisionTramiteTrasladoSgpController.$inject = [
        '$scope',
        '$location',
        'utilidades',
        '$sessionStorage',
    ...
    function firmaEmisionTramiteTrasladoSgpController(
        $scope,
        $location,
        utilidades,
        $sessionStorage,
        ...
        vm.section = "sgpfirmaresponsablestramite";
        vm.BPIN = undefined;
       ...
       * */
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpfirmaresponsablestramite', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [], esValido: true, errores: null }            
        ];
        ...
        vm.inicializarComponenteCheck = function (estado) {
            ...
            vm.handlerComponentesChecked = {
                'sgpfirmaresponsablestramite': true
            };
        }
    ...
    angular.module('backbone').component('firmaEmisionTramiteTrasladoSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/traslado/firmaEmisionTramiteTrasladoSgp.html",
        controller: firmaEmisionTramiteTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
