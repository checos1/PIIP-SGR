(function () {
    ...
    aprobacionEntidadTrController.$inject = ['$scope',];

    function aprobacionEntidadTrController(
        $scope,
    ...
    angular.module('backbone').component('aprobacionEntidadTr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionTraslado/Componentes/aprobacionEntidadTr/aprobacionEntidadTr.html",

        controller: aprobacionEntidadTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
