(function () {
    ...
    usuariosInvolucradosSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function usuariosInvolucradosSinTramiteSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpviabilidadviabilidadInformacionBasicausuariosinvolucradossintramitesgp";
    ...
    angular.module('backbone').component('usuariosInvolucradosSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/viabilidadAjustesSinTramite/informacionGeneral/usuariosInvolucrados/usuariosInvolucradosSinTramiteSgp.html",
        controller: usuariosInvolucradosSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
