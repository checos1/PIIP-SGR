(function () {
    ...
    documentoSoporteTramiteDistribucionController.$inject = ['$scope'];

    function documentoSoporteTramiteDistribucionController(
        $scope
    ) {
        var vm = this;
    ...
    angular.module('backbone').component('documentoSoporteTramiteDistribucion', {
        templateUrl: "src/app/formulario/ventanas/tramiteDistribucion/componentes/documentos/documentoSoporteTramiteDistribucion.html",
        controller: documentoSoporteTramiteDistribucionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
