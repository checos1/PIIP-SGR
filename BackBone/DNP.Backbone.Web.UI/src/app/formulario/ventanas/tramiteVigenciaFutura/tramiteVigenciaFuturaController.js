(function () {
    ...
    tramiteVigenciaFuturaController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteVigenciaFuturaController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteVigenciaFutura', {
        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/tramiteVigenciaFutura.html",
        controller: tramiteVigenciaFuturaController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
