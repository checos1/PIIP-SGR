(function () {
    ...
    alojarDocumentosPriorizacionSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function alojarDocumentosPriorizacionSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrpriorizacionm1soportes";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrpriorizacionm1soportesalojararchivo";
        vm.notificacionCambiosCapitulos = null;
        vm.rol = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'sgrpriorizacionm1soportesalojararchivo', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('alojarDocumentosPriorizacionSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/Priorizacion/M1/soportes/alojarDocumentosPriorizacionSgr.html",
        controller: alojarDocumentosPriorizacionSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
