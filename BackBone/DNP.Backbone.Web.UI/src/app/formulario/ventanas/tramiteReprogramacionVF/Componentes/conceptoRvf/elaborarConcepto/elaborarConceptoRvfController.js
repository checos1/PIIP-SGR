(function () {
    ...
    elaborarConceptoRvfController.$inject = [
        '$sessionStorage',
        'archivoServicios',
        '$scope',
        'servicioAcciones',
    ...
    function elaborarConceptoRvfController(
        $sessionStorage,
        archivoServicios,
        $scope,
        servicioAcciones,
        ...
        function initElaborarConcepto() {
            $scope.$watch('vm.tramiteid', function () {
                if (vm.tramiteid !== '' && vm.tramiteid !== undefined && vm.tramiteid !== null) {
                    ...
                    vm.rolAnalista = vm.rolanalista == 'true' ? true : false;
                }
            });
            vm.novalidarconcepto = true;
            //Validaciones
        ...
        */
        ...
        vm.verPdf = function () {
            ...
            tramiteReprogramacionVfServicio.generarPdfCartaTramite(tramiteId, true, 'ReprogramacionVF');
        }

    }

    angular.module('backbone').component('elaborarConceptoRvf', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/Componentes/conceptoRvf/elaborarConcepto/elaborarConceptoRvf.html",
        controller: elaborarConceptoRvfController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
