(function () {
    ...
    documentosSoporteViController.$inject = ['$scope','$sessionStorage'];

    function documentosSoporteViController(
        $scope,
        $sessionStorage,
    ...
    angular.module('backbone').component('documentosSoporteVi', {
        templateUrl: "src/app/formulario/ventanas/viabilidad/componentes/documentosSoporteVi/documentosSoporteVi.html",
        controller: documentosSoporteViController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
