(function () {
    ...
    firmaEmisionSinTramiteSgpController.$inject = [
        '$scope',
        '$location',
        'utilidades',
        '$sessionStorage',
        'firmaEmisionSinTramiteSgpServicio',
    ...
    function firmaEmisionSinTramiteSgpController(
        $scope,
        $location,
        utilidades,
        $sessionStorage,
        ...
        * */
        ...
        function eventoValidar() {
            ...
            firmaEmisionSinTramiteSgpServicio.obtenerErroresviabilidadSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {
                ...
                firmaEmisionSinTramiteSgpServicio.SGR_Viabilidad_ValidarCargueDocumentoObligatorio(dataArchivo, "tramites").then(function (response) {
                    if (respuesta.data) {
                        ...
                        var findErrors = respuesta.data.findIndex(p => p.Errores != null && p.Seccion != 'recursos');
                        var error = respuesta.data.findIndex(p => p.Errores != null && p.Seccion != '' && p.Seccion != 'recursos');
    ...
    angular.module('backbone').component('firmaEmisionSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/firmaEmisionSinTramiteSgp.html",
        controller: firmaEmisionSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
