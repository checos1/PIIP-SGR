(function (root, factory) {
    ...
    angular.module('schemaForm').provider('sfErrorMessage', function () {
        ...
        var defaultMessages = {
            ...
            0: 'Tipo inválido',
            1: 'No hay enum que corresponda con: {value}',
            10: 'Los datos no corresponden con ningún esquema de "anyOf"',
            11: 'Los datos no corresponden con ningún esquema de "oneOf"',
            12: 'Los datos son válidos contra más de un esquema de "oneOf"',
            13: 'Los datos se corresponden con el esquema de "not"',
            // Numeric errors
            100: 'El valor {{viewValue}} no es múltiplo de {{schema.multipleOf}}',
            101: '{{viewValue}} es inferior al mínimo {{schema.minimum}}',
            102: '{{viewValue}} es igual que el mínimo exclusivo {{schema.minimum}}',
            103: '{{viewValue}} es mayor que el máximo {{schema.maximum}}',
            104: '{{viewValue}} es igual que el máximo exclusivo {{schema.maximum}}',
            105: 'El valor {{viewValue}} no es un número válido',
            // String errors
            200: 'La cadena es demasiado corta ({{viewValue.length}} chars), mínimo {{schema.minLength}}',
            201: 'Excede el tamaño máximo. {{schema.maxLength}} caracteres.',
            202: 'Formato de campo inválido.',
            // Object errors
            300: 'No se han definido suficientes propiedades, mínimo {{schema.minProperties}}',
            301: 'Se han definido demasiadas propiedades, máximo {{schema.maxProperties}}',
            302: 'Campo requerido',
            303: 'No se permiten propiedades adicionales',
            304: 'Dependencia fallida - debe existir la clave',
            // Array errors
            400: 'Array demasiado corto ({{value.length}}), mínimo {{schema.minItems}}',
            401: 'Array demasiado largo ({{value.length}}), máximo {{schema.maxItems}}',
            402: 'Elementos de array no únicos',
            403: 'Elementos adicionales no permitidos',
            // Format errors
            500: 'Fallo en la validación del formato ',
            501: 'Fallo en la palabra clave: "{{title}}"',
            // Schema structure
            600: 'Referencia $refs Circular',
            // Non-standard validation options
            1000: 'Propiedad desconocida (no existe en el esquema)'
        };
