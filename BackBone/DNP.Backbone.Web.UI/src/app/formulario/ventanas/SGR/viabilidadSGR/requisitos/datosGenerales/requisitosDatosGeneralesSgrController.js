(function () {
    ...
    requisitosDatosGeneralesSgrController.$inject = ['$scope', 'utilidades', '$sessionStorage'];

    function requisitosDatosGeneralesSgrController(
        $scope,
        utilidades,
        $sessionStorage,        
    ) {
        var vm = this;
        vm.nombreComponente = "sgrviabilidadrequisitosdatosgenerales";
        vm.nombreComponenteHijo = "sgrviabilidadrequisitosdatosgeneralesdatosinicialesverificacion";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadrequisitosdatosgeneralesdatosinicialesverificacion', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrviabilidadrequisitosdatosgeneralesagregarsectores', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'sgrviabilidadrequisitosdatosgeneralesdatosadicionalesverificacion', handlerValidacion: null, handlerCambios: null, esValido: true }
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadrequisitosdatosgeneralesdatosinicialesverificacion': true,
                'sgrviabilidadrequisitosdatosgeneralesdatosadicionalesverificacion': true,
                'sgrviabilidadrequisitosdatosgeneralesagregarsectores': true
            };
        }
        ...
        */
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (erroresList.length > 0) {
                ...
                var campomensajeerror2 = document.getElementById("alert-sgrviabilidadrequisitosdatosgeneralesdatosadicionalesverificacion");
    ...
    angular.module('backbone').component('requisitosDatosGeneralesSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/requisitos/datosGenerales/requisitosDatosGeneralesSgr.html",

        controller: requisitosDatosGeneralesSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
