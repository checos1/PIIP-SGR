(function () {
    ...
    aprobacionEntidadDTrController.$inject = ['$scope',];

    function aprobacionEntidadDTrController(
        $scope,
        ...
        vm.nombreComponenteHijo = "aprobacionconfirmacionaprobacion";
        vm.notificacionCambiosCapitulos = null;


        vm.handlerComponentes = [
            { id: 1, componente: 'aprobacionconfirmacionaprobacion', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'aprobacionconfirmacionaprobacion': true
            };
        }
    ...
    angular.module('backbone').component('aprobacionEntidadDTr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/Componentes/aprobacionEntidadTr/aprobacionEntidadDTr.html",

        controller: aprobacionEntidadDTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
