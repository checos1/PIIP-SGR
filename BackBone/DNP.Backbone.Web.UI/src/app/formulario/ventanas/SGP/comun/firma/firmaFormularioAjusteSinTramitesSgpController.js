(function () {
    ...
    firmaFormularioAjusteSinTramitesSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
    ...
    function firmaFormularioAjusteSinTramitesSgpController(
        $scope,
        $sessionStorage,
        utilidades,
        firmaFormularioSgpServicio,
    ...
    angular.module('backbone').component('firmaFormularioAjusteSinTramitesSgp', {

        templateUrl: "src/app/formulario/ventanas/SGP/comun/firma/firmaFormularioAjusteSinTramitesSgp.html",
        controller: firmaFormularioAjusteSinTramitesSgpController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
