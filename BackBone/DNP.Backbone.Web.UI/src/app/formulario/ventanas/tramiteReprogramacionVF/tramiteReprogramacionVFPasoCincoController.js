(function () {
    ...
    tramiteReprogramacionVfPasoCincoController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteReprogramacionVfPasoCincoController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
        ...
        * */
        vm.handlerComponentes = [
            ...
            { id: 1, componente: 'aprobacionfinal', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
    ...
    angular.module('backbone').component('tramiteReprogramacionVfPasoCinco', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/tramiteReprogramacionVfPasoCinco.html",
        controller: tramiteReprogramacionVfPasoCincoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
