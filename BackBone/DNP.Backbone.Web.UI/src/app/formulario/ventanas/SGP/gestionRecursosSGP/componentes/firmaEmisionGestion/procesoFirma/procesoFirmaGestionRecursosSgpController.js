(function () {
    ...
    procesoFirmaGestionRecursosSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function procesoFirmaGestionRecursosSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpsolicitudrecursosfirmaresponsables";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgpsolicitudrecursosfirmaresponsablesprocesofirmasgrsgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpsolicitudrecursosfirmaresponsablesprocesofirmasgrsgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpsolicitudrecursosfirmaresponsablesprocesofirmasgrsgp': true
            };
        }
        ...
        */
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (erroresList.length > 0) {
                ...
                var errorElements = document.getElementsByClassName(`${vm.nombreComponenteHijo}-errores`);
        ...
        */
        ...
        vm.guardadohijos = function (nombreComponente, nombreComponenteHijo) {
            vm.guardadocomponent({ nombreComponente: "sgpsolicitudrecursosfirmaresponsables", nombreComponenteHijo: nombreComponenteHijo });
        }
    ...
    angular.module('backbone').component('procesoFirmaGestionRecursosSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/firmaEmisionGestion/procesoFirma/procesoFirmaGestionRecursosSgp.html",
        controller: procesoFirmaGestionRecursosSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
