(function () {
    'use strict';
    viabilidadViabilidadVotosSgrController.$inject = [
        '$scope',
        '$sessionStorage',
        'viabilidadSgrServicio'
    ];

    function viabilidadViabilidadVotosSgrController(
        $scope,
        $sessionStorage,
        viabilidadSgrServicio
    ) {
        ...
        vm.nombreComponenteHijo = "sgrviabilidadregistrovotos";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadregistrovotos', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadregistrovotos': true
            };
        }
    ...
    angular.module('backbone').component('viabilidadViabilidadVotosSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctei/viabilidad/viabilidad/viabilidadViabilidadVotosSgr.html",
        controller: viabilidadViabilidadVotosSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
