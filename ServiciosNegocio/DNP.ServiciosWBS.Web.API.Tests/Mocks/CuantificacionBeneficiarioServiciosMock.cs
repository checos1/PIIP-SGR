namespace DNP.ServiciosWBS.Web.API.Tests.Mocks
{
    ...
    public class CuantificacionBeneficiarioServiciosMock : ICuantificacionBeneficiarioServicios
    {
        public PoblacionDto ObtenerCuantificacionBeneficiario(ParametrosConsultaDto parametrosConsulta)
        {
