(function () {
    ...
    estadoPriorizacionM2SgrController.$inject = ['$scope', 'priorizacionSgrServicio', 'justificacionCambiosServicio','utilidades', '$sessionStorage'];

    function estadoPriorizacionM2SgrController(
        $scope,
        ...
        var vm = this;
        vm.nombreComponente = "sgrpriorizacionm2priorizacionestadopriorizacion";
        vm.Bpin = null;
    ...
    angular.module('backbone').component('estadoPriorizacionM2Sgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/Priorizacion/M2/priorizacion/estado/estadoPriorizacionM2Sgr.html",

        controller: estadoPriorizacionM2SgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
