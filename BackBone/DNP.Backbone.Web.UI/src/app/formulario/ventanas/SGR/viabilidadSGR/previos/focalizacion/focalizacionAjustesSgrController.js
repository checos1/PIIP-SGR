(function () {
    ...
    focalizacionAjustesSgrController.$inject = [
        '$scope',
        '$sessionStorage'
    ];

    function focalizacionAjustesSgrController(
        $scope,
        $sessionStorage
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrviabilidadpreviosfocalizacion";
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadpreviosfocalizacionpoliticas', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrviabilidadpreviosfocalizacioncategoriapoliticas', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'sgrviabilidadpreviosfocalizacioncrucepoliticas', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 4, componente: 'sgrviabilidadpreviosfocalizacionresumenfocalizacion', handlerValidacion: null, handlerCambios: null, esValido: true }                       
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadpreviosfocalizacionpoliticas': true,
                'sgrviabilidadpreviosfocalizacioncategoriapoliticas': true,
                'sgrviabilidadpreviosfocalizacioncrucepoliticas': true,
                'sgrviabilidadpreviosfocalizacionresumenfocalizacion': true
            };
        }
        ...
        vm.guardado = function (nombreComponenteHijo) {
            ...
            if (nombreComponenteHijo == "sgrviabilidadpreviosfocalizacionpoliticas") {
        ...
        */
        ...
        vm.notificarRefresco = function (handler, nombreComponente) {
            if (nombreComponente == "sgrviabilidadpreviosfocalizacion") {
                vm.notificarRefrescoFuentes = handler;
            }

            if (nombreComponente == "sgrviabilidadpreviosfocalizacioncategoriapoliticas") {
    ...
    angular.module('backbone').component('focalizacionAjustesSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/previos/focalizacion/focalizacionAjustesSgr.html",
        controller: focalizacionAjustesSgrController,
        controllerAs: "vm",
        bindings: {
