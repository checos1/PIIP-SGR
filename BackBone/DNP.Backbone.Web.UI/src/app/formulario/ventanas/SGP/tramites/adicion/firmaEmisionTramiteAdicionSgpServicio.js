(function () {
    ...
    angular.module('backbone').factory('firmaEmisionTramiteAdicionSgpServicio', firmaEmisionTramiteAdicionSgpServicio);

    firmaEmisionTramiteAdicionSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function firmaEmisionTramiteAdicionSgpServicio($http, constantesBackbone) {
