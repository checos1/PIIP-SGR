(function () {
    ...
    seguimientoReporteController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
        'ajustesServicio',
    ...
    function seguimientoReporteController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        ajustesServicio,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'financiero', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
            { id: 2, componente: 'metaproducto', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
            { id: 3, componente: 'regionalizacion', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
            { id: 4, componente: 'segfocalizacion', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [] },
        ...
        vm.eventoValidar = function () {
            ...
            seguimientoServicio.obtenerErroresProyecto(vm.globalVariables.GuidMacroproceso, vm.globalVariables.IdProyecto, vm.globalVariables.GuidInstancia).then(function (respuesta) {
                ...
                vm.visualizarAlerta((findErrors != -1), respuesta.data)
            });
        }
        ...
        vm.visualizarAlerta = function (error, data) {
            if (error) {

                var findreg = data.findIndex(p => p.Seccion != 'regionalizacion');
                ...
                if (findreg != 0) {
                    ...
                    idSpanAlertComponent1.classList.add("ico-advertencia");
                }
        ...
        vm.notificacionValidacionHijos = function (errores) {
            for (var i = 0; i < vm.handlerComponentes.length; i++) {
                if (vm.handlerComponentes[i].handlerValidacion != null /*&& errores != null && errores.length > 0*/) {
                    try {
    ...
    angular.module('backbone').component('seguimientoReporteControl', {
        templateUrl: "src/app/formulario/ventanas/seguimientoControl/reporteAvance/seguimientoReporte.html",
        controller: seguimientoReporteController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
