(function () {
    ...
    tramiteReprogramacionVfPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteReprogramacionVfPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
        ...
        * */
        vm.handlerComponentes = [
            ...
            { id: 1, componente: 'aprobacionpaso4', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
    ...
    angular.module('backbone').component('tramiteReprogramacionVfPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/tramiteReprogramacionVfPasoCuatro.html",
        controller: tramiteReprogramacionVfPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
