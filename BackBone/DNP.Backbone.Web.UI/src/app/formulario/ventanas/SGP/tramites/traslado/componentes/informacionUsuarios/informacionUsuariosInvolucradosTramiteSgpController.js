(function () {
    ...
    informacionUsuariosInvolucradosTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function informacionUsuariosInvolucradosTramiteSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
    ...
    angular.module('backbone').component('informacionUsuariosInvolucradosTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/traslado/componentes/informacionUsuarios/informacionUsuariosInvolucradosTramiteSgp.html",
        controller: informacionUsuariosInvolucradosTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
