    ...
    function elaborarConceptoal(
        ...
        function initElaborarConcepto() {
            $scope.$watch('vm.tramiteid', function () {
                if (vm.tramiteid !== '' && vm.tramiteid !== undefined && vm.tramiteid !== null) {
                    ...
                    vm.rolAnalista = roluser.find(x => x.Nombre.includes('Analista'))  ? true : false;
                    if (!vm.mostrarPDF) {
                        if (vm.rolAnalista)
                            vm.mostrarPDF = true;
        ...
        */
        ...
        vm.verPdf = function () {
            ...
            tramiteVigenciaFuturaServicio.generarPdfCartaTramiteVf(tramiteId, true, "AL");
        }

    }

    angular.module('backbone').component('elaborarConceptoal', {
        templateUrl: "src/app/formulario/ventanas/tramiteLeyenda/componentes/conceptos/elaborarConcepto/elaborarConceptoal.html",
        controller: elaborarConceptoal,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
