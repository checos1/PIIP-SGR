(function () {
    ...
    tramiteIncorporacionController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteIncorporacionController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteIncorporacion', {
        templateUrl: "src/app/formulario/ventanas/tramiteIncorporacion/tramiteIncorporacion.html",
        controller: tramiteIncorporacionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
