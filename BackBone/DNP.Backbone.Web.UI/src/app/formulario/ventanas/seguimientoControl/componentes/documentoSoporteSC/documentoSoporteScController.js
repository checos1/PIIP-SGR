(function () {
    ...
    documentoSoporteScController.$inject = ['$scope'];

    function documentoSoporteScController(
        $scope
    ) {
        var vm = this;
    ...
    angular.module('backbone').component('documentoSoporteSc', {
        templateUrl: "src/app/formulario/ventanas/seguimientoControl/componentes/documentoSoporteSc/documentoSoporteSc.html",
   
        controller: documentoSoporteScController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
