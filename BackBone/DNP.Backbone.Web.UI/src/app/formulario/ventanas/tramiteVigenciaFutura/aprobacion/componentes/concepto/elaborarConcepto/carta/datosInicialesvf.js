(function () {
    ...
    datosInicialesvfController.$inject = [
        'backboneServicios',
        'sesionServicios',
    ...
    function datosInicialesvfController(
        backboneServicios,
        sesionServicios,
        configurarEntidadRolSectorServicio,
        $scope,
        ...
        vm.nombreSccion = vm.tipoTramite == 4 ? 'Datos Iniciales VFO' : vm.tipoTramite == 5 ? 'Datos Iniciales VFO-AoPC' : 'Datos Iniciales';
        ...
        function obtenerDatosIniciales() {
            var idPlantillaSeccion = vm.plantillaCarta.PlantillaSecciones[0].Id;// vm.tipoTramite == 4 ? 4 : 7;
        ...
        function ObtenerSeccionCapitulo() {
            const span = document.getElementById('id-capitulo-solicitarconceptodatosiniciales');
    ...
    angular.module('backbone').component('datosInicialesvf', {

        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/aprobacion/componentes/concepto/elaborarConcepto/carta/datosInicialesvf.html",
        controller: datosInicialesvfController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
