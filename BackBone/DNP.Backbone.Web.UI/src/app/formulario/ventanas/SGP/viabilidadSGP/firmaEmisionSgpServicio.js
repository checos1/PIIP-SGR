(function () {
    ...
    angular.module('backbone').factory('firmaEmisionSgpServicio', firmaEmisionSgpServicio);

    firmaEmisionSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function firmaEmisionSgpServicio($http, constantesBackbone) {
