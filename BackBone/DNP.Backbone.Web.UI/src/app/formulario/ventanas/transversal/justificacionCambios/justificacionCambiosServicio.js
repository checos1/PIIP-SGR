(function () {
    'use strict';
    angular.module('backbone').factory('justificacionCambiosServicio', justificacionCambiosServicio);

    justificacionCambiosServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];

   

    function justificacionCambiosServicio($q, $http, $location, constantesBackbone) {
        return {
