(function () {
    ...
    infoPresupuestalTrasladoSgpController.$inject = [
        '$sessionStorage',
        'utilidades',
        '$scope',
        'constantesBackbone'
    ...
    function infoPresupuestalTrasladoSgpController(
        $sessionStorage,
        utilidades,
        $scope,
        constantesBackbone
    ...
    angular.module('backbone').component('infoPresupuestalTrasladoSgp', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "src/app/formulario/ventanas/SGP/tramites/traslado/componentes/informacionPresupuestalTrasladoSgp/infoPresupuestalTrasladoSgp.html",        
        controller: infoPresupuestalTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
