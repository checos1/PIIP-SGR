(function () {
    ...
    procesoFirmaViabilidadSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function procesoFirmaViabilidadSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponenteHijo = "sgpfirmaresponsablesprocesofirmassgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpfirmaresponsablesprocesofirmassgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpfirmaresponsablesprocesofirmassgp': true
            };
        }
    ...
    angular.module('backbone').component('procesoFirmaViabilidadSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/viabilidadSGP/firmaEmision/procesoFirma/procesoFirmaViabilidadSgp.html",
        controller: procesoFirmaViabilidadSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
