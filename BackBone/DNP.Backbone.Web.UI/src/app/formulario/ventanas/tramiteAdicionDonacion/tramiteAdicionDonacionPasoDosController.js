(function () {
    ...
    tramiteAdicionDonacionPasoDosController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteAdicionDonacionPasoDosController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteAdicionDonacionPasoDos', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/tramiteAdicionDonacionPasoDos.html",
        controller: tramiteAdicionDonacionPasoDosController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
