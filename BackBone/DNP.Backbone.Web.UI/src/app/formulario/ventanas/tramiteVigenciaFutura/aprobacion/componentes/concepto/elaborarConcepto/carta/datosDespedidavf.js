(function () {
    ...
    datosDespedidavfController.$inject = [
        'backboneServicios',
        'sesionServicios',
    ...
    function datosDespedidavfController(
        backboneServicios,
        sesionServicios,
        configurarEntidadRolSectorServicio,
        $scope,
        ...
        vm.nombreSccion = vm.tipoTramite == 4 ? 'Despedida VFO' : vm.tipoTramite == 5 ? 'Despedida VFO-AoPC' : vm.tipoTramite == 18 ? 'Despedida VFO-EXCEP':'';
        ...
        function guardarConceptoDatosDespedida() {
            ...
            vm.CartaDatosDespedida.PantillaSeccionId = vm.plantillaCarta.PlantillaSecciones[0].Id;//6;
        ...
        function obtenerCartaConceptoDatosdespedida() {
            var idPlantillaSeccion = vm.plantillaCarta.PlantillaSecciones[0].Id;//  vm.tipoTramite == 4 ? 6 : 9;
        ...
        function ObtenerSeccionCapitulo() {
            const span = document.getElementById('id-capitulo-solicitarconceptodatosdespedida');
    ...
    angular.module('backbone').component('datosDespedidavf', {

        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/aprobacion/componentes/concepto/elaborarConcepto/carta/datosDespedidavf.html",
        controller: datosDespedidavfController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
