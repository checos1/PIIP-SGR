(function () {
    ...
    aproSuperIncController.$inject = ['$scope',];

    function aproSuperIncController(
        $scope,
    ...
    angular.module('backbone').component('aproSuperInc', {
        templateUrl: "/src/app/formulario/ventanas/tramiteIncorporacion/componentes/aprobacionSupervisorInc/aproSuperInc.html",
        controller: aproSuperIncController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
