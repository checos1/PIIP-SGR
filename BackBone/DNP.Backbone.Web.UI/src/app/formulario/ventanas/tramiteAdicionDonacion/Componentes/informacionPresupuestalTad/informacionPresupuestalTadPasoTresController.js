(function () {
    ...
    informacionPresupuestalTadPasoTresController.$inject = [
        '$scope',

    ];

    function informacionPresupuestalTadPasoTresController(
        $scope,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'informacionpresupuestalsolicitudadiciondonacion', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'informacionpresupuestalsolicitudadiciondonacion': true,
            };
        }
    ...
    angular.module('backbone').component('informacionPresupuestalTadPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/componentes/informacionPresupuestalTad/informacionPresupuestalTadPasoTres.html",


        controller: informacionPresupuestalTadPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
