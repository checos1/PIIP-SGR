(function () {
    'use strict';
    informacionBasicaCtusSgrController.$inject = [
        '$sce',
        '$scope',
        '$rootScope',
        'utilidades',
    ...
    function informacionBasicaCtusSgrController(
        $sce,
        $scope,
        $rootScope,
        utilidades,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgrctuselaboracioninfogeneralinfobasica';
        ...
        vm.init = function () {
            var tipoConceptoViabilidad = constantesTipoConceptoViabilidad.CTUS;
            $scope.$on("SendProyectoCtus", function (evt, data) {
                LeerInformacionGeneral(vm.proyectoId, data.Instancia, tipoConceptoViabilidad);
            });
        ...
        vm.guardar = function (response) {
            ...
            //    return;
            //}
            //if (vm.form.regionSgr === "" || vm.form.regionSgr === null || vm.form.regionSgr === undefined || vm.form.regionSgr === 7) {
    ...
    angular.module('backbone').component('informacionBasicaCtusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctus/elaboracion/informacionGeneral/informacionBasica/informacionBasicaCtusSgr.html",
        controller: informacionBasicaCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
