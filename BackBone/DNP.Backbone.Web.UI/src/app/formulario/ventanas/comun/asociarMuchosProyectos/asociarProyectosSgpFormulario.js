(function () {
    ...
    asociarProyectosSgpFormulario.$inject = [
        '$sessionStorage',
        'utilidades',
        '$scope',
        'constantesBackbone',
    ...
    function asociarProyectosSgpFormulario(
        $sessionStorage,
        utilidades,
        $scope,
        constantesBackbone,
        ...
        tramiteSGPServicio.registrarObservador(function (datos) {
            if (datos.cargarProyectoAsociado === true || datos.actualizarDetalleProyectoAsociado === true) {
                //vm.init();
                obtenerTramite();
                obtenerTramiteD();
            }
        ...
        function obtenerTramite() {
            ...
            comunesServicio.obtenerEntidadAsociarProyecto(vm.instanciaId, 'C').then(
                function (respuesta) {
                    ...
                    vm.IdEntidadSeleccionadaCC = vm.listaFiltroEntidades[0].Id;
                    if (vm.tipotramiteid == 90) {//trasl                         
                        vm.listaFiltroEntidadesD = vm.listaFiltroEntidades;
                        vm.actualizaCombos();
                        vm.seleccionProyectos = true;//deshabilita los combos de entidades
                    }
                });
            ...
            if (vm.ProyectosSeleccionadosD && vm.ProyectosSeleccionadosD.length > 0) {
                vm.ProyectosSeleccionadosD.forEach(proyecto => {
                    ...
                    datoproyectoD.forEach(p => {
                        ...
                        if (vm.tipotramiteid == 90) { // solo para tramite de traslado 
    ...
    angular.module('backbone').component('asociarProyectosSgpFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/asociarProyectosSgpFormulario.html",
        controller: asociarProyectosSgpFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
