(function () {
    ...
    agregarRegistroPresupuestalFormularioController.$inject = [
        '$scope',
        '$sessionStorage',
        '$uibModal',
        'utilidades',
    ...
    function agregarRegistroPresupuestalFormularioController(
        $scope,
        $sessionStorage,
        $uibModal,
        utilidades,
        ...
        function init() {
            ...
            $scope.$watch(function () {
                if (vm.tramiteid != $sessionStorage.InstanciaSeleccionada.tramiteId || vm.ProyectoId != $sessionStorage.proyectoId) {
        ...
        function abrirModalEditarCDP() {
            const span = document.getElementById('id-capitulo-informacionpresupuestalrp');
            $sessionStorage.seccionCapitulo = span.textContent;
            $uibModal.open({
                templateUrl: 'src/app/formulario/ventanas/comun/informacionPresupuestalRpRvf/modalEditarCrp.html',
    ...
    angular
        .module('backbone')
        .component('agregarRegistroPresupuestalFormulario', {
            templateUrl: "src/app/formulario/ventanas/comun/informacionPresupuestalRpRvf/agregarRegistroPresupuestalFormulario.html",
            controller: agregarRegistroPresupuestalFormularioController,
            controllerAs: "vm",
            bindings: {
                callback: '&',
                guardadoevent: '&',
