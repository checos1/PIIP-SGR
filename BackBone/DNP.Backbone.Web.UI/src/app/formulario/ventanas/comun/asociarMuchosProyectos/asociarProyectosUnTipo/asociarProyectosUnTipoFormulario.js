(function () {
    ...
    asociarProyectosUnTipoFormulario.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarProyectosUnTipoFormulario(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
    ...
    angular.module('backbone').component('asociarProyectosUnTipoFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/asociarProyectosUnTipo/asociarProyectosUnTipoFormulario.html",
        controller: asociarProyectosUnTipoFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
