(function () {
    ...
    soportesAvalUsoSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function soportesAvalUsoSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrviabilidadavalusosoportes";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrviabilidadavalusosoportesalojararchivo";
        vm.notificacionCambiosCapitulos = null;
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";

        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadavalusosoportesalojararchivo', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadavalusosoportesalojararchivo': true
            };
        }
    ...
    angular.module('backbone').component('soportesAvalUsoSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/EntidadNacionalFlujo9/soportes/soportesAvalUsoSgr.html",
        controller: soportesAvalUsoSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
