(function () {
    ...
    procesoFirmaCtusSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function procesoFirmaCtusSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctusfirmaprocesofirma', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('procesoFirmaCtusSgr', {
        templateUrl: "src/app/formulario/ventanas/SGR/ctus/firmaEmision/procesoFirma/procesoFirmaCtusSgr.html",
        controller: procesoFirmaCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
