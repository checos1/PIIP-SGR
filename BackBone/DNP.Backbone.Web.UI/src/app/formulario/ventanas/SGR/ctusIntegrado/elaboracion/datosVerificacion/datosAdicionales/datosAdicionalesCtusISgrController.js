(function () {
    'use strict';
    datosAdicionalesCtusISgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function datosAdicionalesCtusISgrController(
        $scope,
        utilidades,
        $sessionStorage,
        requisitosSgrServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "sgrctusintegradoelaboraciondatosverificaciondatosadicionalesverificacion";
    ...
    angular.module('backbone').component('datosAdicionalesCtusISgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/elaboracion/datosVerificacion/datosAdicionales/datosAdicionalesCtusISgr.html",
        controller: datosAdicionalesCtusISgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
