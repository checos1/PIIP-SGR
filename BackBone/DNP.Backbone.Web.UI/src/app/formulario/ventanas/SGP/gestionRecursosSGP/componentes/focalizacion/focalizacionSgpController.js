(function () {
    ...
    focalizacionSgpController.$inject = [
        '$scope',
        '$sessionStorage'
    ];

    function focalizacionSgpController(
        $scope,
        $sessionStorage
    ) {
        var vm = this;
        ...
        */
        ...
        vm.notificarRefresco = function (handler, nombreComponente) {
            if (nombreComponente == "focalizacionpol") {
    ...
    angular.module('backbone').component('focalizacionSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/focalizacion/focalizacionSgp.html",        
        controller: focalizacionSgpController,
        controllerAs: "vm",
        bindings: {
