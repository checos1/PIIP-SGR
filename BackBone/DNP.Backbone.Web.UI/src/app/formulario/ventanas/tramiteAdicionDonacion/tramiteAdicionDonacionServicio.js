(function () {
    ...
    angular.module('backbone').factory('tramiteAdicionDonacionServicio', tramiteAdicionDonacionServicio);

    tramiteAdicionDonacionServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone', 'servicioFichasProyectos', 'utilidades', 'FileSaver'];


    function tramiteAdicionDonacionServicio($q, $http, $location, constantesBackbone, servicioFichasProyectos, utilidades, FileSaver) {
        return {
