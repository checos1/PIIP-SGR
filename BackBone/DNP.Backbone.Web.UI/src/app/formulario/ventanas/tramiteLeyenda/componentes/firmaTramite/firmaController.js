(function () {
    ...
    firmaController.$inject = [
        '$scope',
        'utilidades',
        'trasladosServicio'
    ];

    function firmaController(
        $scope,
        utilidades,
        trasladosServicio
    ){
    ...
    angular.module('backbone').component('firma', {

        templateUrl: "src/app/formulario/ventanas/tramiteLeyenda/componentes/firmaTramite/firma.html",
