(function () {
    'use strict';
    angular.module('backbone').factory('ajustesServicio', ajustesServicio);

    ajustesServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];

    function ajustesServicio($q, $http, $location, constantesBackbone) {
        return {
