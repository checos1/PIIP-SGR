(function () {
    ...
    aprobacionTramiteSgpController.$inject = [
        '$sessionStorage',
        '$scope',
        'tramiteSGPServicio',
        'utilidades',
    ...
    function aprobacionTramiteSgpController(
        $sessionStorage,
        $scope,
        tramiteSGPServicio,
        utilidades,
        ...
        $scope.respuesta = "";
        $scope.justificacion = "";
        $sessionStorage.respuesta = undefined;
        ...
        function Cancelar() {
            ...
            transversalSgpServicio.notificarCambio({ actualizarAprobacion: true });
       }

        function Editar() {
            vm.disabled = true;
            vm.disabled2 = true;
            $sessionStorage.respuesta = $scope.respuesta;
            transversalSgpServicio.notificarCambio({ actualizarAprobacion: true });
        }
        ...
        function Guardar() {
            ...
            return tramiteSGPServicio.guardarRespuestasJustificacion(vm.Justificaciones).then(
                function (response) {
        ...
        function obtenerPreguntas() {
            ...
            return tramiteSGPServicio.obtenerPreguntasJustificacion(idTramite, proyectoid, tipoTramiteId, tipoRolId, vm.IdNivel).then(
                function (respuesta) {
    ...
    angular.module('backbone').component('aprobacionTramiteSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/comun/aprobacionSgp/aprobacionTramiteSgp.html",
        controller: aprobacionTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            prueba: '&',
            guardadoevent: '&',
