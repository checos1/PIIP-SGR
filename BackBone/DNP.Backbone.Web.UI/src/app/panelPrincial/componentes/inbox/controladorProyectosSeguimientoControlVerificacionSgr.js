...
(function () {
    'use strict';
    angular.module('backbone').controller('proyectosSeguimientoControlVerificacionSgrController', proyectosSeguimientoControlVerificacionSgrController);

    proyectosSeguimientoControlVerificacionSgrController.$inject = [
        '$scope',
    ...
    function proyectosSeguimientoControlVerificacionSgrController(
        $scope,
        servicioPanelPrincipal,
        $uibModal,
        $log,
        ...
        vm.proyectoFiltro = {
            ...
            IdsSubPasosVerificacion: [constantesBackbone.idSubPasoSeguimientoControlOcadPazSgr],
            procesoId: null,
        ...
        function cargarDatosVerificacionOcadPaz() {
            ...
            transversalSgrServicio.SGR_Transversal_LeerParametro("MensajeAvanceCoordinadorVerificacionSGR")
                .then(function (respuestaParametro) {
                    if (respuestaParametro.data) {
            ...
            transversalSgrServicio.SGR_Transversal_LeerParametro("MensajeExitoAvanceCoordinadorVerificacionSGR")
                .then(function (respuestaParametro) {
                    if (respuestaParametro.data) {
    ...
    angular.module('backbone')
        .component('proyectosSeguimientoControlVerificacionSgr', {
            templateUrl: "/src/app/panelPrincial/componentes/inbox/proyectosSeguimientoControlVerificacionSgr.template.html",
            controller: 'proyectosSeguimientoControlVerificacionSgrController',
            controllerAs: 'vm'
        });
