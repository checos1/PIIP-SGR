(function () {
    ...
    angular.module('backbone').component('firmaInc', {
        templateUrl: "/src/app/formulario/ventanas/tramiteIncorporacion/componentes/firmaInc/firmaInc.html",

        controller: firmaIncController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
