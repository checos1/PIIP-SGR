(function () {
    ...
    angular.module('backbone').component('cuestionarioViabilidadSgr2', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/viabilidad/viabilidad/cuestionarioViabilidad/cuestionarioViabilidadSgr2.html",
        controller: cuestionarioViabilidadSgrController2,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
