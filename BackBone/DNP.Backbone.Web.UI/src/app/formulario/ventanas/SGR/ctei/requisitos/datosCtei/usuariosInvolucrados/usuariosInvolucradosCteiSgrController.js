(function () {
    ...
    usuariosInvolucradosCteiSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function usuariosInvolucradosCteiSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrcteidatoscteiusuariosinvolucrados";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrcteidatoscteiusuariosinvolucrados";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrcteidatoscteiusuariosinvolucrados', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('usuariosInvolucradosCteiSgr', {
        templateUrl:"/src/app/formulario/ventanas/SGR/ctei/requisitos/datosCtei/usuariosInvolucrados/usuariosInvolucradosCteiSgr.html",
        controller: usuariosInvolucradosCteiSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
