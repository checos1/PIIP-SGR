(function () {
    ...
    fuentesPrPasoTresController.$inject = ['$scope', '$sessionStorage', 'comunesServicio'];

    function fuentesPrPasoTresController(
        $scope,
        $sessionStorage,
        comunesServicio
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "fuentes";
        vm.nombreComponenteHijo = "fuentesfuentesdefinanc";
        vm.notificacionCambiosCapitulos = null;


        vm.handlerComponentes = [
            { id: 1, componente: 'fuentesfuentesdefinanc', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        function validarVariables() {
            if (vm.IdNivel !== undefined && vm.IdEntidad !== undefined && vm.IdSeccionCapitulo !== undefined)
                vm.verificacalendario({ idEntidad: vm.IdEntidad, idNivel: vm.IdNivel, idSeccionCapitulo: vm.IdSeccionCapitulo, seccion: 'fuentes' });
        }
    ...
    angular.module('backbone').component('fuentesPrPasoTres', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/componentes/fuentesPr/fuentesPrPasoTres.html",
        controller: fuentesPrPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
