(function () {
    ...
    justificacionRvfPasoTresController.$inject = [
        '$scope',

    ];

    function justificacionRvfPasoTresController(
        $scope,
    ...
    angular.module('backbone').component('justificacionRvfPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/Componentes/justificacionRvf/justificacionRvfPasoTres.html",


        controller: justificacionRvfPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
