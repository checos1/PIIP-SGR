(function () {
    ...
    modificacionLeyTrCreditosController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
        '$timeout',
    ...
    function modificacionLeyTrCreditosController(
        $scope,
        $sessionStorage,
        utilidades,
        $timeout,
...
/*                            ObtenerInformacionPresupuestalDetalle();*/
        ...
        vm.actualizaFila = function (event, fuentes, campo, index) {
            ...
            if (campo === 'ValorAcreditarCSF') fuentes.Creditos[index].ValorAcreditarCSF = event.target.value;
            if (campo === 'ValorAcreditarSSF') fuentes.Creditos[index].ValorAcreditarSSF = event.target.value;

            angular.forEach(fuentes.Creditos, function (series) {
                TAcreditar += parseFloat(series.ValorAcreditarCSF) + parseFloat(series.ValorAcreditarSSF);
            });

            fuentes.TotalAcreditar = TAcreditar;
    ...
    angular.module('backbone').component('modificacionLeyTrCreditos', {

        templateUrl: "src/app/formulario/ventanas/comun/modificacionLey/creditos/modificacionLeyTrCreditos.html",
        controller: modificacionLeyTrCreditosController,
        controllerAs: "vm",
        bindings: {
            tramiteproyectoid: '@',
            origen: '@',
