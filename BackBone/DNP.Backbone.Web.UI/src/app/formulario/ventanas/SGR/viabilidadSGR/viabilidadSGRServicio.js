(function () {
    ...
    angular.module('backbone').factory('viabilidadSgrServicio', viabilidadSgrServicio);

    viabilidadSgrServicio.$inject = ['$http', 'constantesBackbone'];

    function viabilidadSgrServicio($http, constantesBackbone) {
        ...
        return {
            ...
            SGR_ObtenerPuntajeProyecto: SGR_ObtenerPuntajeProyecto,
            guardarPuntajeProyecto: guardarPuntajeProyecto,
        };
        ...
        function SGR_ObtenerPuntajeProyecto(instanciaId, entidadId) {
            var url = apiBackboneServicioBaseUri + constantesBackbone.apiBackBoneObtenerPuntajeProyecto + "?instanciaId=" + instanciaId + "&entidadId=" + entidadId;
            return $http.get(url);
        }

        function guardarPuntajeProyecto(data) {
            return $http.post(apiBackboneServicioBaseUri + constantesBackbone.apiBackBoneGuardarPuntajeProyecto, data);
        }
    }
})();