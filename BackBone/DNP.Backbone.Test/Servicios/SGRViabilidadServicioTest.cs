...
namespace DNP.Backbone.Test.Servicios
{
    ...
    /// </summary>
    [TestClass]
    public class SGRViabilidadServicioTest
    {
        private ISGRViabilidadServicios _sgrViabilidadServicios;

        [TestInitialize]
        public void Init()
        {
            _sgrViabilidadServicios = Config.UnityConfig.Container.Resolve<ISGRViabilidadServicios>();
        }

        [TestMethod]
        public void LeerInformacionBasicaViabilidadTest_AntesGuardar()
        {
            ...
            var actionResult = _sgrViabilidadServicios.SGR_Viabilidad_LeerInformacionGeneral(proyectoId, instanciaId, usuarioDNP, tipoConceptoViabilidadCode).Result;
        ...
        public void LeerParametricasViabilidadTest()
        {
            ...
            var usuarioDNP = "CC7012345678907";
            var actionResult = _sgrViabilidadServicios.SGR_Viabilidad_LeerParametricas(proyectoId, nivel, usuarioDNP).Result;
        ...
        public void GuardarInformacionViabilidadTest()
        {
            ...
            var usuarioDNP = "usuariodnp";
            var actionResult = _sgrViabilidadServicios.SGR_Viabilidad_GuardarInformacionBasica(data, usuarioDNP).Result;
