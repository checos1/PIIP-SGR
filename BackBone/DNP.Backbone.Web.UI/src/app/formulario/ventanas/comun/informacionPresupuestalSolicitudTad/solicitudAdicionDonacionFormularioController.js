(function () {
    ...
    solicitudAdicionDonacionFormularioController.$inject = [
        '$sessionStorage',
        '$scope',
        'utilidades',
    ...
    function solicitudAdicionDonacionFormularioController(
        $sessionStorage,
        $scope,
        utilidades,
        justificacionCambiosServicio,
        ...
        vm.actualizaFila = function (event, asociados) {
            ...
            $scope.datos.ResumenProyectos[credito].Proyectos[0].TotalSolicitadoNacion = TotalSolicitadoNacion;

            var TotalSolicitadoPropios = 0;
            angular.forEach(asociados.DetalleFuentes.filter(x => x.NombreTipoRecurso.includes('Propios')), function (series) {
                TotalSolicitadoPropios = TotalSolicitadoPropios + parseFloat(series.ValorIncorporarCSF) + parseFloat(series.ValorIncorporarSSF);
            });
            $scope.datos.ResumenProyectos[credito].Proyectos[0].TotalSolicitadoPropios = TotalSolicitadoPropios;
        ...
        vm.actualizaFila2 = function (event, aportantes) {
            ...
            $scope.datos.ResumenProyectos[contrato].Proyectos[0].TotalSolicitadoNacion = TotalSolicitadoNacion;

            var TotalSolicitadoPropios = 0;
            angular.forEach(aportantes.DetalleFuentes.filter(x => x.NombreTipoRecurso.includes('Propios')), function (series) {
                TotalSolicitadoPropios = TotalSolicitadoPropios + parseFloat(series.ValorIncorporarCSF) + parseFloat(series.ValorIncorporarSSF);
            });
            $scope.datos.ResumenProyectos[contrato].Proyectos[0].TotalSolicitadoPropios = TotalSolicitadoPropios;
    ...
    angular.module('backbone').component('solicitudAdicionDonacionFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/informacionPresupuestalSolicitudTad/solicitudAdicionDonacionFormulario.html",
        controller: solicitudAdicionDonacionFormularioController,
        controllerAs: "vm",
        bindings: {
            guardadoevent: '&',
            notificacioncambios: '&',
