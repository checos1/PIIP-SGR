(function() {
    ...
    certificadoDisponibilidadPresupuestalController.$inject = [
        '$scope',
        'utilidades',
        'trasladosServicio',
        '$sessionStorage',
    ...
    function certificadoDisponibilidadPresupuestalController(
        $scope,
        utilidades,
        trasladoServicio,
        $sessionStorage,
        ...
        vm.notificacionCambiosCapitulos = function (nombreCapituloHijo) {
            console.log("vm.notificacionCambiosCapitulos CDP ", nombreCapituloHijo)
    ...
    angular.module('backbone').component('certificadoDisponibilidadPresupuestal', {
        templateUrl: "src/app/formulario/ventanas/comun/certificadoDisponibilidadPresupuestal/certificadoDisponibilidadPresupuestal.html",
        controller: certificadoDisponibilidadPresupuestalController,
        controllerAs: "vm",
        bindings: {
            tramiteid: '@',
