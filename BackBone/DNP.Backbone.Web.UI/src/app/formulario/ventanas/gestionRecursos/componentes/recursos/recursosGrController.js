(function () {
    ...
    recursosGrController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
    ];

    function recursosGrController(
        $scope,
        $sessionStorage,
        constantesBackbone,
    ) {
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'recursosgrfuentesdefinanc', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'recursosgrregionalizacion', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'recursosgrfuentesdefinanc': true,
                'recursosgrregionalizacion': true
            };
        }
    ...
    angular.module('backbone').component('recursosGr', {

        templateUrl: "src/app/formulario/ventanas/gestionRecursos/componentes/recursos/recursosGr.html",
        controller: recursosGrController,
        controllerAs: "vm",
        bindings: {
            verificacion: '&',
            modelo: '=',
