(function () {
    ...
    tramiteModificacionDTrasladoAPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionDTrasladoAPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteModificacionDTrasladoServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionDTrasladoAPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/analista/tramiteModificacionDTrasladoAPasoCuatro.html",
        controller: tramiteModificacionDTrasladoAPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
