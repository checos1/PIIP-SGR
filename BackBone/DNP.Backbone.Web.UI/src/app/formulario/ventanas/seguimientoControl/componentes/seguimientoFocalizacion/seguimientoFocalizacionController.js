(function () {
    ...
    seguimientoFocalizacionController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
    ...
    function seguimientoFocalizacionController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        justificacionCambiosServicio
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "segfocalizacion";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'segfocalizacionsegindipoliticas', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'segfocalizacionsegfocpoliticas', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 3, componente: 'segfocalizacionsegcrucepoliticas', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'segfocalizacionsegindipoliticas': true,
                'segfocalizacionsegfocpoliticas': true,
    ...
    angular.module('backbone').component('seguimientoFocalizacion', {
        templateUrl: "src/app/formulario/ventanas/seguimientoControl/componentes/seguimientoFocalizacion/seguimientoFocalizacion.html",
        controller: seguimientoFocalizacionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
