(function () {
    ...
    priorizacionM2PriorizaSgrController.$inject = ['$scope', 'priorizacionSgrServicio', 'utilidades', '$sessionStorage'];

    function priorizacionM2PriorizaSgrController(
        $scope,
        ...
        var vm = this;
        vm.nombreComponente = "sgrpriorizacionm2priorizacion";
        vm.nombreComponenteHijo = "sgrpriorizacionm2priorizacionregistropriorizacion";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrpriorizacionm2priorizacionregistropriorizacion', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrpriorizacionm2priorizacionestadopriorizacion', handlerValidacion: null, handlerCambios: null, esValido: true }
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrpriorizacionM2priorizacionregistro': true,
                'sgrpriorizacionM2priorizacionestado': true
            };
        }
    ...
    angular.module('backbone').component('priorizacionM2PriorizaSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/Priorizacion/M2/priorizacion/priorizacionM2PriorizaSgr.html",
        controller: priorizacionM2PriorizaSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
