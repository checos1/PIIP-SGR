(function () {
    ...
    asociarProyectoTrController.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarProyectoTrController(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
    ...
    angular.module('backbone').component('asociarProyectoTr', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionTraslado/componentes/asociarProyectoTr/asociarProyectoTr.html",
        controller: asociarProyectoTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
