(function () {
    'use strict';
    preguntasLiderController.$inject = [
        '$scope',
        '$sessionStorage',
        'viabilidadServicio',
        'utilidades',
    ...
    function preguntasLiderController(
        $scope,
        $sessionStorage,
        viabilidadServicio,
        utilidades,
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "viabilidad";
        ...
        vm.IdNivelFlujo = $sessionStorage.InstanciaSeleccionada != undefined ? $sessionStorage.InstanciaSeleccionada.IdNivel : 0;
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'viabilidadespecificas', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'viabilidadgenerales', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.obtener = function () {
            ...
            if (!vm.soloLectura && constantesBackbone.idEtapaViabilidadRegistro.toUpperCase() != vm.IdNivelFlujo.toUpperCase() ) {
                vm.soloLectura = true;
            }
        ...
        vm.devolverProyecto = function () {
            ...
            if (Observacion.value != null) {
                ...
                return viabilidadServicio.devolverProyecto(vm.DevolverProyecto).then(
                    function (response) {
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'viabilidadespecificas': true,
                'viabilidadgenerales': true
            };
        }
        ...
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (erroresList[0].Errores == null &&
                erroresList[1].Errores == null &&
                erroresList[2].Errores == null &&
                (vm.visualizarCumple == true || vm.visualizarCumple == false)) {
    ...
    angular.module('backbone').component('preguntasLider', {
        templateUrl: "src/app/formulario/ventanas/viabilidad/componentes/preguntasLider/preguntasLider.html",
        controller: preguntasLiderController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
