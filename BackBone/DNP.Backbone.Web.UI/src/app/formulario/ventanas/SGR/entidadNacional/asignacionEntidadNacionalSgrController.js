(function () {
    ...
    asignacionEntidadNacionalSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
        'previosSgrServicio',
    ...
    function asignacionEntidadNacionalSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        previosSgrServicio,
        ...
        vm.init = function () {
            ...
            utilsValidacionSeccionCapitulosServicio.getSeccionCapitulo(vm.guiMacroproceso, $sessionStorage.idNivel, $sessionStorage.idFlujoIframe).then(function (respuesta) {
                ...
                var indexobs = respuesta.data.findIndex(p => p.SeccionModificado == 'sgrentidadnacionalasignacion');
    ...
    angular.module('backbone').component('asignacionEntidadNacionalSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/entidadNacional/asignacionEntidadNacionalSgr.html",
        controller: asignacionEntidadNacionalSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
