(function () {
    'use strict';
    resultadoConceptoCtusSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
    ...
    function resultadoConceptoCtusSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = 'sgrctuselaboracionctusresultadoconcepto';
        ...
        vm.isCumpleRequisitosCtusBool = false;
        ...
        vm.init = function () {
            ...
            ObtenerProyectoCtus(vm.proyectoId, $sessionStorage.InstanciaSeleccionada.InstanciaPadreId);
    ...
    angular.module('backbone').component('resultadoConceptoCtusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctus/elaboracion/ctus/resultadoconcepto/resultadoConceptoCtusSgr.html",
        controller: resultadoConceptoCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
