...
(function () {
    'use strict';
    angular.module('backbone').controller('proyectosRevisionCoordinadorVerificacionSgrController', proyectosRevisionCoordinadorVerificacionSgrController);

    proyectosRevisionCoordinadorVerificacionSgrController.$inject = [
        '$scope',
    ...
    function proyectosRevisionCoordinadorVerificacionSgrController(
        $scope,
        servicioPanelPrincipal,
        $uibModal,
        $log,
        ...
        vm.proyectoFiltro = {
            ...
            IdsSubPasosVerificacion: [constantesBackbone.idSubPasoRevisionCoordinadorOcadPazSgr],
            procesoId: null,
            ...
            function exitoCantidad(respuesta) {
                if (respuesta.data != null) {
                    ...
                    var dataE = vm.macroProcesosCantidad.filter(x => (String(x.NivelPadreId).toUpperCase() == constantesBackbone.idEtapaNuevaEjecucion ||
                        ...
                        String(x.NivelPadreId).toUpperCase() == constantesBackbone.idEtapaRevisionCoordinador) && x.TipoObjeto == 'Proyecto');
        ...
        function cargarDatosVerificacionOcadPaz() {
            ...
            transversalSgrServicio.SGR_Transversal_LeerParametro("MensajeAvanceSubdirectorVerificacionSGR")
                .then(function (respuestaParametro) {
                    if (respuestaParametro.data) {
            ...
            transversalSgrServicio.SGR_Transversal_LeerParametro("MensajeExitoAvanceSubdirectorVerificacionSGR")
                .then(function (respuestaParametro) {
                    if (respuestaParametro.data) {
        ...
        function getIdEtapa() {
            ...
            switch (vm.etapa) {
                ...
                case 'gr':
                    ...
                    break;
                case 'ej':
                    idEtapa = [constantesBackbone.idEtapaNuevaEjecucion, constantesBackbone.idEtapaProgramacionEjecucion, constantesBackbone.idEtapaAjustesEjecucion, constantesBackbone.idEtapaTramitesEjecucion, constantesBackbone.idEtapaRevisionCoordinador];
                    break;
                case 'se':
                    idEtapa = [];
                    break;
    ...
    angular.module('backbone')
        .component('proyectosRevisionCoordinadorVerificacionSgr', {
            templateUrl: "/src/app/panelPrincial/componentes/inbox/proyectosRevisionCoordinadorVerificacionSgr.template.html",
            controller: 'proyectosRevisionCoordinadorVerificacionSgrController',
            controllerAs: 'vm'
        });
