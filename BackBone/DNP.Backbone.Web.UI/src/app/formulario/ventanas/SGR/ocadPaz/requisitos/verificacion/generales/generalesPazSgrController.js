(function () {
    'use strict';
    generalesPazSgrController.$inject = [
        '$rootScope',
        'utilidades',
        '$sessionStorage',
    ...
    function generalesPazSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        requisitosSgrServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "sgrocadpazrequisitosverificacionrequisitos";
        vm.habilitaEnvioSubPaso = false;
        ...
        vm.habilitaBotones = $sessionStorage.HabilitarGuardarPaso;
            ...
            if (errores != undefined) {
                ...
                if (!isValid) {
                    erroresJson[vm.nombreComponente].forEach(p => {
                        ...
                        var atributoError = nameArr[1].toString();
                        if (TipoError == 'ErrorG') {
                            if (atributoError == "0") {
                                $sessionStorage.visualizaEnviarSubpaso = true;
                            } else {
    ...
    angular.module('backbone').component('generalesPazSgr', {
        templateUrl: "src/app/formulario/ventanas/SGR/ocadPaz/requisitos/verificacion/generales/generalesPazSgr.html",
        controller: generalesPazSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
