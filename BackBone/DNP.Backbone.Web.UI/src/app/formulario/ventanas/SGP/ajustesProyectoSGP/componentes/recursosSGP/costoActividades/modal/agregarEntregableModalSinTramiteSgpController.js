(function () {
    ...
    angular.module('backbone')
        .controller('agregarEntregableModalSinTramiteSgpController', agregarEntregableModalSinTramiteSgpController);

    agregarEntregableModalSinTramiteSgpController.$inject = [
        '$scope',
        '$uibModalInstance',
        'utilidades',
        '$filter',
    ...
    function agregarEntregableModalSinTramiteSgpController(
        $scope,
        $uibModalInstance,
        utilidades,
        $filter,
