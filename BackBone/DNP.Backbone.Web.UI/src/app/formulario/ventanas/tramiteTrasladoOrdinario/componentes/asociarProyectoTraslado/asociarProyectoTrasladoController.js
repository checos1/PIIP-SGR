(function () {
    ...
    asociarProyectoTrasladoController.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarProyectoTrasladoController(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
        ...
        if ($sessionStorage.idNivel.toUpperCase() === constantesBackbone.idNivelSeleccionProyectos) 
            ...
            vm.nombreComponenteHijo = "proyectoproyectosasociados";
        ...
        vm.handlerComponentes = [
            ...
            { id: 1, componente: 'proyectoproyectosasociados', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
    ...
    angular.module('backbone').component('asociarProyectoTraslado', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoOrdinario/componentes/asociarProyectoTraslado/asociarProyectoTraslado.html",
        controller: asociarProyectoTrasladoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
