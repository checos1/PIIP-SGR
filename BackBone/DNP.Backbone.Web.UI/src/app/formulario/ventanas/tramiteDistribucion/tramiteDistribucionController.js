(function () {
    'use strict';
     ...
     tramiteDistribucionController.$inject = [
        '$sessionStorage',
        '$scope',
        ...
        'sesionServicios',
        'tramiteDistribucionServicio'
    ];
            
    function tramiteDistribucionController(
        $sessionStorage,
        $scope,
        aclaracionLeyendaServicio,
        constantesBackbone,
       ...
       * */
        ...
        vm.notificacionValidacionHijos = function (errores) {
            ...
            let error = {};
            if (($sessionStorage.sessionDocumentos < 100 || $sessionStorage.sessionDocumentos === undefined) && vm.IdNivel.toLowerCase() === constantesBackbone.idNivelSeleccionProyectos.toLowerCase())  {
                error = {
                    Seccion: "soporte",
    ...
    angular.module('backbone').component('tramiteDistribucion', {
        templateUrl: "src/app/formulario/ventanas/tramiteDistribucion/tramiteDistribucion.html",
        controller: tramiteDistribucionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
