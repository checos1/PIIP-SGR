(function () {
    ...
    distribucionPrController.$inject = ['$scope', '$sessionStorage', 'comunesServicio'];

    function distribucionPrController(
        $scope,
        $sessionStorage,
        comunesServicio
    ) {
    ...
    angular.module('backbone').component('distribucionPr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/Componentes/distribucionPr/distribucionPr.html",
        controller: distribucionPrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
