(function () {
    ...
    tramiteModificacionLeyRedPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionLeyRedPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteProgramacionRecursosServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionLeyRedPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionLeyRed/presupuestoPrel/tramiteModificacionLeyRedPasoCuatro.html",
        controller: tramiteModificacionLeyRedPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
