(function () {
    'use strict';
    angular.module('backbone.entidades').controller('privadasController', privadasController);

    privadasController.$inject = [
        '$scope',
        'servicioEntidades',
    ...
    function privadasController($scope, servicioEntidades, constantesAutorizacion, $uibModal, backboneServicios) {
        ...
        function listarEntidades(entidadeFiltro, cabezaSector, actualizar) {
            if (vm.listaEntidadesOrigem && !actualizar) {
                ...
                servicioEntidades.obtenerEntidadesPorTipo('Privadas')
                    .then(function (response) {
