(function () {
    ...
    firmaEmisionTramiteAdicionSgpController.$inject = [
        '$scope',
        '$location',
        'utilidades',
        '$sessionStorage',
    ...
    function firmaEmisionTramiteAdicionSgpController(
        $scope,
        $location,
        utilidades,
        $sessionStorage,
    ...
    angular.module('backbone').component('firmaEmisionTramiteAdicionSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/adicion/firmaEmisionTramiteAdicionSgp.html",
        controller: firmaEmisionTramiteAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
