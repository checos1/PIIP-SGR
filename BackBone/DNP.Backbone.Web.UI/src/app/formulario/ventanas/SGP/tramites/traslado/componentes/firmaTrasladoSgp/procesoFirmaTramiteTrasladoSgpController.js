(function () {
    ...
    procesoFirmaTramiteTrasladoSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function procesoFirmaTramiteTrasladoSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgpfirmaresponsablestramite";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgpfirmaresponsablestramiteprocesofirmastrasladosgp";
        vm.notificacionCambiosCapitulos = null;
        vm.rol = '00000000-0000-0000-0000-000000000000';
        vm.tipoConceptoViabilidadId = 6;
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";

        vm.handlerComponentes = [
            { id: 1, componente: 'sgpfirmaresponsablestramiteprocesofirmastrasladosgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpfirmaresponsablestramiteprocesofirmastrasladosgp': true
            };
        }
    ...
    angular.module('backbone').component('procesoFirmaTramiteTrasladoSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/traslado/componentes/firmaTrasladoSgp/procesoFirmaTramiteTrasladoSgp.html",
        controller: procesoFirmaTramiteTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
