(function () {
    ...
    enviarProgramaciondetSgpController.$inject = ['$scope', 'gestionRecursosServicio', '$sessionStorage', 'utilidades'];

    function enviarProgramaciondetSgpController(
        $scope,
        ...
        vm.nombreComponente = "sgpgraprobaciondefinitivaaprobaciondefinitivagrsgp";
            ...
            if (rolJefe == false) {
                ...
                for (var sa = 0; sa < listaPreguntasIds.length; sa++) {
                    ...
                    if ($("#" + controlId)[0] != 'undefined' && $("#" + controlId)[0].type != 'radio') {
                        ...
                        else if (valorRespuesta.trim().length == 0) {
    ...
    angular.module('backbone').component('enviarProgramaciondetSgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/recursos/enviarProgramacion/enviarProgramacionDetalle/enviarProgramaciondetSgp.html",
        controller: enviarProgramaciondetSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
