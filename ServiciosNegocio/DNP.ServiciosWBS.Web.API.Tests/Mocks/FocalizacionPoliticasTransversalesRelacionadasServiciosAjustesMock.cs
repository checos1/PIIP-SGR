...
{
    public class FocalizacionPoliticasTransversalesRelacionadasServiciosAjustesMock : IFocalizacionPoliticasTransversalesRelacionadasAjustesServicios
    {
        public ParametrosGuardarDto<PoliticaTransversalRelacionadaAjustesDto> ConstruirParametrosGuardado(HttpRequestMessage request, PoliticaTransversalRelacionadaAjustesDto contenido)
        {
            var parametrosGuardar = new ParametrosGuardarDto<PoliticaTransversalRelacionadaAjustesDto>();
        ...
        public void Guardar(ParametrosGuardarDto<PoliticaTransversalRelacionadaAjustesDto> parametrosGuardar, ParametrosAuditoriaDto parametrosAuditoria, bool guardarTemporalmente)
        {
        ...
        public PoliticaTransversalRelacionadaAjustesDto ObtenerFocalizacionPoliticasTransversalesRelacionadasAjustesServicios(ParametrosConsultaDto parametrosConsulta)
        {
            ...
            {
                return new PoliticaTransversalRelacionadaAjustesDto()
                {
