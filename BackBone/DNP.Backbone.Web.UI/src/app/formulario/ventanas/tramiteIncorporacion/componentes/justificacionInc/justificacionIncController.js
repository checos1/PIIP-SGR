(function () {
    ...
    justificacionIncController.$inject = [
        '$scope',
        'constantesBackbone',
        '$sessionStorage',
    ...
    function justificacionIncController(
        $scope,
        constantesBackbone,
        $sessionStorage
        ...
        vm.init = function () {
            ...
            if ($sessionStorage.idNivel.toUpperCase() === constantesBackbone.idNivelElaboracionConcepto.toUpperCase() ) {
    ...
    angular.module('backbone').component('justificacionInc', {
        templateUrl: "/src/app/formulario/ventanas/tramiteIncorporacion/componentes/justificacionInc/justificacionInc.html",
                   
               
        controller: justificacionIncController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
