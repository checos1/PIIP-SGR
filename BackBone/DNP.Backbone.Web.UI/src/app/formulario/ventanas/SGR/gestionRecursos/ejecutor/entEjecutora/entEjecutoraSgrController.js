(function () {
    ...
    entEjecutoraSgrController.$inject = ['$scope'];

    function entEjecutoraSgrController(
        $scope
    ) {
        var vm = this;
        vm.nombreComponente = "sgrejecutordesignacionentejecutora";
        vm.nombreComponenteHijo = "sgrejecutordesignacionentejecutoraregistrodesignacionejecutor";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrejecutordesignacionentejecutoraregistrodesignacionejecutor', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrejecutordesignacionentejecutoraregistrodesignacionejecutor': true
            };
        };
        ...
        */
        ...
        //        }
        //    } else {
        //        var errorElements = document.getElementsByClassName('errorSeccionEjecutor');
    ...
    angular.module('backbone').component('entEjecutoraSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/gestionRecursos/ejecutor/entEjecutora/entEjecutoraSgr.html",
        controller: entEjecutoraSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
