(function () {
    'use strict';
    registroVotosViabilidadSgrController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function registroVotosViabilidadSgrController(
        utilidades,
        $sessionStorage,
        viabilidadSgrServicio,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "sgrviabilidadregistrovotos";
    ...
    angular.module('backbone').component('registroVotosViabilidadSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctei/viabilidad/viabilidad/registroVotos/registroVotosViabilidadSgr.html",
        controller: registroVotosViabilidadSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
