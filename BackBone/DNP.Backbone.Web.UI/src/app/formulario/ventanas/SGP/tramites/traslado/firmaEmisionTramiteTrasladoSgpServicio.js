(function () {
    ...
    angular.module('backbone').factory('firmaEmisionTramiteTrasladoSgpServicio', firmaEmisionTramiteTrasladoSgpServicio);

    firmaEmisionTramiteTrasladoSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function firmaEmisionTramiteTrasladoSgpServicio($http, constantesBackbone) {
