(function () {
    ...
    asociarProyectovfController.$inject = [
        '$sessionStorage',
        '$scope',
        
    ];

    function asociarProyectovfController(
        $sessionStorage,
        $scope,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "asociarproyecto";
        vm.notificacionCambiosCapitulos = null;
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";

        vm.handlerComponentes = [
            { id: 1, componente: 'asociarproyectoasociarproyecto', handlerValidacion: null, handlerCambios: null, esValido: true },
        ...
        function inicializarDS() {
            //vm.inicializarComponenteCheck();
            //vm.notificacionvalidacion({ handler: vm.notificacionValidacionEvent, nombreComponente: vm.nombreComponente, errores: "" });
        }
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'asociarproyectoasociarproyecto': true,
                // 'archivosenprocesoactual': true,
            };
        }
    ...
    angular.module('backbone').component('asociarProyectovf', {
        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/componentes/asociarProyectovf/asociarProyectovf.html",
        controller: asociarProyectovfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
