(function () {
    ...
    ctusIntegradoElaboracionSgrController.$inject = [
        '$scope',
        'utilidades',
        '$sessionStorage',
        'ctusIntegradoElaboracionSgrServicio',
    ...
    function ctusIntegradoElaboracionSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        ctusIntegradoElaboracionSgrServicio,
        ...
        vm.init = function () {
            ...
            utilsValidacionSeccionCapitulosServicio.getSeccionCapitulo(vm.guiMacroproceso, $sessionStorage.idNivel, $sessionStorage.idFlujoIframe).then(function (respuesta) {
                ...
                var indexobs = respuesta.data.findIndex(p => p.SeccionModificado == 'sgrctusintegradoelaboracionverificacion');
        ...
        * */
        vm.handlerComponentes = [
            ...
            { id: 4, componente: 'sgrctusintegradoviabilidad', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null,handlerInicio: null },
        ...
        function ObtenerProyectoCtus(proyectoId, instanciaId) {
            solicitarCtusSgrServicio.SGR_Proyectos_LeerProyectoCtus(proyectoId, instanciaId)
                .then(function (response) {
                    ...
                    utilidades.mensajeError('Ocurrió un problema al leer la información del concepto integrado.');
                    return "";
                });
        }
        ...
        function eventoValidar() {
            ...
            const seccionCap = 'sgrctusintegradosoportes';

            //validar que obtenerErroresviabilidadSgr sea del servico correcto
            ctusIntegradoElaboracionSgrServicio.obtenerErroresviabilidadSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
        ...
        //function eventoValidar() {
        //    vm.inicializarComponenteCheck();
        //    ctusIntegradoElaboracionSgrServicio.obtenerErroresviabilidadSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {
        ...
        //                        var seccion = 'sgrctusintegradosoportes';
       ...
       */
        vm.showAlertError = function (nombreComponente, esValido) {
            ...
            var nomAlerta = "";
            if (nombreComponente == "sgrctusintegradoelaboracionverificacion" && vm.SeccionIdViabilidad !== '')
            ...
            if (nombreComponente === "sgrctusintegradodsoportes") {
    ...
    angular.module('backbone').component('ctusIntegradoElaboracionSgr', {
        templateUrl: "src/app/formulario/ventanas/SGR/ctusIntegrado/ctusIntegradoElaboracionSgr.html",
        controller: ctusIntegradoElaboracionSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
