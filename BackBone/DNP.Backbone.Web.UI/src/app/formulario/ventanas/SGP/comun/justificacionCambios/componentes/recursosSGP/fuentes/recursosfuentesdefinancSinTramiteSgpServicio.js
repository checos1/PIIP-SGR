(function () {
    'use strict';
    angular.module('backbone').factory('recursosfuentesdefinancSinTramiteSgpServicio', recursosfuentesdefinancSinTramiteSgpServicio);

    recursosfuentesdefinancSinTramiteSgpServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];


    function recursosfuentesdefinancSinTramiteSgpServicio($q, $http, $location, constantesBackbone) {
        return {
