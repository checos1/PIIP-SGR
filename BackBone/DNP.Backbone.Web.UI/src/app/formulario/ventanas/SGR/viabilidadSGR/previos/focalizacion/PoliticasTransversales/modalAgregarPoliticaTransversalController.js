(function () {
    ...
    modalAgregarPoliticaTransversalController.$inject = [
        '$uibModalInstance',
        '$sessionStorage',       
    ...
    function modalAgregarPoliticaTransversalController(
        $uibModalInstance,
        $sessionStorage,
        focalizacionAjustesSgrServicio,
        utilidades
        ...
        function guardar() {
            ...
            return focalizacionAjustesSgrServicio.guardarPoliticasTransversalesAjustes(parametros, usuarioDNP)
        ...
        async function _listarRecursosEntidades(idEntidad) {
            ...
            return focalizacionAjustesSgrServicio.obtenerListaRecursos(parametros, idEntidad)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
    ...
    angular.module('backbone').controller('modalAgregarPoliticaTransversalController', modalAgregarPoliticaTransversalController);
