(function () {
    ...
    categoriaProductosPoliticaController.$inject = [
        '$scope',
        '$sessionStorage',
        'categoriaProductosPoliticaServicio',
        '$anchorScroll',
        '$location',
        'utilidades',
        'guardarDatosSolicitudRecursosServicio',
        '$compile',
        'justificacionCambiosServicio'
    ];

    function categoriaProductosPoliticaController(
        $scope,
        $sessionStorage,
        categoriaProductosPoliticaServicio,
        $anchorScroll,
        ...
        vm.nombreComponente = "focalizaciongrcapitulo1";
        ...
        //Inicio
        vm.init = function () {
            vm.cargarCss('/src/app/formulario/ventanas/gestionRecursos/componentes/categoriaProductosPolitica/categoriaProductosPolitica.css',
                'categoriaProductosPoliticaCss');
    ...
    var app = angular.module('backbone').component('categoriaProductosPolitica', {
        templateUrl: "src/app/formulario/ventanas/gestionRecursos/componentes/categoriaProductosPolitica/categoriaProductosPolitica.html",
        controller: categoriaProductosPoliticaController,
        controllerAs: "vm",
        bindings: {
            guardadoevent: '&',
