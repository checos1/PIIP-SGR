(function () {
    ...
    tramiteModificacionAdicionPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionAdicionPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteProgramacionRecursosServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionAdicionPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionAdicion/presupuestoPrel/tramiteModificacionAdicionPasoCuatro.html",
        controller: tramiteModificacionAdicionPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
