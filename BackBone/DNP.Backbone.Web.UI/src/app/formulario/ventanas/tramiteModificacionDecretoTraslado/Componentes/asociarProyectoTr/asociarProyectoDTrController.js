(function () {
    ...
    asociarProyectoDTrController.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function asociarProyectoDTrController(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
    ...
    angular.module('backbone').component('asociarProyectoDTr', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/componentes/asociarProyectoTr/asociarProyectoDTr.html",
        controller: asociarProyectoDTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
