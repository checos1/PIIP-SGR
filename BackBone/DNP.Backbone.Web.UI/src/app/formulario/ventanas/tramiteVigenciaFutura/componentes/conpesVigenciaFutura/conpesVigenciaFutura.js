(function () {
    ...
    conpesVigenciaFuturaController.$inject = [
        '$scope',
        '$filter',
        'conpesServicio',
        'utilidades',
    ...
    function conpesVigenciaFuturaController(
        $scope,
        $filter,
        conpesServicio,
        utilidades,
        ...
        vm.guardarCompes = function (compesList) {
            ...
            if (compesList === undefined || compesList.lenght === 0) {
                utilidades.mensajeError('Debe seleccionar al menos un CONPES para asociar');
                return;
            }
        ...
        vm.errores = {
            'VFO003': vm.validarValoresVigenciaInformacionPresupuestalConpes
        }
        /* ------------------------ FIN Validaciones ---------------------------------*/
    }


    angular.module('backbone').component('conpesVigenciaFutura', {
        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/componentes/conpesVigenciaFutura/conpesVigenciaFutura.html",
        controller: conpesVigenciaFuturaController,
        controllerAs: "vm",
        bindings: {
            tramiteid: '@',
            guardadoevent: '&',
