(function () {
    ...
    tramiteModificacionDTrasladoPasoCuatroController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionDTrasladoPasoCuatroController(
        $sessionStorage,
        $scope,
        tramiteProgramacionRecursosServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionDTrasladoPasoCuatro', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/presupuestoPrel/tramiteModificacionDTrasladoPasoCuatro.html",
        controller: tramiteModificacionDTrasladoPasoCuatroController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
