(function () {
    ...
    asignacionTecnicoCtusSgrController.$inject = [
        '$scope',
        '$sessionStorage',
        'ctusAsignacionSgrServicio'
    ];

    function asignacionTecnicoCtusSgrController(
        $scope,
        $sessionStorage,
        ctusAsignacionSgrServicio
    ) {
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctusasignaciondelegar', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgrctusasignacionasignar', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (vm.reqEntidad) {
                var listErrorest = {
                    errores: [
                        {
                            Seccion: 'sgrctusasignacion',
                            Capitulo: 'delegar',
                            Errores: '{"sgrctusasignaciondelegar":[{"Error":"DELECTUS-sgrctusasignaciondelegar","Descripcion":"Debe responder esta pregunta."}]}'
                        }
                    ]
                };
    ...
    angular.module('backbone').component('asignacionTecnicoCtusSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctus/asignacion/asignacionTecnico/asignacionTecnicoCtusSgr.html",
        controller: asignacionTecnicoCtusSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
