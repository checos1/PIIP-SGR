(function () {
    ...
    aprobarConceptoVictimasPasoTres.$inject = ['$scope', '$sessionStorage', '$uibModal', 'utilidades',
    ...
    function aprobarConceptoVictimasPasoTres(
        $scope,
        $sessionStorage,
        $uibModal,
        utilidades,
        ...
        var vm = this;
        vm.init = init;
        vm.nombreComponente = "aprobarConceptoVictimasPasoTresFormulario";
    ...
    angular.module('backbone').component('aprobarConceptoVictimasPasoTres', {
        templateUrl: "src/app/formulario/ventanas/comun/programacionRecursos/politicas/aprobarConcepto/aprobarConceptoVictimasPasoTresFormulario.html",
        controller: aprobarConceptoVictimasPasoTres,
        controllerAs: "vm",
        bindings: {
            callback: '&',
