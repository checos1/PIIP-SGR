(function () {
    ...
    informacionUsuariosInvolucradosAdicionSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function informacionUsuariosInvolucradosAdicionSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "usuariosinvolucradossgp";
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'usuariosinvolucradossgptramiteproyectosgp': true
            };
        }
    ...
    angular.module('backbone').component('informacionUsuariosInvolucradosAdicionSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/adicion/componentes/informacionUsuariosSgp/informacionUsuariosInvolucradosAdicionSgp.html",
        controller: informacionUsuariosInvolucradosAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
