(function () {
    ...
    aproentLeyController.$inject = ['$scope',];

    function aproentLeyController(
        $scope,
    ...
    angular.module('backbone').component('aproentLey', {
        templateUrl: "/src/app/formulario/ventanas/tramiteTrasladoLey/componentes/aprobacionEntidad/aproentLey.html",

        controller: aproentLeyController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
