(function () {
	'use strict';
	angular.module('backbone').factory('justificacionHorizonteServicio', justificacionHorizonteServicio);

	justificacionHorizonteServicio.$inject = ['$q', '$http', '$location', 'constantesBackbone'];

	function justificacionHorizonteServicio($q, $http, $location, constantesBackbone) {
		return {
