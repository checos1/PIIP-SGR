(function () {
    ...
    justificacionDistribucionController.$inject = ['$scope',  '$sessionStorage', 'constantesBackbone'];

    function justificacionDistribucionController(
        $scope,
        $sessionStorage,
        constantesBackbone
        ...
        vm.nombreComponenteHijo = "justificacionjustificacion";
        vm.notificacionCambiosCapitulos = null;
        vm.mostrarjustificacion = false;


        vm.handlerComponentes = [
            { id: 1, componente: 'justificacionjustificacion', handlerValidacion: null, handlerCambios: null, esValido: true },
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'justificacionjustificacion': true
            };
        }
    ...
    angular.module('backbone').component('justificacionDistribucion', {
        templateUrl: "src/app/formulario/ventanas/tramiteDistribucion/componentes/justificacion/justificacionDistribucion.html",
        controller: justificacionDistribucionController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
