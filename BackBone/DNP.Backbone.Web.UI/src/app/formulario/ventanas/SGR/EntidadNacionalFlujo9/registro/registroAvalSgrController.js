(function () {
    ...
    registroAvalSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function registroAvalSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrviabilidadavaluso";
        vm.nombreComponenteHijo = "sgrviabilidadavalusoavaluso";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadavalusoavaluso', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrviabilidadavalusoavaluso': true
            };
        }
        ...
        vm.notificacionCambios = function (handler, nombreComponenteHijo) {
            ...
            if (nombreComponenteHijo == "sgrviabilidadavalusoavaluso") {
        ...
        */
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (erroresList.length > 0) {
                ...
                var errorElements = document.getElementsByClassName('errorsgrviabilidadavalusoavaluso');
    ...
    angular.module('backbone').component('registroAvalSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/EntidadNacionalFlujo9/registro/registroAvalSgr.html",
        controller: registroAvalSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
