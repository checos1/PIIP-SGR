(function () {
    ...
    desagregarEdtController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
    ...
    function desagregarEdtController(
        $scope,
        $sessionStorage,
        constantesBackbone,
        justificacionCambiosServicio,
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "desagregaredt";
        ...
        vm.handlerComponentes = [{ id: 1, componente: 'desagregaredtdesagregarcap', handlerValidacion: null, handlerCambios: null, esValido: true }];        
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'desagregaredtdesagregarcap': true
            };
        }
        ...
        */
        ...
        vm.notificacionValidacionEvent = function (listErrores) {
            ...
            if (erroresList.length > 0) {
                ...
                var idSpanAlertComponent = document.getElementById("alert-desagregaredtdesagregarcap-1");
    ...
    angular.module('backbone').component('desagregaredt', {

        templateUrl: "src/app/formulario/ventanas/seguimientoControl/componentes/desagregarEdt/desagregarEdt.html",
        controller: desagregarEdtController,
        controllerAs: "vm",
        bindings: {
            verificacion: '&',
            notificacioncambios: '&',
