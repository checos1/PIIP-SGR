(function () {
    ...
    recursosSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'constantesBackbone',
    ];

    function recursosSgpController(
        $scope,
        $sessionStorage,
        constantesBackbone,
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgprecursos";
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";

        vm.handlerComponentes = [
            { id: 1, componente: 'sgprecursosfuentesfinanciacionsgp', handlerValidacion: null, handlerCambios: null, esValido: true },
            { id: 2, componente: 'sgprecursosregionalizacionsgp', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
        ...
        //vm.recargarRegionalizacion = function (handler) {
        //    vm.recargaRegionalizacionGuardado = handler;
        //}
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgprecursosfuentesfinanciacionsgp': true,
                'sgprecursosregionalizacionsgp': true
            };
        }
        ...
        */
        ...
        vm.notificacionValidacionEvent = function (listErrores) {
            var erroresList = listErrores.errores.filter(p => p.Seccion == vm.nombreComponente || p.Seccion == 'recursos');
            vm.inicializarComponenteCheck();
            vm.esValido = true;
    ...
    angular.module('backbone').component('recursosSgp', {

        templateUrl: "src/app/formulario/ventanas/SGP/gestionRecursosSGP/componentes/recursos/recursosSgp.html",
        controller: recursosSgpController,
        controllerAs: "vm",
        bindings: {
            verificacion: '&',
            modelo: '=',
