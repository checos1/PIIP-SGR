(function () {
    ...
    documentoSoporteTramiteTrasladoOrdinarioController.$inject = ['$scope'];

    function documentoSoporteTramiteTrasladoOrdinarioController(
        $scope
    ) {
        var vm = this;
        vm.nombreComponente = "soporte";
    ...
    angular.module('backbone').component('documentoSoporteTramiteTrasladoOrdinario', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoOrdinario/componentes/documentos/documentoSoporteTramiteTrasladoOrdinario.html",
        controller: documentoSoporteTramiteTrasladoOrdinarioController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
