(function () {
    ...
    angular.module('backbone').factory('viabilidadSgpServicio', viabilidadSgpServicio);

    viabilidadSgpServicio.$inject = ['$http', 'constantesBackbone'];

    function viabilidadSgpServicio($http, constantesBackbone) {
