(function () {
    ...
    conceptosTrasladoController.$inject = ['$scope', 'aclaracionLeyendaServicio'];

    function conceptosTrasladoController(
        $scope,
        ...
        vm.handlerComponentes = [
            ...
            { id: 2, componente: 'conceptoselaborartecnico', handlerValidacion: null, handlerCambios: null, esValido: true },
        ...
        $scope.$watch('vm.tramiteid', function () {
            ...
            if (vm.tramiteid !== '' && vm.tramiteid !== undefined && vm.tramiteid !== null) {
                ...
                vm.muestraCapitulospaso3 = vm.muestracapitulospaso3.toLowerCase() === 'true' ? true : false;
    ...
    angular.module('backbone').component('conceptosTraslado', {
        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoOrdinario/componentes/conceptosTraslado/conceptosTraslado.html",
        controller: conceptosTrasladoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
