(function () {
    ...
    alojarDocumentosViabilidadSgrController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function alojarDocumentosViabilidadSgrController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
        ...
        vm.nombreComponente = "sgrviabilidadsoportes";
        vm.tipotramiteid = $sessionStorage.tipotramiteid;
        vm.tramiteid = $sessionStorage.tipotramiteid;
        vm.nombreComponenteHijo = "sgrviabilidadsoportesalojararchivo";
        vm.notificacionCambiosCapitulos = null;
        vm.rol = null;
        vm.arrowIcoDown = "glyphicon-chevron-down";
        vm.arrowIcoUp = "glyphicon-chevron-up";
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadsoportesalojararchivo', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        vm.handlerComponentesChecked = {};

        vm.init = function () {
            var accionViabilidad = $sessionStorage.listadoAccionesTramite.find(f => f.Ventana == 'viabilidadSgr');
    ...
    angular.module('backbone').component('alojarDocumentosViabilidadSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/viabilidadSGR/viabilidad/soportes/alojarDocumentosViabilidadSgr.html",
        controller: alojarDocumentosViabilidadSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
