(function () {
    ...
    aprobacionEntidadRvfController.$inject = ['$scope',];

    function aprobacionEntidadRvfController(
        $scope,
    ...
    angular.module('backbone').component('aprobacionEntidadRvf', {
        templateUrl: "/src/app/formulario/ventanas/tramiteReprogramacionVF/Componentes/aprobacionEntidadRvf/aprobacionEntidadRvf.html",

        controller: aprobacionEntidadRvfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
