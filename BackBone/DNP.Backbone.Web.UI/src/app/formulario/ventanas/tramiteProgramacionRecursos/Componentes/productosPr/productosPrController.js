(function () {
    ...
    productosPrController.$inject = ['$scope', '$sessionStorage', 'comunesServicio'];

    function productosPrController(
        $scope,
        $sessionStorage,
        comunesServicio
    ) {
    ...
    angular.module('backbone').component('productosPr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/componentes/productosPr/productosPr.html",
        controller: productosPrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
