(function () {
    ...
    tramiteModificacionTrasladoPasoTresController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
    ...
    function tramiteModificacionTrasladoPasoTresController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
    ...
    angular.module('backbone').component('tramiteModificacionTrasladoPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionTraslado/presupuestoPrel/tramiteModificacionTrasladoPasoTres.html",
        controller: tramiteModificacionTrasladoPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
