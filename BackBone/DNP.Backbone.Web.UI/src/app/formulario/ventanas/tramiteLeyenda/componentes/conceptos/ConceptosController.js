(function () {
    ...
    conceptosController.$inject = ['$scope', 'aclaracionLeyendaServicio'];

    function conceptosController(
        $scope,
    ...
    angular.module('backbone').component('conceptos', {
        templateUrl: "src/app/formulario/ventanas/tramiteLeyenda/componentes/conceptos/conceptos.html",
