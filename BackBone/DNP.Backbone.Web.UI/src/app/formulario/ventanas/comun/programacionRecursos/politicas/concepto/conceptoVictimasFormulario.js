var conceptoVictimasCtrl = null;

(function () {
    'use strict';
    angular.module('backbone').controller('conceptoVictimas', conceptoVictimas);
    conceptoVictimas.$inject = [
        '$scope',
        '$sessionStorage',
        '$timeout',
    ...
    function conceptoVictimas(
        ...
        vm.TienePoliticas = 0;
        vm.nombreComponente = "conceptoVictimasFormulario";
        vm.activar = false;
    ...
    angular.module('backbone')
        .component('conceptoVictimas', {
            templateUrl: 'src/app/formulario/ventanas/comun/programacionRecursos/politicas/concepto/conceptoVictimasFormulario.html',
            controller: 'conceptoVictimas',
            controllerAs: 'vm',
            bindings: {
                callback: '&',
