(function () {
    ...
    modalTipoInvitacionUsuarioController.$inject = [
        'actions',
        '$uibModalInstance'
    ];

    function modalTipoInvitacionUsuarioController(
        actions,
        $uibModalInstance
    ) {
        var vm = this;
    ...
    angular.module('backbone.usuarios').controller('modalTipoInvitacionUsuarioController', modalTipoInvitacionUsuarioController);
})();
