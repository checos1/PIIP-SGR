(function () {
    ...
    focalizacionPoliticasTransversalesMl.$inject = ['$scope', '$sessionStorage', 'comunesServicio'];

    function focalizacionPoliticasTransversalesMl(
        $scope,
        $sessionStorage,
        comunesServicio
    ) {
        var vm = this;
        vm.nombreComponente = "focalizacion";
        vm.nombreComponenteHijo = "focalizacionfocalizacionfocalizacionpoliticastransversales";
        vm.notificacionCambiosCapitulos = null;

        vm.handlerComponentes = [
            { id: 1, componente: 'focalizacionfocalizacionfocalizacionpoliticastransversales', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        function validarVariables() {
            if (vm.IdNivel !== undefined && vm.IdEntidad !== undefined && vm.IdSeccionCapitulo !== undefined)
                vm.verificacalendario({ idEntidad: vm.IdEntidad, idNivel: vm.IdNivel, idSeccionCapitulo: vm.IdSeccionCapitulo, seccion: 'politicastransversales' });
        }
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'focalizacionfocalizacionfocalizacionpoliticastransversales': true
            };
        }
    ...
    angular.module('backbone').component('focalizacionPoliticasTransversalesMl', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionLeyPoliticas/Componentes/politicasTransversalesMl/politicasTransversalesMl.html",
        controller: focalizacionPoliticasTransversalesMl,
        controllerAs: "vm",
        bindings: {
            callback: '&',
