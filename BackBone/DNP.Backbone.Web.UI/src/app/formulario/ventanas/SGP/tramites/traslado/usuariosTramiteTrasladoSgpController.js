(function () {
    ...
    usuariosTramiteTrasladoSgpController.$inject = [
        '$scope',
        '$location',
        'utilidades',
        '$sessionStorage',
        'usuariosTramiteTrasladoSgpServicio',
    ...
    function usuariosTramiteTrasladoSgpController(
        $scope,
        $location,
        utilidades,
        $sessionStorage,
        ...
        vm.section = "usuariosinvolucradossgp";
        vm.BPIN = undefined;
       ...
       * */
        vm.handlerComponentes = [
            { id: 1, componente: 'usuariosinvolucradossgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [], esValido: true, errores: null },
            { id: 2, componente: 'aprobaciontramitesgp', handlerValidacion: null, handlerCambios: null, handlerCapitulos: [], esValido: true, errores: null }            
        ];
        ...
        vm.inicializarComponenteCheck = function (estado) {
            ...
            vm.handlerComponentesChecked = {
                'usuariosinvolucradossgp': true,
                'aprobaciontramitesgp': true
            };
        }
    ...
    angular.module('backbone').component('usuariosTramiteTrasladoSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/traslado/usuariosTramiteTrasladoSgp.html",
        controller: usuariosTramiteTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
