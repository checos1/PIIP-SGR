(function () {
    'use strict';
    cuestionarioViabilidadSectorialSgpController.$inject = [
        'utilidades',
        '$sessionStorage',
    ...
    function cuestionarioViabilidadSectorialSgpController(
        utilidades,
        $sessionStorage,
        viabilidadSgpServicio,
        justificacionCambiosServicio,
        ...
        vm.user = {};
        vm.lang = "es";
        vm.nombreComponente = "cuestionarioViabilidadSectorialSgp";
        ...
        vm.guardar = function (response) {
            ...
            ObtenerSeccionCapitulo("sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsgp");
        ...
        function ObtenerSeccionCapitulo(nombreComponente) {
            const span = document.getElementById('id-capitulo-' + 'sgpviabilidadviabilidadInformacionBasicaviabilidadsectorialsgp');
    ...
    angular.module('backbone').component('cuestionarioViabilidadSectorialSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/comun/cuestionarioSectorialSgp/cuestionarioViabilidadSectorialSgp.html",
        controller: cuestionarioViabilidadSectorialSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
