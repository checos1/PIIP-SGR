(function () {
    ...
    regionalizacionPrController.$inject = ['$scope', '$sessionStorage', 'comunesServicio'];

    function regionalizacionPrController(
        $scope,
        $sessionStorage,
        comunesServicio
    ...
    angular.module('backbone').component('regionalizacionPr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/Componentes/regionalizacionPr/regionalizacionPr.html",
        controller: regionalizacionPrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
