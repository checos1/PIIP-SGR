(function () {
    ...
    iniciativasPrController.$inject = ['$scope', '$sessionStorage','comunesServicio'];

    function iniciativasPrController(
        $scope,
        $sessionStorage,
        comunesServicio
        ...
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "iniciativas";
        vm.nombreComponenteHijo = "iniciativasiniciativasinversion";
        vm.notificacionCambiosCapitulos = null;
        

        vm.handlerComponentes = [
            { id: 1, componente: 'iniciativasiniciativasinversion', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        function validarVariables() {
            if (vm.IdNivel !== undefined && vm.IdEntidad !== undefined && vm.IdSeccionCapitulo !== undefined)
                vm.verificacalendario({ idEntidad: vm.IdEntidad, idNivel: vm.IdNivel, idSeccionCapitulo: vm.IdSeccionCapitulo, seccion:'iniciativas' });
        }
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'iniciativasiniciativasinversion': true
            };
        }
    ...
    angular.module('backbone').component('iniciativasPr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteProgramacionRecursos/componentes/iniciativasPr/iniciativasPr.html",
        controller: iniciativasPrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
