(function () {
    ...
    angular.module('backbone').component('cuestionarioViabilidadSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/viabilidadSGP/viabilidad/viabilidad/cuestionarioViabilidad/cuestionarioViabilidadSgp.html",
        controller: cuestionarioViabilidadSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
