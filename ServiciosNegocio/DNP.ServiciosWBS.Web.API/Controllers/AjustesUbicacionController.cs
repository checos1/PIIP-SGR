namespace DNP.ServiciosWBS.Web.API.Controllers
{
    ...
    public class AjustesUbicacionController : ApiController
    {
        private readonly IAjustesUbicacionServicios _ajustesUbicacionServicios;
        private readonly IAutorizacionUtilidades _autorizacionUtilidades;

        public AjustesUbicacionController(IAjustesUbicacionServicios ajustesUbicacionServicios, IAutorizacionUtilidades autorizacionUtilidades)
        {
            _ajustesUbicacionServicios = ajustesUbicacionServicios;
            _autorizacionUtilidades = autorizacionUtilidades;
        }

        [Route("api/DNP_SN_Eje_Ajustes_UbicacionesDto")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion de la Ubicación", typeof(AjustesUbicacionDto))]
        [HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings["consultarAjustesUbicacion"]).
                                            Result;
                ...
                var result =
                    await Task.Run(() => _ajustesUbicacionServicios.ObtenerAjustesUbicacion(new ParametrosConsultaDto
                    {
                        Bpin =
                                                                                          bpin,
                        AccionId
                ...
                if (result != null) return Ok<AjustesUbicacionDto>(result);
        ...
        [Route("api/DNP_SN_Eje_Ajustes_UbicacionesDto/Preview")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion de la Ubicación dummy", typeof(AjustesUbicacionDto))]
        [HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           RequestContext.Principal.Identity.GetHashCode().ToString(),
                                                           ConfigurationManager.AppSettings["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["previewAjustesUbicacion"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var result = await Task.Run(() => _ajustesUbicacionServicios.ObtenerAjustesUbicacionPreview());

                return Ok<AjustesUbicacionDto>(result);
            }
            catch (AutorizacionException e)
            {
                throw new HttpResponseException(Request.CreateErrorResponse(HttpStatusCode.Unauthorized, e));
        ...
        [Route("api/DNP_SN_Eje_Ajustes_UbicacionesDto/Temporal")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion devuelta por guardado temporal", typeof(HttpResponseMessage))]
        [HttpPost]
        public async Task<IHttpActionResult> Temporal(AjustesUbicacionDto contenido)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           RequestContext.Principal.Identity.GetHashCode().ToString(),
                                                           ConfigurationManager.AppSettings["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["postAjustesUbicacionTemporal"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var parametrosGuardar = _ajustesUbicacionServicios.ConstruirParametrosGuardado(Request, contenido);
                ...
                await Task.Run((Action)(() => _ajustesUbicacionServicios.Guardar(parametrosGuardar, parametrosAuditoria, true)));
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Definitivo([FromBody] AjustesUbicacionDto proyecto)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           RequestContext.Principal.Identity.GetHashCode().ToString(),
                                                           ConfigurationManager.AppSettings["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["postAjustesUbicacionDefinitivo"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);


                var parametrosGuardar = _ajustesUbicacionServicios.ConstruirParametrosGuardado(Request, proyecto);
                ...
                await Task.Run((Action)(() => _ajustesUbicacionServicios.Guardar(parametrosGuardar, parametrosAuditoria, false)));
