(function () {
    ...
    ResumenController.$inject = ['$scope', '$sessionStorage', '$uibModal', 'utilidades',
        'constantesBackbone', '$timeout', 'focalizacionAjustesServicio', 'justificacionCambiosServicio'
    ];

    function ResumenController(
        $scope,
        $sessionStorage,
        $uibModal,  
        utilidades,
        ...
        var vm = this;
        vm.init = init;
        vm.nombreComponente = "focalizacionresumen";
        ...
        vm.obtenerPoliticasTransversalesResumen = function (bpin) {
            ...
            return focalizacionAjustesServicio.ObtenerPoliticasTransversalesResumen($sessionStorage.idInstancia, usuarioDNP, idInstancia).then(
                function (respuesta) {
    ...
    angular.module('backbone').component('resumen', {
        templateUrl: "src/app/formulario/ventanas/ajustes/componentes/focalizacion/Resumen/Resumen.html",
