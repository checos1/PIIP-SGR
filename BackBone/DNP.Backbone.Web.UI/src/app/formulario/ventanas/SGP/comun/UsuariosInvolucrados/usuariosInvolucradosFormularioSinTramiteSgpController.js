(function () {
    ...
    usuariosInvolucradosFormularioSinTramiteSgpController.$inject = [
        '$scope',
    ...
    function usuariosInvolucradosFormularioSinTramiteSgpController(
        $scope,
        usuariosInvolucradosSgpServicio,
        $sessionStorage,
        utilidades,
        ...
        function consultar() { 
            ObtenerProyectoViabilidadInvolucrados($sessionStorage.proyectoId, vm.IdInstancia, vm.tipoConceptoId);
        }
        ...
        function Guardar(involucrado) {
            involucrado.ProyectoId = $sessionStorage.proyectoId;
        ...
        function abrirModalAgregarInvolucrado(TipoRolConcepto) {
            ...
            var data = {
                TipoConceptoViabilidadId: vm.tipoConceptoId,
                TipoRolConceptoId: TipoRolConcepto.TipoRolConceptoId,
                TipoConceptoViabilidad: TipoRolConcepto.TipoConceptoViabilidad,
            ...
            let modalInstance = $uibModal.open({
                ...
                templateUrl: "/src/app/formulario/ventanas/SGP/comun/usuariosInvolucrados/modalAgregarInvolucradosSinTramiteSgp.html",
                controller: 'modalAgregarInvolucradosSinTramiteSgpController',
                controllerAs: "vm",
    ...
    angular.module('backbone').component('usuariosInvolucradosFormularioSinTramiteSgp', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "/src/app/formulario/ventanas/SGP/comun/usuariosInvolucrados/usuariosInvolucradosFormularioSinTramiteSgp.html",
        controller: usuariosInvolucradosFormularioSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
