(function () {
    'use strict';
     ...
     tramiteCargueMasivoController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
        ...
        'sesionServicios',
        'tramiteCargueMasivoServicio'
    ];
            
    function tramiteCargueMasivoController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
        ...
        * */
        vm.handlerComponentes = [
            { id: 1, componente: 'seleccionarcargue', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
        ...
        function eventoValidar() {
            ...
            var error = false;
            tramiteCargueMasivoServicio.obtenerErroresTramite(vm.guiMacroproceso, vm.instanciaId, vm.accionId, vm.TieneCDP).then(function (respuesta) {
                if (respuesta.data != null) {
                    ...
                    vm.visualizarAlerta(false, false);
                }
                
            });

            //    //ESTO SE DEBE BORRAR SOLO ES PARA LAS PRUEBAS
            //let findErrors = -1
            //vm.visualizarAlerta((findErrors != -1), false);
        ...
        vm.notificacionValidacionHijos = function (errores) {
            ...
            if ($sessionStorage.sessionDocumentos < 100 && vm.IdNivel.toLowerCase() === constantesBackbone.idNivelSeleccionProyectos.toLowerCase()) {
                error = {
                    Seccion: "soporte",
    ...
    angular.module('backbone').component('tramiteCargueMasivo', {
        templateUrl: "src/app/formulario/ventanas/tramiteCargueMasivo/tramiteCargueMasivo.html",        
        controller: tramiteCargueMasivoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
