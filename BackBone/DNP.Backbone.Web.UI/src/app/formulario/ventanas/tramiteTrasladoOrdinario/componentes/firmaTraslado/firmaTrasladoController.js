(function () {
    ...
    firmaTrasladoController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
        'trasladosServicio'
    ...
    function firmaTrasladoController(
        $scope,
        $sessionStorage,
        utilidades,
        trasladosServicio
    ...
    angular.module('backbone').component('firmaTraslado', {

        templateUrl: "src/app/formulario/ventanas/tramiteTrasladoOrdinario/componentes/firmaTraslado/firmaTraslado.html",
        controller: firmaTrasladoController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
