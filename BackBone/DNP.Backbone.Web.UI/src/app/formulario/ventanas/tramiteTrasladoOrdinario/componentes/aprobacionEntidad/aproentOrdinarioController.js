(function () {
    ...
    aproentOrdinarioController.$inject = ['$scope',];

    function aproentOrdinarioController(
        $scope,
    ...
    angular.module('backbone').component('aproentOrdinario', {
        templateUrl: "/src/app/formulario/ventanas/tramiteTrasladoOrdinario/componentes/aprobacionEntidad/aproentOrdinario.html",
        controller: aproentOrdinarioController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
