(function () {
    ...
    detalleMuchosProyectosSgpFormulario.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
        'flujoServicios',
    ...
    function detalleMuchosProyectosSgpFormulario(
        $sessionStorage,
        sesionServicios,
        utilidades,
        flujoServicios,
    ...
    angular.module('backbone').component('detalleMuchosProyectosSgpFormulario', {
        templateUrl: "src/app/formulario/ventanas/comun/asociarMuchosProyectos/detalleMuchosProyectos/detalleMuchosProyectosSgpFormulario.html",
        controller: detalleMuchosProyectosSgpFormulario,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
