namespace DNP.ServiciosWBS.Web.API.Controllers
{
    ...
    public class CuantificacionBeneficiarioController : ApiController
    {
        private readonly ICuantificacionBeneficiarioServicios _cuantificacionBeneficiarioServicios;
        private readonly IAutorizacionUtilidades _autorizacionUtilidades;

        public CuantificacionBeneficiarioController(ICuantificacionBeneficiarioServicios cuantificacionBeneficiarioServicios, IAutorizacionUtilidades autorizacionUtilidades)
        {
            _cuantificacionBeneficiarioServicios = cuantificacionBeneficiarioServicios;
            _autorizacionUtilidades = autorizacionUtilidades;
        }

        [Route("api/CuantificacionBeneficiario")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion de la cuantificación del beneficiario", typeof(PoblacionDto))]
        [HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings["consultarCuantificacionBeneficiario"]).
                                            Result;
                ...
                var result =
                    await Task.Run(() => _cuantificacionBeneficiarioServicios.ObtenerCuantificacionBeneficiario(new ParametrosConsultaDto
                    {
                        Bpin =
                                                                                          bpin,
                        AccionId
        ...
        [Route("api/CuantificacionBeneficiario/Preview")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion de la cuantificacion del beneficiario priview", typeof(PoblacionDto))]
        [HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["PreviewCuantificacionBeneficiario"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var result = await Task.Run(() => _cuantificacionBeneficiarioServicios.ObtenerCuantificacionBeneficiarioPreview());
        ...
        [Route("api/CuantificacionBeneficiario/Temporal")]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["postCuantificacionBeneficiarioTemporal"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var parametrosGuardar = _cuantificacionBeneficiarioServicios.ConstruirParametrosGuardado(Request, contenido);
                ...
                await Task.Run((Action)(() => _cuantificacionBeneficiarioServicios.Guardar(parametrosGuardar, parametrosAuditoria, true)));
        ...
        public async Task<IHttpActionResult> Definitivo([FromBody] PoblacionDto proyecto)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings
                                                               ["postCuantificacionBeneficiarioDefinitivo"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);


                var parametrosGuardar = _cuantificacionBeneficiarioServicios.ConstruirParametrosGuardado(Request, proyecto);
                ...
                await Task.Run((Action)(() => _cuantificacionBeneficiarioServicios.Guardar(parametrosGuardar, parametrosAuditoria, false)));
