(function () {
    ...
    requisitosPazSgrController.$inject = [
        '$rootScope',
        'utilidades',
        '$sessionStorage',
        '$uibModal',
    ...
    function requisitosPazSgrController(
        $scope,
        utilidades,
        $sessionStorage,
        $uibModal,
        ...
        //vm.documentoOtroSectorObligatorio = false;
        ...
        vm.init = function () {
            ...
            transversalSgrServicio.SGR_Transversal_LeerParametro("IdPreguntaInsumoOtroSector")
            ...
            var accionRequisitos = $sessionStorage.listadoAccionesTramite.find(f => f.Ventana == 'requisitosOcadPazSgr');
        ...
        * */
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrviabilidadrequisitosdatosgenerales', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
            { id: 2, componente: 'sgrocadpazrequisitosverificacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
            { id: 3, componente: 'sgrviabilidadrequisitossoportes', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null }
        ];
        ...
        vm.inicializarComponenteCheck = function (estado) {
            ...
            vm.handlerComponentesChecked = {
                ...
                'sgrocadpazrequisitosverificacion': true,
                'sgrviabilidadrequisitossoportes': true
            };
        }
        ...
        function eventoValidar() {
            ...
            const seccionCap = 'sgrviabilidadrequisitossoportes';

            //validar que obtenerErroresviabilidadSgr sea del servico correcto
            requisitosSgrServicio.obtenerErroresviabilidadSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
                ...
                .then(respVal => {
                    ...
                    if (respVal > 1) {
                        $sessionStorage.visualizaEnviarSubpaso = false;
                        $scope.$broadcast("visualizaEnviarSubpaso", $sessionStorage.visualizaEnviarSubpaso);
                    }
        ...
        //function eventoValidar() {
        //    vm.inicializarComponenteCheck();
        //    requisitosSgrServicio.obtenerErroresviabilidadSgr(vm.guiMacroproceso, vm.ProyectoId, vm.IdNivel, vm.idInstancia).then(function (respuesta) {
        ...
        //                        var seccion = 'sgrviabilidadrequisitossoportes'
       ...
       */
        vm.showAlertError = function (nombreComponente, esValido) {
            var nomAlerta = "";
            if (nombreComponente == "sgrocadpazrequisitosverificacion" && vm.SeccionIdViabilidad !== '')
        ...
        vm.notificacionCambios = function (nombreComponente, nombreComponenteHijo) {
            ...
            if (nombreComponente == "sgrocadpazrequisitosverificacion") {
    ...
    angular.module('backbone').component('requisitosPazSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ocadPaz/requisitosPazSgr.html",
        controller: requisitosPazSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&'
        }
