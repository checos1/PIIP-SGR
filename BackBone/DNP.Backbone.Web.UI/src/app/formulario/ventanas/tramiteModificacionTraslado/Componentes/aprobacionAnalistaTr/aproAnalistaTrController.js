(function () {
    ...
    aproAnalistaTrController.$inject = ['$scope',];

    function aproAnalistaTrController(
        $scope,
    ...
    angular.module('backbone').component('aproAnalistaTr', {
        templateUrl: "/src/app/formulario/ventanas/tramiteModificacionTraslado/componentes/aprobacionAnalistaTr/aproAnalistaTr.html",
        controller: aproAnalistaTrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
