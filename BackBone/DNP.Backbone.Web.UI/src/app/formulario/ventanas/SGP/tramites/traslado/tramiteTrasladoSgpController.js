(function () {
    ...
    tramiteTrasladoSgpController.$inject = [
        '$sessionStorage',
        '$scope',
        'constantesBackbone',
        'utilidades',
    ...
    function tramiteTrasladoSgpController(
        $sessionStorage,
        $scope,
        constantesBackbone,
        utilidades,
    ...
    angular.module('backbone').component('tramiteTrasladoSgp', {        
        templateUrl: "src/app/formulario/ventanas/SGP/tramites/traslado/tramiteTrasladoSgp.html",
        controller: tramiteTrasladoSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&',
