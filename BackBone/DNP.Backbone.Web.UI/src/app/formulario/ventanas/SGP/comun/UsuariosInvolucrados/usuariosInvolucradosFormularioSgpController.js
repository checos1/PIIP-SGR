(function () {
    ...
    usuariosInvolucradosFormularioSgpController.$inject = [
        '$scope',
    ...
    function usuariosInvolucradosFormularioSgpController(
        $scope,
        usuariosInvolucradosSgpServicio,
        $sessionStorage,
        utilidades,
        ...
        function consultar() { 
            ObtenerProyectoViabilidadInvolucrados($sessionStorage.proyectoId, vm.IdInstancia, 1);
        }
            ...
            utilidades.mensajeWarning(
                ...
                function funcionContinuar() {
                    ...
                    usuariosInvolucradosSgpServicio.EliminarProyectoViabilidadInvolucrados(Id).then(function () {
                        vm.involucradosConador = vm.involucrados.filter(x => x.Nombre !== null);

                        if (vm.involucradosConador.length == 1) {
        ...
        function abrirModalAgregarInvolucrado(TipoRolConcepto) {
            ...
            let modalInstance = $uibModal.open({
                ...
                templateUrl: "/src/app/formulario/ventanas/SGP/comun/UsuariosInvolucrados/modalAgregarInvolucradosSgp.html",
                controller: 'modalAgregarInvolucradosSgpController',
                controllerAs: "vm",
    ...
    angular.module('backbone').component('usuariosInvolucradosFormularioSgp', {
        restrict: 'E',
        transclude: true,
        scope: {
            modelo: '='
        },
        templateUrl: "/src/app/formulario/ventanas/SGP/comun/usuariosInvolucrados/usuariosInvolucradosFormularioSgp.html",
        controller: usuariosInvolucradosFormularioSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
