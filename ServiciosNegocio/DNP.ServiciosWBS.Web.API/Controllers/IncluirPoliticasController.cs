...
{
    public class IncluirPoliticasController : ApiController
    {
        private readonly IAutorizacionUtilidades _autorizacionUtilidades;
        private readonly IIncluirPoliticasServicios _incluirPoliticasServicios;

        public IncluirPoliticasController(IAutorizacionUtilidades autorizacionUtilidades, IIncluirPoliticasServicios incluirPoliticasServicios)
        {
            _autorizacionUtilidades = autorizacionUtilidades;
            _incluirPoliticasServicios = incluirPoliticasServicios;
        }
        [System.Web.Http.Route("api/DNP_SN_Pla_DistriRec_IncluirPoliticasTDto")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion del proyecto Agregar Politicas", typeof(IncluirPoliticasTDto))]
        ...
        public async Task<IHttpActionResult> Consultar(string bpin)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.
                                                               AppSettings["consultarAgregarPoliticas"]).
                                            Result;
                ...
                var result =
                    await Task.Run(() => _incluirPoliticasServicios.ObtenerIncluirPoliticas(new ParametrosConsultaDto
                    {
                        Bpin
                                                                                                  =
                                                                                                  bpin,
                ...
                if (result != null) return Ok<IncluirPoliticasTDto>(result);
        ...
        [System.Web.Http.Route("api/DNP_SN_Pla_DistriRec_IncluirPoliticasTDto/Preview")]
        [SwaggerResponse(HttpStatusCode.OK, "Información del proyecto detallando su agregar politicas con información dummy", typeof(IncluirPoliticasTDto))]
        [System.Web.Http.HttpGet]
            ...
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings["previewAgregarPoliticas"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var result = await Task.Run(() => _incluirPoliticasServicios.ObtenerIncluirPoliticasPreview());

                return Ok<IncluirPoliticasTDto>(result);
            }
            catch (AutorizacionException e)
            {
                throw new HttpResponseException(Request.CreateErrorResponse(HttpStatusCode.Unauthorized, e));
        ...
        [System.Web.Http.Route("api/DNP_SN_Pla_DistriRec_IncluirPoliticasTDto/Temporal")]
        [SwaggerResponse(HttpStatusCode.OK, "Informacion devuelta por guardado temporal", typeof(HttpResponseMessage))]
        [System.Web.Http.HttpPost]
        public async Task<IHttpActionResult> Temporal(IncluirPoliticasTDto contenido)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings
                                                               ["postAgregarPoliticasTemporal"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);

                var parametrosGuardar = _incluirPoliticasServicios.ConstruirParametrosGuardado(Request, contenido);
                ...
                await Task.Run((Action)(() => _incluirPoliticasServicios.Guardar(parametrosGuardar, parametrosAuditoria, true)));
        ...
        [System.Web.Http.HttpPost]
        public async Task<IHttpActionResult> Definitivo([FromBody] IncluirPoliticasTDto proyecto)
        {
            try
            {
                var respuestaAutorizacion = _autorizacionUtilidades.
                                            ValidarUsuario(RequestContext.Principal.Identity.Name,
                                                           ...
                                                           ConfigurationManager.AppSettings
                                                               ["idAdministracionEnAutorizaciones"],
                                                           ConfigurationManager.AppSettings
                                                               ["postAgregarPoliticas"]).
                                            Result;

                if (!respuestaAutorizacion.IsSuccessStatusCode) return ResponseMessage(respuestaAutorizacion);


                var parametrosGuardar = _incluirPoliticasServicios.ConstruirParametrosGuardado(Request, proyecto);
                ...
                await Task.Run((Action)(() => _incluirPoliticasServicios.Guardar(parametrosGuardar, parametrosAuditoria, false)));
