(function () {
    ...
    elaborarConceptovfController.$inject = [
        '$sessionStorage',
        'archivoServicios',
        '$scope',
        'servicioAcciones',
    ...
    function elaborarConceptovfController(
        $sessionStorage,
        archivoServicios,
        $scope,
        servicioAcciones,
        ...
        $scope.$watch('vm.tramiteid', function () {
            if (vm.tramiteid !== '' && vm.tramiteid !== undefined && vm.tramiteid !== null) {
                if ($sessionStorage.tipoTramiteId ===undefined) $sessionStorage.tipoTramiteId = vm.tipotramiteid;
                if ($sessionStorage.tramiteId === undefined) $sessionStorage.tramiteId = vm.tramiteid;
        ...
        vm.notificacionValidacionPadre = function (errores) {
            ...
            if (errores != undefined) {
                let valido = true;
                var erroresRelacionconlapl = errores.find(p => (p.Seccion + p.Capitulo) == vm.nombreComponenteDatosIniciales);
                if (erroresRelacionconlapl != undefined) {
                    ...
                    MostrarMensaje();
                    vm.notificacionestado({ nombreComponente: vm.nombreComponenteDatosIniciales, esValido: valido });
                }
        ...
        vm.guardadoEC = function (nombreComponenteHijo) {
            vm.callback();
        ...
        vm.verPdf = function () {
            ...
            tramiteVigenciaFuturaServicio.generarPdfCartaTramiteVf(tramiteId, true, "VF");
        }

    }

    angular.module('backbone').component('elaborarConceptovf', {
        templateUrl: "src/app/formulario/ventanas/tramiteVigenciaFutura/aprobacion/componentes/concepto/elaborarConcepto/elaborarConceptovf.html",
        controller: elaborarConceptovfController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
