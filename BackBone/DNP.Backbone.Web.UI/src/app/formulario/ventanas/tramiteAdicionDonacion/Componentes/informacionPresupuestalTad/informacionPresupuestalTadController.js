(function () {
    ...
    informacionPresupuestalTadController.$inject = [
        '$scope',

    ];

    function informacionPresupuestalTadController(
        $scope,
    ...
    angular.module('backbone').component('informacionPresupuestalTad', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/componentes/informacionPresupuestalTad/informacionPresupuestalTad.html",
                   
               
        controller: informacionPresupuestalTadController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
