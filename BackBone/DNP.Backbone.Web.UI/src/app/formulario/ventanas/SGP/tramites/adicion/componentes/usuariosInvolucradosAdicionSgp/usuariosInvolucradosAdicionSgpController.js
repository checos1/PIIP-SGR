(function () {
    ...
    usuariosInvolucradosAdicionSgpController.$inject = [
        '$scope',
        '$sessionStorage',
    ];

    function usuariosInvolucradosAdicionSgpController(
        $scope,
        $sessionStorage,
    ) {
        var vm = this;
    ...
    angular.module('backbone').component('usuariosInvolucradosAdicionSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/adicion/componentes/usuariosInvolucradosAdicionSgp/usuariosInvolucradosAdicionSgp.html",
        controller: usuariosInvolucradosAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
