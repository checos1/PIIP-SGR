(function () {
    ...
    proyectosTadPasoTresController.$inject = [
        '$scope',
        '$sessionStorage',
    ...
    function proyectosTadPasoTresController(
        $scope,
        $sessionStorage,
        tramiteVigenciaFuturaServicio,
        utilidades,
    ...
    angular.module('backbone').component('proyectosTadPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteAdicionDonacion/Componentes/proyectosTad/proyectosTadPasoTres.html",
               
        controller: proyectosTadPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
