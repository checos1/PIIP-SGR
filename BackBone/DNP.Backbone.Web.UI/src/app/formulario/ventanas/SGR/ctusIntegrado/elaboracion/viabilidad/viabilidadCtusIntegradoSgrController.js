(function () {
    'use strict';
    viabilidadCtusIntegradoSgrController.$inject = [
        '$scope',
        '$sessionStorage',
        'viabilidadSgrServicio'
    ];

    function viabilidadCtusIntegradoSgrController(
        $scope,
        $sessionStorage,
        viabilidadSgrServicio
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgrctusintegradoviabilidad";
        vm.nombreComponenteHijo = "sgrctusintegradoviabilidadcuestionarioviabilidad";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrctusintegradoviabilidadcuestionarioviabilidad', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgrctusintegradoviabilidadcuestionarioviabilidad': true
            };
        }
    ...
    angular.module('backbone').component('viabilidadCtusIntegradoSgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/ctusIntegrado/elaboracion/viabilidad/viabilidadCtusIntegradoSgr.html",
        controller: viabilidadCtusIntegradoSgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
