(function () {
    ...
    tramiteReprogramacionVfPasoUnoController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteReprogramacionVfPasoUnoController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteReprogramacionVfPasoUno', {
        templateUrl: "src/app/formulario/ventanas/tramiteReprogramacionVF/tramiteReprogramacionVfPasoUno.html",
        controller: tramiteReprogramacionVfPasoUnoController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
