(function () {
    ...
    recursosregionalizacionSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        ...
        'constantesBackbone',
        'recursosregionalizacionSinTramiteSgpServicio'
    ];

    function recursosregionalizacionSinTramiteSgpController($scope,
        $sessionStorage,
        recursosfuentesdefinancServicio,
        utilidades,
        justificacionCambiosServicio,
        ...
        function obtenerDetalleAjustesJustificaionRegionalizacion() {
            return recursosregionalizacionSinTramiteSgpServicio.obtenerDetalleAjustesJustificaionRegionalizacion(vm.BPIN, vm.idUsuario, vm.idInstancia).then(
                function (respuesta) {
                    if (respuesta.data != null && respuesta.data != "") {
        ...
        vm.limpiarErrores = function () {
            var campoObligatorioJustificacion = document.getElementById("recursossgpregionalizacionsintramitesgp-justificacion-error");
            var ValidacionFFR1Error = document.getElementById("recursossgpregionalizacionsintramitesgp-justificacion-error-mns");
    ...
    angular.module('backbone').component('recursossgpregionalizacionsintramitesgp', {
        templateUrl: "src/app/formulario/ventanas/SGP/comun/justificacionCambios/componentes/recursosSGP/regionalizacion/recursosregionalizacionSinTramiteSgp.html",
        controller: recursosregionalizacionSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
