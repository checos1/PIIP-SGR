(function () {
    ...
    proyectosTmlrController.$inject = [
        '$sessionStorage',
        'sesionServicios',
        'utilidades',
    ...
    function proyectosTmlrController(
        $sessionStorage,
        sesionServicios,
        utilidades,
        tramiteVigenciaFuturaServicio,
    ...
    angular.module('backbone').component('proyectosTmlr', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionLeyRed/componentes/proyectosTmlr/proyectosTmlr.html",
        controller: proyectosTmlrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            guardadoevent: '&',
