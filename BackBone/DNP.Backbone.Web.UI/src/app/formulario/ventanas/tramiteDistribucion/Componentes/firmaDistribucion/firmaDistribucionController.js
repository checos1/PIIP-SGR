(function () {
    ...
    firmaDistribucionController.$inject = [
        '$scope',
        '$sessionStorage',
        'utilidades',
        'trasladosServicio'
    ...
    function firmaDistribucionController(
        $scope,
        $sessionStorage,
        utilidades,
        trasladosServicio
    ...
    angular.module('backbone').component('firmaDistribucion', {

        templateUrl: "src/app/formulario/ventanas/tramiteDistribucion/componentes/firmaDistribucion/firmaDistribucion.html",
        controller: firmaDistribucionController,
        controllerAs: "vm",
        bindings: {
            disabled: '=',
            callback: '&',
