(function () {
    ...
    aprobacionEntidadController.$inject = [
        '$scope',
        'aprobacionEntidadServicio',
        '$sessionStorage',
        'utilidades',
        'constantesBackbone'
    ];

    function aprobacionEntidadController(
        $scope,
        $sessionStorage,
        aprobacionEntidadServicio,
        utilidades,
       ...
       // vm.usuario = $sessionStorage.usuario.permisos.IdUsuarioDNP;
        ...
        // se coloca el nombre del componenete de sql
    ...
    angular.module('backbone').component('aprobacionEntidad', {
        templateUrl: "src/app/formulario/ventanas/tramiteLeyenda/componentes/aprobacionEntidad/aprobacionEntidad.html",
        controller: aprobacionEntidadController,
        controllerAs: "vm",
        bindings: {
            notificarGuardado: '&',
            callback: '&',
