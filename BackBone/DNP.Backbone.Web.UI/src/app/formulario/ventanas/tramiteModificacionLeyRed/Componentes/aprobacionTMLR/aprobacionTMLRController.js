(function () {
    ...
    aprobacionTmlrController.$inject = ['$scope',];

    function aprobacionTmlrController(
        $scope,
    ...
    angular.module('backbone').component('aprobacionTmlr', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionLeyRed/componentes/aprobacionTmlr/aprobacionTmlr.html",

        controller: aprobacionTmlrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
