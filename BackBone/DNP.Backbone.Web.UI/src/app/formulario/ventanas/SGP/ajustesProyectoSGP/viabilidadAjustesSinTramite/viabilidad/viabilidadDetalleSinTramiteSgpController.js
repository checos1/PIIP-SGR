(function () {
    'use strict';
    viabilidadDetalleSinTramiteSgpController.$inject = [
        '$scope',
        '$sessionStorage',
        'viabilidadSinTramiteSgpServicio'
    ];

    function viabilidadDetalleSinTramiteSgpController(
        $scope,
        $sessionStorage,
        viabilidadSinTramiteSgpServicio
    ) {
        var vm = this;
        vm.lang = "es";
        vm.nombreComponente = "sgpviabilidad";
        vm.nombreComponenteHijo = "sgpviabilidadcuestionarioviabilidadsintramitesgp";
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgpviabilidadcuestionarioviabilidadsintramitesgp', handlerValidacion: null, handlerCambios: null, esValido: true }
        ];
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'sgpviabilidadcuestionarioviabilidadsintramitesgp': true
            };
        }
    ...
    angular.module('backbone').component('viabilidadDetalleSinTramiteSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/ajustesProyectoSGP/viabilidadAjustesSinTramite/viabilidad/viabilidadDetalleSinTramiteSgp.html",
        controller: viabilidadDetalleSinTramiteSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
