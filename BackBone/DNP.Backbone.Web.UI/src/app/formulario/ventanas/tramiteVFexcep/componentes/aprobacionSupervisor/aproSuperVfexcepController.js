(function () {
    ...
    aprosuperVfexcepController.$inject = ['$scope',];

    function aprosuperVfexcepController(
        $scope,
    ...
    angular.module('backbone').component('aprosuperVfexcep', {
        templateUrl: "/src/app/formulario/ventanas/tramiteVFexcep/componentes/aprobacionSupervisor/aprosuperVfexcep.html",
        controller: aprosuperVfexcepController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
