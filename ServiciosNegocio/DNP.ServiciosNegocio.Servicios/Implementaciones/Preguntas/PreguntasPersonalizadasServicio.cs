namespace DNP.ServiciosNegocio.Servicios.Implementaciones.Preguntas
{
    ...
    public class PreguntasPersonalizadasServicio : ServicioBase<ServicioPreguntasPersonalizadasDto>, IPreguntasPersonalizadasServicio
    {
        private readonly IPreguntasPersonalizadasPersistencia _preguntasPersonalizadasPersistencia;
        private readonly IPreguntasPersonalizadasComponentePersistencia _preguntasPersonalizadasComponentePersistencia;
        public string Usuario { get; set; }
        public string Ip { get; set; }

        public PreguntasPersonalizadasServicio(IPreguntasPersonalizadasPersistencia preguntasPersonalizadasPersistencia,
            IPreguntasPersonalizadasComponentePersistencia preguntasPersonalizadasComponentePersistencia,
        ...
        public ServicioPreguntasPersonalizadasDto ObtenerPreguntasPersonalizadasComponente(string bPin, Guid nivelId, Guid instanciaId, string nombreComponente, string listaRoles)
        {
            ...
            if (tipoGrilla == TipoGrillaPreguntasEnum.Generales || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                preguntas.PreguntasGenerales = _preguntasPersonalizadasComponentePersistencia.ObtenerPreguntasGeneralesComponente(bPin, nivelId, instanciaId, nombreComponente, listaRoles, out infoCuestionario);
                if (infoCuestionario != null)
                {
                    preguntas.CodigoBPIN = infoCuestionario.CodigoBPIN;
                    preguntas.Cuestionario = infoCuestionario.Cuestionario;
            ...
            if (tipoGrilla == TipoGrillaPreguntasEnum.Especificas || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                preguntas.PreguntasEspecificas = _preguntasPersonalizadasComponentePersistencia.ObtenerPreguntasEspecificasComponente(bPin, nivelId, instanciaId, nombreComponente, listaRoles, out infoCuestionario);
                if (infoCuestionario != null)
                {
                    preguntas.CodigoBPIN = infoCuestionario.CodigoBPIN;
                    preguntas.Cuestionario = infoCuestionario.Cuestionario;
        ...
        public ServicioPreguntasPersonalizadasDto ObtenerPreguntasPersonalizadasComponenteSGR(string bPin, Guid nivelId, Guid instanciaId, string nombreComponente, string listaRoles)
        {
            ...
            if (tipoGrilla == TipoGrillaPreguntasEnum.Generales || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                preguntas.PreguntasGenerales = _preguntasPersonalizadasComponentePersistencia.ObtenerPreguntasGeneralesComponenteSGR(bPin, nivelId, instanciaId, nombreComponente, listaRoles, out infoCuestionario);
                if (infoCuestionario != null)
                {
                    preguntas.CodigoBPIN = infoCuestionario.CodigoBPIN;
                    preguntas.Cuestionario = infoCuestionario.Cuestionario;
            ...
            if (tipoGrilla == TipoGrillaPreguntasEnum.Especificas || tipoGrilla == TipoGrillaPreguntasEnum.TodosLosTipos)
            {
                preguntas.PreguntasEspecificas = _preguntasPersonalizadasComponentePersistencia.ObtenerPreguntasEspecificasComponenteSGR(bPin, nivelId, instanciaId, nombreComponente, listaRoles, out infoCuestionario);
                if (infoCuestionario != null)
                {
                    preguntas.CodigoBPIN = infoCuestionario.CodigoBPIN;
                    preguntas.Cuestionario = infoCuestionario.Cuestionario;
        ...
        public void GuardarCustomSGR(ParametrosGuardarDto<ServicioPreguntasPersonalizadasDto> parametrosGuardar, ParametrosAuditoriaDto parametrosAuditoria,
                                     bool guardarTemporalmente)
        {
            string mensajeAccion;

            GuardadoDefinitivoCustomSGR(parametrosGuardar, parametrosAuditoria.Usuario);
            mensajeAccion = string.Format(ServiciosNegocioRecursos.GuardadoDefinitivo, parametrosGuardar.Contenido);
        ...
        protected void GuardadoDefinitivoCustomSGR(ParametrosGuardarDto<ServicioPreguntasPersonalizadasDto> parametrosGuardar, string usuario)
        {
            ...
            _preguntasPersonalizadasComponentePersistencia.GuardarDefinitivamenteCustomSGR(parametrosGuardar, usuario);

            GenerarAuditoriaGlobal(parametrosGuardar, parametrosAuditoria, TipoMensajeEnum.Creacion, "GuardadoDefinitivoCustomSGR");
        ...
        {
            return _preguntasPersonalizadasComponentePersistencia.ObtenerConceptosPreviosEmitidos(bPin, tipoConcepto);
        }
