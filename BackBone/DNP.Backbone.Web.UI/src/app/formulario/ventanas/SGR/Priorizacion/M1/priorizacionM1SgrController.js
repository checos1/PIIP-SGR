(function () {
    ...
    priorizacionM1SgrController.$inject = ['$scope', 'priorizacionSgrServicio', 'utilidades', '$sessionStorage', 'sesionServicios', 'utilsValidacionSeccionCapitulosServicio', 'constantesBackbone','validacionArchivosServicio'];

    function priorizacionM1SgrController(
        $scope,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'sgrpriorizacionm1priorizacion', handlerValidacion: null, handlerCambios: null, esValido: true, errores: null },
        ...
        vm.inicializarComponenteCheck = function (estado) {
            ...
            vm.handlerComponentesChecked = {
                'sgrpriorizacionm1priorizacion': true,
                'sgrpriorizacionm1soportes': true,
            };
        }
    ...
    angular.module('backbone').component('priorizacionM1Sgr', {
        templateUrl: "/src/app/formulario/ventanas/SGR/Priorizacion/M1/priorizacionM1Sgr.html",

        controller: priorizacionM1SgrController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
