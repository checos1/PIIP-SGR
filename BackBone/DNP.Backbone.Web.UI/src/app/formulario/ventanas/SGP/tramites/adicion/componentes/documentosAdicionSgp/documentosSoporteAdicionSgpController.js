(function () {
    ...
    documentosSoporteAdicionSgpController.$inject = ['$scope', '$sessionStorage'];

    function documentosSoporteAdicionSgpController(
        $scope,
        $sessionStorage,
    ...
    angular.module('backbone').component('documentosSoporteAdicionSgp', {
        templateUrl: "/src/app/formulario/ventanas/SGP/tramites/adicion/componentes/documentosAdicionSgp/documentosSoporteAdicionSgp.html",
        controller: documentosSoporteAdicionSgpController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
