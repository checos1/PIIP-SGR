(function () {
    ...
    informacionPresupuestalalController.$inject = [
        '$scope',
        '$sessionStorage',
    ...
    function informacionPresupuestalalController(
        $scope,
        $sessionStorage,
        aclaracionLeyendaServicio,
        utilidades,
        ...
        vm.handlerComponentes = [
            { id: 1, componente: 'informacionpresupuestalsolicitudmodifi', handlerValidacion: null, handlerCambios: null, esValido: true },
        ];
       ...
       * */
        ...
        vm.inicializarComponenteCheck = function () {
            vm.handlerComponentesChecked = {
                'informacionpresupuestalsolicitudmodifi': true,
            };
        }
        ...
        */
        ...
        vm.deshabilitarBotonDevolver = function () {
            vm.callback();
    ...
    angular.module('backbone').component('informacionPresupuestalal', {
        templateUrl: "src/app/formulario/ventanas/tramiteLeyenda/componentes/informacionPresupuestal/informacionPresupuestalal.html",
        controller: informacionPresupuestalalController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            tramiteid: '@',
