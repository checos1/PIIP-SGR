(function () {
    ...
    tramiteModificacionDTrasladoAPasoTresController.$inject = [
        '$sessionStorage',
        '$scope',
    ...
    function tramiteModificacionDTrasladoAPasoTresController(
        $sessionStorage,
        $scope,
        tramiteVigenciaFuturaServicio,
        constantesBackbone,
    ...
    angular.module('backbone').component('tramiteModificacionDTrasladoAPasoTres', {
        templateUrl: "src/app/formulario/ventanas/tramiteModificacionDecretoTraslado/analista/tramiteModificacionDTrasladoAPasoTres.html",
        controller: tramiteModificacionDTrasladoAPasoTresController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
            registrarEvento: '&'
