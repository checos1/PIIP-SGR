(function () {
    ...
    aprosuperOrdinarioController.$inject = ['$scope',];

    function aprosuperOrdinarioController(
        $scope,
    ...
    angular.module('backbone').component('aprosuperOrdinario', {
        templateUrl: "/src/app/formulario/ventanas/tramiteTrasladoOrdinario/componentes/aprobacionSupervisor/aprosuperOrdinario.html",
        controller: aprosuperOrdinarioController,
        controllerAs: "vm",
        bindings: {
            callback: '&',
