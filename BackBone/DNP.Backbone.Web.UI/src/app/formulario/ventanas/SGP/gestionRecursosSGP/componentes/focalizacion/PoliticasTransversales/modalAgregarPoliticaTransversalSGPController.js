(function () {
    ...
    modalAgregarPoliticaTransversalSgpController.$inject = [
        '$sessionStorage',
        '$uibModalInstance',
    ...
    function modalAgregarPoliticaTransversalSgpController(
        $uibModalInstance,
        $sessionStorage,
        focalizacionAjustesSGPServicio,
        utilidades
        ...
        function guardar() {
            ...
            return focalizacionAjustesSGPServicio.guardarPoliticasTransversalesAjustesSGP(parametros, usuarioDNP)
        ...
        async function _listarRecursosEntidades(idEntidad) {
            ...
            return focalizacionAjustesSGPServicio.obtenerListaRecursosSGP(parametros, idEntidad)
                .then(respuesta => {
                    if (!respuesta.data)
                        return;
    ...
    angular.module('backbone').controller('modalAgregarPoliticaTransversalSgpController', modalAgregarPoliticaTransversalSgpController);
